...
class SlackLogger:
    ...
    def _save_and_post_to_slack(self, error_text: str, message: str, channel_id: str | None, color: str | None):
        ...
        self.slacker.post_message(message=message, error_text=truncated_error_text, channel_id=channel_id, color=color)
