...
class EnumWithSelectedValue_MicroGeometryDefinitionMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _741.MicroGeometryDefinitionMethod
        """
        return _741.MicroGeometryDefinitionMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _741.MicroGeometryDefinitionMethod.type_()

    @property
    def selected_value(self: "Self") -> "_741.MicroGeometryDefinitionMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_741.MicroGeometryDefinitionMethod]":
