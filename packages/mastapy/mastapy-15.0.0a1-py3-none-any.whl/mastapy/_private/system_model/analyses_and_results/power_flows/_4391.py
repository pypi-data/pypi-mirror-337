...
class WormGearSetPowerFlow(_4321.GearSetPowerFlow):
    """WormGearSetPowerFlow
    ...
    @property
    def rating(self: "Self") -> "_460.WormGearSetRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_460.WormGearSetRating":
        """mastapy.gears.rating.worm.WormGearSetRating
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4390.WormGearPowerFlow]":
    ...
    @property
    def worm_gears_power_flow(self: "Self") -> "List[_4390.WormGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4389.WormGearMeshPowerFlow]":
    ...
    @property
    def worm_meshes_power_flow(self: "Self") -> "List[_4389.WormGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearMeshPowerFlow]
