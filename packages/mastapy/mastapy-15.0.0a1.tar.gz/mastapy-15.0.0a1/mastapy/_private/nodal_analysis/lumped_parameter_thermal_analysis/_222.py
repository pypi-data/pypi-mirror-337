...
class _Cast_UserDefinedThermalConnectorWithResistance:
    ...
    def thermal_connector_with_resistance(
        self: "CastSelf",
    ) -> "_211.ThermalConnectorWithResistance":
        return self.__parent__._cast(_211.ThermalConnectorWithResistance)

    @property
    def thermal_connector(self: "CastSelf") -> "_209.ThermalConnector":
        from mastapy._private.nodal_analysis.lumped_parameter_thermal_analysis import (
            _209,
        )

        return self.__parent__._cast(_209.ThermalConnector)
...
class UserDefinedThermalConnectorWithResistance(_211.ThermalConnectorWithResistance):
    """UserDefinedThermalConnectorWithResistance
