...
class ProfileSet(_0.APIBase):
    ...
    @property
    def active_profile_type(self: "Self") -> "_2077.RollerBearingProfileTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2077", "RollerBearingProfileTypes"
        )(value)

    @active_profile_type.setter
    @enforce_parameter_types
    def active_profile_type(
        self: "Self", value: "_2077.RollerBearingProfileTypes"
    ) -> None:
    ...
    @property
    def active_profile(self: "Self") -> "_2122.RollerBearingProfile":
