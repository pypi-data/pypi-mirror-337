...
from mastapy._private.utility.enums import _2003, _2004
...
class _Cast_PartAnalysisCaseWithContourViewable:
    ...
    def abstract_system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2434.AbstractSystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2434

        return self.__parent__._cast(_2434.AbstractSystemDeflectionViewable)

    @property
    def advanced_system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2435.AdvancedSystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2435

        return self.__parent__._cast(_2435.AdvancedSystemDeflectionViewable)

    @property
    def dynamic_analysis_viewable(self: "CastSelf") -> "_2439.DynamicAnalysisViewable":
        from mastapy._private.system_model.drawing import _2439

        return self.__parent__._cast(_2439.DynamicAnalysisViewable)

    @property
    def harmonic_analysis_viewable(
        self: "CastSelf",
    ) -> "_2440.HarmonicAnalysisViewable":
        from mastapy._private.system_model.drawing import _2440

        return self.__parent__._cast(_2440.HarmonicAnalysisViewable)

    @property
    def modal_analysis_viewable(self: "CastSelf") -> "_2442.ModalAnalysisViewable":
        from mastapy._private.system_model.drawing import _2442

        return self.__parent__._cast(_2442.ModalAnalysisViewable)

    @property
    def system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2451.SystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2451

        return self.__parent__._cast(_2451.SystemDeflectionViewable)
...
class PartAnalysisCaseWithContourViewable(_0.APIBase):
    ...
    def contour(
        self: "Self", value: "_2003.ThreeDViewContourOptionFirstSelection"
    ) -> None:
    ...
    @enforce_parameter_types
    def contour_secondary(
        self: "Self", value: "_2004.ThreeDViewContourOptionSecondSelection"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def contour_draw_style(self: "Self") -> "_2437.ContourDrawStyle":
