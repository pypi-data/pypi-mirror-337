...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating import _441, _449
    from mastapy._private.gears.rating.concept import _636
    from mastapy._private.gears.rating.conical import _625
    from mastapy._private.gears.rating.cylindrical import _547, _564
...
class GearSetDutyCycleRating(_438.AbstractGearSetRating):
    """GearSetDutyCycleRating
    ...
    @property
    def gear_set_design(self: "Self") -> "_1047.GearSetDesign":
    ...
    @property
    def gear_ratings(self: "Self") -> "List[_441.GearDutyCycleRating]":
    ...
    @property
    def gear_duty_cycle_ratings(self: "Self") -> "List[_441.GearDutyCycleRating]":
        """List[mastapy.gears.rating.GearDutyCycleRating]
    ...
    @property
    def gear_mesh_ratings(self: "Self") -> "List[_449.MeshDutyCycleRating]":
    ...
    @property
    def gear_mesh_duty_cycle_ratings(self: "Self") -> "List[_449.MeshDutyCycleRating]":
        """List[mastapy.gears.rating.MeshDutyCycleRating]
