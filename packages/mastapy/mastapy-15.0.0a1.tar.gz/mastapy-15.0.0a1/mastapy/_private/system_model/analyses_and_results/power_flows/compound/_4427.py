...
class ConicalGearCompoundPowerFlow(_4453.GearCompoundPowerFlow):
    """ConicalGearCompoundPowerFlow
    ...
    @property
    def gear_duty_cycle_rating(self: "Self") -> "_622.ConicalGearDutyCycleRating":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4291.ConicalGearPowerFlow]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4291.ConicalGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConicalGearPowerFlow]
