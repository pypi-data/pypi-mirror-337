...
class V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobs(BaseModel):
    ...
    active: Optional[V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive] = (
        None
    )
    accruing: Optional[
        V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsAccruing
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "per": V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPer.from_dict(
                    obj["per"]
                )
                if obj.get("per") is not None
                else None,
                "active": V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive.from_dict(
                    obj["active"]
                )
                if obj.get("active") is not None
                else None,
                "accruing": V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsAccruing.from_dict(
                    obj["accruing"]
                )
                if obj.get("accruing") is not None
                else None,
                "total": V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsTotal.from_dict(
                    obj["total"]
                )
