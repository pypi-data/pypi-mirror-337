...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1630
    ...
    from mastapy._private.system_model.part_model import _2631, _2639, _2657, _2666
...
class CycloidalDisc(_2630.AbstractShaft):
    """CycloidalDisc
    ...
    @property
    def cycloidal_disc_design(self: "Self") -> "_1630.CycloidalDiscDesign":
    ...
    @property
    def disc_material(self: "Self") -> "_352.Material":
    ...
    @property
    def load_sharing_settings(self: "Self") -> "_2657.LoadSharingSettings":
    ...
    def planetary_bearing_sockets(
        self: "Self",
    ) -> "List[_2530.CycloidalDiscPlanetaryBearingSocket]":
