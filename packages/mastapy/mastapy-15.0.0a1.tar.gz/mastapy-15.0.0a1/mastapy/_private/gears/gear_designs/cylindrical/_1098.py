...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1155, _1156
...
class CaseHardeningProperties(_0.APIBase):
    ...
    def hardness_profile_calculation_method(
        self: "Self",
    ) -> "_1155.HardnessProfileCalculationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1155",
    ...
    @enforce_parameter_types
    def hardness_profile_calculation_method(
        self: "Self", value: "_1155.HardnessProfileCalculationMethod"
    ) -> None:
    ...
    @property
    def heat_treatment_type(self: "Self") -> "_1156.HeatTreatmentType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1156", "HeatTreatmentType"
        )(value)
