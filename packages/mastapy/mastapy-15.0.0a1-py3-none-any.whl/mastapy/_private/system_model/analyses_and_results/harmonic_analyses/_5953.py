...
class BoltHarmonicAnalysis(_5959.ComponentHarmonicAnalysis):
    """BoltHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7658.BoltLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2916.BoltSystemDeflection":
