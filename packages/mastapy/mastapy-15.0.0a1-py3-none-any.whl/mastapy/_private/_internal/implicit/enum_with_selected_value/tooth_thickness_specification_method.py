...
class EnumWithSelectedValue_ToothThicknessSpecificationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ToothThicknessSpecificationMethod]",
    ) -> "_1303.ToothThicknessSpecificationMethod":
        ...
        Returns:
            _1303.ToothThicknessSpecificationMethod
        """
        return _1303.ToothThicknessSpecificationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1303.ToothThicknessSpecificationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1303.ToothThicknessSpecificationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1303.ToothThicknessSpecificationMethod]":
