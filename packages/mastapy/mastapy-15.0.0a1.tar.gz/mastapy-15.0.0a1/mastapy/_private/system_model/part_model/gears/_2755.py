...
class WormGearSet(_2734.GearSet):
    """WormGearSet
    ...
    @property
    def active_gear_set_design(self: "Self") -> "_1056.WormGearSetDesign":
    ...
    @property
    def worm_gear_set_design(self: "Self") -> "_1056.WormGearSetDesign":
        """mastapy.gears.gear_designs.worm.WormGearSetDesign
    ...
    @property
    def worm_gears(self: "Self") -> "List[_2754.WormGear]":
    ...
    @property
    def worm_meshes(self: "Self") -> "List[_2520.WormGearMesh]":
