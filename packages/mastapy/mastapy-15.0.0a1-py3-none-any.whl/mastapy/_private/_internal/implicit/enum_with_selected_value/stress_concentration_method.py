...
class EnumWithSelectedValue_StressConcentrationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_StressConcentrationMethod]",
    ) -> "_2299.StressConcentrationMethod":
        ...
        Returns:
            _2299.StressConcentrationMethod
        """
        return _2299.StressConcentrationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2299.StressConcentrationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2299.StressConcentrationMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_2299.StressConcentrationMethod]":
