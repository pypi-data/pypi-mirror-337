...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.hypoid import _525
    from mastapy._private.gears.rating.iso_10300 import _504, _512, _519
...
class BevelHypoidGearRatingSettingsItem(_2011.NamedDatabaseItem):
    """BevelHypoidGearRatingSettingsItem
    ...
    @property
    def bevel_gear_rating_method(self: "Self") -> "_700.RatingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.materials._700", "RatingMethods"
        )(value)

    @bevel_gear_rating_method.setter
    @enforce_parameter_types
    def bevel_gear_rating_method(self: "Self", value: "_700.RatingMethods") -> None:
    ...
    def bevel_general_load_factors_k_method(
        self: "Self",
    ) -> "_504.GeneralLoadFactorCalculationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._504", "GeneralLoadFactorCalculationMethod"
        )(value)

    @bevel_general_load_factors_k_method.setter
    @enforce_parameter_types
    def bevel_general_load_factors_k_method(
        self: "Self", value: "_504.GeneralLoadFactorCalculationMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Iso10300.GeneralLoadFactorCalculationMethod",
    ...
    def bevel_pitting_factor_calculation_method(
        self: "Self",
    ) -> "_519.PittingFactorCalculationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._519", "PittingFactorCalculationMethod"
        )(value)

    @bevel_pitting_factor_calculation_method.setter
    @enforce_parameter_types
    def bevel_pitting_factor_calculation_method(
        self: "Self", value: "_519.PittingFactorCalculationMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def hypoid_gear_rating_method(self: "Self") -> "_525.HypoidRatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.hypoid._525", "HypoidRatingMethod"
        )(value)

    @hypoid_gear_rating_method.setter
    @enforce_parameter_types
    def hypoid_gear_rating_method(
        self: "Self", value: "_525.HypoidRatingMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def iso_rating_method_for_bevel_gears(self: "Self") -> "_512.ISO10300RatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._512", "ISO10300RatingMethod"
        )(value)

    @iso_rating_method_for_bevel_gears.setter
    @enforce_parameter_types
    def iso_rating_method_for_bevel_gears(
        self: "Self", value: "_512.ISO10300RatingMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def iso_rating_method_for_hypoid_gears(self: "Self") -> "_512.ISO10300RatingMethod":
        """mastapy.gears.rating.isoISO10300RatingMethod"""
