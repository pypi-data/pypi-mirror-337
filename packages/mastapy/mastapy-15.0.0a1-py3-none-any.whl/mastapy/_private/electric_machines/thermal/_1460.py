...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.lumped_parameter_thermal_analysis import _201
...
class EndWindingThermalElement(_212.ThermalElement):
    """EndWindingThermalElement
    ...
    @property
    def face(self: "Self") -> "_201.GenericConvectionFace":
