...
class EnumWithSelectedValue_ScuffingCoefficientOfFrictionMethods(
    ...
    def wrapped_type(
        ...
        Returns:
            _1177.ScuffingCoefficientOfFrictionMethods
        """
        return _1177.ScuffingCoefficientOfFrictionMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1177.ScuffingCoefficientOfFrictionMethods.type_()

    @property
    def selected_value(self: "Self") -> "_1177.ScuffingCoefficientOfFrictionMethods":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1177.ScuffingCoefficientOfFrictionMethods]":
