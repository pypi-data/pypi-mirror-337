...
if TYPE_CHECKING:
    ...
    from msgspec_schemaorg.models.intangible.PaymentMethodType import PaymentMethodType
...
class PaymentCard(Struct, frozen=True):
    ...
    paymentMethodType: 'PaymentMethodType' | None = None
    ...
    monthlyMinimumRepaymentAmount: 'MonetaryAmount' | int | float | None = None
    cashBack: bool | int | float | None = None