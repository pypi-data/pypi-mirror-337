...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _825
...
class _Cast_CutterSimulationCalc:
    ...
    def form_wheel_grinding_simulation_calculator(
        self: "CastSelf",
    ) -> "_834.FormWheelGrindingSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _834,
        )

        return self.__parent__._cast(_834.FormWheelGrindingSimulationCalculator)

    @property
    def hob_simulation_calculator(self: "CastSelf") -> "_836.HobSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _836,
        )

        return self.__parent__._cast(_836.HobSimulationCalculator)

    @property
    def rack_simulation_calculator(self: "CastSelf") -> "_839.RackSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _839,
        )

        return self.__parent__._cast(_839.RackSimulationCalculator)

    @property
    def shaper_simulation_calculator(
        self: "CastSelf",
    ) -> "_841.ShaperSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _841,
        )

        return self.__parent__._cast(_841.ShaperSimulationCalculator)

    @property
    def shaving_simulation_calculator(
        self: "CastSelf",
    ) -> "_842.ShavingSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _842,
        )

        return self.__parent__._cast(_842.ShavingSimulationCalculator)

    @property
    def virtual_simulation_calculator(
        self: "CastSelf",
    ) -> "_843.VirtualSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _843,
        )

        return self.__parent__._cast(_843.VirtualSimulationCalculator)

    @property
    def worm_grinder_simulation_calculator(
        self: "CastSelf",
    ) -> "_844.WormGrinderSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _844,
        )

        return self.__parent__._cast(_844.WormGrinderSimulationCalculator)
...
class CutterSimulationCalc(_0.APIBase):
    ...
    @property
    def gear(self: "Self") -> "_828.CylindricalCutterSimulatableGear":
    ...
    @property
    def stock_removed_at_designed_sap(self: "Self") -> "_833.FinishStockPoint":
    ...
    @property
    def stock_removed_at_reference_diameter(self: "Self") -> "_833.FinishStockPoint":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.FinishStockPoint
    ...
    @property
    def stock_removed_at_rough_tip_form(self: "Self") -> "_833.FinishStockPoint":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.FinishStockPoint
    ...
    @property
    def finish_stock_indexed_arcs(self: "Self") -> "List[_833.FinishStockPoint]":
    ...
    @property
    def gear_fillet_points(self: "Self") -> "List[_825.NamedPoint]":
    ...
    @property
    def main_profile_finish_stock(self: "Self") -> "List[_833.FinishStockPoint]":
        """List[mastapy.gears.manufacturing.cylindrical.cutter_simulation.FinishStockPoint]
