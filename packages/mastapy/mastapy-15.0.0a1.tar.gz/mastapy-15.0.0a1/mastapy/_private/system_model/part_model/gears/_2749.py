...
class StraightBevelDiffGearSet(_2722.BevelGearSet):
    """StraightBevelDiffGearSet
    ...
    @property
    def conical_gear_set_design(self: "Self") -> "_1064.StraightBevelDiffGearSetDesign":
    ...
    @property
    def straight_bevel_diff_gears(self: "Self") -> "List[_2748.StraightBevelDiffGear]":
    ...
    def straight_bevel_diff_meshes(
        self: "Self",
    ) -> "List[_2516.StraightBevelDiffGearMesh]":
