...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.interference_fits import _1623
...
class InterferenceFitHalfDesign(_1564.DetailedRigidConnectorHalfDesign):
    """InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self: "Self") -> "_1623.StressRegions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.detailed_rigid_connectors.interference_fits._1623",
            "StressRegions",
        )(value)
    ...
    @property
    def tolerance(self: "Self") -> "_2108.SupportTolerance":
