...
class GearMeshCompoundPowerFlow(
    ...
    @property
    def gear_mesh_duty_cycle_rating(self: "Self") -> "_449.MeshDutyCycleRating":
    ...
    @property
    def connection_analysis_cases(self: "Self") -> "List[_4319.GearMeshPowerFlow]":
