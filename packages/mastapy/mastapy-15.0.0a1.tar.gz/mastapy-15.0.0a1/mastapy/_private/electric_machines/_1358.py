...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1359, _1366, _1428, _1447
...
class _Cast_AbstractStator:
    ...
    @property
    def cad_stator(self: "CastSelf") -> "_1366.CADStator":
        from mastapy._private.electric_machines import _1366

        return self.__parent__._cast(_1366.CADStator)

    @property
    def stator(self: "CastSelf") -> "_1428.Stator":
        from mastapy._private.electric_machines import _1428

        return self.__parent__._cast(_1428.Stator)
...
class AbstractStator(_0.APIBase):
    ...
    @property
    def tooth_and_slot(self: "Self") -> "_1359.AbstractToothAndSlot":
