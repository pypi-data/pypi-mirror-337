...
class ConceptGearMesh(_2504.GearMesh):
    """ConceptGearMesh
    ...
    @property
    def active_gear_mesh_design(self: "Self") -> "_1290.ConceptGearMeshDesign":
    ...
    @property
    def concept_gear_mesh_design(self: "Self") -> "_1290.ConceptGearMeshDesign":
        """mastapy.gears.gear_designs.concept.ConceptGearMeshDesign
