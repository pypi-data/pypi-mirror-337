...
def parse_memtest_umcs(file_name, system_name, bios, output_file):
    ...
    if(os.path.splitext(file_name)[1] == ".log"):
        ...
        df_am = {"Log File":[fl],"System":[system_name],"BIOS":[bios],"IOD0 ESID Pass":["Pass" if esid_complete_match0 else "Fail"],
...
def check_memtest(inputlog, memtest_output):
    header_data = {"Log File":[],"System":[],"BIOS":[],"IOD0 Pass":[],"IOD1 Pass":[], "Miscompares":[], "Channels Absent From Memtest":[]}
