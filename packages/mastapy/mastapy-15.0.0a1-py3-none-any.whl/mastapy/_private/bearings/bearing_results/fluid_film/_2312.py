...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.fluid_film import _2310, _2313, _2314
...
class LoadedPlainJournalBearingResults(_2309.LoadedFluidFilmBearingResults):
    """LoadedPlainJournalBearingResults
    ...
    def journal_bearing_rows(
        self: "Self",
    ) -> "List[_2313.LoadedPlainJournalBearingRow]":
