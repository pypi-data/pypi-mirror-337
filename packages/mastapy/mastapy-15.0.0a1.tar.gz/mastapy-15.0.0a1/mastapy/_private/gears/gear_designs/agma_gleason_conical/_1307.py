...
from mastapy._private.gears.gear_designs.conical import _1268, _1282
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.iso_10300 import _505, _518, _520, _521
...
class AGMAGleasonConicalGearMeshDesign(_1268.ConicalGearMeshDesign):
    """AGMAGleasonConicalGearMeshDesign
    ...
    def iso10300_gear_set_finishing_methods(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._505", "Iso10300FinishingMethods"
        )(value)

    @iso10300_gear_set_finishing_methods.setter
    @enforce_parameter_types
    def iso10300_gear_set_finishing_methods(
        self: "Self", value: "_505.Iso10300FinishingMethods"
    ) -> None:
    ...
    @enforce_parameter_types
    def load_distribution_factor_method(
        self: "Self", value: "_1282.LoadDistributionFactorMethods"
    ) -> None:
    ...
    def mounting_conditions_of_pinion_and_wheel(
        self: "Self",
    ) -> "_518.MountingConditionsOfPinionAndWheel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._518", "MountingConditionsOfPinionAndWheel"
        )(value)

    @mounting_conditions_of_pinion_and_wheel.setter
    @enforce_parameter_types
    def mounting_conditions_of_pinion_and_wheel(
        self: "Self", value: "_518.MountingConditionsOfPinionAndWheel"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Iso10300.MountingConditionsOfPinionAndWheel",
    ...
    @property
    def profile_crowning_setting(self: "Self") -> "_520.ProfileCrowningSetting":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._520", "ProfileCrowningSetting"
        )(value)

    @profile_crowning_setting.setter
    @enforce_parameter_types
    def profile_crowning_setting(
        self: "Self", value: "_520.ProfileCrowningSetting"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def verification_of_contact_pattern(
        self: "Self",
    ) -> "_521.VerificationOfContactPattern":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._521", "VerificationOfContactPattern"
        )(value)

    @verification_of_contact_pattern.setter
    @enforce_parameter_types
    def verification_of_contact_pattern(
        self: "Self", value: "_521.VerificationOfContactPattern"
    ) -> None:
        value = conversion.mp_to_pn_enum(
