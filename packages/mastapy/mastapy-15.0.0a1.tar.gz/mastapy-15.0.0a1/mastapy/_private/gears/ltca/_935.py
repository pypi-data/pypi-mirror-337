...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _926, _933
...
class _Cast_GearFilletNodeStressResultsRow:
    ...
    def cylindrical_gear_fillet_node_stress_results_row(
        self: "CastSelf",
    ) -> "_926.CylindricalGearFilletNodeStressResultsRow":
        from mastapy._private.gears.ltca import _926

        return self.__parent__._cast(_926.CylindricalGearFilletNodeStressResultsRow)
