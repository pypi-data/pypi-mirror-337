...
class _Cast_CutterProcessSimulation:
    ...
    def form_wheel_grinding_process_simulation(
        self: "CastSelf",
    ) -> "_736.FormWheelGrindingProcessSimulation":
        from mastapy._private.gears.manufacturing.cylindrical.process_simulation import (
            _736,
        )

        return self.__parent__._cast(_736.FormWheelGrindingProcessSimulation)

    @property
    def shaping_process_simulation(self: "CastSelf") -> "_737.ShapingProcessSimulation":
        from mastapy._private.gears.manufacturing.cylindrical.process_simulation import (
            _737,
        )

        return self.__parent__._cast(_737.ShapingProcessSimulation)
