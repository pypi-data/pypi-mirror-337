...
class HobbingProcessTotalModificationCalculation(_762.HobbingProcessCalculation):
    """HobbingProcessTotalModificationCalculation
    ...
    @property
    def total_errors_chart_left_flank(self: "Self") -> "_2051.ThreeDChartDefinition":
    ...
    @property
    def total_errors_chart_right_flank(self: "Self") -> "_2051.ThreeDChartDefinition":
        """mastapy.utility_gui.charts.ThreeDChartDefinition
