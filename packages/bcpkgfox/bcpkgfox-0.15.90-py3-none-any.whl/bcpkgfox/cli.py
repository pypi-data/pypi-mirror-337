    ...
    class exec_gen_:
        ...
        def run_pyinstaller(self):
            ...
            try:
                ...
                if "pynput" in self.cli.find_imports.main(return_=True):
                    command.extend(["--hidden-import", "pynput"])
                if "screeninfo" in self.cli.find_imports.main(return_=True):
                    command.extend(["--hidden-import", "screeninfo"])
