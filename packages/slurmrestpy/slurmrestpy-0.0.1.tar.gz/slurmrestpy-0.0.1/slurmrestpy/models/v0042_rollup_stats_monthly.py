...
class V0042RollupStatsMonthly(BaseModel):
    ...
    count: Optional[StrictInt] = Field(
        default=None, description="Number of monthly rollups since last_run"
    )
    last_run: Optional[StrictInt] = Field(
        default=None, description="Last time monthly rollup ran (UNIX timestamp)"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "duration": V0042RollupStatsMonthlyDuration.from_dict(obj["duration"])
