...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling.skf_module import _2283
...
class DynamicAxialLoadCarryingCapacity(_2286.SKFCalculationResult):
    """DynamicAxialLoadCarryingCapacity
    ...
    @property
    def permissible_axial_load(self: "Self") -> "_2283.PermissibleAxialLoad":
