...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_two_d_fe_analysis import _996
...
class CylindricalGearTIFFAnalysisDutyCycle(_1331.GearDesignAnalysis):
    """CylindricalGearTIFFAnalysisDutyCycle
    ...
    @property
    def analysis(self: "Self") -> "_996.CylindricalGearTwoDimensionalFEAnalysis":
