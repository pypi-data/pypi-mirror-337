...
class ShaftOrHousingSelection(_0.APIBase):
    ...
    @property
    def include_in_tpa_submodel(self: "Self") -> "bool":
        """bool"""
        temp = pythonnet_property_get(self.wrapped, "IncludeInTPASubmodel")
    ...
    @include_in_tpa_submodel.setter
    @enforce_parameter_types
    def include_in_tpa_submodel(self: "Self", value: "bool") -> None:
        pythonnet_property_set(
            self.wrapped,
            "IncludeInTPASubmodel",
