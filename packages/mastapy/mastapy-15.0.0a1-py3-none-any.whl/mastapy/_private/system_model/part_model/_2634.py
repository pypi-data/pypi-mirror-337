...
from mastapy._private.bearings.bearing_results import _2129, _2148
from mastapy._private.bearings.tolerances import _2089
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2055, _2059, _2072
...
class Bearing(_2642.Connector):
    ...
    @enforce_parameter_types
    def bearing_tolerance_class(
        self: "Self", value: "_2089.BearingToleranceClass"
    ) -> None:
    ...
    def bearing_tolerance_definition(
        self: "Self",
    ) -> "_2090.BearingToleranceDefinitionOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.tolerances._2090",
    ...
    @enforce_parameter_types
    def bearing_tolerance_definition(
        self: "Self", value: "_2090.BearingToleranceDefinitionOptions"
    ) -> None:
    ...
    @property
    def damping_options(self: "Self") -> "_2059.BearingDampingMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2059", "BearingDampingMatrixOption"
        )(value)

    @damping_options.setter
    @enforce_parameter_types
    def damping_options(
        self: "Self", value: "_2059.BearingDampingMatrixOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def efficiency_rating_method(
        self: "Self",
        value: "Union[_376.BearingEfficiencyRatingMethod, Tuple[_376.BearingEfficiencyRatingMethod, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    def force_at_zero_displacement_input_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model._2635", "BearingF0InputMethod"
        )(value)

    @force_at_zero_displacement_input_method.setter
    @enforce_parameter_types
    def force_at_zero_displacement_input_method(
        self: "Self", value: "_2635.BearingF0InputMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def inner_fitting_chart(self: "Self") -> "_1964.SimpleChartDefinition":
    ...
    @property
    def journal_bearing_type(self: "Self") -> "_2072.JournalBearingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2072", "JournalBearingType"
        )(value)

    @journal_bearing_type.setter
    @enforce_parameter_types
    def journal_bearing_type(self: "Self", value: "_2072.JournalBearingType") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @model.setter
    @enforce_parameter_types
    def model(self: "Self", value: "_2063.BearingModel") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def outer_fitting_chart(self: "Self") -> "_1964.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    def permissible_axial_load_calculation_method(
        self: "Self",
        value: "Union[_2129.CylindricalRollerMaxAxialLoadMethod, Tuple[_2129.CylindricalRollerMaxAxialLoadMethod, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    @preload.setter
    @enforce_parameter_types
    def preload(self: "Self", value: "_2148.PreloadType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def axial_internal_clearance_tolerance(
        self: "Self",
    ) -> "_2633.AxialInternalClearanceTolerance":
    ...
    @property
    def detail(self: "Self") -> "_2320.BearingDesign":
    ...
    @property
    def inner_support_detail(self: "Self") -> "_2106.SupportDetail":
    ...
    @property
    def left_support_detail(self: "Self") -> "_2106.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def outer_support_detail(self: "Self") -> "_2106.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def overridden_lubrication_detail(self: "Self") -> "_350.LubricationDetail":
    ...
    def radial_internal_clearance_tolerance(
        self: "Self",
    ) -> "_2672.RadialInternalClearanceTolerance":
    ...
    @property
    def right_support_detail(self: "Self") -> "_2106.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def ring_tolerance_inner(self: "Self") -> "_2092.InnerRingTolerance":
    ...
    @property
    def ring_tolerance_left(self: "Self") -> "_2103.RingTolerance":
    ...
    @property
    def ring_tolerance_outer(self: "Self") -> "_2098.OuterRingTolerance":
    ...
    @property
    def ring_tolerance_right(self: "Self") -> "_2103.RingTolerance":
        """mastapy.bearings.tolerances.RingTolerance
    ...
    @property
    def simple_bearing_detail_property(self: "Self") -> "_2320.BearingDesign":
        """mastapy.bearings.bearing_designs.BearingDesign
    ...
    @property
    def support_tolerance_inner(self: "Self") -> "_2093.InnerSupportTolerance":
        """mastapy.bearings.tolerances.InnerSupportTolerance
    ...
    @property
    def support_tolerance_left(self: "Self") -> "_2108.SupportTolerance":
    ...
    @property
    def support_tolerance_outer(self: "Self") -> "_2099.OuterSupportTolerance":
        """mastapy.bearings.tolerances.OuterSupportTolerance
    ...
    @property
    def support_tolerance_right(self: "Self") -> "_2108.SupportTolerance":
        """mastapy.bearings.tolerances.SupportTolerance
    ...
    @property
    def mounting(self: "Self") -> "List[_2636.BearingRaceMountingOptions]":
    ...
    @property
    def tolerance_combinations(self: "Self") -> "List[_2110.ToleranceCombination]":
    ...
    def try_attach_right_side_to(
        self: "Self", shaft: "_2682.Shaft", offset: "float" = float("nan")
    ...
    def set_detail_from_catalogue(
        self: "Self", catalogue: "_2055.BearingCatalog", designation: "str"
    ) -> None:
