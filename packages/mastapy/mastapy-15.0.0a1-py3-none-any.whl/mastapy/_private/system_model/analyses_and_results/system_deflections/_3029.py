...
class SynchroniserHalfSystemDeflection(_3030.SynchroniserPartSystemDeflection):
    """SynchroniserHalfSystemDeflection
    ...
    @property
    def clutch_connection(self: "Self") -> "_2917.ClutchConnectionSystemDeflection":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4378.SynchroniserHalfPowerFlow":
