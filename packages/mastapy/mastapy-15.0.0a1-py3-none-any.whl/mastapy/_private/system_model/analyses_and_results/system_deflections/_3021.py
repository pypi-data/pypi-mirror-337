...
class StraightBevelDiffGearMeshSystemDeflection(_2912.BevelGearMeshSystemDeflection):
    """StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def rating(self: "Self") -> "_482.StraightBevelDiffGearMeshRating":
    ...
    @property
    def connection_load_case(self: "Self") -> "_7789.StraightBevelDiffGearMeshLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4370.StraightBevelDiffGearMeshPowerFlow":
