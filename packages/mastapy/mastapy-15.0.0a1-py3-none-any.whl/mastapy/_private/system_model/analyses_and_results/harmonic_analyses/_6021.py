...
from mastapy._private.system_model.part_model.acoustics import _2832
...
class _Cast_HarmonicAnalysisOptions:
    ...
    def harmonic_analysis_options_for_advanced_time_stepping_analysis_for_modulation(
        self: "CastSelf",
    ) -> "_7149.HarmonicAnalysisOptionsForAdvancedTimeSteppingAnalysisForModulation":
        from mastapy._private.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import (
            _7149,
        )
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    def acoustic_analysis_setup(
        self: "Self", value: "_2832.AcousticAnalysisSetup"
    ) -> None:
    ...
    @enforce_parameter_types
    def damping_specification(
        self: "Self", value: "_5985.DampingSpecification"
    ) -> None:
    ...
    @enforce_parameter_types
    def modal_correction_method(
        self: "Self", value: "_6043.ModalCorrectionMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def per_frequency_damping_profile(self: "Self") -> "_1709.Vector2DListAccessor":
    ...
    @property
    def response_cache_level(self: "Self") -> "_6057.ResponseCacheLevel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses._6057",
            "ResponseCacheLevel",
        )(value)

    @response_cache_level.setter
    @enforce_parameter_types
    def response_cache_level(self: "Self", value: "_6057.ResponseCacheLevel") -> None:
    ...
    @property
    def excitation_selection(self: "Self") -> "_6111.ExcitationSourceSelectionGroup":
    ...
    @property
    def modal_analysis_options(self: "Self") -> "_4894.ModalAnalysisOptions":
    ...
    @property
    def stiffness_options(self: "Self") -> "_6076.StiffnessOptionsForHarmonicAnalysis":
    ...
    def transfer_path_analysis_setup_options(
        self: "Self",
    ) -> "_6106.TransferPathAnalysisSetupOptions":
