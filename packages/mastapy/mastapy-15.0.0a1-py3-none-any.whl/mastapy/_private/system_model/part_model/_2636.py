...
from mastapy._private.bearings.bearing_results import _2150, _2151
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2654, _2665
...
class _Cast_BearingRaceMountingOptions:
    ...
    def inner_bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2654.InnerBearingRaceMountingOptions":
        from mastapy._private.system_model.part_model import _2654

        return self.__parent__._cast(_2654.InnerBearingRaceMountingOptions)

    @property
    def outer_bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2665.OuterBearingRaceMountingOptions":
        from mastapy._private.system_model.part_model import _2665

        return self.__parent__._cast(_2665.OuterBearingRaceMountingOptions)
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    def axial_mounting(self: "Self", value: "_2150.RaceAxialMountingType") -> None:
    ...
    @enforce_parameter_types
    def simple_radial_mounting(
        self: "Self", value: "_2151.RaceRadialMountingType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def mounting_sleeve_material(self: "Self") -> "_326.BearingMaterial":
