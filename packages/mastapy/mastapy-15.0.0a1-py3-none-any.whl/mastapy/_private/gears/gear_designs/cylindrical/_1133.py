...
class _Cast_CylindricalGearSetMacroGeometryOptimiser:
    ...
    @property
    def gear_set_optimiser(self: "CastSelf") -> "_415.GearSetOptimiser":
        return self.__parent__._cast(_415.GearSetOptimiser)
...
class CylindricalGearSetMacroGeometryOptimiser(_415.GearSetOptimiser):
    """CylindricalGearSetMacroGeometryOptimiser
