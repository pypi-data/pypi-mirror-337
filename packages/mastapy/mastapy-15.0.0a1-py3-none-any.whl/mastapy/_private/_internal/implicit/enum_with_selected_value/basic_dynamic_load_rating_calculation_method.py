...
from mastapy._private.bearings import _2056
...
class EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod]",
    ) -> "_2056.BasicDynamicLoadRatingCalculationMethod":
        ...
        Returns:
            _2056.BasicDynamicLoadRatingCalculationMethod
        """
        return _2056.BasicDynamicLoadRatingCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2056.BasicDynamicLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2056.BasicDynamicLoadRatingCalculationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2056.BasicDynamicLoadRatingCalculationMethod]":
