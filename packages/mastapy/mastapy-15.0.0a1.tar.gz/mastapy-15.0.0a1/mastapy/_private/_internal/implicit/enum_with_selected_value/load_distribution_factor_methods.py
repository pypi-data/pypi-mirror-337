...
class EnumWithSelectedValue_LoadDistributionFactorMethods(
    ...
    def wrapped_type(
        ...
        Returns:
            _1282.LoadDistributionFactorMethods
        """
        return _1282.LoadDistributionFactorMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1282.LoadDistributionFactorMethods.type_()

    @property
    def selected_value(self: "Self") -> "_1282.LoadDistributionFactorMethods":
    ...
    @property
    def available_values(self: "Self") -> "List[_1282.LoadDistributionFactorMethods]":
