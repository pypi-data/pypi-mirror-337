...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2394, _2399
    from mastapy._private.system_model.analyses_and_results import _2854
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    def analysis_type(self: "Self", value: "_7644.AnalysisType") -> None:
    ...
    @property
    def parametric_study_type(self: "Self") -> "_7756.ParametricStudyType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7756",
            "ParametricStudyType",
        )(value)

    @parametric_study_type.setter
    @enforce_parameter_types
    def parametric_study_type(self: "Self", value: "_7756.ParametricStudyType") -> None:
    ...
    @property
    def step_save_method(self: "Self") -> "_4624.ParametricStudyToolStepSaveMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.parametric_study_tools._4624",
    ...
    def step_save_method(
        self: "Self", value: "_4624.ParametricStudyToolStepSaveMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ParametricStudyTools.ParametricStudyToolStepSaveMethod",
    ...
    @property
    def external_full_fe_loader(self: "Self") -> "_2399.ExternalFullFELoader":
    ...
    @property
    def step_results(self: "Self") -> "List[_4623.ParametricStudyToolStepResult]":
    ...
    @property
    def study_variables(self: "Self") -> "List[_4625.ParametricStudyVariable]":
    ...
    def parametric_study_logging_variables(
        self: "Self",
    ) -> "List[_2854.AnalysisCaseVariable]":
    ...
    def add_logging_variable(
        self: "Self", design_entity: "_2394.DesignEntity", path: "List[str]"
    ) -> "_2854.AnalysisCaseVariable":
    ...
    def move_study_variable_down(
        self: "Self", study_variable: "_4625.ParametricStudyVariable"
    ) -> None:
        """Method does not return.
    ...
    def remove_logging_variable(
        self: "Self", analysis_variable: "_2854.AnalysisCaseVariable"
    ) -> None:
        """Method does not return.
