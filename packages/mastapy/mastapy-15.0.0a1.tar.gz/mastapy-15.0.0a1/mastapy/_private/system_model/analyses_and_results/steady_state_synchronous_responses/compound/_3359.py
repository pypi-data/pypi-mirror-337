...
class ConceptGearSetCompoundSteadyStateSynchronousResponse(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3223.ConceptGearSetSteadyStateSynchronousResponse]":
    ...
    def concept_gears_compound_steady_state_synchronous_response(
        self: "Self",
    ) -> "List[_3357.ConceptGearCompoundSteadyStateSynchronousResponse]":
    ...
    def concept_meshes_compound_steady_state_synchronous_response(
        self: "Self",
    ) -> "List[_3358.ConceptGearMeshCompoundSteadyStateSynchronousResponse]":
