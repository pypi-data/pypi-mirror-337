...
class V0041OpenapiReservationResp(BaseModel):
    ...
    reservations: List[V0041OpenapiReservationRespReservationsInner] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "reservations": [
                    V0041OpenapiReservationRespReservationsInner.from_dict(_item)
                    for _item in obj["reservations"]
                ]
                if obj.get("reservations") is not None
                else None,
                "last_update": V0041OpenapiReservationRespLastUpdate.from_dict(
                    obj["last_update"]
                )
