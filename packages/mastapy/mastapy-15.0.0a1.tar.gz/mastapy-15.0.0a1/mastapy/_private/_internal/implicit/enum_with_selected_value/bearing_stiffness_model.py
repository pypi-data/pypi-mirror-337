...
class EnumWithSelectedValue_BearingStiffnessModel(
    ...
    def wrapped_type(
        ...
        Returns:
            _5634.BearingStiffnessModel
        """
        return _5634.BearingStiffnessModel
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5634.BearingStiffnessModel.type_()

    @property
    def selected_value(self: "Self") -> "_5634.BearingStiffnessModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_5634.BearingStiffnessModel]":
