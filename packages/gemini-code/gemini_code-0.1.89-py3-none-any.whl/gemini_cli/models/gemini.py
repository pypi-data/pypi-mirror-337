            ...
            while iteration_count < MAX_AGENT_ITERATIONS:
                ...
                try:
                    ...
                    if function_call_part_to_execute:
                        ...
                        if tool_name in ["edit", "create_file"]: # Add other modifying tools like delete_file here if needed
                            file_path = tool_args.get("file_path", "(unknown file)")
                            content = tool_args.get("content", "(no content provided)")
                            ...
                            self.console.print(Panel(
                                f"[bold yellow]Proposed change:[/bold yellow]\n[cyan]Tool:[/cyan] {tool_name}\n[cyan]File:[/cyan] {file_path}\n\n[bold]Content Preview:[/bold]\n---\n{content_preview}\n---",
                                title="Confirm File Modification",
                                border_style="red",
                                expand=False
                            ))
                            
                            confirmation = self.console.input("Apply this change? [y/N] ")
