...
class ConicalGearSetLoadCase(_7722.GearSetLoadCase):
    """ConicalGearSetLoadCase
    ...
    @property
    def gears_load_case(self: "Self") -> "List[_7671.ConicalGearLoadCase]":
    ...
    @property
    def conical_gears_load_case(self: "Self") -> "List[_7671.ConicalGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ConicalGearLoadCase]
    ...
    @property
    def meshes_load_case(self: "Self") -> "List[_7673.ConicalGearMeshLoadCase]":
    ...
    @property
    def conical_meshes_load_case(self: "Self") -> "List[_7673.ConicalGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ConicalGearMeshLoadCase]
