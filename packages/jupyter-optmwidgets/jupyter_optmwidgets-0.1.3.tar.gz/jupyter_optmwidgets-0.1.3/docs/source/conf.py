...
# -*- coding: utf-8 -*-
#
# optmwidgets documentation build configuration file
#
...
_version_py = os.path.join(repo, 'optmwidgets', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'optmwidgetsdoc'
...
latex_documents = [
    (master_doc, 'optmwidgets.tex', 'optmwidgets Documentation',
     'Chung Chan', 'manual'),
]
