...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.concept import _634, _635
...
class ConceptGearSetRating(_447.GearSetRating):
    """ConceptGearSetRating
    ...
    @property
    def concept_gear_set(self: "Self") -> "_1291.ConceptGearSetDesign":
    ...
    @property
    def gear_ratings(self: "Self") -> "List[_635.ConceptGearRating]":
    ...
    @property
    def concept_gear_ratings(self: "Self") -> "List[_635.ConceptGearRating]":
        """List[mastapy.gears.rating.concept.ConceptGearRating]
    ...
    @property
    def gear_mesh_ratings(self: "Self") -> "List[_634.ConceptGearMeshRating]":
    ...
    @property
    def concept_mesh_ratings(self: "Self") -> "List[_634.ConceptGearMeshRating]":
        """List[mastapy.gears.rating.concept.ConceptGearMeshRating]
