...
class FaceGearSetCompoundHarmonicAnalysis(_6203.GearSetCompoundHarmonicAnalysis):
    """FaceGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6004.FaceGearSetHarmonicAnalysis]":
    ...
    def face_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6196.FaceGearCompoundHarmonicAnalysis]":
    ...
    def face_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6197.FaceGearMeshCompoundHarmonicAnalysis]":
