...
class OAuth2ClientAPI(BaseModel):
    """
    OAuth2ClientAPI
    """ # noqa: E501
    ...
    scope: StrictStr
    __properties: ClassVar[List[str]] = ["client_name", "client_uri", "client_id", "logo_uri", "scope"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OAuth2ClientAPI from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OAuth2ClientAPI from a dict"""
        if obj is None:
            return None
