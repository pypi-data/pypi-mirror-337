...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.iso6336 import _611, _614
...
class CylindricalGearToothFatigueFractureResultsN1457(_0.APIBase):
    ...
    @property
    def fatigue_damage_chart(self: "Self") -> "_2051.ThreeDChartDefinition":
    ...
    @property
    def critical_section(self: "Self") -> "_614.ToothFlankFractureAnalysisRowN1457":
    ...
    def mesh_contact_point_a_section(
        self: "Self",
    ) -> "_614.ToothFlankFractureAnalysisRowN1457":
        """mastapy.gears.rating.cylindrical.iso6336.ToothFlankFractureAnalysisRowN1457
    ...
    def mesh_contact_point_ab_section(
        self: "Self",
    ) -> "_611.ToothFlankFractureAnalysisContactPointN1457":
    ...
    @property
    def analysis_rows(self: "Self") -> "List[_614.ToothFlankFractureAnalysisRowN1457]":
    ...
    def contact_points(
        self: "Self",
    ) -> "List[_611.ToothFlankFractureAnalysisContactPointN1457]":
