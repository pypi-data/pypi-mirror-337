...
class ConicalMeshManufacturingConfig(_883.ConicalMeshMicroGeometryConfigBase):
    """ConicalMeshManufacturingConfig
    ...
    @property
    def pinion_config(self: "Self") -> "_884.ConicalPinionManufacturingConfig":
    ...
    @property
    def wheel_config(self: "Self") -> "_890.ConicalWheelManufacturingConfig":
