...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1715, _1720, _1723
...
TAnalysis = TypeVar("TAnalysis", bound="_1330.AbstractGearSetAnalysis")
...
class _Cast_DesignSpaceSearchBase:
    ...
    @property
    def gear_set_pareto_optimiser(self: "CastSelf") -> "_1008.GearSetParetoOptimiser":
        from mastapy._private.gears.gear_set_pareto_optimiser import _1008

        return self.__parent__._cast(_1008.GearSetParetoOptimiser)
    ...
    def micro_geometry_design_space_search(
        self: "CastSelf",
    ) -> "_1012.MicroGeometryDesignSpaceSearch":
        from mastapy._private.gears.gear_set_pareto_optimiser import _1012

        return self.__parent__._cast(_1012.MicroGeometryDesignSpaceSearch)

    @property
    def micro_geometry_gear_set_design_space_search(
        self: "CastSelf",
    ) -> "_1016.MicroGeometryGearSetDesignSpaceSearch":
        from mastapy._private.gears.gear_set_pareto_optimiser import _1016

        return self.__parent__._cast(_1016.MicroGeometryGearSetDesignSpaceSearch)
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @enforce_parameter_types
    def display_candidates(self: "Self", value: "_999.CandidateDisplayChoice") -> None:
    ...
    @property
    def remove_candidates_with(self: "Self") -> "_1011.LargerOrSmaller":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_set_pareto_optimiser._1011", "LargerOrSmaller"
        )(value)

    @remove_candidates_with.setter
    @enforce_parameter_types
    def remove_candidates_with(self: "Self", value: "_1011.LargerOrSmaller") -> None:
    ...
    def chart_details(
        self: "Self",
    ) -> "List[_1000.ChartInfoBase[TAnalysis, TCandidate]]":
    ...
    @property
    def filters(self: "Self") -> "List[_1720.ParetoOptimisationFilter]":
    ...
    @property
    def input_setters(self: "Self") -> "List[_1715.InputSetter[TAnalysis]]":
    ...
    def optimisation_targets(
        self: "Self",
    ) -> "List[_1019.OptimisationTarget[TAnalysis]]":
    ...
    def reasons_for_invalid_candidates(
        self: "Self",
    ) -> "List[_1034.ReasonsForInvalidDesigns]":
