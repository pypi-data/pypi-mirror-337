...
setup(
    ...
    package_data={
        "edgeidx": ["tesseract/Tesseract-OCR/**/*"],  # Includes all Tesseract files
    },
    ...
    project_urls={
        'Source': 'https://github.com/yourusername/edgeidx',
        'Bug Reports': 'https://github.com/yourusername/edgeidx/issues',
    },
)
