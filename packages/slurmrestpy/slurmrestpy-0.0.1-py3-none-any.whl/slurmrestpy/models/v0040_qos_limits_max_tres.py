...
class V0040QosLimitsMaxTres(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "total": [V0040Tres.from_dict(_item) for _item in obj["total"]]
                if obj.get("total") is not None
                else None,
                "minutes": V0040QosLimitsMaxTresMinutes.from_dict(obj["minutes"])
                if obj.get("minutes") is not None
                else None,
                "per": V0040QosLimitsMaxTresPer.from_dict(obj["per"])
