...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1382, _1384, _1385, _1386, _1389
...
class _Cast_FEMeshingOptions:
    ...
    def electric_machine_electromagnetic_and_thermal_meshing_options(
        self: "CastSelf",
    ) -> "_1382.ElectricMachineElectromagneticAndThermalMeshingOptions":
        from mastapy._private.electric_machines import _1382
    ...
    def electric_machine_mechanical_analysis_meshing_options(
        self: "CastSelf",
    ) -> "_1384.ElectricMachineMechanicalAnalysisMeshingOptions":
    ...
    def electric_machine_meshing_options(
        self: "CastSelf",
    ) -> "_1385.ElectricMachineMeshingOptions":
        from mastapy._private.electric_machines import _1385

        return self.__parent__._cast(_1385.ElectricMachineMeshingOptions)

    @property
    def electric_machine_meshing_options_base(
        self: "CastSelf",
    ) -> "_1386.ElectricMachineMeshingOptionsBase":
        from mastapy._private.electric_machines import _1386

        return self.__parent__._cast(_1386.ElectricMachineMeshingOptionsBase)

    @property
    def electric_machine_thermal_meshing_options(
        self: "CastSelf",
    ) -> "_1389.ElectricMachineThermalMeshingOptions":
        from mastapy._private.electric_machines import _1389

        return self.__parent__._cast(_1389.ElectricMachineThermalMeshingOptions)
