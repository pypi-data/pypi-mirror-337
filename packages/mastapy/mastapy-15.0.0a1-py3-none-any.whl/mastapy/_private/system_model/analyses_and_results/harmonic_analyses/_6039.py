...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _6095
...
class MassDiscHarmonicAnalysis(_6095.VirtualComponentHarmonicAnalysis):
    """MassDiscHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7748.MassDiscLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2985.MassDiscSystemDeflection":
