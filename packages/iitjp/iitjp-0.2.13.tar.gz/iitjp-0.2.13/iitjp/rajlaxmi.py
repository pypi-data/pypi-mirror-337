...
# Handle audioop/pyaudioop compatibility for Python 3.13+
try:
    import audioop
    ...
    try:
        ...
        try:
            # Use our bundled implementation as last resort
            from . import pyaudioop as audioop
            print("[ℹ️ Info: Using bundled pyaudioop implementation]")
        except ImportError:
            print("[⚠️ Warning: Audio processing capabilities will be limited]")
...
if platform.system().lower() == 'windows' or sys.platform == 'win32':
    try:
        ...
        print("[⚠️ Warning: winsound module not available. Will use alternative audio playback methods.]")
