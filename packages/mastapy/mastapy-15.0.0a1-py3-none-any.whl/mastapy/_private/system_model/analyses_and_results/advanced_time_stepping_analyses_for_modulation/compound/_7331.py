...
class StraightBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7200.StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def straight_bevel_gears_compound_advanced_time_stepping_analysis_for_modulation(
        ...
        "List[_7329.StraightBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation]"
    ):
    ...
    def straight_bevel_meshes_compound_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7330.StraightBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]":
