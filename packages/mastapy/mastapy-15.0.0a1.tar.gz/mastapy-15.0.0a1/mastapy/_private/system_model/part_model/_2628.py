...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2055, _2082
    from mastapy._private.gears import _416
    from mastapy._private.gears.gear_designs.creation_options import _1258, _1259, _1262
    ...
    T_get_part_named = TypeVar("T_get_part_named", bound="_2666.Part")
    T_all_parts = TypeVar("T_all_parts", bound="_2666.Part")
...
class Assembly(_2629.AbstractAssembly):
    """Assembly
    ...
    @property
    def oil_level_specification(self: "Self") -> "_2663.OilLevelSpecification":
    ...
    @property
    def bearings(self: "Self") -> "List[_2634.Bearing]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_2638.BoltedJoint]":
    ...
    @property
    def component_details(self: "Self") -> "List[_2639.Component]":
    ...
    @property
    def components_with_unknown_scalar_mass(self: "Self") -> "List[_2639.Component]":
        """List[mastapy.system_model.part_model.Component]
    ...
    @property
    def conical_gear_sets(self: "Self") -> "List[_2726.ConicalGearSet]":
    ...
    @property
    def cylindrical_gear_sets(self: "Self") -> "List[_2728.CylindricalGearSet]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_2649.FEPart]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_2731.FaceGearSet]":
    ...
    @property
    def gear_sets(self: "Self") -> "List[_2734.GearSet]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_2737.HypoidGearSet]":
    ...
    def klingelnberg_cyclo_palloid_gear_sets(
        self: "Self",
    ) -> "List[_2739.KlingelnbergCycloPalloidConicalGearSet]":
    ...
    @property
    def microphone_arrays(self: "Self") -> "List[_2661.MicrophoneArray]":
    ...
    @property
    def microphones(self: "Self") -> "List[_2660.Microphone]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_2664.OilSeal]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_2670.PointLoad]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_2671.PowerLoad]":
    ...
    @property
    def shaft_hub_connections(self: "Self") -> "List[_2805.ShaftHubConnection]":
    ...
    @property
    def shafts(self: "Self") -> "List[_2682.Shaft]":
    ...
    @property
    def spiral_bevel_gear_sets(self: "Self") -> "List[_2747.SpiralBevelGearSet]":
    ...
    @property
    def straight_bevel_gear_sets(self: "Self") -> "List[_2751.StraightBevelGearSet]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_2755.WormGearSet]":
    ...
    def get_part_named(self: "Self", name: "str") -> "_2666.Part":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_bearing(self: "Self", name: "str") -> "_2634.Bearing":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_bolt(self: "Self", name: "str") -> "_2637.Bolt":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_datum(self: "Self", name: "str") -> "_2643.Datum":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_fe_part(self: "Self", name: "str") -> "_2649.FEPart":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_mass_disc(self: "Self", name: "str") -> "_2658.MassDisc":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_oil_seal(self: "Self", name: "str") -> "_2664.OilSeal":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_shaft(self: "Self", name: "str") -> "_2682.Shaft":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_face_gear(self: "Self", name: "str") -> "_2730.FaceGear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_gear(self: "Self", name: "str") -> "_2732.Gear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_gear_set(self: "Self", name: "str") -> "_2734.GearSet":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_worm_gear(self: "Self", name: "str") -> "_2754.WormGear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_ring_pins(self: "Self", name: "str") -> "_2773.RingPins":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_clutch(self: "Self", name: "str") -> "_2782.Clutch":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_coupling(self: "Self", name: "str") -> "_2788.Coupling":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_cvt(self: "Self", name: "str") -> "_2791.CVT":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_pulley(self: "Self", name: "str") -> "_2796.Pulley":
        """T_get_part_named
    ...
    def all_parts(self: "Self") -> "List[_2666.Part]":
    ...
    def all_parts_of_type_abstract_shaft(self: "Self") -> "List[_2630.AbstractShaft]":
    ...
    def all_parts_of_type_abstract_shaft_or_housing(
        self: "Self",
    ) -> "List[_2631.AbstractShaftOrHousing]":
    ...
    def all_parts_of_type_bearing(self: "Self") -> "List[_2634.Bearing]":
        """List[mastapy.system_model.part_model.Bearing]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "Bearing")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_bolt(self: "Self") -> "List[_2637.Bolt]":
    ...
    def all_parts_of_type_bolted_joint(self: "Self") -> "List[_2638.BoltedJoint]":
        """List[mastapy.system_model.part_model.BoltedJoint]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel", "BoltedJoint"
        )
    ...
    def all_parts_of_type_component(self: "Self") -> "List[_2639.Component]":
        """List[mastapy.system_model.part_model.Component]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "Component")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_connector(self: "Self") -> "List[_2642.Connector]":
    ...
    def all_parts_of_type_datum(self: "Self") -> "List[_2643.Datum]":
    ...
    def all_parts_of_type_fe_part(self: "Self") -> "List[_2649.FEPart]":
        """List[mastapy.system_model.part_model.FEPart]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "FEPart")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_flexible_pin_assembly(
        self: "Self",
    ) -> "List[_2650.FlexiblePinAssembly]":
    ...
    def all_parts_of_type_guide_dxf_model(self: "Self") -> "List[_2651.GuideDxfModel]":
    ...
    def all_parts_of_type_mass_disc(self: "Self") -> "List[_2658.MassDisc]":
    ...
    def all_parts_of_type_measurement_component(
        self: "Self",
    ) -> "List[_2659.MeasurementComponent]":
    ...
    def all_parts_of_type_microphone(self: "Self") -> "List[_2660.Microphone]":
        """List[mastapy.system_model.part_model.Microphone]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel", "Microphone"
        )
    ...
    def all_parts_of_type_oil_seal(self: "Self") -> "List[_2664.OilSeal]":
        """List[mastapy.system_model.part_model.OilSeal]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "OilSeal")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_planet_carrier(self: "Self") -> "List[_2668.PlanetCarrier]":
    ...
    def all_parts_of_type_point_load(self: "Self") -> "List[_2670.PointLoad]":
        """List[mastapy.system_model.part_model.PointLoad]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "PointLoad")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_power_load(self: "Self") -> "List[_2671.PowerLoad]":
        """List[mastapy.system_model.part_model.PowerLoad]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "PowerLoad")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_root_assembly(self: "Self") -> "List[_2674.RootAssembly]":
    ...
    def all_parts_of_type_specialised_assembly(
        self: "Self",
    ) -> "List[_2676.SpecialisedAssembly]":
    ...
    def all_parts_of_type_unbalanced_mass(self: "Self") -> "List[_2677.UnbalancedMass]":
    ...
    def all_parts_of_type_shaft(self: "Self") -> "List[_2682.Shaft]":
        """List[mastapy.system_model.part_model.shaft_model.Shaft]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.ShaftModel", "Shaft"
        )
    ...
    def all_parts_of_type_agma_gleason_conical_gear(
        self: "Self",
    ) -> "List[_2715.AGMAGleasonConicalGear]":
    ...
    def all_parts_of_type_agma_gleason_conical_gear_set(
        self: "Self",
    ) -> "List[_2716.AGMAGleasonConicalGearSet]":
    ...
    def all_parts_of_type_bevel_differential_gear(
        self: "Self",
    ) -> "List[_2717.BevelDifferentialGear]":
    ...
    def all_parts_of_type_bevel_differential_gear_set(
        self: "Self",
    ) -> "List[_2718.BevelDifferentialGearSet]":
    ...
    def all_parts_of_type_bevel_differential_planet_gear(
        self: "Self",
    ) -> "List[_2719.BevelDifferentialPlanetGear]":
    ...
    def all_parts_of_type_bevel_differential_sun_gear(
        self: "Self",
    ) -> "List[_2720.BevelDifferentialSunGear]":
    ...
    def all_parts_of_type_bevel_gear(self: "Self") -> "List[_2721.BevelGear]":
    ...
    def all_parts_of_type_bevel_gear_set(self: "Self") -> "List[_2722.BevelGearSet]":
    ...
    def all_parts_of_type_concept_gear(self: "Self") -> "List[_2723.ConceptGear]":
    ...
    def all_parts_of_type_conical_gear(self: "Self") -> "List[_2725.ConicalGear]":
    ...
    def all_parts_of_type_cylindrical_planet_gear(
        self: "Self",
    ) -> "List[_2729.CylindricalPlanetGear]":
    ...
    def all_parts_of_type_face_gear(self: "Self") -> "List[_2730.FaceGear]":
    ...
    def all_parts_of_type_face_gear_set(self: "Self") -> "List[_2731.FaceGearSet]":
        """List[mastapy.system_model.part_model.gears.FaceGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "FaceGearSet"
        )
    ...
    def all_parts_of_type_gear(self: "Self") -> "List[_2732.Gear]":
    ...
    def all_parts_of_type_gear_set(self: "Self") -> "List[_2734.GearSet]":
        """List[mastapy.system_model.part_model.gears.GearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "GearSet"
        )
    ...
    def all_parts_of_type_hypoid_gear(self: "Self") -> "List[_2736.HypoidGear]":
    ...
    def all_parts_of_type_hypoid_gear_set(self: "Self") -> "List[_2737.HypoidGearSet]":
        """List[mastapy.system_model.part_model.gears.HypoidGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "HypoidGearSet"
        )
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_conical_gear(
        self: "Self",
    ) -> "List[_2738.KlingelnbergCycloPalloidConicalGear]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear(
        self: "Self",
    ) -> "List[_2740.KlingelnbergCycloPalloidHypoidGear]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(
        self: "Self",
    ) -> "List[_2741.KlingelnbergCycloPalloidHypoidGearSet]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear(
        self: "Self",
    ) -> "List[_2742.KlingelnbergCycloPalloidSpiralBevelGear]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(
        self: "Self",
    ) -> "List[_2743.KlingelnbergCycloPalloidSpiralBevelGearSet]":
    ...
    def all_parts_of_type_straight_bevel_diff_gear(
        self: "Self",
    ) -> "List[_2748.StraightBevelDiffGear]":
    ...
    def all_parts_of_type_straight_bevel_diff_gear_set(
        self: "Self",
    ) -> "List[_2749.StraightBevelDiffGearSet]":
    ...
    def all_parts_of_type_straight_bevel_gear_set(
        self: "Self",
    ) -> "List[_2751.StraightBevelGearSet]":
        """List[mastapy.system_model.part_model.gears.StraightBevelGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "StraightBevelGearSet"
        )
    ...
    def all_parts_of_type_straight_bevel_planet_gear(
        self: "Self",
    ) -> "List[_2752.StraightBevelPlanetGear]":
    ...
    def all_parts_of_type_straight_bevel_sun_gear(
        self: "Self",
    ) -> "List[_2753.StraightBevelSunGear]":
    ...
    def all_parts_of_type_worm_gear(self: "Self") -> "List[_2754.WormGear]":
    ...
    def all_parts_of_type_worm_gear_set(self: "Self") -> "List[_2755.WormGearSet]":
        """List[mastapy.system_model.part_model.gears.WormGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "WormGearSet"
        )
    ...
    def all_parts_of_type_cycloidal_disc(self: "Self") -> "List[_2772.CycloidalDisc]":
    ...
    def all_parts_of_type_ring_pins(self: "Self") -> "List[_2773.RingPins]":
    ...
    def all_parts_of_type_belt_drive(self: "Self") -> "List[_2780.BeltDrive]":
    ...
    def all_parts_of_type_clutch(self: "Self") -> "List[_2782.Clutch]":
    ...
    def all_parts_of_type_clutch_half(self: "Self") -> "List[_2783.ClutchHalf]":
    ...
    def all_parts_of_type_concept_coupling_half(
        self: "Self",
    ) -> "List[_2786.ConceptCouplingHalf]":
    ...
    def all_parts_of_type_coupling(self: "Self") -> "List[_2788.Coupling]":
    ...
    def all_parts_of_type_coupling_half(self: "Self") -> "List[_2789.CouplingHalf]":
    ...
    def all_parts_of_type_cvt(self: "Self") -> "List[_2791.CVT]":
    ...
    def all_parts_of_type_cvt_pulley(self: "Self") -> "List[_2792.CVTPulley]":
    ...
    def all_parts_of_type_part_to_part_shear_coupling(
        self: "Self",
    ) -> "List[_2793.PartToPartShearCoupling]":
    ...
    def all_parts_of_type_part_to_part_shear_coupling_half(
        self: "Self",
    ) -> "List[_2794.PartToPartShearCouplingHalf]":
    ...
    def all_parts_of_type_pulley(self: "Self") -> "List[_2796.Pulley]":
    ...
    def all_parts_of_type_rolling_ring(self: "Self") -> "List[_2803.RollingRing]":
    ...
    def all_parts_of_type_rolling_ring_assembly(
        self: "Self",
    ) -> "List[_2804.RollingRingAssembly]":
    ...
    def all_parts_of_type_spring_damper(self: "Self") -> "List[_2811.SpringDamper]":
    ...
    def all_parts_of_type_synchroniser(self: "Self") -> "List[_2813.Synchroniser]":
    ...
    def all_parts_of_type_torque_converter_pump(
        self: "Self",
    ) -> "List[_2819.TorqueConverterPump]":
    ...
    def all_parts_of_type_torque_converter_turbine(
        self: "Self",
    ) -> "List[_2821.TorqueConverterTurbine]":
    ...
    @enforce_parameter_types
    def add_bearing(self: "Self", name: "str") -> "_2634.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_bearing_with_name_and_rolling_bearing_type(
        self: "Self", name: "str", type_: "_2082.RollingBearingType"
    ) -> "_2634.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_bearing_with_name_rolling_bearing_type_and_designation(
        self: "Self", name: "str", type_: "_2082.RollingBearingType", designation: "str"
    ) -> "_2634.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_belt_drive_with_options(
        self: "Self",
        belt_creation_options: Optional["_2774.BeltCreationOptions"] = None,
    ) -> "_2780.BeltDrive":
    ...
    @enforce_parameter_types
    def add_cvt(self: "Self", name: "str" = "CVT") -> "_2791.CVT":
    ...
    @enforce_parameter_types
    def add_clutch(self: "Self", name: "str" = "Clutch") -> "_2782.Clutch":
    ...
    def add_cycloidal_assembly_with_options(
        ...
        cycloidal_assembly_creation_options: Optional[
            "_2775.CycloidalAssemblyCreationOptions"
        ] = None,
    ) -> "_2771.CycloidalAssembly":
    ...
    def add_cylindrical_gear_pair_with_options(
        ...
        cylindrical_gear_pair_creation_options: Optional[
            "_1258.CylindricalGearPairCreationOptions"
        ] = None,
    ) -> "_2728.CylindricalGearSet":
    ...
    def add_cylindrical_gear_set_with_options(
        ...
        cylindrical_gear_linear_train_creation_options: Optional[
            "_2776.CylindricalGearLinearTrainCreationOptions"
        ] = None,
    ) -> "_2728.CylindricalGearSet":
        """mastapy.system_model.part_model.gears.CylindricalGearSet
    ...
    @enforce_parameter_types
    def add_datum(self: "Self", name: "str" = "Datum") -> "_2643.Datum":
    ...
    @enforce_parameter_types
    def add_fe_part(self: "Self", name: "str" = "FE Part") -> "_2649.FEPart":
    ...
    def add_hypoid_gear_set_detailed(
        ...
        design_method: "_1292.AGMAGleasonConicalGearGeometryMethods" = _1292.AGMAGleasonConicalGearGeometryMethods.GLEASON,
    ) -> "_2737.HypoidGearSet":
        """mastapy.system_model.part_model.gears.HypoidGearSet
    ...
    @enforce_parameter_types
    def add_mass_disc(self: "Self", name: "str" = "Mass Disc") -> "_2658.MassDisc":
    ...
    @enforce_parameter_types
    def add_oil_seal(self: "Self", name: "str" = "Oil Seal") -> "_2664.OilSeal":
    ...
    def add_planet_carrier_with_options(
        ...
        planet_carrier_creation_options: Optional[
            "_2778.PlanetCarrierCreationOptions"
        ] = None,
    ) -> "_2668.PlanetCarrier":
    ...
    @enforce_parameter_types
    def add_point_load(self: "Self", name: "str" = "Point Load") -> "_2670.PointLoad":
    ...
    @enforce_parameter_types
    def add_power_load(self: "Self", name: "str" = "Power Load") -> "_2671.PowerLoad":
    ...
    def add_rolling_bearing_from_catalogue(
        self: "Self", catalogue: "_2055.BearingCatalog", designation: "str", name: "str"
    ) -> "_2634.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_shaft_with_options(
        self: "Self", shaft_creation_options: "_2779.ShaftCreationOptions"
    ) -> "_2682.Shaft":
    ...
    def add_spiral_bevel_gear_set_with_options(
        ...
        spiral_bevel_gear_set_creation_options: Optional[
            "_1262.SpiralBevelGearSetCreationOptions"
        ] = None,
    ) -> "_2747.SpiralBevelGearSet":
    ...
    def add_differential(
        self: "Self", settings: "_1259.DifferentialAssemblyCreationOptions"
    ) -> "Assembly":
        """mastapy.system_model.part_model.Assembly
