...
def setTTS(scene, num, id, idioma , tts, config, voice):
    ...
    print("Parametros:  ")
    print(params[0])
    print(int(params[1])/100)
    print(int(params[2])/100)
    print(int(params[3]))
    print(int(params[4])/100)
    ...
    out = tts.inference(
        ...
        temperature=int(params[1])/100, # Add custom parameters here
        speed=int(params[2])/100,
        top_k=int(params[3]),
        top_p=int(params[4])/100,
