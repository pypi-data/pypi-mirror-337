...
class FEPart(_2631.AbstractShaftOrHousing):
    """FEPart
    ...
    @enforce_parameter_types
    def default_fe_substructure(self: "Self", value: "_2575.FESubstructure") -> None:
        wrapper_type = (
    ...
    def create_fe_substructure(self: "Self") -> "_2575.FESubstructure":
    ...
    def remove_fe_substructure(
        self: "Self", fe_substructure: "_2575.FESubstructure"
    ) -> "bool":
        """bool
