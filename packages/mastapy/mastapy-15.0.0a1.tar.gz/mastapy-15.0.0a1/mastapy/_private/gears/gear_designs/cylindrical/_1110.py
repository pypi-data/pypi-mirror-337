...
class _Cast_CylindricalGearAbstractRackFlank:
    ...
    def cylindrical_gear_basic_rack_flank(
        self: "CastSelf",
    ) -> "_1112.CylindricalGearBasicRackFlank":
        from mastapy._private.gears.gear_designs.cylindrical import _1112

        return self.__parent__._cast(_1112.CylindricalGearBasicRackFlank)

    @property
    def cylindrical_gear_pinion_type_cutter_flank(
        self: "CastSelf",
    ) -> "_1127.CylindricalGearPinionTypeCutterFlank":
        from mastapy._private.gears.gear_designs.cylindrical import _1127

        return self.__parent__._cast(_1127.CylindricalGearPinionTypeCutterFlank)

    @property
    def standard_rack_flank(self: "CastSelf") -> "_1183.StandardRackFlank":
        from mastapy._private.gears.gear_designs.cylindrical import _1183

        return self.__parent__._cast(_1183.StandardRackFlank)
...
class CylindricalGearAbstractRackFlank(_0.APIBase):
    ...
    @property
    def cutter(self: "Self") -> "_1109.CylindricalGearAbstractRack":
