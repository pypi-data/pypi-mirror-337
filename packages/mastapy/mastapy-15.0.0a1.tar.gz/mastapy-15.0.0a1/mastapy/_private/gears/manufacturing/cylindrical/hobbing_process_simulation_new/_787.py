...
class _Cast_WormGrinderManufactureError:
    ...
    @property
    def rack_manufacture_error(self: "CastSelf") -> "_785.RackManufactureError":
        return self.__parent__._cast(_785.RackManufactureError)
...
class WormGrinderManufactureError(_785.RackManufactureError):
    """WormGrinderManufactureError
