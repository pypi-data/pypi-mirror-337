...
class ZerolBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7218.ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def zerol_bevel_gears_compound_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7347.ZerolBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def zerol_bevel_meshes_compound_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7348.ZerolBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]":
