...
class EfficiencyMapLoadCase(_1542.NonLinearDQModelMultipleOperatingPointsLoadCase):
    """EfficiencyMapLoadCase
    ...
    def efficiency_map_settings(
        self: "Self",
    ) -> "_1530.ElectricMachineEfficiencyMapSettings":
