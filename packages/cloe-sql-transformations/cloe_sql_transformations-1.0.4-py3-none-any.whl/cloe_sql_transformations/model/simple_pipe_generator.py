import cloe_metadata.shared.modeler.simple_pipe as shared_simple_pipe
import jinja2
...
class SimplePipeGenerator:
    ...
    def __init__(
        self,
        simple_pipe: shared_simple_pipe.SimplePipe,
        object_identifier_template: jinja2.Template,
    ) -> None:
        self.shared_obj = simple_pipe
        self.object_identifier_template = object_identifier_template
        self.name = simple_pipe.base_obj.name
        self.job_id = simple_pipe.base_obj.job_id
        self.sql_pipe_template: jinja2.Template = jinja2.Template(
            simple_pipe.base_obj.sql_pipe_template
        )
        self.table_mapping: list[
            shared_simple_pipe.TableMapping
        ] = simple_pipe.shared_table_mappings

    def _gen(self, mapping: shared_simple_pipe.TableMapping) -> str:
