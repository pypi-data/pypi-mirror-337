...
from mastapy._private.utility_gui import _2034
...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.file_access_helpers import _1998
...
class _Cast_MultiTimeSeriesDataInputFileOptions:
    ...
    @property
    def data_input_file_options(self: "CastSelf") -> "_2034.DataInputFileOptions":
        return self.__parent__._cast(_2034.DataInputFileOptions)
...
class MultiTimeSeriesDataInputFileOptions(_2034.DataInputFileOptions):
    """MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self: "Self") -> "_1998.TextFileDelimiterOptions":
