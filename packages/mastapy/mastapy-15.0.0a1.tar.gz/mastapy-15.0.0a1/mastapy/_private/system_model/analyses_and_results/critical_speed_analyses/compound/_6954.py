...
class _Cast_AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis:
    ...
    def coaxial_connection_compound_critical_speed_analysis(
        self: "CastSelf",
    ) -> "_6975.CoaxialConnectionCompoundCriticalSpeedAnalysis":
        from mastapy._private.system_model.analyses_and_results.critical_speed_analyses.compound import (
            _6975,
        )
    ...
    def cycloidal_disc_planetary_bearing_connection_compound_critical_speed_analysis(
        self: "CastSelf",
    ) -> "_6997.CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis":
        from mastapy._private.system_model.analyses_and_results.critical_speed_analyses.compound import (
            _6997,
        )
    ...
    def planetary_connection_compound_critical_speed_analysis(
        self: "CastSelf",
    ) -> "_7036.PlanetaryConnectionCompoundCriticalSpeedAnalysis":
        from mastapy._private.system_model.analyses_and_results.critical_speed_analyses.compound import (
            _7036,
        )
...
class AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis(
    ...
    def connection_analysis_cases(
        self: "Self",
    ) -> "List[_6820.AbstractShaftToMountableComponentConnectionCriticalSpeedAnalysis]":
