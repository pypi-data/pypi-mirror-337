...
class SpiralBevelGear(_2721.BevelGear):
    """SpiralBevelGear
    ...
    @property
    def bevel_gear_design(self: "Self") -> "_1066.SpiralBevelGearDesign":
    ...
    @property
    def spiral_bevel_gear_design(self: "Self") -> "_1066.SpiralBevelGearDesign":
        """mastapy.gears.gear_designs.spiral_bevel.SpiralBevelGearDesign
