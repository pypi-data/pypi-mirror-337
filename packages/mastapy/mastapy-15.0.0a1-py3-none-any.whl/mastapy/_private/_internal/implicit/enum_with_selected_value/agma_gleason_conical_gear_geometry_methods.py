...
class EnumWithSelectedValue_AGMAGleasonConicalGearGeometryMethods(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_AGMAGleasonConicalGearGeometryMethods]",
    ) -> "_1292.AGMAGleasonConicalGearGeometryMethods":
        ...
        Returns:
            _1292.AGMAGleasonConicalGearGeometryMethods
        """
        return _1292.AGMAGleasonConicalGearGeometryMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1292.AGMAGleasonConicalGearGeometryMethods.type_()

    @property
    def selected_value(self: "Self") -> "_1292.AGMAGleasonConicalGearGeometryMethods":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1292.AGMAGleasonConicalGearGeometryMethods]":
