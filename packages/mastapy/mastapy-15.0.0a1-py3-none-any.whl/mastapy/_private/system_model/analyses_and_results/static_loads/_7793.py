...
class StraightBevelGearSetLoadCase(_7656.BevelGearSetLoadCase):
    """StraightBevelGearSetLoadCase
    ...
    @property
    def bevel_gears_load_case(self: "Self") -> "List[_7791.StraightBevelGearLoadCase]":
    ...
    def straight_bevel_gears_load_case(
        self: "Self",
    ) -> "List[_7791.StraightBevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.StraightBevelGearLoadCase]
    ...
    def bevel_meshes_load_case(
        self: "Self",
    ) -> "List[_7792.StraightBevelGearMeshLoadCase]":
