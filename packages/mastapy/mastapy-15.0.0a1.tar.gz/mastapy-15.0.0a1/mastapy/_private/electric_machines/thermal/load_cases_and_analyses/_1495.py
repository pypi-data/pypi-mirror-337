...
class ThermalLoadCaseGroup(_0.APIBase):
    ...
    @property
    def load_cases(self: "Self") -> "List[_1494.ThermalLoadCase]":
    ...
    @enforce_parameter_types
    def load_case_named(self: "Self", name: "str") -> "_1494.ThermalLoadCase":
        """mastapy.electric_machines.thermal.load_cases_and_analyses.ThermalLoadCase
    ...
    def perform_compound_analysis_with_progress(
        self: "Self",
        setup: "_1472.ThermalElectricMachineSetup",
        token: "_7859.TaskProgress",
    ) -> "_1764.MethodOutcome":
        """mastapy.utility.MethodOutcome
    ...
    def try_remove_load_case(
        self: "Self", load_case: "_1494.ThermalLoadCase"
    ) -> "bool":
        """bool
