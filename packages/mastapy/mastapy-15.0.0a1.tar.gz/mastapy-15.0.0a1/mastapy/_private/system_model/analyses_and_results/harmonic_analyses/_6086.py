...
class SynchroniserHarmonicAnalysis(_6068.SpecialisedAssemblyHarmonicAnalysis):
    """SynchroniserHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self: "Self") -> "_3032.SynchroniserSystemDeflection":
