classdef  Slice < casadi.PrintableCommon
  ...
  methods
    function v = start(self)
      v = casadiMEX(197, self);
    end
    function v = stop(self)
      v = casadiMEX(198, self);
    end
    function v = step(self)
      v = casadiMEX(199, self);
    end
    ...
    %
    %
      out = casadiMEX(201, self, varargin{:});
      if nargout<=1
        varargout{1}=out;
      else
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(208, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(212, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(213, self, varargin{:});
    end
