...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.hypoid import _1082, _1084, _1085
...
class HypoidGearMeshDesign(_1307.AGMAGleasonConicalGearMeshDesign):
    """HypoidGearMeshDesign
    ...
    @property
    def hypoid_meshed_gears(self: "Self") -> "List[_1085.HypoidMeshedGearDesign]":
