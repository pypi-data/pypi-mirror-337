...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe.links import _2613, _2620
...
class GearMeshFELink(_2618.MultiAngleConnectionFELink):
    """GearMeshFELink
    ...
    def reference_fe_substructure_node_for_misalignments(
        self: "Self", value: "_2577.FESubstructureNode"
    ) -> None:
