...
class CloudConfigAPIModel(APIBaseModel):
    ...
    status: Optional[str]
    organization_uuid: Optional[Union[str, UUID]] = Field(None, alias="organizationUUID")
    name: Optional[str]
    provider_data: Optional[Union[AzureProviderDataAPIModel, AwsProviderDataAPIModel]] = Field(
        None, alias="providerData"
    )
