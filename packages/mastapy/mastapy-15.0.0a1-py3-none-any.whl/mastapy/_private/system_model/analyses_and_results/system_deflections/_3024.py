...
class StraightBevelGearMeshSystemDeflection(_2912.BevelGearMeshSystemDeflection):
    """StraightBevelGearMeshSystemDeflection
    ...
    @property
    def rating(self: "Self") -> "_479.StraightBevelGearMeshRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_479.StraightBevelGearMeshRating":
        """mastapy.gears.rating.straight_bevel.StraightBevelGearMeshRating
    ...
    @property
    def power_flow_results(self: "Self") -> "_4373.StraightBevelGearMeshPowerFlow":
