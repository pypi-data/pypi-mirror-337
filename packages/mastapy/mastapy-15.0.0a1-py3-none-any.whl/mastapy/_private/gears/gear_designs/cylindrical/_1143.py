...
from mastapy._private.gears.gear_designs.cylindrical import _1096, _1189
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1140, _1172
...
class _Cast_CylindricalMeshLinearBacklashSpecification:
    ...
    def toleranced_value_specification(
        self: "CastSelf",
    ) -> "_1189.TolerancedValueSpecification":
        return self.__parent__._cast(_1189.TolerancedValueSpecification)
...
class CylindricalMeshLinearBacklashSpecification(
    _1189.TolerancedValueSpecification[_1096.BacklashSpecification]
):
    """CylindricalMeshLinearBacklashSpecification
