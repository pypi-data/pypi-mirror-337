...
version='0.0.4',
author='Starry',
author_email='uifox_starry@163.com',
description=f'A powerful tool library',
long_description=open('README.md','r',encoding='utf-8').read(),
long_description_content_type='text/markdown',
url='https://github.com/starry/chaichai',
packages=find_packages(),
license='Apache-2.0',
keywords=['rpa','windows','rabbitmq','automation'],
install_requires=["pika~=1.3.1","pdfminer.six>=20221105"])
