...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2914
...
class ZerolBevelGearSystemDeflection(_2914.BevelGearSystemDeflection):
    """ZerolBevelGearSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_454.ZerolBevelGearRating":
    ...
    @property
    def component_load_case(self: "Self") -> "_7815.ZerolBevelGearLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4393.ZerolBevelGearPowerFlow":
