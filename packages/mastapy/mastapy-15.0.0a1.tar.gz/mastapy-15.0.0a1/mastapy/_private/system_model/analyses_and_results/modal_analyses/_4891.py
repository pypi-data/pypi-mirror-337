...
class ModalAnalysis(_7850.StaticLoadAnalysisCase):
    """ModalAnalysis
    ...
    @property
    def analysis_settings(self: "Self") -> "_4894.ModalAnalysisOptions":
    ...
    @property
    def bar_model_export(self: "Self") -> "_4892.ModalAnalysisBarModelFEExportOptions":
    ...
    @property
    def modal_analysis_results(self: "Self") -> "_6599.DynamicAnalysis":
    ...
    @property
    def normal_modes(self: "Self") -> "List[_1682.Eigenmode]":
