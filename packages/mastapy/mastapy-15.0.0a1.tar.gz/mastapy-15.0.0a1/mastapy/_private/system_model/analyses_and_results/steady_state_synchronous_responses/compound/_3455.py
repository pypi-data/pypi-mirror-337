...
class WormGearSetCompoundSteadyStateSynchronousResponse(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3323.WormGearSetSteadyStateSynchronousResponse]":
    ...
    def worm_gears_compound_steady_state_synchronous_response(
        self: "Self",
    ) -> "List[_3453.WormGearCompoundSteadyStateSynchronousResponse]":
    ...
    def worm_meshes_compound_steady_state_synchronous_response(
        self: "Self",
    ) -> "List[_3454.WormGearMeshCompoundSteadyStateSynchronousResponse]":
