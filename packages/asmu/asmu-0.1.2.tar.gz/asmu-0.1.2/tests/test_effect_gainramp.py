...
def test_effect_gainramp(in_buffer, out_buffer, benchmark):
    step = 0.1
    # create objects
    ...
    gainramp = asmu.effect.GainRamp(interface, 0, step, scale = "log", in_buffer = in_buffer, out_buffer = out_buffer)
