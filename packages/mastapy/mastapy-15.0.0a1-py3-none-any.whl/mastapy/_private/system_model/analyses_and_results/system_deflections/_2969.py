...
class HypoidGearMeshSystemDeflection(_2895.AGMAGleasonConicalGearMeshSystemDeflection):
    """HypoidGearMeshSystemDeflection
    ...
    @property
    def rating(self: "Self") -> "_522.HypoidGearMeshRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_522.HypoidGearMeshRating":
        """mastapy.gears.rating.hypoid.HypoidGearMeshRating
    ...
    @property
    def power_flow_results(self: "Self") -> "_4323.HypoidGearMeshPowerFlow":
