...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1146, _1147
...
class DIN3967SystemOfGearFits(_0.APIBase):
    ...
    def tooth_thickness_reduction_allowance(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1146",
    ...
    def tooth_thickness_reduction_allowance(
        self: "Self", value: "_1146.DIN3967AllowanceSeries"
    ) -> None:
    ...
    @property
    def tooth_thickness_tolerance(self: "Self") -> "_1147.DIN3967ToleranceSeries":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1147",
    ...
    def tooth_thickness_tolerance(
        self: "Self", value: "_1147.DIN3967ToleranceSeries"
    ) -> None:
        value = conversion.mp_to_pn_enum(
