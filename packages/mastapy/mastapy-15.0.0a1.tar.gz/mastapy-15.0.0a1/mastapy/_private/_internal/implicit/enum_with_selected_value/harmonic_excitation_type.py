...
class EnumWithSelectedValue_HarmonicExcitationType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7724.HarmonicExcitationType
        """
        return _7724.HarmonicExcitationType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7724.HarmonicExcitationType.type_()

    @property
    def selected_value(self: "Self") -> "_7724.HarmonicExcitationType":
    ...
    @property
    def available_values(self: "Self") -> "List[_7724.HarmonicExcitationType]":
