...
class IInstanceRoleClient:
    ...
    @abstractmethod
    def list(self, filters: Optional[Union[dict, IInstanceRoleFilter]], order: dict) -> "IInstanceRoleList":
        raise NotImplementedError
    ...
    @abstractmethod
    def create(self, role_arn: str, identity: str, description: str, name: str = None) -> "IInstanceRole":
        raise NotImplementedError
...
class IJobTemplate(ABC):
    ...
    def run(
        ...
        code_type: str = None,
        source: Union[dict, IS3Source, IGitRepoSource, IWorkspaceSource, ITextSource] = None,
        exec_file: str = None,
        exec_text: str = None,
...
class IClusterList(IBaseList):
    ...
    @abstractmethod
    def wait_for_status(self, statuses: List[str], timeout: int = 300, tick: int = 30) -> "IClusterList":
        raise NotImplementedError
...
class ICluster(ABC):
    ...
    @abstractmethod
    def wait_for_status(self, statuses: List[str], timeout: int = 600, tick: int = 30) -> "ICluster":
        raise NotImplementedError
...
class ISecretsApi:
    ...
    def get_all_secrets(self, page=None, page_size=None, names=None, secret_groups=None, order=None):
        raise NotImplementedError
...
class ISecretGroupApi:
    ...
    def get_secret_groups(self, page=None, page_size=None, names=None, order=None) -> List[dict]:
        raise NotImplementedError
...
class ISecretClient:
    ...
    def list_secret_groups(self, filters: Union[dict, ISecretGroupFilter] = None) -> ISecretGroupList:
        raise NotImplementedError
