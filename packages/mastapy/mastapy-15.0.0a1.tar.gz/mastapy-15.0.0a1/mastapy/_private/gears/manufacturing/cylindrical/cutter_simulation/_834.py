...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _820
...
class FormWheelGrindingSimulationCalculator(_827.CutterSimulationCalc):
    """FormWheelGrindingSimulationCalculator
