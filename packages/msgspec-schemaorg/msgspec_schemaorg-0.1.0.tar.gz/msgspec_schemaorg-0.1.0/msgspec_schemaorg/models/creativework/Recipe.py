...
if TYPE_CHECKING:
    ...
    from msgspec_schemaorg.models.creativework.HowToStep import HowToStep
...
class Recipe(Struct, frozen=True):
    ...
    step: 'CreativeWork' | str | 'HowToSection' | 'HowToStep' | None = None
    ...
    recipeInstructions: 'ItemList' | 'CreativeWork' | str | None = None
