...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2898
...
class RootAssemblySystemDeflection(_2898.AssemblySystemDeflection):
    """RootAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4359.RootAssemblyPowerFlow":
    ...
    @property
    def system_deflection_inputs(self: "Self") -> "_3033.SystemDeflection":
    ...
    def shaft_deflection_results(
        self: "Self",
    ) -> "List[_2922.ConcentricPartGroupCombinationSystemDeflectionResults]":
