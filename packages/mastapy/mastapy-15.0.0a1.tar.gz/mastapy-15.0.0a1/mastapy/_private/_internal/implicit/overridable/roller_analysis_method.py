...
class Overridable_RollerAnalysisMethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2258.RollerAnalysisMethod
        """
        return _2258.RollerAnalysisMethod
    ...
    def implicit_type(cls: "Type[Overridable_RollerAnalysisMethod]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2258.RollerAnalysisMethod.type_()

    @property
    def value(self: "Self") -> "_2258.RollerAnalysisMethod":
    ...
    @property
    def override_value(self: "Self") -> "_2258.RollerAnalysisMethod":
        """mastapy.bearings.bearing_results.rolling.RollerAnalysisMethod
    ...
    @property
    def calculated_value(self: "Self") -> "_2258.RollerAnalysisMethod":
        """mastapy.bearings.bearing_results.rolling.RollerAnalysisMethod
