...
class ConceptGearSetPowerFlow(_4321.GearSetPowerFlow):
    """ConceptGearSetPowerFlow
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7670.ConceptGearSetLoadCase":
    ...
    @property
    def rating(self: "Self") -> "_637.ConceptGearSetRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_637.ConceptGearSetRating":
        """mastapy.gears.rating.concept.ConceptGearSetRating
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4288.ConceptGearPowerFlow]":
    ...
    @property
    def concept_gears_power_flow(self: "Self") -> "List[_4288.ConceptGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4287.ConceptGearMeshPowerFlow]":
    ...
    def concept_meshes_power_flow(
        self: "Self",
    ) -> "List[_4287.ConceptGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearMeshPowerFlow]
