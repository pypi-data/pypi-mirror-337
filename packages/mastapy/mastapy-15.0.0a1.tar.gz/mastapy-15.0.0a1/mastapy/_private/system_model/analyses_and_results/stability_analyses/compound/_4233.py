...
class StraightBevelGearSetCompoundStabilityAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4101.StraightBevelGearSetStabilityAnalysis]":
    ...
    def straight_bevel_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4231.StraightBevelGearCompoundStabilityAnalysis]":
    ...
    def straight_bevel_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4232.StraightBevelGearMeshCompoundStabilityAnalysis]":
