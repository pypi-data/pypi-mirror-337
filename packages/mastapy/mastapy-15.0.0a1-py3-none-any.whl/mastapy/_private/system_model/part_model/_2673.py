...
from mastapy._private.bearings.bearing_designs.rolling import _2356
...
class _Cast_RollingBearingElementLoadCase:
    ...
    @property
    def rolling_bearing_element(self: "CastSelf") -> "_2356.RollingBearingElement":
        return self.__parent__._cast(_2356.RollingBearingElement)
...
class RollingBearingElementLoadCase(_2356.RollingBearingElement):
    """RollingBearingElementLoadCase
