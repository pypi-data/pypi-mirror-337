...
class V0042QosLimitsMaxTresPer(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "account": [V0042Tres.from_dict(_item) for _item in obj["account"]]
                if obj.get("account") is not None
                else None,
                "job": [V0042Tres.from_dict(_item) for _item in obj["job"]]
                if obj.get("job") is not None
                else None,
                "node": [V0042Tres.from_dict(_item) for _item in obj["node"]]
                if obj.get("node") is not None
                else None,
                "user": [V0042Tres.from_dict(_item) for _item in obj["user"]]
