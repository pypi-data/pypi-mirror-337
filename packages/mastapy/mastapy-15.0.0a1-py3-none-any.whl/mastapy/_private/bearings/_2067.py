...
from mastapy._private.bearings import _2070
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2069, _2076
...
class BearingSettingsItem(_2011.NamedDatabaseItem):
    """BearingSettingsItem
    ...
    @property
    def failure_probability_for_rating_life_percent(self: "Self") -> "_2076.RatingLife":
    ...
    def include_exponent_and_reduction_factors_in_iso162812025(
        self: "Self",
    ) -> "_2069.ExponentAndReductionFactorsInISO16281Calculation":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2069",
    ...
    @enforce_parameter_types
    def include_exponent_and_reduction_factors_in_iso162812025(
        self: "Self", value: "_2069.ExponentAndReductionFactorsInISO16281Calculation"
    ) -> None:
    ...
    @enforce_parameter_types
    def lubricant_film_temperature_calculation_pressure_fed_grease_filled_bearings(
        self: "Self", value: "_2070.FluidFilmTemperatureOptions"
    ) -> None:
