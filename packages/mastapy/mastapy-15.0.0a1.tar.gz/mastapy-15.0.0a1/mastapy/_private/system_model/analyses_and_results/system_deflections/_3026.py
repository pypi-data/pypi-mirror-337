...
class StraightBevelGearSystemDeflection(_2914.BevelGearSystemDeflection):
    """StraightBevelGearSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_480.StraightBevelGearRating":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4374.StraightBevelGearPowerFlow":
