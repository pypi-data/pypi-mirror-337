...
from mastapy._private.system_model.analyses_and_results import _2862
...
class ShaftHarmonicAnalysis(
    _5934.AbstractShaftHarmonicAnalysis, _2862.IHaveShaftHarmonicResults
):
    """ShaftHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7779.ShaftLoadCase":
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4916.ShaftModalAnalysis":
    ...
    @property
    def export(self: "Self") -> "_6023.HarmonicAnalysisShaftExportOptions":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_3012.ShaftSystemDeflection":
