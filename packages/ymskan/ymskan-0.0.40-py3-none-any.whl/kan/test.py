...
def fixs(model, dataset: dict, batch_size, batch_size_test, opt="LBFGS", epochs=100, log=1, lamb=0.,
    ...
    for epoch in range(epochs):
        ...
        train_pbar = tqdm(range(steps), desc=f'Epoch {epoch + 1}/{epochs} Training')
