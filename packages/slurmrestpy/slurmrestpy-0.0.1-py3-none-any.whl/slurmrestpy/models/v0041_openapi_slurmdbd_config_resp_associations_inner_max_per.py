...
class V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxPer(BaseModel):
    ...
    account: Optional[V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxPerAccount] = (
        None
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "account": V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxPerAccount.from_dict(
                    obj["account"]
                )
