...
class QGLDoubleList(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, v: typing.Sequence[float]) -> None: ...
    @typing.overload
    def __init__(self, QGLDoubleList: 'QuickGraphLib._QuickGraphLib.QGLDoubleList') -> None: ...
    @typing.overload
    def __init__(self) -> None: ...

    def __add__(self, l: typing.Sequence[float]) -> typing.List[float]: ...
    @staticmethod
    def __copy__() -> None: ...
    def __iadd__(self, l: typing.Sequence[float]) -> typing.List[float]: ...
    def __lshift__(self, l: typing.Sequence[float]) -> typing.List[float]: ...
    @typing.overload
    def append(self, l: typing.Sequence[float]) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def fromList(list: typing.Sequence[float]) -> typing.List[float]: ...
    @staticmethod
    def fromNDArray(data: typing.Sequence[typing.Any]) -> 'QuickGraphLib._QuickGraphLib.QGLDoubleList': ...
    @staticmethod
    def fromVector(vector: typing.Sequence[float]) -> typing.List[float]: ...
    def front(self) -> float: ...
    def insert(self, arg__1: int, arg__2: float) -> None: ...
    def isEmpty(self) -> bool: ...
    def isSharedWith(self, other: typing.Sequence[float]) -> bool: ...
    @typing.overload
    def last(self) -> float: ...
    @typing.overload
...
class QGLPolygonF(PySide6.QtGui.QPolygonF):
    ...
    @typing.overload
    def __init__(self, v: PySide6.QtGui.QPolygonF | typing.Sequence[PySide6.QtCore.QPointF] | PySide6.QtGui.QPolygon | PySide6.QtCore.QRectF) -> None: ...
    @typing.overload
    ...
    def __copy__() -> None: ...
    @staticmethod
    def fromNDArray(data: typing.Sequence[typing.Any]) -> 'QuickGraphLib._QuickGraphLib.QGLPolygonF': ...
