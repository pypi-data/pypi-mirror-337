...
class EnumWithSelectedValue_FluidFilmTemperatureOptions(
    ...
    def wrapped_type(
        ...
        Returns:
            _2070.FluidFilmTemperatureOptions
        """
        return _2070.FluidFilmTemperatureOptions
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2070.FluidFilmTemperatureOptions.type_()

    @property
    def selected_value(self: "Self") -> "_2070.FluidFilmTemperatureOptions":
    ...
    @property
    def available_values(self: "Self") -> "List[_2070.FluidFilmTemperatureOptions]":
