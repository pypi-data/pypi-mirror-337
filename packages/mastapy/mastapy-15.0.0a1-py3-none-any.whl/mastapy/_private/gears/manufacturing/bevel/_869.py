...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _870
...
class BevelMachineSettingOptimizationResult(_0.APIBase):
    ...
    def calculated_deviations_concave(
        self: "Self",
    ) -> "_870.ConicalFlankDeviationsData":
    ...
    @property
    def calculated_deviations_convex(self: "Self") -> "_870.ConicalFlankDeviationsData":
        """mastapy.gears.manufacturing.bevel.ConicalFlankDeviationsData
    ...
    @property
    def imported_deviations_concave(self: "Self") -> "_870.ConicalFlankDeviationsData":
        """mastapy.gears.manufacturing.bevel.ConicalFlankDeviationsData
    ...
    @property
    def imported_deviations_convex(self: "Self") -> "_870.ConicalFlankDeviationsData":
        """mastapy.gears.manufacturing.bevel.ConicalFlankDeviationsData
