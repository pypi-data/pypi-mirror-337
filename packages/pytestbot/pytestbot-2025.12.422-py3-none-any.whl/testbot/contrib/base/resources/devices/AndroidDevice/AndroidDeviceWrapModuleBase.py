...
class AndroidDeviceWrapModuleBase(AndroidDeviceAtomModuleBase):
    """
    AndroidDevice测试设备资源封装接口模块基类
    """
    def __init__(self, resource, *args: tuple, **kwargs: dict):
        super(AndroidDeviceWrapModuleBase, self).__init__(resource, *args, **kwargs)
