...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="ListWithSelectedItem_ElectricMachineFEAnalysis")


__docformat__ = "restructuredtext en"
__all__ = ("ListWithSelectedItem_ElectricMachineFEAnalysis",)


class ListWithSelectedItem_ElectricMachineFEAnalysis(
    _1531.ElectricMachineFEAnalysis, mixins.ListWithSelectedItemMixin
):
    """ListWithSelectedItem_ElectricMachineFEAnalysis

    A specific implementation of 'ListWithSelectedItem' for 'ElectricMachineFEAnalysis' types.
    """

    __qualname__ = "ElectricMachineFEAnalysis"
    ...
    @classmethod
    def wrapper_type(
        cls: "Type[ListWithSelectedItem_ElectricMachineFEAnalysis]",
    ) -> "Any":
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1531.ElectricMachineFEAnalysis.TYPE

    @property
    def selected_value(self: "Self") -> "_1531.ElectricMachineFEAnalysis":
    ...
    @property
    def available_values(self: "Self") -> "List[_1531.ElectricMachineFEAnalysis]":
