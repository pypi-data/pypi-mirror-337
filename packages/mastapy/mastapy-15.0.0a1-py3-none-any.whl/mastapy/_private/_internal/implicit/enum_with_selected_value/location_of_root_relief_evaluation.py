...
from mastapy._private.gears.micro_geometry import _659
...
class EnumWithSelectedValue_LocationOfRootReliefEvaluation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfRootReliefEvaluation]",
    ) -> "_659.LocationOfRootReliefEvaluation":
        ...
        Returns:
            _659.LocationOfRootReliefEvaluation
        """
        return _659.LocationOfRootReliefEvaluation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _659.LocationOfRootReliefEvaluation.type_()

    @property
    def selected_value(self: "Self") -> "_659.LocationOfRootReliefEvaluation":
    ...
    @property
    def available_values(self: "Self") -> "List[_659.LocationOfRootReliefEvaluation]":
