...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1716
...
class _Cast_AbstractOptimisable:
    ...
    @property
    def optimisable(self: "CastSelf") -> "_1716.Optimisable":
        from mastapy._private.math_utility.optimisation import _1716

        return self.__parent__._cast(_1716.Optimisable)
