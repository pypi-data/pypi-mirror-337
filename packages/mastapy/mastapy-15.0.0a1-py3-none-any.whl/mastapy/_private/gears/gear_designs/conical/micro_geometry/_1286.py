...
class ConicalGearFlankMicroGeometry(_654.FlankMicroGeometry):
    """ConicalGearFlankMicroGeometry
    ...
    @property
    def bias(self: "Self") -> "_1285.ConicalGearBiasModification":
    ...
    @property
    def lead_relief(self: "Self") -> "_1287.ConicalGearLeadModification":
    ...
    @property
    def profile_relief(self: "Self") -> "_1288.ConicalGearProfileModification":
    ...
    @property
    def gear_design(self: "Self") -> "_1267.ConicalGearDesign":
