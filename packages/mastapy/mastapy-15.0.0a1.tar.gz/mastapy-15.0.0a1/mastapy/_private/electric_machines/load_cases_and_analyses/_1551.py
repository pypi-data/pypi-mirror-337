...
class SpeedTorqueLoadCase(_1533.ElectricMachineLoadCase):
    """SpeedTorqueLoadCase
    ...
    @property
    def load_specification(self: "Self") -> "_1547.SpecifyTorqueOrCurrent":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines.load_cases_and_analyses._1547",
