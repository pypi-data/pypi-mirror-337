...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2629, _2660, _2666
    from mastapy._private.system_model.part_model.acoustics import _2845
...
class MicrophoneArray(_2676.SpecialisedAssembly):
    """MicrophoneArray
    ...
    @property
    def array_design(self: "Self") -> "_2845.MicrophoneArrayDesign":
