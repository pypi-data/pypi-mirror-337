...
class _Cast_ConventionalShavingDynamics:
    ...
    @property
    def shaving_dynamics(self: "CastSelf") -> "_861.ShavingDynamics":
        return self.__parent__._cast(_861.ShavingDynamics)
...
class ConventionalShavingDynamics(_861.ShavingDynamics):
    """ConventionalShavingDynamics
