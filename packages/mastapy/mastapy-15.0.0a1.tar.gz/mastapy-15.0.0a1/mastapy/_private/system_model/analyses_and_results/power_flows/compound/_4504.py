...
class StraightBevelDiffGearSetCompoundPowerFlow(_4413.BevelGearSetCompoundPowerFlow):
    """StraightBevelDiffGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4372.StraightBevelDiffGearSetPowerFlow]":
    ...
    def straight_bevel_diff_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4502.StraightBevelDiffGearCompoundPowerFlow]":
    ...
    def straight_bevel_diff_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4503.StraightBevelDiffGearMeshCompoundPowerFlow]":
