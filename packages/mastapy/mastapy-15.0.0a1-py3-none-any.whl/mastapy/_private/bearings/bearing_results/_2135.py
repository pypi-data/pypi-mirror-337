...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results import _2136, _2143, _2146
...
class LoadedBearingDutyCycle(_0.APIBase):
    ...
    @property
    def bearing_design(self: "Self") -> "_2320.BearingDesign":
    ...
    @property
    def bearing_load_case_results(self: "Self") -> "List[_2136.LoadedBearingResults]":
