...
class ListWithSelectedItem_RoundedOrder(
    _1704.RoundedOrder, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_RoundedOrder]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1704.RoundedOrder.TYPE

    @property
    def selected_value(self: "Self") -> "_1704.RoundedOrder":
    ...
    @property
    def available_values(self: "Self") -> "List[_1704.RoundedOrder]":
