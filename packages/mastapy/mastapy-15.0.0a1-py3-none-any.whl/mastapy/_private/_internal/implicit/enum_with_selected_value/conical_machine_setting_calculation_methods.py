...
from mastapy._private.gears.gear_designs.conical import _1270
...
class EnumWithSelectedValue_ConicalMachineSettingCalculationMethods(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ConicalMachineSettingCalculationMethods]",
    ) -> "_1270.ConicalMachineSettingCalculationMethods":
        ...
        Returns:
            _1270.ConicalMachineSettingCalculationMethods
        """
        return _1270.ConicalMachineSettingCalculationMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1270.ConicalMachineSettingCalculationMethods.type_()

    @property
    def selected_value(self: "Self") -> "_1270.ConicalMachineSettingCalculationMethods":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1270.ConicalMachineSettingCalculationMethods]":
