...
from mastapy._private.gears.gear_set_pareto_optimiser import _1000, _1013
...
class _Cast_MicroGeometryDesignSpaceSearchChartInformation:
    ...
    @property
    def chart_info_base(self: "CastSelf") -> "_1000.ChartInfoBase":
        return self.__parent__._cast(_1000.ChartInfoBase)
...
class MicroGeometryDesignSpaceSearchChartInformation(
    ...
    @property
    def optimiser(self: "Self") -> "_1012.MicroGeometryDesignSpaceSearch":
