...
class AcousticAnalysisOptions(_0.APIBase):
    ...
    @property
    def initial_guess(self: "Self") -> "_7624.InitialGuessOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.acoustic_analyses._7624",
            "InitialGuessOption",
        )(value)

    @initial_guess.setter
    @enforce_parameter_types
    def initial_guess(self: "Self", value: "_7624.InitialGuessOption") -> None:
    ...
    @property
    def m2l_cache_type(self: "Self") -> "_7625.M2LHfCacheType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.acoustic_analyses._7625",
            "M2LHfCacheType",
        )(value)

    @m2l_cache_type.setter
    @enforce_parameter_types
    def m2l_cache_type(self: "Self", value: "_7625.M2LHfCacheType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.M2LHfCacheType",
        )
    ...
    def near_field_integrals_cache_type(
        self: "Self",
    ) -> "_7626.NearFieldIntegralsCacheType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.acoustic_analyses._7626",
    ...
    @enforce_parameter_types
    def near_field_integrals_cache_type(
        self: "Self", value: "_7626.NearFieldIntegralsCacheType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.NearFieldIntegralsCacheType",
    ...
    @property
    def octree_creation_method(self: "Self") -> "_7627.OctreeCreationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.acoustic_analyses._7627",
    ...
    def octree_creation_method(
        self: "Self", value: "_7627.OctreeCreationMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.OctreeCreationMethod",
    ...
    @property
    def preconditioner(self: "Self") -> "_7620.AcousticPreconditionerType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.acoustic_analyses._7620",
            "AcousticPreconditionerType",
        )(value)

    @preconditioner.setter
    @enforce_parameter_types
    def preconditioner(self: "Self", value: "_7620.AcousticPreconditionerType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.AcousticPreconditionerType",
        )
