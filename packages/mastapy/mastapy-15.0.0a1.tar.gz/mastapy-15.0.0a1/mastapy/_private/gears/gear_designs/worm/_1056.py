...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.worm import _1054, _1055
...
class WormGearSetDesign(_1047.GearSetDesign):
    """WormGearSetDesign
    ...
    @property
    def gears(self: "Self") -> "List[_1054.WormGearDesign]":
    ...
    @property
    def worm_gears(self: "Self") -> "List[_1054.WormGearDesign]":
        """List[mastapy.gears.gear_designs.worm.WormGearDesign]
    ...
    @property
    def worm_meshes(self: "Self") -> "List[_1055.WormGearMeshDesign]":
