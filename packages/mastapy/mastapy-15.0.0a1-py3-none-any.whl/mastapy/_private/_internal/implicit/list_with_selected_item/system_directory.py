...
class ListWithSelectedItem_SystemDirectory(
    _1775.SystemDirectory, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_SystemDirectory]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1775.SystemDirectory.TYPE

    @property
    def selected_value(self: "Self") -> "_1775.SystemDirectory":
    ...
    @property
    def available_values(self: "Self") -> "List[_1775.SystemDirectory]":
