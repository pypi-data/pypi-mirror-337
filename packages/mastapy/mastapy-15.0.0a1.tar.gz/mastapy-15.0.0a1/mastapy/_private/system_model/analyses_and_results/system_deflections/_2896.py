...
class AGMAGleasonConicalGearSetSystemDeflection(_2931.ConicalGearSetSystemDeflection):
    """AGMAGleasonConicalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4264.AGMAGleasonConicalGearSetPowerFlow":
