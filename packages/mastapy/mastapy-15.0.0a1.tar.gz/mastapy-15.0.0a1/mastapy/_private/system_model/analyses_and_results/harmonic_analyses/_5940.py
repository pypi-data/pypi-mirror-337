...
class AssemblyHarmonicAnalysis(_5932.AbstractAssemblyHarmonicAnalysis):
    """AssemblyHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4814.AssemblyModalAnalysis":
    ...
    @property
    def bearings(self: "Self") -> "List[_5941.BearingHarmonicAnalysis]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_5943.BeltDriveHarmonicAnalysis]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_5952.BoltedJointHarmonicAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_5953.BoltHarmonicAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_5975.CVTHarmonicAnalysis]":
    ...
    @property
    def clutches(self: "Self") -> "List[_5956.ClutchHarmonicAnalysis]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_5965.ConceptGearSetHarmonicAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_5977.CycloidalAssemblyHarmonicAnalysis]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_5979.CycloidalDiscHarmonicAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_6005.FEPartHarmonicAnalysis]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_6004.FaceGearSetHarmonicAnalysis]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_6028.HypoidGearSetHarmonicAnalysis]":
    ...
    @property
    def loaded_gear_sets(self: "Self") -> "List[_6013.GearSetHarmonicAnalysis]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_6039.MassDiscHarmonicAnalysis]":
    ...
    @property
    def microphones(self: "Self") -> "List[_6042.MicrophoneHarmonicAnalysis]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_6045.OilSealHarmonicAnalysis]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_6053.PlanetCarrierHarmonicAnalysis]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_6054.PointLoadHarmonicAnalysis]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_6055.PowerLoadHarmonicAnalysis]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_6058.RingPinsHarmonicAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_6064.ShaftHarmonicAnalysis]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_6075.SpringDamperHarmonicAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6082.StraightBevelGearSetHarmonicAnalysis]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_6086.SynchroniserHarmonicAnalysis]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_6094.UnbalancedMassHarmonicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_6098.WormGearSetHarmonicAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6101.ZerolBevelGearSetHarmonicAnalysis]":
