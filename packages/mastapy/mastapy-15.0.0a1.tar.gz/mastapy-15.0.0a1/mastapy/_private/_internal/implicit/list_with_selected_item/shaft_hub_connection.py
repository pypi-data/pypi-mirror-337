...
class ListWithSelectedItem_ShaftHubConnection(
    _2805.ShaftHubConnection, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ShaftHubConnection]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2805.ShaftHubConnection.TYPE

    @property
    def selected_value(self: "Self") -> "_2805.ShaftHubConnection":
    ...
    @property
    def available_values(self: "Self") -> "List[_2805.ShaftHubConnection]":
