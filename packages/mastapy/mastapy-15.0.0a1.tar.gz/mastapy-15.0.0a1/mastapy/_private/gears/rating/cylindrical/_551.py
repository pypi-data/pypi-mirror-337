...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1176, _1177
    from mastapy._private.gears.rating.cylindrical import _538, _546, _549
...
class CylindricalMeshSingleFlankRating(_450.MeshSingleFlankRating):
    """CylindricalMeshSingleFlankRating
    ...
    def coefficient_of_friction_method_flash_temperature_method(
        self: "Self",
    ) -> "_1177.ScuffingCoefficientOfFrictionMethods":
    ...
    @property
    def contact_ratio_source(self: "Self") -> "_404.ContactRatioDataSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._404", "ContactRatioDataSource"
        )(value)
    ...
    @property
    def sorted_scuffing_results(self: "Self") -> "_546.CylindricalGearScuffingResults":
    ...
    def sorted_scuffing_results_without_special_values(
        self: "Self",
    ) -> "_546.CylindricalGearScuffingResults":
        """mastapy.gears.rating.cylindrical.CylindricalGearScuffingResults
    ...
    def gear_single_flank_ratings(
        self: "Self",
    ) -> "List[_549.CylindricalGearSingleFlankRating]":
