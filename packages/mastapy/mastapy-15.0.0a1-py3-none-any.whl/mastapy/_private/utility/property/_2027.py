...
from mastapy._private.utility.property import _2023
...
class _Cast_DutyCyclePropertySummaryStress:
    ...
    def duty_cycle_property_summary(
        self: "CastSelf",
    ) -> "_2023.DutyCyclePropertySummary":
        return self.__parent__._cast(_2023.DutyCyclePropertySummary)
...
class DutyCyclePropertySummaryStress(_2023.DutyCyclePropertySummary[_1891.Stress, T]):
    """DutyCyclePropertySummaryStress
