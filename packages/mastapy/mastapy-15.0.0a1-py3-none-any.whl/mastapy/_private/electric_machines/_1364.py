...
from mastapy._private.electric_machines import _1408
...
class _Cast_CADMagnetsForLayer:
    ...
    @property
    def magnet_design(self: "CastSelf") -> "_1408.MagnetDesign":
        return self.__parent__._cast(_1408.MagnetDesign)
...
class CADMagnetsForLayer(_1408.MagnetDesign):
    """CADMagnetsForLayer
    ...
    @property
    def cad_magnet_details(self: "Self") -> "List[_1363.CADMagnetDetails]":
