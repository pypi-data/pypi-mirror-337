...
from mastapy._private.bearings.bearing_results.rolling import _2160
from mastapy._private.bearings.bearing_results.rolling.iso_rating_results import _2299
from mastapy._private.gears import _420
from mastapy._private.nodal_analysis.nodal_entities import _135
from mastapy._private.system_model import _2405
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2154, _2258
    from mastapy._private.system_model import _2400, _2415
...
class LoadCase(_2856.Context):
    ...
    def ball_bearing_contact_calculation(
        self: "Self",
    ) -> "_2154.BallBearingContactCalculation":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_results.rolling._2154",
    ...
    @enforce_parameter_types
    def ball_bearing_contact_calculation(
        self: "Self", value: "_2154.BallBearingContactCalculation"
    ) -> None:
    ...
    @enforce_parameter_types
    def ball_bearing_friction_model_for_gyroscopic_moment(
        self: "Self", value: "_2160.FrictionModelForGyroscopicMoment"
    ) -> None:
    ...
    @property
    def bearing_element_orbit_model(self: "Self") -> "_5632.BearingElementOrbitModel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5632",
    ...
    def bearing_element_orbit_model(
        self: "Self", value: "_5632.BearingElementOrbitModel"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.BearingElementOrbitModel",
    ...
    def hypoid_gear_wind_up_removal_method_for_misalignments(
        self: "Self",
    ) -> "_2400.HypoidWindUpRemovalMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2400", "HypoidWindUpRemovalMethod"
        )(value)

    @hypoid_gear_wind_up_removal_method_for_misalignments.setter
    @enforce_parameter_types
    def hypoid_gear_wind_up_removal_method_for_misalignments(
        self: "Self", value: "_2400.HypoidWindUpRemovalMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def mesh_stiffness_model(self: "Self", value: "_2405.MeshStiffnessModel") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def micro_geometry_model_for_simple_mesh_stiffness(
        self: "Self",
        value: "Union[_420.MicroGeometryModel, Tuple[_420.MicroGeometryModel, bool]]",
    ) -> None:
    ...
    @property
    def roller_analysis_method(self: "Self") -> "_2258.RollerAnalysisMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_results.rolling._2258",
    ...
    def roller_analysis_method(
        self: "Self", value: "_2258.RollerAnalysisMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def shear_area_factor_method(
        self: "Self", value: "_135.ShearAreaFactorMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @enforce_parameter_types
    def stress_concentration_method_for_rating(
        self: "Self", value: "_2299.StressConcentrationMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def additional_acceleration(self: "Self") -> "_7637.AdditionalAccelerationOptions":
    ...
    @property
    def input_power_load(self: "Self") -> "_7768.PowerLoadLoadCase":
    ...
    @property
    def output_power_load(self: "Self") -> "_7768.PowerLoadLoadCase":
        """mastapy.system_model.analyses_and_results.static_loads.PowerLoadLoadCase
    ...
    def parametric_study_tool_options(
        self: "Self",
    ) -> "_4621.ParametricStudyToolOptions":
    ...
    @property
    def temperatures(self: "Self") -> "_2415.TransmissionTemperatureSet":
    ...
    def transmission_efficiency_settings(
        self: "Self",
    ) -> "_7808.TransmissionEfficiencySettings":
    ...
    @property
    def power_loads(self: "Self") -> "List[_7768.PowerLoadLoadCase]":
    ...
    @enforce_parameter_types
    def inputs_for_cvt(self: "Self", design_entity: "_2791.CVT") -> "_7682.CVTLoadCase":
