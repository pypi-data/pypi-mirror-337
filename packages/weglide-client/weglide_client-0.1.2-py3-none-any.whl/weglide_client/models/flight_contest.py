...
class FlightContest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["points", "distance", "speed"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FlightContest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FlightContest from a dict"""
        if obj is None:
            return None
