...
def get_args(ver):
  ...
  parser=argparse.ArgumentParser(\
          ...
          epilog="example: x4_dirupd.py -t trans/trans.txt -d entry -g x4_dirupd.log")
...
def get_input(args):
  ...
  if file_trans is None:
    file_trans=input("input trans tape [trans/trans.txt] --------> ")
    if file_trans=="":
      file_trans="trans/trans.txt"
