...
from mastapy._private.bearings.bearing_results.rolling import _2161
...
class _Cast_ThreePointContactInternalClearance:
    ...
    @property
    def internal_clearance(self: "CastSelf") -> "_2161.InternalClearance":
        return self.__parent__._cast(_2161.InternalClearance)
...
class ThreePointContactInternalClearance(_2161.InternalClearance):
    """ThreePointContactInternalClearance
