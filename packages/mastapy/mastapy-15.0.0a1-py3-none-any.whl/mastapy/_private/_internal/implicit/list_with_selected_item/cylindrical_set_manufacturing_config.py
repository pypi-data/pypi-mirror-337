...
class ListWithSelectedItem_CylindricalSetManufacturingConfig(
    _721.CylindricalSetManufacturingConfig, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _721.CylindricalSetManufacturingConfig.TYPE

    @property
    def selected_value(self: "Self") -> "_721.CylindricalSetManufacturingConfig":
