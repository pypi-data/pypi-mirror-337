...
class ConceptGearSetParametricStudyTool(_4593.GearSetParametricStudyTool):
    """ConceptGearSetParametricStudyTool
    ...
    def gears_parametric_study_tool(
        self: "Self",
    ) -> "List[_4556.ConceptGearParametricStudyTool]":
    ...
    def meshes_parametric_study_tool(
        self: "Self",
    ) -> "List[_4555.ConceptGearMeshParametricStudyTool]":
