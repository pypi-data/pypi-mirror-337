...
@LastEditTime: 2025-03-28 17:01:26
...
class FrameBaseModel():
    ...
    def lottery_algorithm_stock_probability(prize_list, field_name="probability", surplus_field_name="surplus", is_upset_prize=True):
        """
