...
from geneva.packager import UDFSpec
from geneva.transformer import UDF

if TYPE_CHECKING:
    from lance import LanceDataset
    from lancedb.util import safe_import_pandas
...
class GenevaQueryBuilder(LanceEmptyQueryBuilder):
    ...
    def create_materialized_view(self, conn: Connection, view_name: str) -> "Table":
        ...
        view_schema = view_schema.with_metadata(
            {
                "geneva::view::query": query.model_dump_json(),
                "geneva::view::base_table": self._table._ltbl.name,
