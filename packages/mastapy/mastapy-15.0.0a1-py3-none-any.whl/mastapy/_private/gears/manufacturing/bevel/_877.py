...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel.control_parameters import _913
...
class _Cast_ConicalMeshFlankManufacturingConfig:
    ...
    def conical_mesh_flank_micro_geometry_config(
        self: "CastSelf",
    ) -> "_878.ConicalMeshFlankMicroGeometryConfig":
        return self.__parent__._cast(_878.ConicalMeshFlankMicroGeometryConfig)
...
class ConicalMeshFlankManufacturingConfig(_878.ConicalMeshFlankMicroGeometryConfig):
    """ConicalMeshFlankManufacturingConfig
    ...
    def control_parameters(
        self: "Self",
    ) -> "_913.ConicalGearManufacturingControlParameters":
    ...
    def specified_cradle_style_machine_settings(
        self: "Self",
    ) -> "_920.CradleStyleConicalMachineSettingsGenerated":
    ...
    def specified_phoenix_style_machine_settings(
        self: "Self",
    ) -> "_919.BasicConicalGearMachineSettingsGenerated":
