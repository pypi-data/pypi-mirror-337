...
/* harmony import */ var _components_ThemeSwitch__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/ThemeSwitch */ "./lib/components/ThemeSwitch.js");
/* harmony import */ var _components_EnergyMixBar__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/EnergyMixBar */ "./lib/components/EnergyMixBar.js");
/* harmony import */ var _components_CountdownTimer__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/CountdownTimer */ "./lib/components/CountdownTimer.js");
/* harmony import */ var _components_SidePanel__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/SidePanel */ "./lib/components/SidePanel.js");
/* harmony import */ var _services_gpu_detection__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./services/gpu-detection */ "./lib/services/gpu-detection.js");
/* harmony import */ var _services_theme_manager__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./services/theme-manager */ "./lib/services/theme-manager.js");
/* harmony import */ var _services_credits_system__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./services/credits-system */ "./lib/services/credits-system.js");
/* harmony import */ var _utils_helpers__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./utils/helpers */ "./lib/utils/helpers.js");
/* harmony import */ var _style_index_css__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../style/index.css */ "./style/index.css");
/* harmony import */ var _style_enverge_svg__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../style/enverge.svg */ "./style/enverge.svg");
...
// import { FAVICON_BASE64 } from './utils/imageConstants';
// Import styles


var CommandIDs;
(function (CommandIDs) {
    CommandIDs.loadState = 'enverge_placeholder:load-statedb';
    CommandIDs.print = 'enverge_placeholder:print';
    CommandIDs.reset = 'enverge_placeholder:reset';
    CommandIDs.resetOnLoad = 'enverge_placeholder:reset-on-load';
...
const extension = {
    ...
    autoStart: true,
    requires: [_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.IThemeManager, _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_5__.INotebookTracker],
    ...
    activate: async (app, themeManager, notebookTracker, toolbarRegistry, restorer) => {
        ...
        const toggleTheme = (0,_services_theme_manager__WEBPACK_IMPORTED_MODULE_15__.setupThemeManager)(app, themeManager);
        // Adjust UI for branding
        (0,_services_theme_manager__WEBPACK_IMPORTED_MODULE_15__.adjustUIForBranding)();
        ...
        setTimeout(() => {
            (0,_services_theme_manager__WEBPACK_IMPORTED_MODULE_15__.replaceLogo)(_style_enverge_svg__WEBPACK_IMPORTED_MODULE_19__, themeManager);
            // Set up listener for theme changes
            (0,_services_theme_manager__WEBPACK_IMPORTED_MODULE_15__.setupLogoThemeListener)(themeManager);
        }, 2000);
        // Initialize credits display
        setTimeout(_services_credits_system__WEBPACK_IMPORTED_MODULE_16__.updateCreditsDisplay, 100);
        // Create toggle ID for congestion simulation
        const toggleId = 'cell-alert-toggle';
        // Create side panel
        const sidePanel = (0,_components_SidePanel__WEBPACK_IMPORTED_MODULE_13__.createSidePanel)(toggleId);
        ...
        const updateGPUState = (isGPUActive) => {
            ...
            (0,_services_credits_system__WEBPACK_IMPORTED_MODULE_16__.updateGPUStats)(isGPUActive);
            ...
            if (isGPUActive) {
                ...
                updateInterval = window.setInterval(() => {
                    ...
                    (0,_services_credits_system__WEBPACK_IMPORTED_MODULE_16__.updateGPUStats)(stillActive);
        ...
        if (toolbarRegistry) {
            ...
            toolbarRegistry.addFactory('TopBar', 'enverge-placeholder', () => {
                ...
                const widget = _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_4__.ReactWidget.create(react__WEBPACK_IMPORTED_MODULE_9__.createElement("div", { style: { display: 'flex', alignItems: 'center' } },
                    react__WEBPACK_IMPORTED_MODULE_9__.createElement(_components_ThemeSwitch__WEBPACK_IMPORTED_MODULE_10__.ThemeSwitch, { themeManager: themeManager, onChange: () => toggleTheme() },
                        react__WEBPACK_IMPORTED_MODULE_9__.createElement("span", { slot: "unchecked-message" }, "Light"),
                        react__WEBPACK_IMPORTED_MODULE_9__.createElement("span", { slot: "checked-message" }, "Dark")),
                    react__WEBPACK_IMPORTED_MODULE_9__.createElement(_components_EnergyMixBar__WEBPACK_IMPORTED_MODULE_11__.EnergyMixBar, null)));
                return widget;
            });
        }
        else {
        ...
        notebookTracker.currentChanged.connect((_, notebook) => {
            if (notebook) {
                ...
                _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_5__.NotebookActions.executionScheduled.connect((_, args) => {
                    const { cell } = args;
                    ...
                    const contentHash = (0,_utils_helpers__WEBPACK_IMPORTED_MODULE_17__.hashCode)(code);
                    const cellId = `${cell.model.id}-${contentHash}`;
                    console.log('Generated cell ID for execution:', cellId);
                    // Check if the code uses GPU
                    const usesGPU = (0,_services_gpu_detection__WEBPACK_IMPORTED_MODULE_14__.detectGPUUsage)(code);
                    console.log({ usesGPU });
                    if (usesGPU) {
                    ...
                    if (toggle === null || toggle === void 0 ? void 0 : toggle.checked) {
                        void (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.showDialog)({
                            ...
                            body: (react__WEBPACK_IMPORTED_MODULE_9__.createElement("div", null,
                                react__WEBPACK_IMPORTED_MODULE_9__.createElement(_components_CountdownTimer__WEBPACK_IMPORTED_MODULE_12__.CountdownTimer, null),
                                react__WEBPACK_IMPORTED_MODULE_9__.createElement("div", { style: { marginTop: '10px', marginBottom: '10px' } },
                                    react__WEBPACK_IMPORTED_MODULE_9__.createElement("label", null,
                                        "Purchase priority runtime (hours):",
                                        ' ',
                                        react__WEBPACK_IMPORTED_MODULE_9__.createElement("select", { defaultValue: "1" },
                                            react__WEBPACK_IMPORTED_MODULE_9__.createElement("option", { value: "1" }, "1 hour ($3)"),
                                            react__WEBPACK_IMPORTED_MODULE_9__.createElement("option", { value: "4" }, "4 hours ($12)"),
                                            react__WEBPACK_IMPORTED_MODULE_9__.createElement("option", { value: "8" }, "8 hours ($24)"),
                                            react__WEBPACK_IMPORTED_MODULE_9__.createElement("option", { value: "24" }, "24 hours ($150)")))),
                                react__WEBPACK_IMPORTED_MODULE_9__.createElement("button", { className: "jp-mod-styled", onClick: (e) => {
                                        e.preventDefault();
                                ...
                                react__WEBPACK_IMPORTED_MODULE_9__.createElement("div", { id: "payment-area", style: {
                                        display: 'none',
                                        border: '1px solid var(--jp-border-color1)',
                                        borderRadius: '4px',
                                        padding: '15px',
                                    ...
                                    react__WEBPACK_IMPORTED_MODULE_9__.createElement("input", { type: "text", placeholder: "Card number", style: {
                                            width: '100%',
                                            padding: '8px',
                                            marginBottom: '10px',
                                            border: '1px solid var(--jp-border-color1)',
                                    ...
                                    react__WEBPACK_IMPORTED_MODULE_9__.createElement("div", { style: { display: 'flex', gap: '10px', marginBottom: '10px' } },
                                        react__WEBPACK_IMPORTED_MODULE_9__.createElement("input", { type: "text", placeholder: "MM/YY", style: {
                                                width: '50%',
                                                padding: '8px',
                                                border: '1px solid var(--jp-border-color1)',
                                                borderRadius: '4px'
                                            } }),
                                        react__WEBPACK_IMPORTED_MODULE_9__.createElement("input", { type: "text", placeholder: "CVC", style: {
                                                width: '50%',
                                                padding: '8px',
                                                border: '1px solid var(--jp-border-color1)',
                                                borderRadius: '4px'
                                            } })),
                                    react__WEBPACK_IMPORTED_MODULE_9__.createElement("button", { className: "jp-mod-styled", onClick: () => {
                                            var _a, _b, _c;
                                ...
                                react__WEBPACK_IMPORTED_MODULE_9__.createElement("div", { style: { marginTop: '10px', textAlign: 'right' } },
                                    react__WEBPACK_IMPORTED_MODULE_9__.createElement("a", { href: "https://docs.enverge.ai", target: "_blank", rel: "noopener noreferrer" }, "Click here to learn more")))),
                            buttons: [
        ...
        // Call this when a notebook is opened
        notebookTracker.currentChanged.connect(() => {
            (0,_services_gpu_detection__WEBPACK_IMPORTED_MODULE_14__.injectGPUMonitoring)(notebookTracker.currentWidget);
        });
    },
};
const APP_NAME = 'enverge.ai';
async function updateTabTitle(workspace, db) {
    const data = await db.toJSON();
    console.log({ data, workspace });
    document.title = `${APP_NAME}`;
}
const state = {
    id: 'enverge_placeholder:state',
    description: 'Provides the application state. It is stored per workspaces.',
    autoStart: true,
    provides: _jupyterlab_statedb__WEBPACK_IMPORTED_MODULE_6__.IStateDB,
    requires: [_jupyterlab_application__WEBPACK_IMPORTED_MODULE_0__.JupyterFrontEnd.IPaths, _jupyterlab_application__WEBPACK_IMPORTED_MODULE_0__.IRouter, _jupyterlab_translation__WEBPACK_IMPORTED_MODULE_2__.ITranslator],
    ...
    activate: (app, paths, router, translator, resolver) => {
        ...
        if (resolver === null) {
            return new _jupyterlab_statedb__WEBPACK_IMPORTED_MODULE_6__.StateDB();
        }
        let resolved = false;
        ...
        const db = new _jupyterlab_statedb__WEBPACK_IMPORTED_MODULE_6__.StateDB({ transform: transform.promise });
        const save = new _lumino_polling__WEBPACK_IMPORTED_MODULE_8__.Debouncer(async () => {
            const id = workspace;
            const metadata = { id };
            const data = await db.toJSON();
        ...
        db.changed.connect(() => updateTabTitle(workspace, db));
        commands.addCommand(CommandIDs.loadState, {
            ...
            execute: async (args) => {
                ...
                const query = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_3__.URLExt.queryStringToObject(search || '');
                const clone = typeof query['clone'] === 'string'
                    ? query['clone'] === ''
                        ? _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_3__.PageConfig.defaultWorkspace
                        : query['clone']
                    : null;
                ...
                try {
                    ...
                    console.warn(`Fetching workspace "${workspace}" failed.`, error.message);
                ...
                if (source === clone) {
                    ...
                    delete query['clone'];
                    const url = path + _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_3__.URLExt.objectToQueryString(query) + hash;
...
/* harmony export */   injectGPUMonitoring: () => (/* binding */ injectGPUMonitoring)
/* harmony export */ });
// Function to detect GPU usage in code using the gpu_check service
const detectGPUUsage = async (code) => {
...
const injectGPUMonitoring = async (notebook) => {
    var _a;
    if (!notebook)
        return;
  ...
  `;
    ...
    await ((_a = session === null || session === void 0 ? void 0 : session.kernel) === null || _a === void 0 ? void 0 : _a.requestExecute({ code }).done);
};
...
//# sourceMappingURL=lib_index_js.4ee5ee2d22b8e603d4a7.js.map