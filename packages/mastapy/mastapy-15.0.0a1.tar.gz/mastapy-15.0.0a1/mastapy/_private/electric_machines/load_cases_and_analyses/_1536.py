...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.elmer import _251
...
class ElectricMachineMechanicalLoadCase(_1534.ElectricMachineLoadCaseBase):
    """ElectricMachineMechanicalLoadCase
    ...
    @property
    def solver_type(self: "Self") -> "_251.MechanicalSolverType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.elmer._251", "MechanicalSolverType"
        )(value)

    @solver_type.setter
    @enforce_parameter_types
    def solver_type(self: "Self", value: "_251.MechanicalSolverType") -> None:
