...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2203, _2204, _2239
...
class LoadedMultiPointContactBallBearingElement(_2189.LoadedBallBearingElement):
    """LoadedMultiPointContactBallBearingElement
