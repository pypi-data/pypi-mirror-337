...
from mastapy._private.system_model.analyses_and_results.acoustic_analyses import _7628
...
class _Cast_SingleHarmonicExcitationAnalysisDetail:
    ...
    @property
    def single_excitation_details(self: "CastSelf") -> "_7628.SingleExcitationDetails":
        return self.__parent__._cast(_7628.SingleExcitationDetails)
...
class SingleHarmonicExcitationAnalysisDetail(_7628.SingleExcitationDetails):
    """SingleHarmonicExcitationAnalysisDetail
