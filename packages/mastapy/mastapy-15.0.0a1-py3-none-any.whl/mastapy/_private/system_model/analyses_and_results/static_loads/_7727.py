...
from mastapy._private.system_model.analyses_and_results.static_loads import _7706, _7725
...
class _Cast_HarmonicLoadDataFluxImport:
    ...
    def harmonic_load_data_import_from_motor_packages(
        self: "CastSelf",
    ) -> "_7729.HarmonicLoadDataImportFromMotorPackages":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7729,
        )

        return self.__parent__._cast(_7729.HarmonicLoadDataImportFromMotorPackages)
...
class HarmonicLoadDataFluxImport(
    _7725.HarmonicLoadDataCSVImport[_7706.ElectricMachineHarmonicLoadFluxImportOptions]
):
    """HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self: "Self") -> "_7737.InnerDiameterReference":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7737",
    ...
    def inner_diameter_reference(
        self: "Self", value: "_7737.InnerDiameterReference"
    ) -> None:
