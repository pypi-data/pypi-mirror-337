...
class ShaftDeflectionDrawingNodeItem(_0.APIBase):
    ...
    @property
    def node_detail(self: "Self") -> "_1734.ForceAndDisplacementResults":
    ...
    @property
    def section_to_the_left_side(self: "Self") -> "_3011.ShaftSectionSystemDeflection":
    ...
    @property
    def section_to_the_right_side(self: "Self") -> "_3011.ShaftSectionSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSectionSystemDeflection
