...
from mastapy._private.gears.gear_set_pareto_optimiser import _1002, _1013
from mastapy._private.gears.ltca.cylindrical import _952, _953, _956
...
class MicroGeometryDesignSpaceSearch(
    _1002.DesignSpaceSearchBase[
        ...
        _1013.MicroGeometryDesignSpaceSearchCandidate,
    ]
):
    """MicroGeometryDesignSpaceSearch
    ...
    @enforce_parameter_types
    def select_gear(
        self: "Self", value: "_952.CylindricalGearLoadDistributionAnalysis"
    ) -> None:
    ...
    @enforce_parameter_types
    def select_mesh(
        self: "Self", value: "_953.CylindricalGearMeshLoadDistributionAnalysis"
    ) -> None:
    ...
    def all_candidate_gear_sets(
        self: "Self",
    ) -> "List[_1213.CylindricalGearSetMicroGeometry]":
