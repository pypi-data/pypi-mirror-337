...
TConnection = TypeVar("TConnection", bound="_2463.Connection")
TConnectionStaticLoad = TypeVar(
    "TConnectionStaticLoad", bound="_7676.ConnectionLoadCase"
)
...
class ConnectionStaticLoadCaseGroup(
    _5929.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]
):
    """ConnectionStaticLoadCaseGroup
