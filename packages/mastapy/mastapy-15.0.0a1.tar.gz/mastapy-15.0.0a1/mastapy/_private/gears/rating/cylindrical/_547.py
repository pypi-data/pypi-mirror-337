...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _550, _564
...
class CylindricalGearSetDutyCycleRating(_446.GearSetDutyCycleRating):
    """CylindricalGearSetDutyCycleRating
    ...
    def gear_mesh_duty_cycle_ratings(
        self: "Self",
    ) -> "List[_550.CylindricalMeshDutyCycleRating]":
