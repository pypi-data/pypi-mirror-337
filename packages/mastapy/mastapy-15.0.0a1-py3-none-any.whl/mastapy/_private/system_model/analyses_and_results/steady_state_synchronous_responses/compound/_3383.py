...
class FaceGearSetCompoundSteadyStateSynchronousResponse(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3248.FaceGearSetSteadyStateSynchronousResponse]":
    ...
    def face_gears_compound_steady_state_synchronous_response(
        self: "Self",
    ) -> "List[_3381.FaceGearCompoundSteadyStateSynchronousResponse]":
    ...
    def face_meshes_compound_steady_state_synchronous_response(
        self: "Self",
    ) -> "List[_3382.FaceGearMeshCompoundSteadyStateSynchronousResponse]":
