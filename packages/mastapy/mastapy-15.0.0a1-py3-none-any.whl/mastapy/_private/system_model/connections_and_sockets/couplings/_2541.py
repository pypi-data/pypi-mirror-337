...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2392, _2394
...
class SpringDamperConnection(_2537.CouplingConnection):
    """SpringDamperConnection
    ...
    @property
    def damping_option(self: "Self") -> "_2392.ComponentDampingOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2392", "ComponentDampingOption"
        )(value)

    @damping_option.setter
    @enforce_parameter_types
    def damping_option(self: "Self", value: "_2392.ComponentDampingOption") -> None:
