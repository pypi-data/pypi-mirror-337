...
class CylindricalGearMeshSystemDeflection(_2965.GearMeshSystemDeflection):
    """CylindricalGearMeshSystemDeflection
    ...
    @property
    def rating(self: "Self") -> "_542.CylindricalGearMeshRating":
    ...
    @property
    def gear_a(self: "Self") -> "_2951.CylindricalGearSystemDeflection":
    ...
    @property
    def gear_b(self: "Self") -> "_2951.CylindricalGearSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4306.CylindricalGearMeshPowerFlow":
    ...
    def cylindrical_meshed_gear_system_deflections(
        self: "Self",
    ) -> "List[_2955.CylindricalMeshedGearSystemDeflection]":
    ...
    def mesh_deflections_left_flank(
        self: "Self",
    ) -> "List[_3053.GearMeshResultsAtOffset]":
    ...
    @property
    def gear_set(self: "Self") -> "_2948.CylindricalGearSetSystemDeflection":
