...
from mastapy._private.detailed_rigid_connectors.splines import _1579
...
class EnumWithSelectedValue_Modules(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[EnumWithSelectedValue_Modules]") -> "_1579.Modules":
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_Modules]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1579.Modules.type_()

    @property
    def selected_value(self: "Self") -> "_1579.Modules":
    ...
    @property
    def available_values(self: "Self") -> "List[_1579.Modules]":
