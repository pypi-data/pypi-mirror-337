...
from .link_points_complicator.LinkPointsComplicator import LinkPointsComplicator
...
class NetEditorFactory:
    mode_mapping = {
        ...
        "merge_link": LinkMerger,  # link_groups: List[List[int]], include_connector: bool = xxx, simplify_points: bool = xxx ignore_lane_type: bool, ignore_missing_connector: bool, max_length: float
        ...
        "complicate_link_points": LinkPointsComplicator,
