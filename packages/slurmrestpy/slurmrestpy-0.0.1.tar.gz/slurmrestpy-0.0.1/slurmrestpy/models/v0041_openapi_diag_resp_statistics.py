...
class V0041OpenapiDiagRespStatistics(BaseModel):
    ...
    schedule_cycle_sum: Optional[StrictInt] = Field(
        default=None,
    ...
    schedule_cycle_depth: Optional[StrictInt] = Field(
        default=None, description="Total number of jobs processed in scheduling cycles"
    )
    ...
    bf_cycle_max: Optional[StrictInt] = Field(
        default=None,
    ...
    bf_table_size_sum: Optional[StrictInt] = Field(
        default=None,
    ...
    rpcs_by_message_type: Optional[
        List[V0041OpenapiDiagRespStatisticsRpcsByMessageTypeInner]
    ] = Field(
        default=None, description="Most frequently issued remote procedure calls (RPCs)"
    )
    rpcs_by_user: Optional[List[V0041OpenapiDiagRespStatisticsRpcsByUserInner]] = Field(
        default=None, description="RPCs issued by user ID"
    )
    pending_rpcs: Optional[List[V0041OpenapiDiagRespStatisticsPendingRpcsInner]] = (
        Field(default=None, description="Pending RPC statistics")
    )
    pending_rpcs_by_hostlist: Optional[
        List[V0041OpenapiDiagRespStatisticsPendingRpcsByHostlistInner]
    ] = Field(default=None, description="Pending RPCs hostlists")
        ...
        _obj = cls.model_validate(
            {
                ...
                "req_time": V0041OpenapiDiagRespStatisticsReqTime.from_dict(
                    obj["req_time"]
                )
                if obj.get("req_time") is not None
                else None,
                "req_time_start": V0041OpenapiDiagRespStatisticsReqTimeStart.from_dict(
                    obj["req_time_start"]
                )
                ...
                "schedule_exit": V0041OpenapiDiagRespStatisticsScheduleExit.from_dict(
                    obj["schedule_exit"]
                )
                ...
                "job_states_ts": V0041OpenapiDiagRespStatisticsJobStatesTs.from_dict(
                    obj["job_states_ts"]
                )
                ...
                "bf_exit": V0041OpenapiDiagRespStatisticsBfExit.from_dict(
                    obj["bf_exit"]
                )
                ...
                "bf_when_last_cycle": V0041OpenapiDiagRespStatisticsBfWhenLastCycle.from_dict(
                    obj["bf_when_last_cycle"]
                )
                if obj.get("bf_when_last_cycle") is not None
                else None,
                "bf_active": obj.get("bf_active"),
                "rpcs_by_message_type": [
                    V0041OpenapiDiagRespStatisticsRpcsByMessageTypeInner.from_dict(
                        _item
                    )
                ...
                "rpcs_by_user": [
                    V0041OpenapiDiagRespStatisticsRpcsByUserInner.from_dict(_item)
                    for _item in obj["rpcs_by_user"]
                ]
                if obj.get("rpcs_by_user") is not None
                else None,
                "pending_rpcs": [
                    V0041OpenapiDiagRespStatisticsPendingRpcsInner.from_dict(_item)
                    for _item in obj["pending_rpcs"]
                ]
                if obj.get("pending_rpcs") is not None
                else None,
                "pending_rpcs_by_hostlist": [
                    V0041OpenapiDiagRespStatisticsPendingRpcsByHostlistInner.from_dict(
                        _item
                    )
                    for _item in obj["pending_rpcs_by_hostlist"]
                ]
                if obj.get("pending_rpcs_by_hostlist") is not None
                else None,
            }
        )
        return _obj
