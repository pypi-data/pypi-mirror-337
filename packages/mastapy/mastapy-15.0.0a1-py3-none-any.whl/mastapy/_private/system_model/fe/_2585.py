...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.dev_tools_analyses import _257, _267
    from mastapy._private.system_model.fe import _2551, _2579
...
class FESubstructureWithSelectionForModalAnalysis(_2582.FESubstructureWithSelection):
    """FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    def modal_draw_style(self: "Self") -> "_267.FEModelModalAnalysisDrawStyle":
    ...
    def full_fe_mode_shapes_at_condensation_nodes(
        self: "Self",
    ) -> "List[_2579.FESubstructureNodeModeShapes]":
