...
from mastapy._private.system_model.optimization import _2424
...
class _Cast_CylindricalGearOptimizationStep:
    ...
    @property
    def optimization_step(self: "CastSelf") -> "_2424.OptimizationStep":
        return self.__parent__._cast(_2424.OptimizationStep)
...
class CylindricalGearOptimizationStep(_2424.OptimizationStep):
    """CylindricalGearOptimizationStep
