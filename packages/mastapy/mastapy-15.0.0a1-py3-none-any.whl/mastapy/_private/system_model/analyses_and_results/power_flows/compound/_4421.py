...
class ConceptCouplingCompoundPowerFlow(_4432.CouplingCompoundPowerFlow):
    """ConceptCouplingCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4286.ConceptCouplingPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4286.ConceptCouplingPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptCouplingPowerFlow]
