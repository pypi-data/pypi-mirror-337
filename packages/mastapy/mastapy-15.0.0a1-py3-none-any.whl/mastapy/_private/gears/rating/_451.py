...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.agma import _620
    from mastapy._private.gears.rating.cylindrical.iso6336 import _606, _607
    ...
    from mastapy._private.gears.rating.klingelnberg_conical.kn3030 import _499
...
class _Cast_RateableMesh:
    ...
    def klingelnberg_conical_rateable_mesh(
        self: "CastSelf",
    ) -> "_499.KlingelnbergConicalRateableMesh":
        from mastapy._private.gears.rating.klingelnberg_conical.kn3030 import _499

        return self.__parent__._cast(_499.KlingelnbergConicalRateableMesh)
    ...
    @property
    def cylindrical_rateable_mesh(self: "CastSelf") -> "_555.CylindricalRateableMesh":
        from mastapy._private.gears.rating.cylindrical import _555

        return self.__parent__._cast(_555.CylindricalRateableMesh)

    @property
    def plastic_gear_vdi2736_abstract_rateable_mesh(
        self: "CastSelf",
    ) -> "_577.PlasticGearVDI2736AbstractRateableMesh":
        from mastapy._private.gears.rating.cylindrical.plastic_vdi2736 import _577

        return self.__parent__._cast(_577.PlasticGearVDI2736AbstractRateableMesh)

    @property
    def vdi2736_metal_plastic_rateable_mesh(
        self: "CastSelf",
    ) -> "_582.VDI2736MetalPlasticRateableMesh":
        from mastapy._private.gears.rating.cylindrical.plastic_vdi2736 import _582

        return self.__parent__._cast(_582.VDI2736MetalPlasticRateableMesh)

    @property
    def vdi2736_plastic_metal_rateable_mesh(
        self: "CastSelf",
    ) -> "_583.VDI2736PlasticMetalRateableMesh":
        from mastapy._private.gears.rating.cylindrical.plastic_vdi2736 import _583

        return self.__parent__._cast(_583.VDI2736PlasticMetalRateableMesh)

    @property
    def vdi2736_plastic_plastic_rateable_mesh(
        self: "CastSelf",
    ) -> "_584.VDI2736PlasticPlasticRateableMesh":
        from mastapy._private.gears.rating.cylindrical.plastic_vdi2736 import _584

        return self.__parent__._cast(_584.VDI2736PlasticPlasticRateableMesh)

    @property
    def iso6336_metal_rateable_mesh(
        self: "CastSelf",
    ) -> "_606.ISO6336MetalRateableMesh":
        from mastapy._private.gears.rating.cylindrical.iso6336 import _606

        return self.__parent__._cast(_606.ISO6336MetalRateableMesh)

    @property
    def iso6336_rateable_mesh(self: "CastSelf") -> "_607.ISO6336RateableMesh":
        from mastapy._private.gears.rating.cylindrical.iso6336 import _607

        return self.__parent__._cast(_607.ISO6336RateableMesh)

    @property
    def agma2101_rateable_mesh(self: "CastSelf") -> "_620.AGMA2101RateableMesh":
        from mastapy._private.gears.rating.cylindrical.agma import _620

        return self.__parent__._cast(_620.AGMA2101RateableMesh)

    @property
    def conical_rateable_mesh(self: "CastSelf") -> "_631.ConicalRateableMesh":
        from mastapy._private.gears.rating.conical import _631

        return self.__parent__._cast(_631.ConicalRateableMesh)
