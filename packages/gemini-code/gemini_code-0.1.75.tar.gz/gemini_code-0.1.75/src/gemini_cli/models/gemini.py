...
class GeminiModel:
    ...
    def __init__(self, api_key: str, console: Console, model_name: str ="gemini-2.5-pro-exp-03-25"):
        ...
        self.chat_history = [
            ...
            {'role': 'model', 'parts': [Part(text="Okay, I'm ready. Provide the directory context and your request.")]}
        ]
    ...
    def generate(self, prompt: str) -> str | None:
        ...
        self.chat_history.append({'role': 'user', 'parts': [Part(text=turn_input_prompt)]})
