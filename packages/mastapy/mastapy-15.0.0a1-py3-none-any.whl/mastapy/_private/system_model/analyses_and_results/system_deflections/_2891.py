...
class AbstractAssemblySystemDeflection(_2993.PartSystemDeflection):
    """AbstractAssemblySystemDeflection
    ...
    def rigidly_connected_groups(
        self: "Self",
    ) -> "List[_3056.RigidlyConnectedComponentGroupSystemDeflection]":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4258.AbstractAssemblyPowerFlow":
