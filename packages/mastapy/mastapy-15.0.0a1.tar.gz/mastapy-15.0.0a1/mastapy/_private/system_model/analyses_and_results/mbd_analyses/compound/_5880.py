...
class _Cast_ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis:
    ...
    def coaxial_connection_compound_multibody_dynamics_analysis(
        self: "CastSelf",
    ) -> "_5805.CoaxialConnectionCompoundMultibodyDynamicsAnalysis":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses.compound import (
            _5805,
        )
    ...
    def planetary_connection_compound_multibody_dynamics_analysis(
        self: "CastSelf",
    ) -> "_5866.PlanetaryConnectionCompoundMultibodyDynamicsAnalysis":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses.compound import (
            _5866,
        )
...
class ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis(
    ...
    def connection_analysis_cases(
        self: "Self",
    ) -> "List[_5737.ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis]":
