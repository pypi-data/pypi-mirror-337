...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2639, _2657, _2666
...
class PlanetCarrier(_2662.MountableComponent):
    """PlanetCarrier
    ...
    @property
    def planetary_sockets(self: "Self") -> "List[_2479.PlanetarySocket]":
