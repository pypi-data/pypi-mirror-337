...
from mastapy._private.system_model.part_model.couplings import _2798
...
class EnumWithSelectedValue_RigidConnectorStiffnessType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorStiffnessType]",
    ) -> "_2798.RigidConnectorStiffnessType":
        ...
        Returns:
            _2798.RigidConnectorStiffnessType
        """
        return _2798.RigidConnectorStiffnessType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2798.RigidConnectorStiffnessType.type_()

    @property
    def selected_value(self: "Self") -> "_2798.RigidConnectorStiffnessType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2798.RigidConnectorStiffnessType]":
