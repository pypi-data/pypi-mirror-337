...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.agma_gleason_conical import _1305
...
class _Cast_AccuracyGrades:
    ...
    @property
    def agma20151_accuracy_grades(self: "CastSelf") -> "_1245.AGMA20151AccuracyGrades":
        from mastapy._private.gears.gear_designs.cylindrical.accuracy_and_tolerances import (
            _1245,
        )

        return self.__parent__._cast(_1245.AGMA20151AccuracyGrades)
    ...
    def cylindrical_accuracy_grades(
        ...
        return self.__parent__._cast(_1250.CylindricalAccuracyGrades)

    @property
    def iso1328_accuracy_grades(self: "CastSelf") -> "_1256.ISO1328AccuracyGrades":
        from mastapy._private.gears.gear_designs.cylindrical.accuracy_and_tolerances import (
            _1256,
        )

        return self.__parent__._cast(_1256.ISO1328AccuracyGrades)

    @property
    def agma_gleason_conical_accuracy_grades(
        self: "CastSelf",
    ) -> "_1305.AGMAGleasonConicalAccuracyGrades":
        from mastapy._private.gears.gear_designs.agma_gleason_conical import _1305

        return self.__parent__._cast(_1305.AGMAGleasonConicalAccuracyGrades)
