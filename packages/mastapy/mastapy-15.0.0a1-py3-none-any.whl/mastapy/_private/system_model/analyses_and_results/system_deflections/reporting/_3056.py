...
from mastapy._private.system_model.analyses_and_results import _2858
...
class _Cast_RigidlyConnectedComponentGroupSystemDeflection:
    ...
    def design_entity_group_analysis(
        self: "CastSelf",
    ) -> "_2858.DesignEntityGroupAnalysis":
        return self.__parent__._cast(_2858.DesignEntityGroupAnalysis)
...
class RigidlyConnectedComponentGroupSystemDeflection(_2858.DesignEntityGroupAnalysis):
    """RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def mass_properties(self: "Self") -> "_1693.MassProperties":
    ...
    @property
    def components(self: "Self") -> "List[_2921.ComponentSystemDeflection]":
