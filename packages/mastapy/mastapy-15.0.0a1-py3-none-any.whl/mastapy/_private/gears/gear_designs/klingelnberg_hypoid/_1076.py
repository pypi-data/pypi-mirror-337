...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.klingelnberg_hypoid import _1074, _1075
...
class KlingelnbergCycloPalloidHypoidGearSetDesign(
    ...
    @property
    def gears(self: "Self") -> "List[_1074.KlingelnbergCycloPalloidHypoidGearDesign]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears(
        self: "Self",
    ) -> "List[_1074.KlingelnbergCycloPalloidHypoidGearDesign]":
        """List[mastapy.gears.gear_designs.klingelnberg_hypoid.KlingelnbergCycloPalloidHypoidGearDesign]
    ...
    def klingelnberg_conical_meshes(
        self: "Self",
    ) -> "List[_1075.KlingelnbergCycloPalloidHypoidGearMeshDesign]":
