...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2055, _2071, _2082
...
class RollingBearingDatabase(
    _2014.SQLDatabase[_2080.RollingBearingKey, _2355.RollingBearing]
):
    """RollingBearingDatabase
    ...
    def add_to_database(self: "Self", bearing: "_2355.RollingBearing") -> None:
    ...
    @enforce_parameter_types
    def create_bearing(
        self: "Self", type_: "_2082.RollingBearingType", designation: "str" = "None"
    ) -> "_2355.RollingBearing":
    ...
    @enforce_parameter_types
    def remove_from_database(self: "Self", bearing: "_2355.RollingBearing") -> None:
        """Method does not return.
    ...
    def search_for_rolling_bearing_with_catalog(
        self: "Self", catalog: "_2055.BearingCatalog"
    ) -> "List[_2355.RollingBearing]":
    ...
    def search_for_rolling_bearing_with_name_and_catalog(
        self: "Self", designation: "str", catalog: "_2055.BearingCatalog"
    ) -> "_2355.RollingBearing":
        """mastapy.bearings.bearing_designs.rolling.RollingBearing
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(
        self: "Self",
        designation: "str",
        catalog: "_2055.BearingCatalog",
        type_: "_2082.RollingBearingType",
    ) -> "List[_2355.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
    ...
    def search_for_rolling_bearing(
        ...
        number_of_rows: "int",
        material_type: "_2071.HybridSteelAll",
    ) -> "List[_2355.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
