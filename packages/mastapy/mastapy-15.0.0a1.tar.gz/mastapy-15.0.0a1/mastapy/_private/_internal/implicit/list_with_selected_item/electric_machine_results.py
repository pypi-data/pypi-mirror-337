...
class ListWithSelectedItem_ElectricMachineResults(
    _1501.ElectricMachineResults, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1501.ElectricMachineResults.TYPE

    @property
    def selected_value(self: "Self") -> "_1501.ElectricMachineResults":
    ...
    @property
    def available_values(self: "Self") -> "List[_1501.ElectricMachineResults]":
