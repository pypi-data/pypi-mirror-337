...
def convert_to_elongation(
    phase: npt.ArrayLike, coefficient: float = 9.239
) -> npt.ArrayLike:
    """Converte un np array di phase (espressa in radiante) ad array di delta allungamento (in um), rispetto all'instate t0."""
    return (phase - phase[0]) / coefficient
