...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.modal_analysis import _1976
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2858.DesignEntityGroupAnalysis):
    """RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    def excitation_frequencies_at_reference_speed(
        self: "Self",
    ) -> "List[_1976.DesignEntityExcitationDescription]":
