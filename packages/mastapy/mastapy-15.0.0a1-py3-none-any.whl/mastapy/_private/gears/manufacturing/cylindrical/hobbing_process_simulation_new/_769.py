...
class _Cast_HobbingProcessSimulationNew:
    ...
    @property
    def process_simulation_new(self: "CastSelf") -> "_782.ProcessSimulationNew":
        return self.__parent__._cast(_782.ProcessSimulationNew)
...
class HobbingProcessSimulationNew(
    _782.ProcessSimulationNew[_768.HobbingProcessSimulationInput]
):
    """HobbingProcessSimulationNew
