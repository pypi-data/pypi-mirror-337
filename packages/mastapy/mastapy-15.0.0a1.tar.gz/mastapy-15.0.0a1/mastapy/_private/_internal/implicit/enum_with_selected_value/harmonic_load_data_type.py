...
class EnumWithSelectedValue_HarmonicLoadDataType(
    ...
    def wrapped_type(
        ...
        Returns:
            _1557.HarmonicLoadDataType
        """
        return _1557.HarmonicLoadDataType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_HarmonicLoadDataType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1557.HarmonicLoadDataType.type_()

    @property
    def selected_value(self: "Self") -> "_1557.HarmonicLoadDataType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1557.HarmonicLoadDataType]":
