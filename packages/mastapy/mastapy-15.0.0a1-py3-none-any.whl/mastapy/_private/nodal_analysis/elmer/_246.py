...
from mastapy._private.nodal_analysis.elmer import _245
...
class _Cast_ElmerResultsFromElectromagneticAnalysis:
    ...
    @property
    def elmer_results(self: "CastSelf") -> "_245.ElmerResults":
        return self.__parent__._cast(_245.ElmerResults)
...
class ElmerResultsFromElectromagneticAnalysis(_245.ElmerResults):
    """ElmerResultsFromElectromagneticAnalysis
