classdef  XmlFile < casadi.SharedObject & casadi.PrintableCommon
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1151, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1153, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1154, varargin{:});
    end
  end
end
