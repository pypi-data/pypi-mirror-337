...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.component_mode_synthesis import _309, _310
...
class _Cast_ModalCMSResults:
    ...
    @property
    def real_cms_results(self: "CastSelf") -> "_313.RealCMSResults":
        return self.__parent__._cast(_313.RealCMSResults)
...
class ModalCMSResults(_313.RealCMSResults):
    """ModalCMSResults
    ...
    @property
    def fe_results_per_section(self: "Self") -> "List[_310.FESectionResults]":
