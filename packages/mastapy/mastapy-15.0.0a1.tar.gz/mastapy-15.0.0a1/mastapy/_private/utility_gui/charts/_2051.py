...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.report import _1921, _1926
    from mastapy._private.utility_gui.charts import _2047
...
class ThreeDChartDefinition(_2045.NDChartDefinition):
    """ThreeDChartDefinition
    ...
    @property
    def z_axis(self: "Self") -> "_1921.AxisSettings":
    ...
    def data_points_for_surfaces(self: "Self") -> "List[_2047.PointsForSurface]":
