...
class UserWithImageAndCopilot(BaseModel):
    """
    UserWithImageAndCopilot
    """ # noqa: E501
    id: StrictInt
    name: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "image", "badge", "copilot_uid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserWithImageAndCopilot from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserWithImageAndCopilot from a dict"""
        if obj is None:
            return None
