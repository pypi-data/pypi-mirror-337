...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _535, _558, _569
...
class _Cast_ScuffingResultsRow:
    ...
    @property
    def agma_scuffing_results_row(self: "CastSelf") -> "_535.AGMAScuffingResultsRow":
        from mastapy._private.gears.rating.cylindrical import _535

        return self.__parent__._cast(_535.AGMAScuffingResultsRow)

    @property
    def iso_scuffing_results_row(self: "CastSelf") -> "_558.ISOScuffingResultsRow":
        from mastapy._private.gears.rating.cylindrical import _558

        return self.__parent__._cast(_558.ISOScuffingResultsRow)
...
class ScuffingResultsRow(_0.APIBase):
    ...
    @property
    def pinion(self: "Self") -> "_569.ScuffingResultsRowGear":
