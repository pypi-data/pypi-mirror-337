...
if TYPE_CHECKING:
    ...
    from mastapy._private.html import _387
    from mastapy._private.utility.report import _1941, _1949
...
class CustomReportText(_1938.CustomReportDefinitionItem):
    """CustomReportText
    ...
    @property
    def heading_type(self: "Self") -> "_387.HeadingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.html._387", "HeadingType"
        )(value)

    @heading_type.setter
    @enforce_parameter_types
    def heading_type(self: "Self", value: "_387.HeadingType") -> None:
