...
if TYPE_CHECKING:
    ...
    from msgspec_schemaorg.models.intangible.GameAvailabilityEnumeration import GameAvailabilityEnumeration
...
class PlayGameAction(Struct, frozen=True):
    ...
    gameAvailabilityType: str | 'GameAvailabilityEnumeration' | None = None