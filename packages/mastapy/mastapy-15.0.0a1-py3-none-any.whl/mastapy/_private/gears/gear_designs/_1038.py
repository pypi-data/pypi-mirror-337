...
class BevelHypoidGearDesignSettingsItem(_2011.NamedDatabaseItem):
    """BevelHypoidGearDesignSettingsItem
    ...
    @property
    def quality_grade_type(self: "Self") -> "_427.QualityGradeTypes":
    ...
    @enforce_parameter_types
    def quality_grade_type(self: "Self", value: "_427.QualityGradeTypes") -> None:
