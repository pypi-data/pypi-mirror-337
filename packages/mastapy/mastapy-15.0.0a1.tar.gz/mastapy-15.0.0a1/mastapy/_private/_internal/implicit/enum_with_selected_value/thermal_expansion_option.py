...
from mastapy._private.system_model.fe import _2606
...
class EnumWithSelectedValue_ThermalExpansionOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _2606.ThermalExpansionOption
        """
        return _2606.ThermalExpansionOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2606.ThermalExpansionOption.type_()

    @property
    def selected_value(self: "Self") -> "_2606.ThermalExpansionOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2606.ThermalExpansionOption]":
