...
class EnumWithSelectedValue_ExportOutputType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ExportOutputType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _6000.ExportOutputType.type_()

    @property
    def selected_value(self: "Self") -> "_6000.ExportOutputType":
    ...
    @property
    def available_values(self: "Self") -> "List[_6000.ExportOutputType]":
