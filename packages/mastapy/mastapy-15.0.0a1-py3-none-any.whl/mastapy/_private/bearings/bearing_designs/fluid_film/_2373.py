...
from mastapy._private.bearings.bearing_designs.fluid_film import _2372
...
class _Cast_AxialGrooveJournalBearing:
    ...
    @property
    def axial_feed_journal_bearing(self: "CastSelf") -> "_2372.AxialFeedJournalBearing":
        return self.__parent__._cast(_2372.AxialFeedJournalBearing)
...
class AxialGrooveJournalBearing(_2372.AxialFeedJournalBearing):
    """AxialGrooveJournalBearing
