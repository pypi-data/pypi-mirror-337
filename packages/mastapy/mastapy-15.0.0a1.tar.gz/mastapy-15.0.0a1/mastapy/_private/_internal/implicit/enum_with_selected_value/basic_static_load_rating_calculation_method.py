...
from mastapy._private.bearings import _2057
...
class EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod]",
    ) -> "_2057.BasicStaticLoadRatingCalculationMethod":
        ...
        Returns:
            _2057.BasicStaticLoadRatingCalculationMethod
        """
        return _2057.BasicStaticLoadRatingCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2057.BasicStaticLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2057.BasicStaticLoadRatingCalculationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2057.BasicStaticLoadRatingCalculationMethod]":
