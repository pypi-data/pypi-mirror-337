...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.analysis import _1328, _1331, _1332
...
class CylindricalGearLoadDistributionAnalysis(_936.GearLoadDistributionAnalysis):
    """CylindricalGearLoadDistributionAnalysis
    ...
    @property
    def rating(self: "Self") -> "_544.CylindricalGearRating":
    ...
    @property
    def tiff_analysis(self: "Self") -> "_994.CylindricalGearTIFFAnalysis":
