...
class TaskUpdate(BaseModel):
    ...
    TaskUpdate
    """ # noqa: E501
    point_features: Optional[List[TurnpointFeature]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if point_features (nullable) is None
        # and model_fields_set contains the field
        if self.point_features is None and "point_features" in self.model_fields_set:
            _dict['point_features'] = None
