...
from mastapy._private.nodal_analysis.elmer.results import _253
...
class _Cast_Data3D:
    ...
    @property
    def data(self: "CastSelf") -> "_253.Data":
        return self.__parent__._cast(_253.Data)
