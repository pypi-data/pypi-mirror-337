...
def create_cdf_plot_3d(tensor_np, ax=None):
    """
    Create a cumulative distribution function plot for 3D array voxel values.
    ...
    """
    logger.debug("Creating 3D CDF plot")
    ...
    try:
        ...
        logger.error(f"Failed to create 3D CDF plot: {e}")
        ax.text(
            0.5,
            0.5,
            f"CDF Error: {str(e)}",
