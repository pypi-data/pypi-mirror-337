...
class BoltedJointCompoundPowerFlow(_4495.SpecialisedAssemblyCompoundPowerFlow):
    """BoltedJointCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4277.BoltedJointPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4277.BoltedJointPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BoltedJointPowerFlow]
