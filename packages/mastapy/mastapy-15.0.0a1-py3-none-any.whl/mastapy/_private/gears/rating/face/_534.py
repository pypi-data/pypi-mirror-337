...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.face import _531, _532
...
class FaceGearSetRating(_447.GearSetRating):
    """FaceGearSetRating
    ...
    @property
    def face_gear_set(self: "Self") -> "_1092.FaceGearSetDesign":
    ...
    @property
    def gear_ratings(self: "Self") -> "List[_532.FaceGearRating]":
    ...
    @property
    def gear_mesh_ratings(self: "Self") -> "List[_531.FaceGearMeshRating]":
    ...
    @property
    def face_mesh_ratings(self: "Self") -> "List[_531.FaceGearMeshRating]":
        """List[mastapy.gears.rating.face.FaceGearMeshRating]
