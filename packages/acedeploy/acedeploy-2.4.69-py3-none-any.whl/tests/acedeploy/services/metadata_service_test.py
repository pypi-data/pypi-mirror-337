...
@pytest.mark.parametrize(
    "metadata_list, metadata_options, expected",
    [
        (
            [{"PROP1": "val1"}],
            {"PROP1": {"ignore": False}},
        ...
        (
            [{"PROP1": "val1", "PROP2": "val2"}],
            {"PROP2": {"ignore": True}},
            [{"PROP1": "val1", "PROP2": None}],
        ),
        (
            [{"PROP1": "val1", "COLUMN_DETAILS": [{"DETAIL1": 1, "DETAIL2": 2}]}],
            {"PROP1": {"ignore": True}},
            [{"PROP1": None, "COLUMN_DETAILS": [{"DETAIL1": 1, "DETAIL2": 2}]}],
        ),
        (
            [{"PROP1": "val1", "COLUMN_DETAILS": [{"DETAIL1": 1, "DETAIL2": 2}]}],
            {"COLUMN_DETAILS": {"DETAIL1": {"ignore": True}}},
            [{"PROP1": "val1", "COLUMN_DETAILS": [{"DETAIL1": None, "DETAIL2": 2}]}],
        ),
        (
            [{"PROP1": "val1", "COLUMN_DETAILS": [{"DETAIL1": 1, "DETAIL2": 2}]}],
            {"PROP1": {"ignore": True}, "COLUMN_DETAILS": {"DETAIL1": {"ignore": True}, "DETAIL2": {"ignore": True}}},
            [{"PROP1": None, "COLUMN_DETAILS": [{"DETAIL1": None, "DETAIL2": None}]}],
        ),
        (
            [{"PROP1": "val1", "COLUMN_DETAILS": [{"DETAIL1": 1, "DETAIL2": 2}, {"DETAIL1": 1, "DETAIL2": 2}]}],
            {"COLUMN_DETAILS": {"DETAIL1": {"ignore": True}}},
            [{"PROP1": "val1", "COLUMN_DETAILS": [{"DETAIL1": None, "DETAIL2": 2}, {"DETAIL1": None, "DETAIL2": 2}]}],
        ),
    ],
)
def test__update_metadata_using_object_options(metadata_list, metadata_options, expected):
    result = mds.MetadataService._update_metadata_using_object_options(metadata_list, metadata_options)
