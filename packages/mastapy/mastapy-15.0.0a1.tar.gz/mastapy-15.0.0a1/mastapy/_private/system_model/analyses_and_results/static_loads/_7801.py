...
class TimeSeriesLoadCase(_7631.LoadCase):
    """TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self: "Self") -> "_5709.MBDAnalysisOptions":
    ...
    @property
    def time_series_load_case_group(self: "Self") -> "_5925.TimeSeriesLoadCaseGroup":
    ...
    def duplicate(
        self: "Self",
        new_load_case_group: "_5925.TimeSeriesLoadCaseGroup",
        name: "str" = "None",
    ) -> "TimeSeriesLoadCase":
