...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.klingelnberg_conical.kn3030 import _502, _503
...
class KlingelnbergConicalMeshSingleFlankRating(_450.MeshSingleFlankRating):
    """KlingelnbergConicalMeshSingleFlankRating
