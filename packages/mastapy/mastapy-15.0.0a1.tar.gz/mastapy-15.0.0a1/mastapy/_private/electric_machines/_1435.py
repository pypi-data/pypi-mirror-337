...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1436, _1437
...
class _Cast_ToothAndSlot:
    ...
    @property
    def abstract_tooth_and_slot(self: "CastSelf") -> "_1359.AbstractToothAndSlot":
        return self.__parent__._cast(_1359.AbstractToothAndSlot)
...
class ToothAndSlot(_1359.AbstractToothAndSlot):
    """ToothAndSlot
    ...
    @property
    def tooth_taper_specification(self: "Self") -> "_1437.ToothTaperSpecification":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1437", "ToothTaperSpecification"
        )(value)

    @tooth_taper_specification.setter
    @enforce_parameter_types
    def tooth_taper_specification(
        self: "Self", value: "_1437.ToothTaperSpecification"
    ) -> None:
    ...
    @property
    def tooth_slot_style(self: "Self") -> "_1436.ToothSlotStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1436", "ToothSlotStyle"
        )(value)

    @tooth_slot_style.setter
    @enforce_parameter_types
    def tooth_slot_style(self: "Self", value: "_1436.ToothSlotStyle") -> None:
        value = conversion.mp_to_pn_enum(
