...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears import _406, _424
    ...
    from mastapy._private.gears.rating.cylindrical import _544, _548, _551
...
class CylindricalGearMeshRating(_444.GearMeshRating):
    """CylindricalGearMeshRating
    ...
    @property
    def no_load_power_loss(self: "Self") -> "float":
        """float

        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "NoLoadPowerLoss")
    ...
    @property
    def cylindrical_gear_mesh(self: "Self") -> "_1121.CylindricalGearMeshDesign":
    ...
    @property
    def gear_set_rating(self: "Self") -> "_548.CylindricalGearSetRating":
    ...
    @property
    def mesh_load_case(self: "Self") -> "_980.CylindricalMeshLoadCase":
    ...
    def vdi_cylindrical_gear_single_flank_rating(
        self: "Self",
    ) -> "_573.VDI2737InternalGearSingleFlankRating":
