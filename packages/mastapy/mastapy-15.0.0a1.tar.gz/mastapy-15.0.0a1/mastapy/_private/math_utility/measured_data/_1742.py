...
class TwodimensionalFunctionLookupTable(
    _1740.LookupTableBase["TwodimensionalFunctionLookupTable"]
):
    """TwodimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: "Self") -> "_1739.GriddedSurfaceAccessor":
    ...
    def lookup_table(self: "Self", value: "_1739.GriddedSurfaceAccessor") -> None:
