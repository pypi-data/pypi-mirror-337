...
class StiffnessOptionsForHarmonicAnalysis(
    _7836.AbstractAnalysisOptions[_7632.StaticLoadCase]
):
    """StiffnessOptionsForHarmonicAnalysis
    ...
    @property
    def curve_with_stiffness_steps(self: "Self") -> "_2053.TwoDChartDefinition":
    ...
    @enforce_parameter_types
    def torque_input_type(
        self: "Self", value: "_6024.HarmonicAnalysisTorqueInputType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def torque_speed_curve(self: "Self") -> "_1709.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def torque_speed_curve(self: "Self", value: "_1709.Vector2DListAccessor") -> None:
