...
class DocumentGenerator:
    ...
    def _generate_action_items(self, output_dir: str) -> Tuple[Optional[str], Optional[str]]:
        ...
        user_prompt = f"""
        Analyze the following documents and generate the Markdown action plan (using checkbox syntax '- [ ]' for tasks) for the FOUNDATION phase.
        ...
        Remember to output ONLY the structured Markdown action plan using checkbox syntax.
        """
