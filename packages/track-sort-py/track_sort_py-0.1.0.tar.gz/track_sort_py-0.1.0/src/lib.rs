...
#[pyclass(frozen)]
struct TrackingResult(::track_sort::track_sort::TrackingResult);
...
impl TrackingResult {
    ...
    fn status(&self) -> TrackerStatus {
        match self.0.status {
            ::track_sort::track_sort::TrackerStatus::Unborn => TrackerStatus::Unborn,
            ::track_sort::track_sort::TrackerStatus::Born => TrackerStatus::Born,
            ::track_sort::track_sort::TrackerStatus::Alive => TrackerStatus::Alive,
            ::track_sort::track_sort::TrackerStatus::Dead => TrackerStatus::Dead,
            ::track_sort::track_sort::TrackerStatus::Zombie => TrackerStatus::Zombie,
        }
    }
...
#[pyclass(frozen)]
#[derive(Clone)]
struct DetectionBox(::track_sort::track_sort::Box);
...
impl DetectionBox {
    ...
    fn new(x: f32, y: f32, w: f32, h: f32) -> Self {
        Self(::track_sort::track_sort::Box { x, y, w, h })
    }
...
#[pyclass]
struct Tracker {
    tracker: ::track_sort::track_sort::Tracker,
    config: ::track_sort::track_sort::Config,
}
...
impl Tracker {
    ...
    fn new(threshold: f32, min_hits: u32, max_age: u64) -> Self {
        Self {
            tracker: ::track_sort::track_sort::Tracker::default(),
            config: ::track_sort::track_sort::Config {
    ...
    fn track_boxes<'p>(
        ...
        let b = boxes
            .iter()
            .map(|b| b.0)
            .collect::<Vec<::track_sort::track_sort::Box>>();
