...
class PlanetCarrierSystemDeflection(_2990.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_7764.PlanetCarrierLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4348.PlanetCarrierPowerFlow":
    ...
    @property
    def windup(self: "Self") -> "List[_3054.PlanetCarrierWindup]":
