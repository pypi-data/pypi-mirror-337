...
from semantha_sdk.smartcluster.smartcluster_api import SmartclusterAPI


def login(server_url: str = None, key: str = None, key_file: str = None, client_id: str = None, client_secret: str = None, token_url: str = None) -> SmartclusterAPI:
    """ Access to the Smartcluster API.

        author semantha, this is a generated class do not change manually!

    Args:
        server_url (str): URL to the Smartcluster server
    ...
    Returns:
        SmartclusterAPI: Entry point to the Smartcluster API.
    """
    if key:
        pass
    elif key_file:
    ...
    __api = SmartclusterAPI(RestClient(server_url, key, client_id, client_secret, token_url), "/api")
