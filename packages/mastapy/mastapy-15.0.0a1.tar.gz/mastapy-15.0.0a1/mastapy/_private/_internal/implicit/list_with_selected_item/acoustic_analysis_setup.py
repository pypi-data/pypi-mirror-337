...
class ListWithSelectedItem_AcousticAnalysisSetup(
    _2832.AcousticAnalysisSetup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_AcousticAnalysisSetup]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2832.AcousticAnalysisSetup.TYPE

    @property
    def selected_value(self: "Self") -> "_2832.AcousticAnalysisSetup":
    ...
    @property
    def available_values(self: "Self") -> "List[_2832.AcousticAnalysisSetup]":
