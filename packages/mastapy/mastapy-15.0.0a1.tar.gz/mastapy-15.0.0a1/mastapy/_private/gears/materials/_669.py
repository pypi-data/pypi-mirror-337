...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.materials import _671, _672
...
T = TypeVar("T", bound="_672.BevelGearMaterial")
...
class BevelGearAbstractMaterialDatabase(_353.MaterialDatabase[T]):
    """BevelGearAbstractMaterialDatabase
