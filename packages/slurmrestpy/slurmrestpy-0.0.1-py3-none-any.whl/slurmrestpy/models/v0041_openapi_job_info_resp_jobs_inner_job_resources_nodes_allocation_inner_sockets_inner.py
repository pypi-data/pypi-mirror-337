...
class V0041OpenapiJobInfoRespJobsInnerJobResourcesNodesAllocationInnerSocketsInner(
    BaseModel
):
    """
    ...
    cores: List[
        V0041OpenapiJobInfoRespJobsInnerJobResourcesNodesAllocationInnerSocketsInnerCoresInner
    ] = Field(description="Core in socket")
        ...
        _obj = cls.model_validate(
            {
                "index": obj.get("index"),
                "cores": [
                    V0041OpenapiJobInfoRespJobsInnerJobResourcesNodesAllocationInnerSocketsInnerCoresInner.from_dict(
                        _item
                    )
                    for _item in obj["cores"]
                ]
                if obj.get("cores") is not None
                else None,
            }
        )
        return _obj
