...
from maleo_core.clients.google_cloud_logging import GoogleCloudLogging
...
class Logger(logging.Logger):
    def __init__(
        ...
        service_name:str,
        category:str,
        level:LoggerLevel = LoggerLevel.NOTSET
    ):
        """
        ...
        try:
            client = GoogleCloudLogging.ClientManager.get()
            cloud_handler = client.create_handler(name=name.replace(" ", ""))
