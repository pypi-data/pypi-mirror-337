...
class MasterArm:
    class ControlInput:
        target_operation_mode: numpy.ndarray[tuple[typing.Literal[14], typing.Literal[1]], numpy.dtype[numpy.int32]]
    ...
    class State:
        ...
        def gravity_term(self) -> numpy.ndarray[tuple[typing.Literal[14], typing.Literal[1]], numpy.dtype[numpy.float64]]:
            ...
        @property
        def operation_mode(self) -> numpy.ndarray[tuple[typing.Literal[14], typing.Literal[1]], numpy.dtype[numpy.int32]]:
            ...
        @property
