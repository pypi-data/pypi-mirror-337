...
class BevelDifferentialGearSetCompoundPowerFlow(_4413.BevelGearSetCompoundPowerFlow):
    """BevelDifferentialGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4271.BevelDifferentialGearSetPowerFlow]":
    ...
    def bevel_differential_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4406.BevelDifferentialGearCompoundPowerFlow]":
    ...
    def bevel_differential_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4407.BevelDifferentialGearMeshCompoundPowerFlow]":
