...
class SignerV4(object):
    ...
    def get_signing_secret_key_v4(sk, date, region, service):
        k_date = SignerV4.hmac_sha256(sk.encode('utf-8'), date)
        k_region = SignerV4.hmac_sha256(k_date, region)
        k_service = SignerV4.hmac_sha256(k_region, service)
        return SignerV4.hmac_sha256(k_service, 'request')
