...
type_set_colors = [
    '#a52a2a', '#daa520', '#4b0082', '#f5ddb3', '#cd853f',
    '#008080', '#808000', '#ff00ff', '#2f4f4f', '#d3b48b',
    '#ffd700', '#8b4513', '#7fff00', '#ff69b4', '#66cdaa',
    '#f4d037', '#e5c494', '#f2f0a7', '#9a60b4', '#c16772',
    '#8da0cb', '#e78ac3', '#a6d854', '#66c2a5', '#fc8d62',
    '#c1c167', '#b3b3b3'
]
