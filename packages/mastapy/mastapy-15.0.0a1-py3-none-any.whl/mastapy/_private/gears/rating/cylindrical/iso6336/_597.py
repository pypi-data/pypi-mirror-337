...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.iso6336 import _592, _593, _599, _601
...
class ISO63362006GearSingleFlankRating(_603.ISO6336AbstractMetalGearSingleFlankRating):
    """ISO63362006GearSingleFlankRating
    ...
    def tooth_fatigue_fracture_results(
        self: "Self",
    ) -> "_592.CylindricalGearToothFatigueFractureResults":
    ...
    def tooth_fatigue_fracture_results_according_to_french_proposal(
        self: "Self",
    ) -> "_593.CylindricalGearToothFatigueFractureResultsN1457":
