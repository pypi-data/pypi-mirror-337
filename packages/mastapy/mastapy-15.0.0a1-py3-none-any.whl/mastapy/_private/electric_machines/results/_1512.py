...
from mastapy._private.electric_machines import _1420, _1424
from mastapy._private.electric_machines.results import _1501
...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1513
...
class _Cast_ElectricMachineResultsViewable:
    ...
    @property
    def elmer_results_viewable(self: "CastSelf") -> "_248.ElmerResultsViewable":
        return self.__parent__._cast(_248.ElmerResultsViewable)
...
class ElectricMachineResultsViewable(_248.ElmerResultsViewable):
    """ElectricMachineResultsViewable
    ...
    @property
    def force_view_options(self: "Self") -> "_1513.ElectricMachineForceViewOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines.results._1513",
    ...
    def force_view_options(
        self: "Self", value: "_1513.ElectricMachineForceViewOptions"
    ) -> None:
    ...
    @results.setter
    @enforce_parameter_types
    def results(self: "Self", value: "_1501.ElectricMachineResults") -> None:
    ...
    @property
    def parts_to_view(self: "Self") -> "List[_2029.EnumWithBoolean[_1420.RegionID]]":
