...
class ListWithSelectedItem_MeasurementBase(
    _1780.MeasurementBase, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_MeasurementBase]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1780.MeasurementBase.TYPE

    @property
    def selected_value(self: "Self") -> "_1780.MeasurementBase":
    ...
    @property
    def available_values(self: "Self") -> "List[_1780.MeasurementBase]":
