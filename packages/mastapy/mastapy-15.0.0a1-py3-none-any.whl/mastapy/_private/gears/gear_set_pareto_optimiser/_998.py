...
from mastapy._private.math_utility.optimisation import _1724
...
class _Cast_BarForPareto:
    ...
    def pareto_optimisation_strategy_bars(
        self: "CastSelf",
    ) -> "_1724.ParetoOptimisationStrategyBars":
        return self.__parent__._cast(_1724.ParetoOptimisationStrategyBars)
...
class BarForPareto(
    _1724.ParetoOptimisationStrategyBars, Generic[TAnalysis, TCandidate]
):
    """BarForPareto
