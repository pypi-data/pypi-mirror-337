...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1638, _1639
...
class RingPins(_2662.MountableComponent):
    """RingPins
    ...
    @property
    def ring_pins_design(self: "Self") -> "_1638.RingPinsDesign":
    ...
    @property
    def ring_pins_material(self: "Self") -> "_1639.RingPinsMaterial":
