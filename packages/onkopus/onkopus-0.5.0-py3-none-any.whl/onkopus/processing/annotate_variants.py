...
def annotate_variant_data(
    ...
    if (genome_version=="hg19") or (genome_version=="t2t"):
        annotated_data = onkopus.LiftOverClient(genome_version=genome_version, target_genome="hg38").process_data(annotated_data)
    ...
    annotated_data = onkopus.onkopus_clients.CCSGeneToGenomicClient(genome_version=genome_version,data_type="g").process_data(annotated_data)
