...
class Metadata:
    ...
    def filter(
        ...
        """
        Returns list of PDBFile that match search criteria

        :param query: string that should appear in the tex file
        :param file_type: consider only those file types
        :param selected_tags: select PDBFiles tagged with any of the
            selected_tags
