...
from mastapy._private.electric_machines.thermal import _1458
...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.thermal import _1459, _1460
...
class ThermalEndWindingSurfaceCollection(_0.APIBase):
    ...
    def cooling_source(
        self: "Self", value: "_1458.EndWindingCoolingFlowSource"
    ) -> None:
    ...
    @property
    def end_winding_length_source(self: "Self") -> "_1459.EndWindingLengthSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines.thermal._1459", "EndWindingLengthSource"
        )(value)

    @end_winding_length_source.setter
    @enforce_parameter_types
    def end_winding_length_source(
        self: "Self", value: "_1459.EndWindingLengthSource"
    ) -> None:
    ...
    @property
    def surfaces(self: "Self") -> "List[_1460.EndWindingThermalElement]":
