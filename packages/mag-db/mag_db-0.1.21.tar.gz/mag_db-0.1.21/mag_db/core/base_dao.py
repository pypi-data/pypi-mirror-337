...
from mag_db.model.transaction_type import TransactionType
...
class BaseDao:
    ...
    def begin_transaction(self, _type: TransactionType, _name: str) -> Transaction:
        return self._session.begin_transaction(
            _name) if TransactionType == TransactionType.REQUIRED else self._session.begin_new_transaction(_name)
    ...
    def _create_transaction(self, _type: TransactionType, _name: str) -> Transaction:
