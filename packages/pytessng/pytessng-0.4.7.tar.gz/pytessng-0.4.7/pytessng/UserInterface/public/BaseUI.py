...
class BaseUI(QWidget, BaseTess):
    ...
    def _select_open_file_path(self, line_edit: Optional[QLineEdit]) -> None:
        """选择文件"""
        file_path: str = self.utils.get_open_file_path(self.formats)
        if file_path:
