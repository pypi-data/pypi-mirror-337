...
class EnumWithSelectedValue_CylindricalMftFinishingMethods(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_CylindricalMftFinishingMethods]",
    ) -> "_719.CylindricalMftFinishingMethods":
        ...
        Returns:
            _719.CylindricalMftFinishingMethods
        """
        return _719.CylindricalMftFinishingMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _719.CylindricalMftFinishingMethods.type_()

    @property
    def selected_value(self: "Self") -> "_719.CylindricalMftFinishingMethods":
    ...
    @property
    def available_values(self: "Self") -> "List[_719.CylindricalMftFinishingMethods]":
