...
from mastapy._private.system_model.analyses_and_results.system_deflections import _3043
...
class MassDiscSystemDeflection(_3043.VirtualComponentSystemDeflection):
    """MassDiscSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4336.MassDiscPowerFlow":
