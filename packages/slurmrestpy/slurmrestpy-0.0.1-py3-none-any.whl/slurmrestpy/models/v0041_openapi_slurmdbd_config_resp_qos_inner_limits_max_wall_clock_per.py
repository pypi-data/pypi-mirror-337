...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPer(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "qos": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos.from_dict(
                    obj["qos"]
                )
                if obj.get("qos") is not None
                else None,
                "job": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob.from_dict(
                    obj["job"]
                )
