...
class _Cast_ShaftPerModeResult:
    ...
    @property
    def component_per_mode_result(self: "CastSelf") -> "_4955.ComponentPerModeResult":
        return self.__parent__._cast(_4955.ComponentPerModeResult)
...
class ShaftPerModeResult(_4955.ComponentPerModeResult):
    """ShaftPerModeResult
