...
class CreateEnterpriseTrialUserRequest(BaseModel):
    ...
    __properties = ["email", "organizationName", "expirationDate", "notes", "useCase", "userHasMLModelsInProduction", "companyName", "companySize", "country", "stateOrProvince", "redirectUrlOrigin", "redirectUrlQueryParams", "name", "username", "privacyPolicy", "password", "jobTitle", "utmParams", "turnstileResponse"]
