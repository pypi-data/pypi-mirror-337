...
class ListWithSelectedItem_CylindricalGear(
    _2727.CylindricalGear, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGear]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2727.CylindricalGear.TYPE

    @property
    def selected_value(self: "Self") -> "_2727.CylindricalGear":
    ...
    @property
    def available_values(self: "Self") -> "List[_2727.CylindricalGear]":
