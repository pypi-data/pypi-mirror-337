...
class V0041JobSubmitReq(BaseModel):
    ...
    script: Optional[StrictStr] = Field(
        default=None, description="Deprecated; Populate script field in jobs[0] or job"
    )
    jobs: Optional[List[V0041JobDescMsg]] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "jobs": [V0041JobDescMsg.from_dict(_item) for _item in obj["jobs"]]
                if obj.get("jobs") is not None
                else None,
                "job": V0041JobDescMsg.from_dict(obj["job"])
