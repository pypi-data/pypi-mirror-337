...
class FabricDataAgentAPI:
    ...
    def __init__(
        ...
        self._data_agent_base_url = f"{self._host}/webapi/capacities/{self.capacity_id}/workloads/ML/AISkill/Automatic/workspaces/{self.workspace_id}/aiskills/{self.data_agent_id}"
