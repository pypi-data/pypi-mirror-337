        ...
        if include_optional:
            return V0040PartitionInfo(
                ...
                cpus = slurmrestpy.models.v0_0_42_partition_info_cpus.v0_0_42_partition_info_cpus(
                    task_binding = 56,
                    total = 56, ),
                defaults = slurmrestpy.models.v0_0_40_partition_info_defaults.v0_0_40_partition_info_defaults(
                    memory_per_cpu = 56,
                    ...
                    job = '', ),
                grace_time = 56,
                maximums = slurmrestpy.models.v0_0_40_partition_info_maximums.v0_0_40_partition_info_maximums(
                ...
                priority = slurmrestpy.models.v0_0_42_partition_info_priority.v0_0_42_partition_info_priority(
                    job_factor = 56,
                    tier = 56, ),
                timeouts = slurmrestpy.models.v0_0_40_partition_info_timeouts.v0_0_40_partition_info_timeouts(
                    resume = slurmrestpy.models.v0/0/40_uint16_no_val.v0.0.40_uint16_no_val(
                        set = True,
                        infinite = True,
                        number = 56, ),
                    suspend = slurmrestpy.models.v0/0/40_uint16_no_val.v0.0.40_uint16_no_val(
                        set = True,
                        infinite = True,
                        number = 56, ), ),
                partition = slurmrestpy.models.v0_0_40_partition_info_partition.v0_0_40_partition_info_partition(
                    state = [
                        'INACTIVE'
                        ], ),
                suspend_time = slurmrestpy.models.v0/0/40_uint32_no_val.v0.0.40_uint32_no_val(
                    set = True,
                    infinite = True,
                    number = 56, )
            )
