...
SAFE_SIMULATE_TX_ACCESSOR_ADDRESS: ChecksumAddress = ChecksumAddress(
    ...
    HexAddress(HexStr("0x50Ec4a9274CC1B43ae0A9341788DF9112730e7fC"))
)
...
MASTER_COPIES: Dict[EthereumNetwork, List[Tuple[str, int, str]]] = {
    ...
    EthereumNetwork.PLATON: [
        ("0x4a4cf07bE8dAbCb569985156c1ea6B0c82a8C1A0", 79304794, "1.4.1+L2"),
        ("0xb9a0002224F173f984a6212AA4D156BEF1eee94F", 79304799, "1.4.1"),
    ],
