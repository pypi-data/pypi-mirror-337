...
@pcAccessor.register('curve_fit', totype='array')
@format_docstring(**_paramdocs_ensure_dims)
def xarray_curve_fit(array, f, dim, *, stddev=True, promote_dims_if_needed=True,
    ...
    kw = xarray_copy_kw(array, dims=other)
...
def xarray_curve_eval(params, f, xdata):
...
class XarrayCurveFitter():
    ...
    def eval(self, xdata=UNSET, params=UNSET):
        ...
        if params is UNSET: params = self.params
        return xarray_curve_eval(params, self.f, xdata)
