...
from gaea_operator.config import OCRNetConfig, KEY_NETWORK_ARCHITECTURE, KEY_EARLY_STOPPING
...
def  ocrnet_train(args):
    ...
    metric_names = [LOSS_METRIC_NAME, MIOU_METRIC_NAME, PACC_METRIC_NAME]
