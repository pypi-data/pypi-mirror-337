        ...
        if include_optional:
            return V0040QosLimitsMax(
                ...
                wall_clock = slurmrestpy.models.v0_0_40_qos_limits_max_wall_clock.v0_0_40_qos_limits_max_wall_clock(
                    per = slurmrestpy.models.v0_0_40_qos_limits_max_wall_clock_per.v0_0_40_qos_limits_max_wall_clock_per(
                        qos = slurmrestpy.models.v0/0/40_uint32_no_val.v0.0.40_uint32_no_val(
                            set = True,
                            infinite = True,
                            number = 56, ),
                        job = slurmrestpy.models.v0/0/40_uint32_no_val.v0.0.40_uint32_no_val(
                            set = True,
                            infinite = True,
                            number = 56, ), ), ),
                jobs = slurmrestpy.models.v0_0_40_qos_limits_max_jobs.v0_0_40_qos_limits_max_jobs(
                    active_jobs = slurmrestpy.models.v0_0_40_qos_limits_max_jobs_active_jobs.v0_0_40_qos_limits_max_jobs_active_jobs(
