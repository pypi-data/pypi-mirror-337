...
class EnumWithSelectedValue_TorqueSpecificationForSystemDeflection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueSpecificationForSystemDeflection]",
    ) -> "_7807.TorqueSpecificationForSystemDeflection":
        ...
        Returns:
            _7807.TorqueSpecificationForSystemDeflection
        """
        return _7807.TorqueSpecificationForSystemDeflection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7807.TorqueSpecificationForSystemDeflection.type_()

    @property
    def selected_value(self: "Self") -> "_7807.TorqueSpecificationForSystemDeflection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_7807.TorqueSpecificationForSystemDeflection]":
