...
class V0040StepTresConsumed(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "max": [V0040Tres.from_dict(_item) for _item in obj["max"]]
                if obj.get("max") is not None
                else None,
                "min": [V0040Tres.from_dict(_item) for _item in obj["min"]]
                if obj.get("min") is not None
                else None,
                "average": [V0040Tres.from_dict(_item) for _item in obj["average"]]
