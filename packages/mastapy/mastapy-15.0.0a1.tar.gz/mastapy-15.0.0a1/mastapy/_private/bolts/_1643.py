...
if TYPE_CHECKING:
    ...
    from mastapy._private.bolts import _1642, _1647, _1652
...
T = TypeVar("T", bound="_1642.BoltedJointMaterial")
...
class BoltedJointMaterialDatabase(_2010.NamedDatabase[T]):
    """BoltedJointMaterialDatabase
