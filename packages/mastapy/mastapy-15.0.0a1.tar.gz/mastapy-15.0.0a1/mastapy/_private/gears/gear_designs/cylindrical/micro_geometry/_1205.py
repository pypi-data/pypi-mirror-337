...
class CylindricalGearMeshMicroGeometryDutyCycle(_1335.GearMeshDesignAnalysis):
    """CylindricalGearMeshMicroGeometryDutyCycle
    ...
    def peak_to_peak_te(
        self: "Self",
    ) -> "_2028.DutyCyclePropertySummaryVeryShortLength[_953.CylindricalGearMeshLoadDistributionAnalysis]":
