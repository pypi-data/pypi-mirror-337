...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.thermal import _1472
...
class ThermalLoadCase(_0.APIBase):
    ...
    @property
    def mapped_electromagnetic_analysis(
        self: "Self",
    ) -> "list_with_selected_item.ListWithSelectedItem_ElectricMachineFEAnalysis":
        """ListWithSelectedItem[mastapy.electric_machines.load_cases_and_analyses.ElectricMachineFEAnalysis]"""
        temp = pythonnet_property_get(self.wrapped, "MappedElectromagneticAnalysis")
        ...
        return constructor.new_from_mastapy(
            ...
            "ListWithSelectedItem_ElectricMachineFEAnalysis",
        )(temp)

    @mapped_electromagnetic_analysis.setter
    @enforce_parameter_types
    def mapped_electromagnetic_analysis(
        self: "Self", value: "_1531.ElectricMachineFEAnalysis"
    ) -> None:
        wrapper_type = list_with_selected_item.ListWithSelectedItem_ElectricMachineFEAnalysis.wrapper_type()
        enclosed_type = list_with_selected_item.ListWithSelectedItem_ElectricMachineFEAnalysis.implicit_type()
        value = wrapper_type[enclosed_type](
            value.wrapped if value is not None else None
        )
        pythonnet_property_set(self.wrapped, "MappedElectromagneticAnalysis", value)
    ...
    @property
    def cooling_jacket(self: "Self") -> "_1487.CoolingLoadCaseSettings":
    ...
    @property
    def load_case_group(self: "Self") -> "_1495.ThermalLoadCaseGroup":
    ...
    @property
    def power_losses(self: "Self") -> "_1491.PowerLosses":
    ...
    @property
    def rotor_cooling_channels(self: "Self") -> "_1487.CoolingLoadCaseSettings":
        """mastapy.electric_machines.thermal.load_cases_and_analyses.CoolingLoadCaseSettings
    ...
    @property
    def shaft_cooling_channel(self: "Self") -> "_1487.CoolingLoadCaseSettings":
        """mastapy.electric_machines.thermal.load_cases_and_analyses.CoolingLoadCaseSettings
    ...
    @property
    def solver_settings(self: "Self") -> "_216.ThermalNetworkSolverSettings":
    ...
    @property
    def stator_cooling_channels(self: "Self") -> "_1487.CoolingLoadCaseSettings":
        """mastapy.electric_machines.thermal.load_cases_and_analyses.CoolingLoadCaseSettings
    ...
    @enforce_parameter_types
    def copy_to(
        self: "Self", another_group: "_1495.ThermalLoadCaseGroup"
    ) -> "ThermalLoadCase":
    ...
    @enforce_parameter_types
    def remove_analysis(
        self: "Self", electric_machine_thermal_analysis: "_1493.ThermalAnalysis"
    ) -> None:
        """Method does not return.
