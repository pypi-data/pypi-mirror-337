...
class ConceptGearSetCompoundDynamicAnalysis(_6740.GearSetCompoundDynamicAnalysis):
    """ConceptGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6578.ConceptGearSetDynamicAnalysis]":
    ...
    def concept_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6709.ConceptGearCompoundDynamicAnalysis]":
    ...
    def concept_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6710.ConceptGearMeshCompoundDynamicAnalysis]":
