...
class LodgingReservation(Struct, frozen=True):
    ...
    numAdults: int | 'QuantitativeValue' | None = None
    checkoutTime: time | datetime | None = None
    checkinTime: time | datetime | None = None
    lodgingUnitDescription: str | None = None
    lodgingUnitType: str | 'QualitativeValue' | None = None
    numChildren: int | 'QuantitativeValue' | None = None