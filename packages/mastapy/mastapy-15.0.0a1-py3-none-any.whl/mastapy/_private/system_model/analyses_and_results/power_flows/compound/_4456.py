...
class GuideDxfModelCompoundPowerFlow(_4420.ComponentCompoundPowerFlow):
    """GuideDxfModelCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4322.GuideDxfModelPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4322.GuideDxfModelPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.GuideDxfModelPowerFlow]
