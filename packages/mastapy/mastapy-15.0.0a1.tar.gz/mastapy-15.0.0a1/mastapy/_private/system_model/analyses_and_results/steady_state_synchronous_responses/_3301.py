...
from mastapy._private.system_model.analyses_and_results.analysis_cases import _7837
...
class SteadyStateSynchronousResponse(_7837.CompoundAnalysisCase):
    """SteadyStateSynchronousResponse
    ...
    def steady_state_analysis_options(
        self: "Self",
    ) -> "_3303.SteadyStateSynchronousResponseOptions":
