...
class RingPinsCompoundModalAnalysis(_5044.MountableComponentCompoundModalAnalysis):
    """RingPinsCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4909.RingPinsModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4909.RingPinsModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.RingPinsModalAnalysis]
