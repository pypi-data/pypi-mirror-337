...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.tolerances import _2087, _2092, _2098, _2104
...
class RingTolerance(_2095.InterferenceTolerance):
    """RingTolerance
    ...
    @property
    def roundness_specification(self: "Self") -> "_2104.RoundnessSpecification":
