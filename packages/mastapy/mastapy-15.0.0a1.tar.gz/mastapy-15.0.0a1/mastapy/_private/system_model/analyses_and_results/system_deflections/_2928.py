...
class ConceptGearSystemDeflection(_2967.GearSystemDeflection):
    """ConceptGearSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_635.ConceptGearRating":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4288.ConceptGearPowerFlow":
