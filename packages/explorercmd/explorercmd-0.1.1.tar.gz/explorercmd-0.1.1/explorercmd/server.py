...
# Настройки сервера
local_ip = "0.0.0.0"  # Слушать все интерфейсы
local_port = 8848     # Порт, соответствующий настройкам playit.gg
...
def handle_client(client_socket):
    ...
    print("Клиент подключён, отправляю запрос пароля.")
                ...
                try:
                    with open(new_path, "rb") as f:
                        ...
                        while file_data:
                            ...
                            file_data = f.read(1024)
                        client_socket.send(b"")  # Сигнал окончания файла
...
server.listen(5)
print(f"Сервер запущен на {local_ip}:{local_port}, ожидание подключений...")
