...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2841, _2842, _2843
...
class _Cast_MeshedResultSurfaceBase:
    ...
    @property
    def meshed_result_surface(self: "CastSelf") -> "_2843.MeshedResultSurface":
        from mastapy._private.system_model.part_model.acoustics import _2843

        return self.__parent__._cast(_2843.MeshedResultSurface)
