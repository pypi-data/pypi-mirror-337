...
import image_article_comprehension.xhs.note_detail as xhs_detail
...
def key_word_search(keyword):
    ...
    save_dir = "/Users/nieqi/Documents/workspace/python/image_article_comprehension/xhs/search_result"
    keyword_search_dir = os.path.join(save_dir, keyword)
