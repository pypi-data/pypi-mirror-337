...
# to access global EMA_BASE object, EXCEPT during multiprocessing adapt


# -------------------------------------------------------------------
__ModelVersion__ = "2025-03-29"
...
class EmaRespondentModel(EmaObject):
    ...
    as defined in package global ema_base.EMA_BASE
    """
    ...
    def adapt(self, s_name, base, prior):
        ...
        :param base: ref to global EmaParamBase instance for logprob calc
...
# ------------------------------------- display functions
    ...
    def rvs_grade_count(self, a, groupby=None, sample_head='_Sample'):
        ...
        theta = base.attribute_theta(self.xi, a)
