...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _821
...
class HobSimulationCalculator(_839.RackSimulationCalculator):
    """HobSimulationCalculator
    ...
    @property
    def hob(self: "Self") -> "_821.CylindricalGearHobShape":
