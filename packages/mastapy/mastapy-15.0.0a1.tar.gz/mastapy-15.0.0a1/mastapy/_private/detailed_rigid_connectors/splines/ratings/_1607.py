...
class _Cast_SplineHalfRating:
    ...
    def agma6123_spline_half_rating(
        self: "CastSelf",
    ) -> "_1599.AGMA6123SplineHalfRating":
        from mastapy._private.detailed_rigid_connectors.splines.ratings import _1599

        return self.__parent__._cast(_1599.AGMA6123SplineHalfRating)

    @property
    def din5466_spline_half_rating(self: "CastSelf") -> "_1601.DIN5466SplineHalfRating":
        from mastapy._private.detailed_rigid_connectors.splines.ratings import _1601

        return self.__parent__._cast(_1601.DIN5466SplineHalfRating)

    @property
    def gbt17855_spline_half_rating(
        self: "CastSelf",
    ) -> "_1603.GBT17855SplineHalfRating":
        from mastapy._private.detailed_rigid_connectors.splines.ratings import _1603

        return self.__parent__._cast(_1603.GBT17855SplineHalfRating)

    @property
    def sae_spline_half_rating(self: "CastSelf") -> "_1605.SAESplineHalfRating":
        from mastapy._private.detailed_rigid_connectors.splines.ratings import _1605

        return self.__parent__._cast(_1605.SAESplineHalfRating)
