...
def calculate_vlims(values, *, vmin=None, vmax=None, robust=False):
    ...
    if computed vmin > vmax, and provided vmin or vmax but not both,
        adjust the not-provided value such that vmin > vmax. I.e.:
