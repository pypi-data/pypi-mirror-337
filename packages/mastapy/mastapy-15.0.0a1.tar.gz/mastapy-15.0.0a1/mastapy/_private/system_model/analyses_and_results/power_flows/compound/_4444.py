...
class CylindricalGearSetCompoundPowerFlow(_4455.GearSetCompoundPowerFlow):
    """CylindricalGearSetCompoundPowerFlow
    ...
    def cylindrical_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4442.CylindricalGearCompoundPowerFlow]":
    ...
    def cylindrical_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4443.CylindricalGearMeshCompoundPowerFlow]":
    ...
    def ratings_for_all_designs(
        self: "Self",
    ) -> "List[_547.CylindricalGearSetDutyCycleRating]":
