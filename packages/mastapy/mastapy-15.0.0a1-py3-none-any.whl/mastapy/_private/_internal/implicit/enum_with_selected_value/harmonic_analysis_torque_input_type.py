...
class EnumWithSelectedValue_HarmonicAnalysisTorqueInputType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HarmonicAnalysisTorqueInputType]",
    ) -> "_6024.HarmonicAnalysisTorqueInputType":
        ...
        Returns:
            _6024.HarmonicAnalysisTorqueInputType
        """
        return _6024.HarmonicAnalysisTorqueInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _6024.HarmonicAnalysisTorqueInputType.type_()

    @property
    def selected_value(self: "Self") -> "_6024.HarmonicAnalysisTorqueInputType":
    ...
    @property
    def available_values(self: "Self") -> "List[_6024.HarmonicAnalysisTorqueInputType]":
