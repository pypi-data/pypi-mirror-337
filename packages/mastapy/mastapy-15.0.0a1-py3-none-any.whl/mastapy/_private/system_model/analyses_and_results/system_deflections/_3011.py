...
class ShaftSectionSystemDeflection(_131.Bar):
    """ShaftSectionSystemDeflection
    ...
    @property
    def left_end(self: "Self") -> "_3010.ShaftSectionEndResultsSystemDeflection":
    ...
    @property
    def right_end(self: "Self") -> "_3010.ShaftSectionEndResultsSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSectionEndResultsSystemDeflection
