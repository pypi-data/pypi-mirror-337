...
from mastapy._private.electric_machines.harmonic_load_data import _1557
...
class _Cast_HarmonicLoadDataImportFromMotorPackages:
    ...
    def harmonic_load_data_import_base(
        self: "CastSelf",
    ) -> "_7728.HarmonicLoadDataImportBase":
        return self.__parent__._cast(_7728.HarmonicLoadDataImportBase)

    @property
    def harmonic_load_data_csv_import(
        self: "CastSelf",
    ) -> "_7725.HarmonicLoadDataCSVImport":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7725,
        )

        return self.__parent__._cast(_7725.HarmonicLoadDataCSVImport)

    @property
    def harmonic_load_data_flux_import(
        self: "CastSelf",
    ) -> "_7727.HarmonicLoadDataFluxImport":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7727,
        )

        return self.__parent__._cast(_7727.HarmonicLoadDataFluxImport)

    @property
    def harmonic_load_data_jmag_import(
        self: "CastSelf",
    ) -> "_7730.HarmonicLoadDataJMAGImport":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7730,
        )

        return self.__parent__._cast(_7730.HarmonicLoadDataJMAGImport)

    @property
    def harmonic_load_data_motor_cad_import(
        self: "CastSelf",
    ) -> "_7731.HarmonicLoadDataMotorCADImport":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7731,
        )

        return self.__parent__._cast(_7731.HarmonicLoadDataMotorCADImport)
...
class HarmonicLoadDataImportFromMotorPackages(_7728.HarmonicLoadDataImportBase[T]):
    """HarmonicLoadDataImportFromMotorPackages
    ...
    @data_type.setter
    @enforce_parameter_types
    def data_type(self: "Self", value: "_1557.HarmonicLoadDataType") -> None:
