...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.elmer import _246, _247
...
class _Cast_ElmerResults:
    ...
    def elmer_results_from_electromagnetic_analysis(
        self: "CastSelf",
    ) -> "_246.ElmerResultsFromElectromagneticAnalysis":
        from mastapy._private.nodal_analysis.elmer import _246

        return self.__parent__._cast(_246.ElmerResultsFromElectromagneticAnalysis)

    @property
    def elmer_results_from_mechanical_analysis(
        self: "CastSelf",
    ) -> "_247.ElmerResultsFromMechanicalAnalysis":
        from mastapy._private.nodal_analysis.elmer import _247

        return self.__parent__._cast(_247.ElmerResultsFromMechanicalAnalysis)
