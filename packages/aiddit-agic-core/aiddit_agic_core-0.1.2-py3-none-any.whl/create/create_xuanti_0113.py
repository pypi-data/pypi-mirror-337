import json
import logging
from image_article_comprehension.create.xuanti_prompt import xuanti_creation_20250113, xuanti_estimate_20250113
import os
from tqdm import tqdm
import traceback
import image_article_comprehension.utils as utils

renshe_path = "/Users/nieqi/Documents/workspace/python/image_article_comprehension/comprehension/renshe/result/20250109_脆肚火锅噗噜噗噜.json"
renshe = json.load(open(renshe_path, 'r'))

output_dir = "/Users/nieqi/Documents/workspace/python/image_article_comprehension/create/result/image_since_0113"
...
def batch_create_executor():
    ...
    reference_note_keypoint_dir = "/Users/nieqi/Documents/workspace/python/image_article_comprehension/create/reference_note/image_0109"
