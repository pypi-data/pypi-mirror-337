...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.cylindrical import _1322
...
class _Cast_GearLTCAContactCharts:
    ...
    def cylindrical_gear_ltca_contact_charts(
        self: "CastSelf",
    ) -> "_1322.CylindricalGearLTCAContactCharts":
        from mastapy._private.gears.cylindrical import _1322

        return self.__parent__._cast(_1322.CylindricalGearLTCAContactCharts)
