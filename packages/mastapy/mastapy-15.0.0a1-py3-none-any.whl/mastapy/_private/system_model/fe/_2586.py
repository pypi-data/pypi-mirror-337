...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2551, _2595
...
class FESubstructureWithSelectionForStaticAnalysis(_2582.FESubstructureWithSelection):
    """FESubstructureWithSelectionForStaticAnalysis
    ...
    @enforce_parameter_types
    def contour_option(self: "Self", value: "_2002.ThreeDViewContourOption") -> None:
    ...
    @property
    def static_draw_style(self: "Self") -> "_270.FEModelStaticAnalysisDrawStyle":
    ...
    def boundary_conditions_all_nodes(
        self: "Self",
    ) -> "List[_2595.NodeBoundaryConditionStaticAnalysis]":
