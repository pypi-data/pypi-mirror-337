...
class V0042OpenapiSlurmdbdConfigResp(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "clusters": [
                    V0042ClusterRec.from_dict(_item) for _item in obj["clusters"]
                ]
                if obj.get("clusters") is not None
                else None,
                "tres": [V0042Tres.from_dict(_item) for _item in obj["tres"]]
                if obj.get("tres") is not None
                else None,
                "accounts": [V0042Account.from_dict(_item) for _item in obj["accounts"]]
                if obj.get("accounts") is not None
                else None,
                "users": [V0042User.from_dict(_item) for _item in obj["users"]]
                if obj.get("users") is not None
                else None,
                "qos": [V0042Qos.from_dict(_item) for _item in obj["qos"]]
                if obj.get("qos") is not None
                else None,
                "wckeys": [V0042Wckey.from_dict(_item) for _item in obj["wckeys"]]
                if obj.get("wckeys") is not None
                else None,
                "associations": [
                    V0042Assoc.from_dict(_item) for _item in obj["associations"]
                ]
                if obj.get("associations") is not None
                else None,
                "instances": [
                    V0042Instance.from_dict(_item) for _item in obj["instances"]
                ]
                if obj.get("instances") is not None
                else None,
                "meta": V0042OpenapiMeta.from_dict(obj["meta"])
                if obj.get("meta") is not None
                else None,
                "errors": [
                    V0042OpenapiError.from_dict(_item) for _item in obj["errors"]
                ]
                if obj.get("errors") is not None
                else None,
                "warnings": [
                    V0042OpenapiWarning.from_dict(_item) for _item in obj["warnings"]
                ]
