...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1380, _1390, _1414
...
class ElectricMachineGroup(_0.APIBase):
    ...
    @property
    def electric_machine_details(self: "Self") -> "List[_1380.ElectricMachineDetail]":
    ...
    def electric_machine_load_case_groups(
        self: "Self",
    ) -> "List[_1535.ElectricMachineLoadCaseGroup]":
    ...
    @property
    def thermal_electric_machines(self: "Self") -> "List[_1471.ThermalElectricMachine]":
    ...
    def add_electric_machine_detail(
        self: "Self", type_: "_1390.ElectricMachineType", name: "str" = "Motor"
    ...
    ) -> "_1535.ElectricMachineLoadCaseGroup":
    ...
    def add_thermal_electric_machine(
        self: "Self", electric_machine: "_1380.ElectricMachineDetail", name: "str"
    ) -> "_1471.ThermalElectricMachine":
    ...
    def duplicate_electric_machine_detail(
        self: "Self", detail: "_1380.ElectricMachineDetail"
    ) -> "_1380.ElectricMachineDetail":
    ...
    def duplicate_thermal_electric_machine(
        self: "Self", thermal_electric_machine: "_1471.ThermalElectricMachine"
    ) -> "_1471.ThermalElectricMachine":
        """mastapy.electric_machines.thermal.ThermalElectricMachine
    ...
    def remove_electric_machine_detail(
        self: "Self", motor: "_1380.ElectricMachineDetail"
    ) -> "bool":
        """bool
    ...
    def try_remove_load_case_group(
        self: "Self", load_case_group: "_1535.ElectricMachineLoadCaseGroup"
    ) -> "bool":
        """bool
