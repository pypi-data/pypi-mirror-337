...
class _Cast_CylindricalGearBasicRackFlank:
    ...
    def cylindrical_gear_abstract_rack_flank(
        self: "CastSelf",
    ) -> "_1110.CylindricalGearAbstractRackFlank":
        return self.__parent__._cast(_1110.CylindricalGearAbstractRackFlank)
...
class CylindricalGearBasicRackFlank(_1110.CylindricalGearAbstractRackFlank):
    """CylindricalGearBasicRackFlank
