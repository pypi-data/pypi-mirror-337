...
class EnumWithSelectedValue_RaceAxialMountingType(
    ...
    def wrapped_type(
        ...
        Returns:
            _2150.RaceAxialMountingType
        """
        return _2150.RaceAxialMountingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2150.RaceAxialMountingType.type_()

    @property
    def selected_value(self: "Self") -> "_2150.RaceAxialMountingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2150.RaceAxialMountingType]":
