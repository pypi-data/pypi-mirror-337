...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2856, _2889
...
class StaticLoadCase(_7631.LoadCase):
    """StaticLoadCase
    ...
    def default_planetary_rating_load_sharing_method(
        self: "Self",
    ) -> "_424.PlanetaryRatingLoadSharingOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._424", "PlanetaryRatingLoadSharingOption"
        )(value)

    @default_planetary_rating_load_sharing_method.setter
    @enforce_parameter_types
    def default_planetary_rating_load_sharing_method(
        self: "Self", value: "_424.PlanetaryRatingLoadSharingOption"
    ) -> None:
    ...
    def unbalanced_mass_inclusion(
        self: "Self",
        value: "Union[_2678.UnbalancedMassInclusionOption, Tuple[_2678.UnbalancedMassInclusionOption, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    def advanced_system_deflection_options(
        self: "Self",
    ) -> "_7355.AdvancedSystemDeflectionOptions":
    ...
    def te_set_up_for_dynamic_analyses_options(
        self: "Self",
    ) -> "_2889.TESetUpForDynamicAnalysisOptions":
    ...
    @property
    def clutch_engagements(self: "Self") -> "List[_5915.ClutchEngagementStatus]":
    ...
    def concept_clutch_engagements(
        self: "Self",
    ) -> "List[_5916.ConceptSynchroGearEngagementStatus]":
    ...
    @property
    def design_state_load_case_group(self: "Self") -> "_5917.DesignState":
    ...
    @enforce_parameter_types
    def duplicate(
        self: "Self", new_design_state_group: "_5917.DesignState", name: "str" = "None"
    ) -> "StaticLoadCase":
