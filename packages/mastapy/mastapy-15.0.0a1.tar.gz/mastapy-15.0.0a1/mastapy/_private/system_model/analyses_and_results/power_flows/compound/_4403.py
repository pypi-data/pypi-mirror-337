...
class BearingCompoundPowerFlow(_4431.ConnectorCompoundPowerFlow):
    """BearingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4266.BearingPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4266.BearingPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BearingPowerFlow]
