...
class BevelDifferentialGearSetModalAnalysis(_4825.BevelGearSetModalAnalysis):
    """BevelDifferentialGearSetModalAnalysis
    ...
    def bevel_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4819.BevelDifferentialGearModalAnalysis]":
    ...
    def bevel_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4818.BevelDifferentialGearMeshModalAnalysis]":
