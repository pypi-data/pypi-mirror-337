...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.optimisation import _587, _588
...
T = TypeVar("T", bound="_588.SafetyFactorOptimisationStepResult")
...
class OptimisationResultsPair(_0.APIBase, Generic[T]):
    ...
    @property
    def results(self: "Self") -> "_587.SafetyFactorOptimisationResults[T]":
    ...
    def results_without_warnings(
        self: "Self",
    ) -> "_587.SafetyFactorOptimisationResults[T]":
        """mastapy.gears.rating.cylindrical.optimisation.SafetyFactorOptimisationResults[T]
