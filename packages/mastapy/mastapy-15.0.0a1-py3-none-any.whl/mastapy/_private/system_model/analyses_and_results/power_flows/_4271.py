...
class BevelDifferentialGearSetPowerFlow(_4276.BevelGearSetPowerFlow):
    """BevelDifferentialGearSetPowerFlow
    ...
    def bevel_gears_power_flow(
        self: "Self",
    ) -> "List[_4270.BevelDifferentialGearPowerFlow]":
    ...
    def bevel_meshes_power_flow(
        self: "Self",
    ) -> "List[_4269.BevelDifferentialGearMeshPowerFlow]":
