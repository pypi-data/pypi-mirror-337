...
class EnumWithSelectedValue_OilSealLossCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_OilSealLossCalculationMethod]",
    ) -> "_383.OilSealLossCalculationMethod":
        ...
        Returns:
            _383.OilSealLossCalculationMethod
        """
        return _383.OilSealLossCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _383.OilSealLossCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_383.OilSealLossCalculationMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_383.OilSealLossCalculationMethod]":
