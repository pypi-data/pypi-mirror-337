...
class EnumWithSelectedValue_LoadCaseOverrideOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _1763.LoadCaseOverrideOption
        """
        return _1763.LoadCaseOverrideOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1763.LoadCaseOverrideOption.type_()

    @property
    def selected_value(self: "Self") -> "_1763.LoadCaseOverrideOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1763.LoadCaseOverrideOption]":
