...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.load_cases_and_analyses import _1537
...
class Windings(_0.APIBase):
    ...
    def double_layer_winding_slot_positions(
        self: "Self",
    ) -> "_1376.DoubleLayerWindingSlotPositions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1376",
    ...
    @enforce_parameter_types
    def double_layer_winding_slot_positions(
        self: "Self", value: "_1376.DoubleLayerWindingSlotPositions"
    ) -> None:
    ...
    def end_winding_inductance_method(
        self: "Self",
    ) -> "_1537.EndWindingInductanceMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines.load_cases_and_analyses._1537",
    ...
    @enforce_parameter_types
    def end_winding_inductance_method(
        self: "Self", value: "_1537.EndWindingInductanceMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.EndWindingInductanceMethod",
    ...
    def fill_factor_specification_method(
        self: "Self",
    ) -> "_1393.FillFactorSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1393", "FillFactorSpecificationMethod"
        )(value)

    @fill_factor_specification_method.setter
    @enforce_parameter_types
    def fill_factor_specification_method(
        self: "Self", value: "_1393.FillFactorSpecificationMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def mmf(self: "Self") -> "_2053.TwoDChartDefinition":
    ...
    def single_double_layer_windings(
        self: "Self",
    ) -> "_1426.SingleOrDoubleLayerWindings":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1426", "SingleOrDoubleLayerWindings"
        )(value)

    @single_double_layer_windings.setter
    @enforce_parameter_types
    def single_double_layer_windings(
        self: "Self", value: "_1426.SingleOrDoubleLayerWindings"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def winding_connection(self: "Self") -> "_1444.WindingConnection":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1444", "WindingConnection"
        )(value)

    @winding_connection.setter
    @enforce_parameter_types
    def winding_connection(self: "Self", value: "_1444.WindingConnection") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def winding_type(self: "Self") -> "_1449.WindingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1449", "WindingType"
        )(value)

    @winding_type.setter
    @enforce_parameter_types
    def winding_type(self: "Self", value: "_1449.WindingType") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def wire_size_specification_method(
        self: "Self",
    ) -> "_1450.WireSizeSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1450", "WireSizeSpecificationMethod"
        )(value)

    @wire_size_specification_method.setter
    @enforce_parameter_types
    def wire_size_specification_method(
        self: "Self", value: "_1450.WireSizeSpecificationMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def mmf_fourier_series_electrical(self: "Self") -> "_1688.FourierSeries":
    ...
    @property
    def mmf_fourier_series_mechanical(self: "Self") -> "_1688.FourierSeries":
        """mastapy.math_utility.FourierSeries
    ...
    @property
    def windings_viewer(self: "Self") -> "_1448.WindingsViewer":
    ...
    @property
    def coils(self: "Self") -> "List[_1369.Coil]":
    ...
    @property
    def conductors(self: "Self") -> "List[_1443.WindingConductor]":
    ...
    @property
    def phases(self: "Self") -> "List[_1419.Phase]":
    ...
    @property
    def slot_section_details(self: "Self") -> "List[_1427.SlotSectionDetail]":
