...
from mastapy._private.detailed_rigid_connectors.splines import _1588, _1594
...
class FitAndTolerance(_0.APIBase):
    ...
    def fit_class(self: "Self", value: "_1588.SplineFitClassType") -> None:
    ...
    @enforce_parameter_types
    def tolerance_class(self: "Self", value: "_1594.SplineToleranceClassTypes") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
