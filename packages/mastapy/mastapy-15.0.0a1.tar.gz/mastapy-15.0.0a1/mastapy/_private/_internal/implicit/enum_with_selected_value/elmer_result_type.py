...
class EnumWithSelectedValue_ElmerResultType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ElmerResultType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _249.ElmerResultType.type_()

    @property
    def selected_value(self: "Self") -> "_249.ElmerResultType":
    ...
    @property
    def available_values(self: "Self") -> "List[_249.ElmerResultType]":
