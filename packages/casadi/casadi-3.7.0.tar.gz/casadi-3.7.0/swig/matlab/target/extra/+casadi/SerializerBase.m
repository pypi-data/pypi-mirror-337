classdef  SerializerBase < SwigRef
  ...
  methods(Static)
    ...
    function v = internal_SERIALIZED_MX_v1()
      persistent vInitialized;
      if isempty(vInitialized)
    ...
    function v = internal_SERIALIZED_SX_v1()
      persistent vInitialized;
      if isempty(vInitialized)
    ...
    function v = internal_SERIALIZED_MX_VECTOR_v1()
      persistent vInitialized;
      if isempty(vInitialized)
    ...
    function v = internal_SERIALIZED_SX_VECTOR_v1()
      persistent vInitialized;
      if isempty(vInitialized)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1179, varargin{:});
    end
  end
end
