...
from glik_plugin_local.entities.model import AIModelEntity, FetchFrom, ModelType
from glik_plugin_local.entities.model.rerank import RerankDocument, RerankResult
