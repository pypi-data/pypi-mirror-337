...
from mastapy._private.electric_machines.load_cases_and_analyses import _1539
...
class EnumWithSelectedValue_LoadCaseType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_LoadCaseType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1539.LoadCaseType.type_()

    @property
    def selected_value(self: "Self") -> "_1539.LoadCaseType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1539.LoadCaseType]":
