...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.cylindrical import _1321, _1322, _1323, _1324
    from mastapy._private.gears.ltca import _923
...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    def worst_contact_charts(
        self: "Self",
    ) -> "_1324.CylindricalGearWorstLTCAContactCharts":
    ...
    def worst_contact_charts_as_text_files(
        self: "Self",
    ) -> "_1323.CylindricalGearWorstLTCAContactChartDataAsTextFile":
    ...
    @property
    def contact_charts(self: "Self") -> "List[_1322.CylindricalGearLTCAContactCharts]":
    ...
    def contact_charts_as_text_files(
        self: "Self",
    ) -> "List[_1321.CylindricalGearLTCAContactChartDataAsTextFile]":
    ...
    def contact_patch_as_text(
        self: "Self",
        result_type: "_923.ContactResultType",
