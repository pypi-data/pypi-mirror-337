...
if TYPE_CHECKING:
    ...
    from msgspec_schemaorg.models.intangible.LegalValueLevel import LegalValueLevel
...
class LegislationObject(Struct, frozen=True):
    ...
    legislationIdentifier: str | str | None = None
    ...
    uploadDate: date | datetime | None = None
