...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5919
...
class _Cast_ClutchEngagementStatus:
    ...
    def generic_clutch_engagement_status(
        self: "CastSelf",
    ) -> "_5919.GenericClutchEngagementStatus":
        return self.__parent__._cast(_5919.GenericClutchEngagementStatus)
...
class ClutchEngagementStatus(
    _5919.GenericClutchEngagementStatus[_2533.ClutchConnection]
):
    """ClutchEngagementStatus
