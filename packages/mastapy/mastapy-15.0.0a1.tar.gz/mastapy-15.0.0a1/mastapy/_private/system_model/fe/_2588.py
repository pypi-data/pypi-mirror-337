...
from mastapy._private.system_model.fe import _2589
...
class _Cast_IndependentMASTACreatedCondensationNode:
    ...
    def independent_masta_created_constrained_nodes(
        self: "CastSelf",
    ) -> "_2589.IndependentMASTACreatedConstrainedNodes":
        return self.__parent__._cast(_2589.IndependentMASTACreatedConstrainedNodes)
...
class IndependentMASTACreatedCondensationNode(
    ...
    @property
    def rigid_coupling_type(self: "Self") -> "_282.RigidCouplingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.dev_tools_analyses._282",
            "RigidCouplingType",
        )(value)

    @rigid_coupling_type.setter
    @enforce_parameter_types
    def rigid_coupling_type(self: "Self", value: "_282.RigidCouplingType") -> None:
    ...
    @property
    def fe_substructure_node(self: "Self") -> "_2577.FESubstructureNode":
