...
from mastapy._private.utility_gui import _2033
...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1667
...
class _Cast_PointLoadInputOptions:
    ...
    @property
    def column_input_options(self: "CastSelf") -> "_2033.ColumnInputOptions":
        return self.__parent__._cast(_2033.ColumnInputOptions)
...
class PointLoadInputOptions(_2033.ColumnInputOptions):
    """PointLoadInputOptions
    ...
    def axis(self: "Self", value: "_1667.Axis") -> None:
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.MathUtility.Axis")
        pythonnet_property_set(self.wrapped, "Axis", value)

    @property
    def conversion_to_load_case(self: "Self") -> "_7818.AdditionalForcesObtainedFrom":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads.duty_cycle_definition._7818",
    ...
    def conversion_to_load_case(
        self: "Self", value: "_7818.AdditionalForcesObtainedFrom"
    ) -> None:
    ...
    @point_load.setter
    @enforce_parameter_types
    def point_load(self: "Self", value: "_2670.PointLoad") -> None:
        wrapper_type = (
