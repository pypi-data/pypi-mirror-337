...
def comm_protocol_encode(prog_list, config: CommProtocolConfig = ...) -> bytes:
    """comm_protocol_encode(prog_list: list[QPanda3::QProg], config: utils.utils.CommProtocolConfig = <utils.utils.CommProtocolConfig object at 0x000002F368C4C970>) -> bytes
