...
from mastapy._private.utility.enums import _2004
...
class EnumWithSelectedValue_ThreeDViewContourOptionSecondSelection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ThreeDViewContourOptionSecondSelection]",
    ) -> "_2004.ThreeDViewContourOptionSecondSelection":
        ...
        Returns:
            _2004.ThreeDViewContourOptionSecondSelection
        """
        return _2004.ThreeDViewContourOptionSecondSelection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2004.ThreeDViewContourOptionSecondSelection.type_()

    @property
    def selected_value(self: "Self") -> "_2004.ThreeDViewContourOptionSecondSelection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2004.ThreeDViewContourOptionSecondSelection]":
