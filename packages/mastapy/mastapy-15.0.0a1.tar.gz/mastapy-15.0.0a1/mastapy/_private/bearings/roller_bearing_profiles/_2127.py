...
from mastapy._private.bearings.roller_bearing_profiles import _2125
...
class _Cast_UserSpecifiedRollerRaceProfilePoint:
    ...
    @property
    def roller_race_profile_point(self: "CastSelf") -> "_2125.RollerRaceProfilePoint":
        return self.__parent__._cast(_2125.RollerRaceProfilePoint)
...
class UserSpecifiedRollerRaceProfilePoint(_2125.RollerRaceProfilePoint):
    """UserSpecifiedRollerRaceProfilePoint
