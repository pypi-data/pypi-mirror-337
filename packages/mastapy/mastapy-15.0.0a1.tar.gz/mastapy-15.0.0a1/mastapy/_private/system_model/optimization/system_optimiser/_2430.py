...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5918
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2728, _2734
    from mastapy._private.utility.logging import _1988
...
class SystemOptimiser(_0.APIBase):
    ...
    def selected_duty_cycle_for_system_optimiser(
        self: "Self", value: "_5918.DutyCycle"
    ) -> None:
        wrapper_type = (
    ...
    @property
    def design(self: "Self") -> "_2391.Design":
    ...
    @property
    def details(self: "Self") -> "_2431.SystemOptimiserDetails":
    ...
    @property
    def log(self: "Self") -> "_1988.Logger":
    ...
    @property
    def tooth_number_finder(self: "Self") -> "_2432.ToothNumberFinder":
    ...
    def gear_set_ratings_fast_power_flow(
        self: "Self",
    ) -> "List[_446.GearSetDutyCycleRating]":
    ...
    def system_optimisation_gear_sets(
        self: "Self",
    ) -> "List[_5922.SystemOptimisationGearSet]":
    ...
    @property
    def target_ratios(self: "Self") -> "List[_2428.DesignStateTargetRatio]":
    ...
    @property
    def system_optimiser_duty_cycle(self: "Self") -> "_5918.DutyCycle":
    ...
    @enforce_parameter_types
    def system_optimiser_duty_cycle(self: "Self", value: "_5918.DutyCycle") -> None:
