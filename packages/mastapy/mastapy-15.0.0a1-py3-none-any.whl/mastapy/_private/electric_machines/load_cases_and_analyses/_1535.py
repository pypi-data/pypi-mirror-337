...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility import _1764
...
class ElectricMachineLoadCaseGroup(_0.APIBase):
    ...
    @property
    def dynamic_forces_load_cases(self: "Self") -> "List[_1523.DynamicForceLoadCase]":
    ...
    def dynamic_forces_load_cases_without_non_linear_dq_model(
        self: "Self",
    ) -> "List[_1521.BasicDynamicForceLoadCase]":
    ...
    @property
    def efficiency_map_load_cases(self: "Self") -> "List[_1526.EfficiencyMapLoadCase]":
    ...
    def mechanical_load_cases(
        self: "Self",
    ) -> "List[_1536.ElectricMachineMechanicalLoadCase]":
    ...
    def single_operating_point_load_cases_with_non_linear_dq_model(
        self: "Self",
    ) -> "List[_1551.SpeedTorqueLoadCase]":
    ...
    def single_operating_point_load_cases_without_non_linear_dq_model(
        self: "Self",
    ) -> "List[_1533.ElectricMachineLoadCase]":
    ...
    def speed_torque_curve_load_cases(
        self: "Self",
    ) -> "List[_1550.SpeedTorqueCurveLoadCase]":
    ...
    @enforce_parameter_types
    def add_load_case(
        self: "Self", load_case_type: "_1539.LoadCaseType"
    ...
    def add_load_case_named(
        self: "Self", load_case_type: "_1539.LoadCaseType", name: "str"
    ) -> "_1534.ElectricMachineLoadCaseBase":
        """mastapy.electric_machines.load_cases_and_analyses.ElectricMachineLoadCaseBase
    ...
    def perform_compound_analysis(
        self: "Self",
        setup: "_1387.ElectricMachineSetup",
        load_case_type: "_1539.LoadCaseType",
    ) -> "_1764.MethodOutcome":
    ...
    def perform_compound_analysis_with_progress(
        ...
        setup: "_1387.ElectricMachineSetup",
        load_case_type: "_1539.LoadCaseType",
        task_progress: "_7859.TaskProgress",
    ) -> "_1764.MethodOutcome":
        """mastapy.utility.MethodOutcome
    ...
    def try_remove_load_case(
        self: "Self", load_case: "_1534.ElectricMachineLoadCaseBase"
    ) -> "bool":
        """bool
