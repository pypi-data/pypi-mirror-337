...
from mastapy._private.gears.rating import _442
...
class _Cast_CylindricalGearFlankDutyCycleRating:
    ...
    @property
    def gear_flank_rating(self: "CastSelf") -> "_442.GearFlankRating":
        return self.__parent__._cast(_442.GearFlankRating)
...
class CylindricalGearFlankDutyCycleRating(_442.GearFlankRating):
    """CylindricalGearFlankDutyCycleRating
