...
class V0041KillJobsMsg(BaseModel):
    ...
    flags: Optional[List[StrictStr]] = Field(
        default=None, description="Filter jobs according to flags"
    )
    ...
    jobs: Optional[List[StrictStr]] = Field(
        default=None, description="List of jobs to signal"
    )
    ...
    job_state: Optional[List[StrictStr]] = Field(
        default=None, description="Filter jobs to a specific state"
    )
    ...
    nodes: Optional[List[StrictStr]] = Field(
        default=None, description="Filter jobs to a set of nodes"
    )
