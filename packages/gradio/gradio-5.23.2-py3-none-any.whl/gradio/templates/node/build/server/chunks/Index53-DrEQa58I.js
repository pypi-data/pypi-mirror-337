...
import { B as Block, S as Static, f as BlockLabel, y as File$1, h as Empty, U as UploadText, i as IconButtonWrapper, j as IconButton, J as Undo, k as Download } from './2-B_nXhyaq.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-CyqSzaZt.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-rRFd0GuQ.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-CdjhJIQ-.js');
  return module.default;
}
...
//# sourceMappingURL=Index53-DrEQa58I.js.map
