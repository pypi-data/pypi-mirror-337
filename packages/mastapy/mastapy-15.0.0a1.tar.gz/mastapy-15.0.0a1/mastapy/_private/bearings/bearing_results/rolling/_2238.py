...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2219, _2223, _2237
...
class LoadedTaperRollerBearingRow(_2214.LoadedNonBarrelRollerBearingRow):
    """LoadedTaperRollerBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2237.LoadedTaperRollerBearingResults":
