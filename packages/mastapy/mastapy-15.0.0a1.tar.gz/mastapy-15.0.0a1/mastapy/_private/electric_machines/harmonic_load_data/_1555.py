...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.harmonic_load_data import _1553, _1559
    ...
    from mastapy._private.units_and_measurements import _7860
...
class _Cast_HarmonicLoadDataBase:
    ...
    def conical_gear_set_harmonic_load_data(
        ...
        return self.__parent__._cast(_7674.ConicalGearSetHarmonicLoadData)
    ...
    def cylindrical_gear_set_harmonic_load_data(
        ...
        return self.__parent__._cast(_7691.CylindricalGearSetHarmonicLoadData)
    ...
    def gear_set_harmonic_load_data(
        self: "CastSelf",
    ) -> "_7721.GearSetHarmonicLoadData":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7721,
        )

        return self.__parent__._cast(_7721.GearSetHarmonicLoadData)
...
class HarmonicLoadDataBase(_0.APIBase):
    ...
    @property
    def excitations(self: "Self") -> "List[_1688.FourierSeries]":
    ...
    def set_selected_harmonic_load_data_with_fourier_series(
        self: "Self", fourier_series: "_1688.FourierSeries"
    ) -> None:
        """Method does not return.
    ...
    def set_selected_harmonic_load_data_extended(
        ...
        fourier_series_measurement_type: "_7860.MeasurementType",
    ) -> None:
        """Method does not return.
