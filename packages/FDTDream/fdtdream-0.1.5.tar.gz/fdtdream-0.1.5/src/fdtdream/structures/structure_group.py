...
from typing import TypedDict, Unpack, Sequence, TypeVar, Self
...
class Add(Module):
    ...
    def structure_group(self, name: str = "structure group",
                        **kwargs: Unpack[StructureGroupKwargs]) -> ScriptedStructureGroup:
        group = ScriptedStructureGroup(self._parent_object._sim, name, **kwargs)
        group._add_parent(self._parent_object)
        return group
