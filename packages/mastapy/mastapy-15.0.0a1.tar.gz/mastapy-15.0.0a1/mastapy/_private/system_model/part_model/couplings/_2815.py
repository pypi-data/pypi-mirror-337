...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2789, _2814
...
class SynchroniserHalf(_2816.SynchroniserPart):
    """SynchroniserHalf
    ...
    @property
    def cones(self: "Self") -> "List[_2814.SynchroniserCone]":
