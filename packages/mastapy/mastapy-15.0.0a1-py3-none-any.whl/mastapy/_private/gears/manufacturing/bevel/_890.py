...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel.cutters import _911, _912
...
class ConicalWheelManufacturingConfig(_872.ConicalGearManufacturingConfig):
    """ConicalWheelManufacturingConfig
    ...
    def specified_machine_settings(
        self: "Self",
    ) -> "_917.BasicConicalGearMachineSettings":
    ...
    @property
    def wheel_finish_cutter(self: "Self") -> "_911.WheelFinishCutter":
    ...
    @property
    def wheel_rough_cutter(self: "Self") -> "_912.WheelRoughCutter":
