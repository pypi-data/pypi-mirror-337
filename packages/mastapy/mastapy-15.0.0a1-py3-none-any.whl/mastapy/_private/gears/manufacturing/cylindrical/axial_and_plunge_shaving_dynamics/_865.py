...
class ShavingDynamicsConfiguration(_0.APIBase):
    ...
    def conventional_shaving_dynamics(
        self: "Self",
    ) -> "_862.ShavingDynamicsCalculation[_847.ConventionalShavingDynamics]":
    ...
    def plunge_shaving_dynamics(
        self: "Self",
    ) -> "_862.ShavingDynamicsCalculation[_851.PlungeShaverDynamics]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_851.PlungeShaverDynamics](
            temp
        )
