...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.concept import _2387
...
class ConceptAxialClearanceBearing(_2389.ConceptClearanceBearing):
    """ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self: "Self") -> "_2387.BearingNodePosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_designs.concept._2387",
            "BearingNodePosition",
        )(value)

    @node_position.setter
    @enforce_parameter_types
    def node_position(self: "Self", value: "_2387.BearingNodePosition") -> None:
