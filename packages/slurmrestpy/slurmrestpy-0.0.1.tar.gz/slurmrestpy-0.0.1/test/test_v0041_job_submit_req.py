    ...
    def make_instance(self, include_optional) -> V0041JobSubmitReq:
        ...
        if include_optional:
            return V0041JobSubmitReq(
                script = '',
                jobs = [
                    slurmrestpy.models.v0/0/41_job_desc_msg.v0.0.41_job_desc_msg(
                        account = '',
                        ...
                        array = '',
                        batch_features = '',
                        begin_time = slurmrestpy.models.v0_0_41_job_desc_msg_begin_time.v0_0_41_job_desc_msg_begin_time(
                            set = True,
                            infinite = True,
                            number = 56, ),
                        flags = [
                        ...
                        cpu_frequency = '',
                        cpus_per_tres = '',
                        crontab = slurmrestpy.models.v0_0_41_job_desc_msg_crontab.v0_0_41_job_desc_msg_crontab(
                            minute = '',
                            hour = '',
                            day_of_month = '',
                            month = '',
                        ...
                        rlimits = slurmrestpy.models.v0_0_41_job_desc_msg_rlimits.v0_0_41_job_desc_msg_rlimits(
                            ...
                            memlock = slurmrestpy.models.v0_0_41_job_desc_msg_rlimits_memlock.v0_0_41_job_desc_msg_rlimits_memlock(
                                ...
                                infinite = True,
                                number = 56, ),
                            as = slurmrestpy.models.v0_0_41_job_desc_msg_rlimits_as.v0_0_41_job_desc_msg_rlimits_as(
                                set = True,
                                infinite = True,
                                number = 56, ), ),
                        excluded_nodes = [
                        ...
                        overcommit = True,
                        partition = '',
                        distribution_plane_size = slurmrestpy.models.v0_0_41_job_desc_msg_distribution_plane_size.v0_0_41_job_desc_msg_distribution_plane_size(
                            set = True,
                            infinite = True,
                            number = 56, ),
                        power_flags = [
                        ...
                        kill_warning_signal = '',
                        kill_warning_delay = slurmrestpy.models.v0_0_41_job_desc_msg_kill_warning_delay.v0_0_41_job_desc_msg_kill_warning_delay(
                            set = True,
                            infinite = True,
                            number = 56, ),
                        ...
                        memory_per_cpu = slurmrestpy.models.v0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required_memory_per_cpu.v0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required_memory_per_cpu(
                            ...
                            infinite = True,
                            number = 56, ),
                        memory_per_node = slurmrestpy.models.v0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required_memory_per_cpu.v0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required_memory_per_cpu(
                            set = True,
                            infinite = True,
                            number = 56, ),
                        temporary_disk_per_node = 56,
                        selinux_context = '',
                        required_switches = slurmrestpy.models.v0_0_41_job_desc_msg_required_switches.v0_0_41_job_desc_msg_required_switches(
                            set = True,
                            infinite = True,
                            number = 56, ),
                        segment_size = slurmrestpy.models.v0_0_41_job_desc_msg_segment_size.v0_0_41_job_desc_msg_segment_size(
                            set = True,
                            infinite = True,
                            number = 56, ),
                        standard_error = '',
                ...
                job = slurmrestpy.models.v0/0/41_job_desc_msg.v0.0.41_job_desc_msg(
                    account = '',
                    account_gather_frequency = '',
                    admin_comment = '',
                    allocation_node_list = '',
