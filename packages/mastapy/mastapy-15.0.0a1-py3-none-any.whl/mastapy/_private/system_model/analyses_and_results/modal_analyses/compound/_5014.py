...
class CylindricalGearSetCompoundModalAnalysis(_5025.GearSetCompoundModalAnalysis):
    """CylindricalGearSetCompoundModalAnalysis
    ...
    def cylindrical_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5012.CylindricalGearCompoundModalAnalysis]":
    ...
    def cylindrical_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5013.CylindricalGearMeshCompoundModalAnalysis]":
