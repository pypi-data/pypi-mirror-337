...
class ListWithSelectedItem_CylindricalGearSystemDeflection(
    _2951.CylindricalGearSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2951.CylindricalGearSystemDeflection.TYPE

    @property
    def selected_value(self: "Self") -> "_2951.CylindricalGearSystemDeflection":
    ...
    @property
    def available_values(self: "Self") -> "List[_2951.CylindricalGearSystemDeflection]":
