...
from mastapy._private.gears.manufacturing.cylindrical import _728, _729
...
class _Cast_MicroGeometryInputsLead:
    ...
    @property
    def micro_geometry_inputs(self: "CastSelf") -> "_729.MicroGeometryInputs":
        return self.__parent__._cast(_729.MicroGeometryInputs)
...
class MicroGeometryInputsLead(_729.MicroGeometryInputs[_728.LeadModificationSegment]):
    """MicroGeometryInputsLead
