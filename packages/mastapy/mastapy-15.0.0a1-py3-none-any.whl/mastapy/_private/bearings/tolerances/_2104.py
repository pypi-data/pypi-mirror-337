...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.tolerances import _2100, _2105, _2111
...
class RoundnessSpecification(
    _1761.IndependentReportablePropertiesBase["RoundnessSpecification"]
):
    """RoundnessSpecification
    ...
    @property
    def specification_type(self: "Self") -> "_2105.RoundnessSpecificationType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.tolerances._2105", "RoundnessSpecificationType"
        )(value)

    @specification_type.setter
    @enforce_parameter_types
    def specification_type(
        self: "Self", value: "_2105.RoundnessSpecificationType"
    ) -> None:
    ...
    @property
    def type_of_fit(self: "Self") -> "_2111.TypeOfFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.tolerances._2111", "TypeOfFit"
        )(value)

    @type_of_fit.setter
    @enforce_parameter_types
    def type_of_fit(self: "Self", value: "_2111.TypeOfFit") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def user_specified_deviation(self: "Self") -> "_1709.Vector2DListAccessor":
    ...
    @property
    def roundness_distribution(self: "Self") -> "List[_2100.RaceRoundnessAtAngle]":
