...
class FaceGearSetAdvancedSystemDeflection(_7415.GearSetAdvancedSystemDeflection):
    """FaceGearSetAdvancedSystemDeflection
    ...
    def assembly_system_deflection_results(
        self: "Self",
    ) -> "List[_2961.FaceGearSetSystemDeflection]":
    ...
    def gears_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7408.FaceGearAdvancedSystemDeflection]":
    ...
    def meshes_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7409.FaceGearMeshAdvancedSystemDeflection]":
