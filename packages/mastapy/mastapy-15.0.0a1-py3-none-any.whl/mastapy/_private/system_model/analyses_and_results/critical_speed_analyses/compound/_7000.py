...
class CylindricalGearSetCompoundCriticalSpeedAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6869.CylindricalGearSetCriticalSpeedAnalysis]":
    ...
    def cylindrical_gears_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6998.CylindricalGearCompoundCriticalSpeedAnalysis]":
    ...
    def cylindrical_meshes_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6999.CylindricalGearMeshCompoundCriticalSpeedAnalysis]":
