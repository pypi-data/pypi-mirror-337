...
- zIndex (string | number; optional):
    ...
    OverlayProps = TypedDict(
        "OverlayProps",
            ...
            "m": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "my": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "mx": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "mt": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "mb": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "ms": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "me": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "ml": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "mr": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "p": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "py": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "px": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "pt": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "pb": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "ps": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "pe": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "pl": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "pr": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            ...
            "fz": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"], Literal["h1"], Literal["h2"], Literal["h3"], Literal["h4"], Literal["h5"], Literal["h6"]]],
            ...
            "lh": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"], Literal["h1"], Literal["h2"], Literal["h3"], Literal["h4"], Literal["h5"], Literal["h6"]]],
            ...
            "radius": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
    ...
    CloseButtonProps = TypedDict(
        "CloseButtonProps",
            {
            "size": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
            "radius": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]],
    ...
    def __init__(
        ...
        radius: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        ...
        padding: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        ...
        m: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        my: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        mx: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        mt: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        mb: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        ms: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        me: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        ml: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        mr: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        p: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        py: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        px: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        pt: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        pb: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        ps: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        pe: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        pl: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        pr: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        ...
        fz: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"], Literal["h1"], Literal["h2"], Literal["h3"], Literal["h4"], Literal["h5"], Literal["h6"]]] = None,
        ...
        lh: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"], Literal["h1"], Literal["h2"], Literal["h3"], Literal["h4"], Literal["h5"], Literal["h6"]]] = None,
