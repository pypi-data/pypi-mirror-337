...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.straight_bevel import _1058, _1059
...
class StraightBevelGearSetDesign(_1295.BevelGearSetDesign):
    """StraightBevelGearSetDesign
    ...
    @property
    def gears(self: "Self") -> "List[_1058.StraightBevelGearDesign]":
    ...
    def straight_bevel_meshes(
        self: "Self",
    ) -> "List[_1059.StraightBevelGearMeshDesign]":
