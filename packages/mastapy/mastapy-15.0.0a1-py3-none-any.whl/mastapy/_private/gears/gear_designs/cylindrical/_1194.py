...
class Usage(_1761.IndependentReportablePropertiesBase["Usage"]):
    """Usage
    ...
    @property
    def safety_requirement(self: "Self") -> "_428.SafetyRequirementsAGMA":
    ...
    @enforce_parameter_types
    def safety_requirement(self: "Self", value: "_428.SafetyRequirementsAGMA") -> None:
    ...
    @property
    def spur_gear_load_sharing_code(self: "Self") -> "_1181.SpurGearLoadSharingCodes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1181",
    ...
    def spur_gear_load_sharing_code(
        self: "Self", value: "_1181.SpurGearLoadSharingCodes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
