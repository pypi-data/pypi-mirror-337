...
class EnumWithSelectedValue_TorqueRippleInputType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7806.TorqueRippleInputType
        """
        return _7806.TorqueRippleInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7806.TorqueRippleInputType.type_()

    @property
    def selected_value(self: "Self") -> "_7806.TorqueRippleInputType":
    ...
    @property
    def available_values(self: "Self") -> "List[_7806.TorqueRippleInputType]":
