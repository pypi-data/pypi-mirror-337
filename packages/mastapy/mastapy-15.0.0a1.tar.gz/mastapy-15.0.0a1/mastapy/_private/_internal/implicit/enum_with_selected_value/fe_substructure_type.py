...
class EnumWithSelectedValue_FESubstructureType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2580.FESubstructureType
        """
        return _2580.FESubstructureType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_FESubstructureType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2580.FESubstructureType.type_()

    @property
    def selected_value(self: "Self") -> "_2580.FESubstructureType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2580.FESubstructureType]":
