...
import image_article_comprehension.video.video_xuanti_prompt as video_xuanti_prompt
...
def create_xuanti_by_keypoint(reference_note, renshe, result, save_file_path):
    ...
    # 获取视频亮点
    reference_note_keypoint_result_path = f"/Users/nieqi/Documents/workspace/python/image_article_comprehension/video/data/reference_note_comprehension/{reference_note.get('channel_content_id')}.json"
...
if __name__ == "__main__":
    renshe_path = "/Users/nieqi/Documents/workspace/python/image_article_comprehension/video/data/renshe/星有野.json"
    renshe = json.load(open(renshe_path, "r"))

    reference_note_dir = "/Users/nieqi/Documents/workspace/python/image_article_comprehension/video/data/reference_note/抖音热榜0212"
