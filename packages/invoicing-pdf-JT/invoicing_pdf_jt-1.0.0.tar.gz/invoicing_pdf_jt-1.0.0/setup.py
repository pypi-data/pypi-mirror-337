...
setup(
  name='invoicing-pdf-JT',         #* Your package will have this name
  ...
  author='Joan Townsend',                   # Your name
  author_email = 'joan.townsend.code@gmail.com',  # Your email
  url='https://github.com/NoajT',              # Homepage of your library (e.g. GitHub or your website)
