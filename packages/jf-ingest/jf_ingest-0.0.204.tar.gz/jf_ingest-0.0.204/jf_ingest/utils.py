...
def retry_for_status(
    ...
    **kwargs,
    ...
    for retry in range(max_retries_for_retry_for_status + 1):
        ...
        # Reset the attributes for the initial and potentially
        # additional next retry
        jelly_counter_attributes['retry_attempt'] = retry
        jelly_counter_attributes['status_code'] = None
        jelly_counter_attributes['exception'] = None
