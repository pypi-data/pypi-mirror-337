...
class RingPinsCompoundDynamicAnalysis(_6759.MountableComponentCompoundDynamicAnalysis):
    """RingPinsCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6640.RingPinsDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6640.RingPinsDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.RingPinsDynamicAnalysis]
