...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2687, _2690, _2691
...
class _Cast_ConcentricOrParallelPartGroup:
    ...
    @property
    def concentric_part_group(self: "CastSelf") -> "_2687.ConcentricPartGroup":
        from mastapy._private.system_model.part_model.part_groups import _2687

        return self.__parent__._cast(_2687.ConcentricPartGroup)

    @property
    def parallel_part_group(self: "CastSelf") -> "_2690.ParallelPartGroup":
        from mastapy._private.system_model.part_model.part_groups import _2690

        return self.__parent__._cast(_2690.ParallelPartGroup)
...
class ConcentricOrParallelPartGroup(_2692.PartGroup):
    """ConcentricOrParallelPartGroup
