...
from mastapy._private.system_model.part_model import _2636
...
class _Cast_OuterBearingRaceMountingOptions:
    ...
    def bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2636.BearingRaceMountingOptions":
        return self.__parent__._cast(_2636.BearingRaceMountingOptions)
...
class OuterBearingRaceMountingOptions(_2636.BearingRaceMountingOptions):
    """OuterBearingRaceMountingOptions
