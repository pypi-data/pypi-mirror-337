...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2712, _2713
...
TPart = TypeVar("TPart", bound="_2666.Part")
...
class _Cast_PartDetailSelection:
    ...
    def active_gear_set_design_selection(
        self: "CastSelf",
    ) -> "_2713.ActiveGearSetDesignSelection":
        from mastapy._private.system_model.part_model.gears import _2713

        return self.__parent__._cast(_2713.ActiveGearSetDesignSelection)

    @property
    def active_fe_substructure_selection(
        self: "CastSelf",
    ) -> "_2822.ActiveFESubstructureSelection":
        from mastapy._private.system_model.part_model.configurations import _2822

        return self.__parent__._cast(_2822.ActiveFESubstructureSelection)

    @property
    def active_shaft_design_selection(
        self: "CastSelf",
    ) -> "_2824.ActiveShaftDesignSelection":
        from mastapy._private.system_model.part_model.configurations import _2824

        return self.__parent__._cast(_2824.ActiveShaftDesignSelection)

    @property
    def bearing_detail_selection(self: "CastSelf") -> "_2827.BearingDetailSelection":
        from mastapy._private.system_model.part_model.configurations import _2827

        return self.__parent__._cast(_2827.BearingDetailSelection)
