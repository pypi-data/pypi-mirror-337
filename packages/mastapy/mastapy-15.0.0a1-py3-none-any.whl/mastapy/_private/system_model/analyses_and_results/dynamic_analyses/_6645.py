...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6554
...
class RootAssemblyDynamicAnalysis(_6554.AssemblyDynamicAnalysis):
    """RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self: "Self") -> "_6599.DynamicAnalysis":
