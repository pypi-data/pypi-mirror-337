...
class EnumWithSelectedValue_RollingBearingArrangement(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RollingBearingArrangement]",
    ) -> "_2078.RollingBearingArrangement":
        ...
        Returns:
            _2078.RollingBearingArrangement
        """
        return _2078.RollingBearingArrangement
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2078.RollingBearingArrangement.type_()

    @property
    def selected_value(self: "Self") -> "_2078.RollingBearingArrangement":
    ...
    @property
    def available_values(self: "Self") -> "List[_2078.RollingBearingArrangement]":
