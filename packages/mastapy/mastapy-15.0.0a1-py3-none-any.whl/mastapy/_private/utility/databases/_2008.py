...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.scripting import _1918
...
class _Cast_DatabaseKey:
    ...
    @property
    def user_defined_property_key(self: "CastSelf") -> "_1918.UserDefinedPropertyKey":
        from mastapy._private.utility.scripting import _1918

        return self.__parent__._cast(_1918.UserDefinedPropertyKey)

    @property
    def custom_report_key(self: "CastSelf") -> "_1946.CustomReportKey":
        from mastapy._private.utility.report import _1946

        return self.__parent__._cast(_1946.CustomReportKey)

    @property
    def named_key(self: "CastSelf") -> "_2012.NamedKey":
        from mastapy._private.utility.databases import _2012

        return self.__parent__._cast(_2012.NamedKey)

    @property
    def rolling_bearing_key(self: "CastSelf") -> "_2080.RollingBearingKey":
        from mastapy._private.bearings import _2080

        return self.__parent__._cast(_2080.RollingBearingKey)
