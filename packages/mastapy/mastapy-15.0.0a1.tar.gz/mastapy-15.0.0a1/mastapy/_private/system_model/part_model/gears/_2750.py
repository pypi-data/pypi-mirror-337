...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2715, _2725, _2732
...
class StraightBevelGear(_2721.BevelGear):
    """StraightBevelGear
    ...
    @property
    def bevel_gear_design(self: "Self") -> "_1058.StraightBevelGearDesign":
    ...
    @property
    def straight_bevel_gear_design(self: "Self") -> "_1058.StraightBevelGearDesign":
        """mastapy.gears.gear_designs.straight_bevel.StraightBevelGearDesign
