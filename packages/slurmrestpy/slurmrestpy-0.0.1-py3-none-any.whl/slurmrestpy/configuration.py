...
class Configuration:
    ...
    conf = slurmrestpy.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("slurmrestpy")
    ...
    def get_basic_auth_token(self) -> Optional[str]:
        ...
        return urllib3.make_headers(basic_auth=username + ":" + password).get(
            "authorization"
        )
    ...
    def to_debug_report(self) -> str:
        ...
        return (
            ...
            "Version of the API: Slurm-24.11.1&amp;openapi/slurmdbd&amp;openapi/slurmctld\n"
