...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1379, _1380, _1433
...
class SurfacePermanentMagnetMachine(_1414.NonCADElectricMachineDetail):
    """SurfacePermanentMagnetMachine
    ...
    @property
    def rotor(self: "Self") -> "_1433.SurfacePermanentMagnetRotor":
