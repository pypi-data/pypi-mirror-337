...
from mastapy._private.gears.rating.cylindrical import _565
...
class EnumWithSelectedValue_ScuffingFlashTemperatureRatingMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _565.ScuffingFlashTemperatureRatingMethod
        """
        return _565.ScuffingFlashTemperatureRatingMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _565.ScuffingFlashTemperatureRatingMethod.type_()

    @property
    def selected_value(self: "Self") -> "_565.ScuffingFlashTemperatureRatingMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_565.ScuffingFlashTemperatureRatingMethod]":
