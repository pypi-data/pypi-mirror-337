...
def upgrade() -> None:
    ...
    with op.batch_alter_table('activities', schema=None) as batch_op:
        batch_op.add_column(sa.Column('sources', sa.String(), nullable=False))
        batch_op.add_column(sa.Column('authors', sa.String(), nullable=False))

    with op.batch_alter_table('textbooks', schema=None) as batch_op:
        batch_op.add_column(sa.Column('reviewers', sa.String(), nullable=False))
