...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _921, _924
...
class _Cast_GearFilletNodeStressResults:
    ...
    def conical_gear_fillet_stress_results(
        self: "CastSelf",
    ) -> "_921.ConicalGearFilletStressResults":
        from mastapy._private.gears.ltca import _921

        return self.__parent__._cast(_921.ConicalGearFilletStressResults)

    @property
    def cylindrical_gear_fillet_node_stress_results(
        self: "CastSelf",
    ) -> "_924.CylindricalGearFilletNodeStressResults":
        from mastapy._private.gears.ltca import _924

        return self.__parent__._cast(_924.CylindricalGearFilletNodeStressResults)
