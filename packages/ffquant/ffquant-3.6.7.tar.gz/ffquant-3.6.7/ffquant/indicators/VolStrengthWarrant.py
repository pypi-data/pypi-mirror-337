    ...
    def determine_final_result(self):
        ...
        if result is not None:
            for key, value in dict(result).items():
                if key in ["volumeRankLevel", "volumeStrengthTodayCoverDays", "today", "volumeIntraU", "consecutiveDays", "window20", "VolumeStrengthRankLevelTest", "VolumeEqualizationLevel", "days7", "VolumeLevelWithSpeed", "closeTime", "openTime"]:
