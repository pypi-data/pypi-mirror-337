...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.databases import _2007
...
class DatabaseSettings(_1768.PerMachineSettings):
    """DatabaseSettings
    ...
    @property
    def connection_settings(self: "Self") -> "_2007.DatabaseConnectionSettings":
