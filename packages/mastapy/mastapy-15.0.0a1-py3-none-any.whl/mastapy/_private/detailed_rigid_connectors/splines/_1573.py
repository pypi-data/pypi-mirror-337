...
from mastapy._private.bearings.tolerances import _2096
...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.splines import _1591, _1596
...
class GBT3478SplineJointDesign(_1576.ISO4156SplineJointDesign):
    """GBT3478SplineJointDesign
    ...
    def major_diameter_standard_tolerance_grade(
        self: "Self", value: "_2096.ITDesignation"
    ) -> None:
