...
class ConceptGearSetLoadCase(_7722.GearSetLoadCase):
    """ConceptGearSetLoadCase
    ...
    @property
    def gears_load_case(self: "Self") -> "List[_7668.ConceptGearLoadCase]":
    ...
    @property
    def concept_gears_load_case(self: "Self") -> "List[_7668.ConceptGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ConceptGearLoadCase]
    ...
    @property
    def meshes_load_case(self: "Self") -> "List[_7669.ConceptGearMeshLoadCase]":
    ...
    @property
    def concept_meshes_load_case(self: "Self") -> "List[_7669.ConceptGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ConceptGearMeshLoadCase]
