...
from mastapy._private.system_model.analyses_and_results import _2861
...
class RootAssemblyHarmonicAnalysis(
    _5940.AssemblyHarmonicAnalysis, _2861.IHaveRootHarmonicAnalysisResults
):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    def assembly_design(self: "Self") -> "_2674.RootAssembly":
    ...
    @property
    def export(self: "Self") -> "_6022.HarmonicAnalysisRootAssemblyExportOptions":
    ...
    @property
    def harmonic_analysis_inputs(self: "Self") -> "_6016.HarmonicAnalysis":
    ...
    def results(
        self: "Self",
    ) -> "_6140.RootAssemblyHarmonicAnalysisResultsPropertyAccessor":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_3008.RootAssemblySystemDeflection":
