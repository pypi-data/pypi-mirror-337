...
class EnumWithSelectedValue_ActiveProcessMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _754.ActiveProcessMethod
        """
        return _754.ActiveProcessMethod
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ActiveProcessMethod]") -> "Any":
        ...
        Returns:
            Any
        """
        return _754.ActiveProcessMethod.type_()

    @property
    def selected_value(self: "Self") -> "_754.ActiveProcessMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_754.ActiveProcessMethod]":
