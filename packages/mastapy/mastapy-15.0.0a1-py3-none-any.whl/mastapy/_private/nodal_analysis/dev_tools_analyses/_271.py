...
class _Cast_FEModelTabDrawStyle:
    ...
    def fe_model_harmonic_analysis_draw_style(
        self: "CastSelf",
    ) -> "_265.FEModelHarmonicAnalysisDrawStyle":
        from mastapy._private.nodal_analysis.dev_tools_analyses import _265

        return self.__parent__._cast(_265.FEModelHarmonicAnalysisDrawStyle)

    @property
    def fe_model_modal_analysis_draw_style(
        self: "CastSelf",
    ) -> "_267.FEModelModalAnalysisDrawStyle":
        from mastapy._private.nodal_analysis.dev_tools_analyses import _267

        return self.__parent__._cast(_267.FEModelModalAnalysisDrawStyle)

    @property
    def fe_model_static_analysis_draw_style(
        self: "CastSelf",
    ) -> "_270.FEModelStaticAnalysisDrawStyle":
        from mastapy._private.nodal_analysis.dev_tools_analyses import _270

        return self.__parent__._cast(_270.FEModelStaticAnalysisDrawStyle)
