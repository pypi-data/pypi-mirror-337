...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2831, _2833, _2836
...
class AcousticAnalysisSetup(_0.APIBase):
    ...
    @property
    def analysis_options(self: "Self") -> "_2831.AcousticAnalysisOptions":
    ...
    @property
    def cache_reporting(self: "Self") -> "_2833.AcousticAnalysisSetupCacheReporting":
    ...
    @property
    def input_surface_options(self: "Self") -> "_2836.AcousticInputSurfaceOptions":
