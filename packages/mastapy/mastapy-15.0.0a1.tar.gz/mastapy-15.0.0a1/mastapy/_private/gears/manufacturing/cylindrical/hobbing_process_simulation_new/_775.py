...
class _Cast_MountingError:
    ...
    @property
    def gear_mounting_error(self: "CastSelf") -> "_761.GearMountingError":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _761,
        )

        return self.__parent__._cast(_761.GearMountingError)

    @property
    def rack_mounting_error(self: "CastSelf") -> "_786.RackMountingError":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _786,
        )

        return self.__parent__._cast(_786.RackMountingError)
