...
def set_env_variable(name, value):
    """Define uma variável de ambiente permanentemente no Windows como administrador via PowerShell."""
    for i in ['Machine']:
...
def cuda_config():
    ...
    # """Baixa um arquivo da internet e salva em uma pasta específica."""
