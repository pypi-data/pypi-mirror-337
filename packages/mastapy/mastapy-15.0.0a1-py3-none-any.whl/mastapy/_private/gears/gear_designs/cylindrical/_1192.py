...
from mastapy._private.utility.units_and_measurements.measurements import _1843, _1864
...
class _Cast_ToothThicknessSpecificationBase:
    ...
    def finish_tooth_thickness_design_specification(
        ...
        from mastapy._private.gears.gear_designs.cylindrical import _1149

        return self.__parent__._cast(_1149.FinishToothThicknessDesignSpecification)

    @property
    def readonly_tooth_thickness_specification(
        self: "CastSelf",
    ) -> "_1171.ReadonlyToothThicknessSpecification":
        from mastapy._private.gears.gear_designs.cylindrical import _1171

        return self.__parent__._cast(_1171.ReadonlyToothThicknessSpecification)
    ...
    def tooth_thickness_specification(
        ...
        return self.__parent__._cast(_1191.ToothThicknessSpecification)
...
class ToothThicknessSpecificationBase(_0.APIBase):
    ...
    def chordal_span(
        self: "Self",
    ) -> "_1139.CylindricalGearToothThicknessSpecification[_1843.LengthShort]":
    ...
    def profile_shift_coefficient(
        self: "Self",
    ) -> "_1139.CylindricalGearToothThicknessSpecification[_1864.Number]":
    ...
    def tooth_thickness(
        self: "Self",
    ) -> "List[_1139.CylindricalGearToothThicknessSpecification[_1843.LengthShort]]":
