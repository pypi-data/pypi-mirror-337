...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.conical.micro_geometry import _1286
    from mastapy._private.gears.gear_designs.cylindrical.micro_geometry import _1201
...
class _Cast_FlankMicroGeometry:
    ...
    def cylindrical_gear_flank_micro_geometry(
        self: "CastSelf",
    ) -> "_1201.CylindricalGearFlankMicroGeometry":
        from mastapy._private.gears.gear_designs.cylindrical.micro_geometry import _1201

        return self.__parent__._cast(_1201.CylindricalGearFlankMicroGeometry)

    @property
    def conical_gear_flank_micro_geometry(
        self: "CastSelf",
    ) -> "_1286.ConicalGearFlankMicroGeometry":
        from mastapy._private.gears.gear_designs.conical.micro_geometry import _1286

        return self.__parent__._cast(_1286.ConicalGearFlankMicroGeometry)
...
class FlankMicroGeometry(_0.APIBase):
    ...
    @property
    def micro_geometry_input_type(self: "Self") -> "_419.MicroGeometryInputTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._419", "MicroGeometryInputTypes"
        )(value)

    @micro_geometry_input_type.setter
    @enforce_parameter_types
    def micro_geometry_input_type(
        self: "Self", value: "_419.MicroGeometryInputTypes"
    ) -> None:
    ...
    @property
    def gear_design(self: "Self") -> "_1044.GearDesign":
