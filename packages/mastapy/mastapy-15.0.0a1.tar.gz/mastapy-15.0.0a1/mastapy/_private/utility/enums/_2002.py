...
class ThreeDViewContourOption(Enum):
    ...
    FORCE_ANGULAR_MAGNITUDE = 16
    FORCE_TORQUE = 17
    FORCE_LINEAR_MAGNITUDE = 18
    FORCE_RADIAL_MAGNITUDE = 19
    FORCE_AXIAL = 20
    STRESS_NOMINAL_AXIAL = 21
    STRESS_NOMINAL_BENDING = 22
    STRESS_NOMINAL_TORSIONAL = 23
    STRESS_NOMINAL_VON_MISES_ALTERNATING = 24
    STRESS_NOMINAL_VON_MISES_MAX = 25
    STRESS_NOMINAL_VON_MISES_MEAN = 26
    STRESS_NOMINAL_MAXIMUM_PRINCIPAL = 27
    STRESS_NOMINAL_MINIMUM_PRINCIPAL = 28
    FE_MESH_NORMAL_DISPLACEMENT = 29
    FE_MESH_NORMAL_VELOCITY = 30
    FE_MESH_NORMAL_ACCELERATION = 31
    SOUND_PRESSURE = 32
