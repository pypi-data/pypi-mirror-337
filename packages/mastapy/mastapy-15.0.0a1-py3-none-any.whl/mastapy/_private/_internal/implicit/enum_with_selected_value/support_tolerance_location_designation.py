...
class EnumWithSelectedValue_SupportToleranceLocationDesignation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_SupportToleranceLocationDesignation]",
    ) -> "_2109.SupportToleranceLocationDesignation":
        ...
        Returns:
            _2109.SupportToleranceLocationDesignation
        """
        return _2109.SupportToleranceLocationDesignation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2109.SupportToleranceLocationDesignation.type_()

    @property
    def selected_value(self: "Self") -> "_2109.SupportToleranceLocationDesignation":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2109.SupportToleranceLocationDesignation]":
