...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5912
...
class DesignState(_5912.AbstractDesignStateLoadCaseGroup):
    """DesignState
    ...
    @property
    def clutches(self: "Self") -> "List[_5915.ClutchEngagementStatus]":
    ...
    def clutch_engagement_status_for(
        self: "Self", clutch_connection: "_2533.ClutchConnection"
    ) -> "_5915.ClutchEngagementStatus":
    ...
    def concept_synchro_gear_engagement_status_for(
        self: "Self", gear: "_2727.CylindricalGear"
    ) -> "_5916.ConceptSynchroGearEngagementStatus":
