...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2577, _2578
...
class FESubstructureNodeModeShapes(_0.APIBase):
    ...
    @property
    def condensation_node(self: "Self") -> "_2577.FESubstructureNode":
    ...
    def mode_shapes_at_condensation_node(
        self: "Self",
    ) -> "List[_2578.FESubstructureNodeModeShape]":
