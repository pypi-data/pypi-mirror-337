...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.connections_and_sockets import _2463, _2467
...
class Connector(_2662.MountableComponent):
    """Connector
    ...
    @property
    def outer_component(self: "Self") -> "_2630.AbstractShaft":
    ...
    @property
    def outer_connection(self: "Self") -> "_2463.Connection":
    ...
    @property
    def outer_socket(self: "Self") -> "_2467.CylindricalSocket":
