...
class RiskOptima:
    ...
    def run_index_vol_divergence_signals(start_date = "2024-01-01", end_date = "2025-01-14",
        ...
        # 1) Fetch signals
        df_signals, df = RiskOptima.run_spy_vix_strategy(start_date, end_date, symbol_base, symbol_vix, ma_window)
        # 2) Calculate exits
    ...
    def build_correlation_matrix(asset_table: pd.DataFrame, start_date, end_date):
        ...
        plt.title(f"Correlation Matrix - {end_date.strftime('%Y-%m')}", fontsize=16)
