...
class Overridable_HeightSeries(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[Overridable_HeightSeries]") -> "_2348.HeightSeries":
    ...
    def implicit_type(cls: "Type[Overridable_HeightSeries]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2348.HeightSeries.type_()

    @property
    def value(self: "Self") -> "_2348.HeightSeries":
    ...
    @property
    def override_value(self: "Self") -> "_2348.HeightSeries":
        """mastapy.bearings.bearing_designs.rolling.HeightSeries
    ...
    @property
    def calculated_value(self: "Self") -> "_2348.HeightSeries":
        """mastapy.bearings.bearing_designs.rolling.HeightSeries
