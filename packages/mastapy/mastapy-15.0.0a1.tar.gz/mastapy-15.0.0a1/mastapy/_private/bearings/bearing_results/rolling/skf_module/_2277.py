...
class GreaseLifeAndRelubricationInterval(_2286.SKFCalculationResult):
    """GreaseLifeAndRelubricationInterval
    ...
    @property
    def grease(self: "Self") -> "_2276.Grease":
    ...
    @property
    def grease_quantity(self: "Self") -> "_2278.GreaseQuantity":
    ...
    @property
    def initial_fill(self: "Self") -> "_2279.InitialFill":
