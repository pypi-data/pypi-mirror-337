...
from mastapy._private.system_model.fe import _2580, _2606
from mastapy._private.system_model.part_model import _2639, _2643
...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials import _318, _366
    ...
    from mastapy._private.nodal_analysis.component_mode_synthesis import _306, _314
    from mastapy._private.nodal_analysis.fe_export_utility import _240
    from mastapy._private.nodal_analysis.geometry_modeller_link import _227, _229
...
class FESubstructure(_69.FEStiffness):
    ...
    @property
    def alignment_method(self: "Self") -> "_2547.AlignmentMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2547", "AlignmentMethod"
        )(value)

    @alignment_method.setter
    @enforce_parameter_types
    def alignment_method(self: "Self", value: "_2547.AlignmentMethod") -> None:
    ...
    @property
    def bearing_node_alignment(self: "Self") -> "_2553.BearingNodeAlignmentOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2553", "BearingNodeAlignmentOption"
        )(value)

    @bearing_node_alignment.setter
    @enforce_parameter_types
    def bearing_node_alignment(
        self: "Self", value: "_2553.BearingNodeAlignmentOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def component_to_align_to(self: "Self", value: "_2639.Component") -> None:
        wrapper_type = (
    ...
    @datum.setter
    @enforce_parameter_types
    def datum(self: "Self", value: "_2643.Datum") -> None:
    ...
    @enforce_parameter_types
    def distance_display_unit(self: "Self", value: "_1785.Unit") -> None:
    ...
    @enforce_parameter_types
    def force_display_unit(self: "Self", value: "_1785.Unit") -> None:
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @property
    def reduction_mode_type(self: "Self") -> "_314.ReductionModeType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.component_mode_synthesis._314",
            "ReductionModeType",
        )(value)

    @reduction_mode_type.setter
    @enforce_parameter_types
    def reduction_mode_type(self: "Self", value: "_314.ReductionModeType") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def thermal_expansion_option(
        self: "Self", value: "_2606.ThermalExpansionOption"
    ) -> None:
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: "Self", value: "_2580.FESubstructureType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def acoustic_radiation_efficiency(
        self: "Self",
    ) -> "_318.AcousticRadiationEfficiency":
    ...
    def alignment_using_axial_node_positions(
        self: "Self",
    ) -> "_2549.AlignmentUsingAxialNodePositions":
    ...
    def alignment_to_component(
        self: "Self",
    ) -> "_2411.RelativeComponentAlignment[_2639.Component]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2639.Component](temp)

    @property
    def cms_model(self: "Self") -> "_306.CMSModel":
    ...
    @property
    def coordinate_system(self: "Self") -> "_1674.CoordinateSystem3D":
    ...
    @property
    def export(self: "Self") -> "_2576.FESubstructureExportOptions":
    ...
    @property
    def fe_part(self: "Self") -> "_2649.FEPart":
    ...
    def geometry_modeller_design_information(
        self: "Self",
    ) -> "_227.GeometryModellerDesignInformation":
    ...
    @property
    def sound_pressure_enclosure(self: "Self") -> "_366.SoundPressureEnclosure":
    ...
    @property
    def gear_meshing_options(self: "Self") -> "List[_2587.GearMeshingOptions]":
    ...
    @property
    def geometries(self: "Self") -> "List[_2573.FEStiffnessGeometry]":
    ...
    def independent_masta_created_condensation_nodes(
        self: "Self",
    ) -> "List[_2588.IndependentMASTACreatedCondensationNode]":
    ...
    def independent_masta_created_rigid_nodes(
        self: "Self",
    ) -> "List[_2591.IndependentMASTACreatedRigidlyConnectedNodeGroup]":
    ...
    @property
    def links(self: "Self") -> "List[_2613.FELink]":
    ...
    @property
    def nodes(self: "Self") -> "List[_2577.FESubstructureNode]":
    ...
    @property
    def replaced_shafts(self: "Self") -> "List[_2682.Shaft]":
    ...
    def shafts_that_can_be_replaced(
        self: "Self",
    ) -> "List[_2604.ReplacedShaftSelectionHelper]":
    ...
    def import_fe_mesh(
        self: "Self",
        file_path: "str",
        format_: "_240.FEExportFormat",
        length_scale: "float" = 1.0,
        force_scale: "float" = 1.0,
        progress: Optional["_7859.TaskProgress"] = None,
    ) -> None:
        """Method does not return.
    ...
    def import_node_positions(
        self: "Self", file_name: "str", distance_unit: "_1785.Unit"
    ) -> None:
        """Method does not return.
    ...
    def import_reduced_stiffness(
        self: "Self",
        file_name: "str",
        distance_unit: "_1785.Unit",
        force_unit: "_1785.Unit",
    ) -> None:
        """Method does not return.
    ...
    @enforce_parameter_types
    def links_for(
        self: "Self", node: "_2577.FESubstructureNode"
    ) -> "List[_2613.FELink]":
        """List[mastapy.system_model.fe.links.FELink]
    ...
    def load_existing_masta_fe_file_with_progress(
        self: "Self", file_name: "str", progress: "_7859.TaskProgress"
    ) -> None:
        """Method does not return.
    ...
    def load_stl_geometry(
        self: "Self", length_unit: "_1785.Unit", file_path: "str"
    ) -> None:
        """Method does not return.
