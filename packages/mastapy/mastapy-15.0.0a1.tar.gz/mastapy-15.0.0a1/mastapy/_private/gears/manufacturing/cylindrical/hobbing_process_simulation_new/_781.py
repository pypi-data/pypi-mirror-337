...
class _Cast_ProcessSimulationInput:
    ...
    def hobbing_process_simulation_input(
        self: "CastSelf",
    ) -> "_768.HobbingProcessSimulationInput":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _768,
        )

        return self.__parent__._cast(_768.HobbingProcessSimulationInput)

    @property
    def worm_grinding_process_simulation_input(
        self: "CastSelf",
    ) -> "_795.WormGrindingProcessSimulationInput":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _795,
        )

        return self.__parent__._cast(_795.WormGrindingProcessSimulationInput)
...
class ProcessSimulationInput(_0.APIBase):
    ...
    @property
    def analysis_setting(self: "Self") -> "_755.AnalysisMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new._755",
            "AnalysisMethod",
        )(value)

    @analysis_setting.setter
    @enforce_parameter_types
    def analysis_setting(self: "Self", value: "_755.AnalysisMethod") -> None:
    ...
    def centre_distance_offset_specification_method(
        self: "Self",
    ) -> "_759.CentreDistanceOffsetMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new._759",
    ...
    @enforce_parameter_types
    def centre_distance_offset_specification_method(
        self: "Self", value: "_759.CentreDistanceOffsetMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Manufacturing.Cylindrical.HobbingProcessSimulationNew.CentreDistanceOffsetMethod",
    ...
    @property
    def cutter_head_slide_error(self: "Self") -> "_760.CutterHeadSlideError":
    ...
    @property
    def cutter_mounting_error(self: "Self") -> "_786.RackMountingError":
    ...
    @property
    def gear_mounting_error(self: "Self") -> "_761.GearMountingError":
