...
from maverick_de.common.metrics import *
from maverick_de.common.util import *
from maverick_de.models.model_incr import *
from maverick_de.models.model_mes import Maverick_mes
from maverick_de.models.model_s2e import *
...
class BasePLModule(pl.LightningModule):
    def __init__(self, *args, **kwargs) -> None:
        ...
        try:
            ...
            self.hparams.model["_target_"] = "maverick_de." + self.hparams.model["_target_"]
            self.model = hydra.utils.instantiate(self.hparams.model)
    ...
    def custom_opt(self):
        ...
        scheduler = transformers.get_linear_schedule_with_warmup(
            optimizer,
            num_warmup_steps=self.hparams.lr_scheduler.num_warmup_steps,
