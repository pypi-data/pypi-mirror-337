...
if TYPE_CHECKING:
    ...
    from msgspec_schemaorg.models.intangible.MusicAlbumProductionType import MusicAlbumProductionType
    from msgspec_schemaorg.models.intangible.MusicAlbumReleaseType import MusicAlbumReleaseType
...
class MusicAlbum(Struct, frozen=True):
