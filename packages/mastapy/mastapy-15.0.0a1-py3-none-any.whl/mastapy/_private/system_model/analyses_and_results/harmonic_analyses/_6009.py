...
class GearMeshExcitationDetail(_5933.AbstractPeriodicExcitationDetail):
    """GearMeshExcitationDetail
    ...
    @property
    def uncoupled_modal_analysis(self: "Self") -> "_4891.ModalAnalysis":
    ...
    @property
    def gear_mesh(self: "Self") -> "_2965.GearMeshSystemDeflection":
    ...
    def get_compliance_and_force_data(self: "Self") -> "_5958.ComplianceAndForceData":
