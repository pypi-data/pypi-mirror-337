...
class Coupling(_2676.SpecialisedAssembly):
    """Coupling
    ...
    @property
    def halves(self: "Self") -> "List[_2789.CouplingHalf]":
    ...
    @property
    def half_a(self: "Self") -> "_2789.CouplingHalf":
    ...
    @property
    def half_b(self: "Self") -> "_2789.CouplingHalf":
        """mastapy.system_model.part_model.couplings.CouplingHalf
