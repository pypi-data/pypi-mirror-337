...
class V0042StepTres(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "requested": V0042StepTresRequested.from_dict(obj["requested"])
                if obj.get("requested") is not None
                else None,
                "consumed": V0042StepTresConsumed.from_dict(obj["consumed"])
                if obj.get("consumed") is not None
                else None,
                "allocated": [V0042Tres.from_dict(_item) for _item in obj["allocated"]]
