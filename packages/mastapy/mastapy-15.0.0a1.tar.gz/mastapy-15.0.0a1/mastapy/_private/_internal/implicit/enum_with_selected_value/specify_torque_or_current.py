...
from mastapy._private.electric_machines.load_cases_and_analyses import _1547
...
class EnumWithSelectedValue_SpecifyTorqueOrCurrent(
    ...
    def wrapped_type(
        ...
        Returns:
            _1547.SpecifyTorqueOrCurrent
        """
        return _1547.SpecifyTorqueOrCurrent
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1547.SpecifyTorqueOrCurrent.type_()

    @property
    def selected_value(self: "Self") -> "_1547.SpecifyTorqueOrCurrent":
    ...
    @property
    def available_values(self: "Self") -> "List[_1547.SpecifyTorqueOrCurrent]":
