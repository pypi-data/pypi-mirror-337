...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.thermal import _1471, _1472
    from mastapy._private.electric_machines.thermal.load_cases_and_analyses import _1494
    from mastapy._private.electric_machines.thermal.results import _1482
...
class ThermalAnalysis(_0.APIBase):
    ...
    @property
    def load_case(self: "Self") -> "_1494.ThermalLoadCase":
    ...
    @property
    def setup(self: "Self") -> "_1472.ThermalElectricMachineSetup":
    ...
    @property
    def thermal_electric_machine(self: "Self") -> "_1471.ThermalElectricMachine":
    ...
    @property
    def thermal_results(self: "Self") -> "_1482.ThermalResults":
    ...
    def user_defined_nodes(
        self: "Self",
    ) -> "List[_220.UserDefinedNodeLoadCaseInformation]":
    ...
    def perform_analysis_with_progress(
        self: "Self", task_progress: "_7859.TaskProgress"
    ) -> None:
        """Method does not return.
