...
class ConceptGearSetMultibodyDynamicsAnalysis(_5688.GearSetMultibodyDynamicsAnalysis):
    """ConceptGearSetMultibodyDynamicsAnalysis
    ...
    def gears_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5657.ConceptGearMultibodyDynamicsAnalysis]":
    ...
    def meshes_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5656.ConceptGearMeshMultibodyDynamicsAnalysis]":
