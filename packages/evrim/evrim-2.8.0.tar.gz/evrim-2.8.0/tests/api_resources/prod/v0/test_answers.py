...
from evrim.types.prod.v0 import (
    AnswerListResponse,
...
class TestAnswers:
    ...
    def test_method_create(self, client: Evrim) -> None:
        answer = client.prod.v0.answers.create(
    ...
    def test_raw_response_create(self, client: Evrim) -> None:
        response = client.prod.v0.answers.with_raw_response.create(
            specification="specification",
        )
    ...
    def test_streaming_response_create(self, client: Evrim) -> None:
        with client.prod.v0.answers.with_streaming_response.create(
            specification="specification",
        ) as response:
    ...
    def test_method_retrieve(self, client: Evrim) -> None:
        answer = client.prod.v0.answers.retrieve(
            0,
        )
    ...
    def test_raw_response_retrieve(self, client: Evrim) -> None:
        response = client.prod.v0.answers.with_raw_response.retrieve(
            0,
        )
    ...
    def test_streaming_response_retrieve(self, client: Evrim) -> None:
        with client.prod.v0.answers.with_streaming_response.retrieve(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_list(self, client: Evrim) -> None:
        answer = client.prod.v0.answers.list()
    ...
    def test_raw_response_list(self, client: Evrim) -> None:
        response = client.prod.v0.answers.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Evrim) -> None:
        with client.prod.v0.answers.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncAnswers:
    ...
    async def test_method_create(self, async_client: AsyncEvrim) -> None:
        answer = await async_client.prod.v0.answers.create(
            specification="specification",
        )
        assert_matches_type(AnswerCreateResponse, answer, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncEvrim) -> None:
        response = await async_client.prod.v0.answers.with_raw_response.create(
            specification="specification",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncEvrim) -> None:
        async with async_client.prod.v0.answers.with_streaming_response.create(
            specification="specification",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_retrieve(self, async_client: AsyncEvrim) -> None:
        answer = await async_client.prod.v0.answers.retrieve(
            0,
        )
        assert_matches_type(AnswerRetrieveResponse, answer, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncEvrim) -> None:
        response = await async_client.prod.v0.answers.with_raw_response.retrieve(
            0,
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncEvrim) -> None:
        async with async_client.prod.v0.answers.with_streaming_response.retrieve(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list(self, async_client: AsyncEvrim) -> None:
        answer = await async_client.prod.v0.answers.list()
        assert_matches_type(AnswerListResponse, answer, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncEvrim) -> None:
        response = await async_client.prod.v0.answers.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncEvrim) -> None:
        async with async_client.prod.v0.answers.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
