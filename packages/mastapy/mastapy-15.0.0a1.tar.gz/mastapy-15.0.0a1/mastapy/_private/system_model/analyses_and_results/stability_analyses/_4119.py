...
class ZerolBevelGearSetStabilityAnalysis(_4002.BevelGearSetStabilityAnalysis):
    """ZerolBevelGearSetStabilityAnalysis
    ...
    def bevel_gears_stability_analysis(
        self: "Self",
    ) -> "List[_4120.ZerolBevelGearStabilityAnalysis]":
    ...
    def bevel_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_4118.ZerolBevelGearMeshStabilityAnalysis]":
