        ...
        try:
            ...
            if decode:
                try:
                    ...
                    logger.error(f"An error occurred while decoding the json response to a request to {response.url}. The data obtained in the answer: {response.text}")
                    raise ConnectionException(f"An error occurred while decoding the json response to a request to {response.url}. The data obtained in the answer: {response.text}")
