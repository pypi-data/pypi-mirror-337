...
from pytoolkit.static import ENCODING, NO_AIRPORTDATA, RE_DOMAIN, RE_IP4
...
def set_bool(value: Union[str, int, float], default: bool = False) -> Union[str, bool]:
    """
    ...
    :return: String if `value` is a file otherwise bool(True|False)
