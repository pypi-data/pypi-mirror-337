...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _819
...
class _Cast_CylindricalGearWormGrinderShape:
    ...
    @property
    def cutter_shape_definition(self: "CastSelf") -> "_819.CutterShapeDefinition":
        from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import (
            _819,
        )

        return self.__parent__._cast(_819.CutterShapeDefinition)
...
class CylindricalGearWormGrinderShape(_826.RackShape):
    """CylindricalGearWormGrinderShape
    ...
    @property
    def design(self: "Self") -> "_804.CylindricalGearGrindingWorm":
