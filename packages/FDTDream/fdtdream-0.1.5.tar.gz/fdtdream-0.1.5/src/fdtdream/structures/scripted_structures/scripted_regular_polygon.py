...
class ScriptedRegularPolygon(RegularPolygon, ScriptedStructure):
    ...
    def __init__(self, sim: SimulationInterface, name: str = "polygon", **kwargs: RegularPolygonKwargs):
    ...
    def copy(self, name: str = "polygon", **kwargs: Unpack[RegularPolygonKwargs]) -> Self:
