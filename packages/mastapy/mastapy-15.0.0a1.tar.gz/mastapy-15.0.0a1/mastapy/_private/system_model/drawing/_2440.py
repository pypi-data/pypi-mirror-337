...
from mastapy._private.system_model.drawing.options import _2453
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.drawing import _2444
...
class _Cast_HarmonicAnalysisViewable:
    ...
    def part_analysis_case_with_contour_viewable(
        self: "CastSelf",
    ) -> "_2444.PartAnalysisCaseWithContourViewable":
        from mastapy._private.system_model.drawing import _2444

        return self.__parent__._cast(_2444.PartAnalysisCaseWithContourViewable)
...
class HarmonicAnalysisViewable(_2439.DynamicAnalysisViewable):
    """HarmonicAnalysisViewable
    ...
    @enforce_parameter_types
    def excitation(
        self: "Self", value: "_5933.AbstractPeriodicExcitationDetail"
    ) -> None:
    ...
    @enforce_parameter_types
    def harmonic_analysis_with_varying_stiffness_step(
        self: "Self", value: "_6025.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase"
    ) -> None:
    ...
    @order.setter
    @enforce_parameter_types
    def order(self: "Self", value: "_1704.RoundedOrder") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def sound_response_type(self: "Self", value: "_4862.DynamicsResponseType") -> None:
    ...
    @enforce_parameter_types
    def uncoupled_mesh(self: "Self", value: "_2965.GearMeshSystemDeflection") -> None:
    ...
    @view_type.setter
    @enforce_parameter_types
    def view_type(self: "Self", value: "_2453.ExcitationAnalysisViewOption") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def dynamic_analysis_draw_style(self: "Self") -> "_6600.DynamicAnalysisDrawStyle":
