...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1725
    from mastapy._private.utility.reporting_property_framework import _1967
...
class _Cast_ChartInfoBase:
    ...
    def micro_geometry_design_space_search_chart_information(
        self: "CastSelf",
    ) -> "_1014.MicroGeometryDesignSpaceSearchChartInformation":
        from mastapy._private.gears.gear_set_pareto_optimiser import _1014
    ...
    def pareto_optimiser_chart_information(
        self: "CastSelf",
    ) -> "_1029.ParetoOptimiserChartInformation":
        from mastapy._private.gears.gear_set_pareto_optimiser import _1029

        return self.__parent__._cast(_1029.ParetoOptimiserChartInformation)
...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def chart_type(self: "Self") -> "_1967.CustomChartType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.reporting_property_framework._1967",
            "CustomChartType",
        )(value)
    ...
    def select_chart_type(
        self: "Self",
    ) -> "_1725.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility.optimisation.ParetoOptimisationStrategyChartInformation._1725",
    ...
    def select_chart_type(
        self: "Self",
        value: "_1725.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart",
    ) -> None:
    ...
    @property
    def optimiser(self: "Self") -> "_1002.DesignSpaceSearchBase[TAnalysis, TCandidate]":
    ...
    @property
    def bars(self: "Self") -> "List[_998.BarForPareto[TAnalysis, TCandidate]]":
    ...
    def input_sliders(
        self: "Self",
    ) -> "List[_1010.InputSliderForPareto[TAnalysis, TCandidate]]":
