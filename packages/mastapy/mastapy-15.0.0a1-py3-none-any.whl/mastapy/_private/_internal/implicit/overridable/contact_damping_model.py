...
from mastapy._private.math_utility.hertzian_contact import _1747
...
class Overridable_ContactDampingModel(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1747.ContactDampingModel
        """
        return _1747.ContactDampingModel
    ...
    def implicit_type(cls: "Type[Overridable_ContactDampingModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1747.ContactDampingModel.type_()

    @property
    def value(self: "Self") -> "_1747.ContactDampingModel":
    ...
    @property
    def override_value(self: "Self") -> "_1747.ContactDampingModel":
        """mastapy.math_utility.hertzian_contact.ContactDampingModel
    ...
    @property
    def calculated_value(self: "Self") -> "_1747.ContactDampingModel":
        """mastapy.math_utility.hertzian_contact.ContactDampingModel
