...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _543, _551, _560, _565, _566
    from mastapy._private.gears.rating.cylindrical.din3990 import _617
    from mastapy._private.gears.rating.cylindrical.iso6336 import _596, _598, _600, _603
...
class ISO6336AbstractMetalMeshSingleFlankRating(
    ...
    def scuffing_rating_method_flash_temperature_method(
        self: "Self",
    ) -> "_565.ScuffingFlashTemperatureRatingMethod":
    ...
    def scuffing_rating_method_integral_temperature_method(
        self: "Self",
    ) -> "_566.ScuffingIntegralTemperatureRatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._566",
    ...
    def sorted_micro_pitting_results(
        self: "Self",
    ) -> "_543.CylindricalGearMicroPittingResults":
    ...
    def isodin_cylindrical_gear_single_flank_ratings(
        self: "Self",
    ) -> "List[_603.ISO6336AbstractMetalGearSingleFlankRating]":
