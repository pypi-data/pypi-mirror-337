...
class _Cast_ExcitationSourceSelectionBase:
    ...
    def excitation_source_selection(
        self: "CastSelf",
    ) -> "_6109.ExcitationSourceSelection":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.results import (
            _6109,
        )

        return self.__parent__._cast(_6109.ExcitationSourceSelection)

    @property
    def excitation_source_selection_group(
        self: "CastSelf",
    ) -> "_6111.ExcitationSourceSelectionGroup":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.results import (
            _6111,
        )

        return self.__parent__._cast(_6111.ExcitationSourceSelectionGroup)
