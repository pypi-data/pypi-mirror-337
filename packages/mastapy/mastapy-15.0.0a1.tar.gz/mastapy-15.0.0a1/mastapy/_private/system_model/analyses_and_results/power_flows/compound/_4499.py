...
class SpringDamperCompoundPowerFlow(_4432.CouplingCompoundPowerFlow):
    """SpringDamperCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2811.SpringDamper":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4369.SpringDamperPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4369.SpringDamperPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SpringDamperPowerFlow]
