...
class InferenceServiceView(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "started_at", "done_at", "logs", "errors", "price", "docker_metadata", "requirement_metadata", "runtime_metadata", "created_at", "updated_at", "container_port", "server_ip", "api_url", "cloudflare_record_id"]
