    ...
    def _generate_cursorrules(self, cursor_dir: str) -> List[str]:
        ...
        for category in categories_to_generate:
            ...
            try:
                ...
                always_apply = (category == "General_Project_Guidelines")
                ...
                ---
                description: <Semantic description of when/why this rule applies, mentioning the FOUNDATION phase context. For General rules, include project summary/goal.> 
                globs: ["<glob pattern 1>", "<glob pattern 2>"] # Use specific patterns relevant to '{category}'. E.g., ["**/*.py"] for Python, ["src/components/**/*.tsx"] for React.
                alwaysApply: {always_apply} # Should be true only for very general rules.
                ---
                ...
                Project Context:
                Phase: FOUNDATION
                Always Apply Setting for this rule: {always_apply}
                ...
                Remember to output ONLY the raw .mdc file content, starting with --- and including the YAML front matter, followed by the # Title and rule content.
                """
