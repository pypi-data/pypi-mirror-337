...
class _Cast_CylindricalGearAbstractRack:
    ...
    def cylindrical_gear_basic_rack(
        self: "CastSelf",
    ) -> "_1111.CylindricalGearBasicRack":
        from mastapy._private.gears.gear_designs.cylindrical import _1111

        return self.__parent__._cast(_1111.CylindricalGearBasicRack)

    @property
    def cylindrical_gear_pinion_type_cutter(
        self: "CastSelf",
    ) -> "_1126.CylindricalGearPinionTypeCutter":
        from mastapy._private.gears.gear_designs.cylindrical import _1126

        return self.__parent__._cast(_1126.CylindricalGearPinionTypeCutter)

    @property
    def standard_rack(self: "CastSelf") -> "_1182.StandardRack":
        from mastapy._private.gears.gear_designs.cylindrical import _1182

        return self.__parent__._cast(_1182.StandardRack)
...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    @property
    def gear(self: "Self") -> "_1115.CylindricalGearDesign":
    ...
    @property
    def left_flank(self: "Self") -> "_1110.CylindricalGearAbstractRackFlank":
    ...
    @property
    def right_flank(self: "Self") -> "_1110.CylindricalGearAbstractRackFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearAbstractRackFlank
    ...
    @property
    def shaper_for_agma_rating(self: "Self") -> "_810.CylindricalGearShaper":
    ...
    @property
    def flanks(self: "Self") -> "List[_1110.CylindricalGearAbstractRackFlank]":
    ...
    @property
    def both_flanks(self: "Self") -> "_1110.CylindricalGearAbstractRackFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearAbstractRackFlank
