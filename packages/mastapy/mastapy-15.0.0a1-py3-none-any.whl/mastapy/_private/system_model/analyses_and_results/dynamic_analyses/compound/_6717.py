...
class CouplingCompoundDynamicAnalysis(_6780.SpecialisedAssemblyCompoundDynamicAnalysis):
    """CouplingCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_6585.CouplingDynamicAnalysis]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6585.CouplingDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.CouplingDynamicAnalysis]
