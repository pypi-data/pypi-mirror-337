...
from pytessng.UserInterface.public import BaseMouse, QuestionMark, HighLightPathItem, TextWindowItem
...
class NetEditMergeLink(BaseNetEdit):
    ...
    def apply_button_click_action(self):
        ...
        self.mouse_link_merger = MouseLinkMerger(params, lambda params0: MyOperation().apply_net_edit_operation(self.mode, params0, self, self.auto_close_window))
