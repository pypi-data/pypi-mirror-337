...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _928
...
class CylindricalGearMeshLoadDistributionAnalysis(
    ...
    @property
    def cylindrical_mesh_load_case(self: "Self") -> "_980.CylindricalMeshLoadCase":
    ...
    def gear_a_in_mesh(
        self: "Self",
    ) -> "_928.CylindricalMeshedGearLoadDistributionAnalysis":
    ...
    @property
    def mesh_micro_geometry(self: "Self") -> "_1204.CylindricalGearMeshMicroGeometry":
    ...
    def load_distribution_analyses_at_single_rotation(
        self: "Self",
    ) -> "List[_957.CylindricalMeshLoadDistributionAtRotation]":
    ...
    def meshed_gears(
        self: "Self",
    ) -> "List[_928.CylindricalMeshedGearLoadDistributionAnalysis]":
