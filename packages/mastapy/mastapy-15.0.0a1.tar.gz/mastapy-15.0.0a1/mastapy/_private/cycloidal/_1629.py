...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1630, _1637, _1638
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self: "Self") -> "_1638.RingPinsDesign":
    ...
    @property
    def disc_phases(self: "Self") -> "List[_1637.NamedDiscPhase]":
    ...
    @property
    def discs(self: "Self") -> "List[_1630.CycloidalDiscDesign]":
