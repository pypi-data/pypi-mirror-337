...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.report import _1934, _1941, _1949, _1951, _1958
...
TItem = TypeVar("TItem", bound="_1951.CustomReportPropertyItem")
...
class CustomReportMultiPropertyItem(
    _1948.CustomReportMultiPropertyItemBase, Generic[TItem]
):
    """CustomReportMultiPropertyItem
