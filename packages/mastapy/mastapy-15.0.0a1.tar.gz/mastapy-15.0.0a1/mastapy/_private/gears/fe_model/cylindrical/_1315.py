...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.analysis import _1329, _1335, _1338
...
class CylindricalGearMeshFEModel(_1311.GearMeshFEModel):
    """CylindricalGearMeshFEModel
    ...
    def stiffness_wrt_contacts_for(
        self: "Self", gear: "_1310.GearFEModel", flank: "_409.GearFlanks"
    ) -> "List[_931.GearContactStiffness]":
    ...
    def generate_stiffness_wrt_contacts_for_flank(
        self: "Self", flank: "_409.GearFlanks", progress: "_7859.TaskProgress"
    ) -> None:
        """Method does not return.
