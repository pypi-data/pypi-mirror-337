...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.fe_model import _1310, _1311
...
class GearSetFEModel(_1344.GearSetImplementationDetail):
    """GearSetFEModel
    ...
    @property
    def gear_fe_models(self: "Self") -> "List[_1310.GearFEModel]":
    ...
    @property
    def mesh_fe_models(self: "Self") -> "List[_1311.GearMeshFEModel]":
    ...
    @enforce_parameter_types
    def is_ready_for_altca_on(self: "Self", flank: "_409.GearFlanks") -> "bool":
        """bool
