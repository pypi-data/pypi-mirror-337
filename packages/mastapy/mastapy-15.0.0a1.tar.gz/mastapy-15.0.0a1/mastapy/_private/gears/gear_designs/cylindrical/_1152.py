...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1099, _1151
...
class GearSetManufacturingConfigurationSetup(_0.APIBase):
    ...
    def create_new_suitable_cutters(
        self: "Self",
    ) -> "_1099.CreateNewSuitableCutterOption":
    ...
    def create_new_suitable_cutters(
        self: "Self", value: "_1099.CreateNewSuitableCutterOption"
    ) -> None:
    ...
    @property
    def gears(self: "Self") -> "List[_1151.GearManufacturingConfigSetupViewModel]":
