...
class _Cast_CylindricalGearBasicRack:
    ...
    def cylindrical_gear_abstract_rack(
        self: "CastSelf",
    ) -> "_1109.CylindricalGearAbstractRack":
        return self.__parent__._cast(_1109.CylindricalGearAbstractRack)
...
class CylindricalGearBasicRack(_1109.CylindricalGearAbstractRack):
    """CylindricalGearBasicRack
    ...
    @property
    def basic_rack_profile(self: "Self") -> "_1097.BasicRackProfiles":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1097", "BasicRackProfiles"
        )(value)

    @basic_rack_profile.setter
    @enforce_parameter_types
    def basic_rack_profile(self: "Self", value: "_1097.BasicRackProfiles") -> None:
    ...
    def proportional_method_for_tip_clearance(
        self: "Self",
    ) -> "_1187.TipAlterationCoefficientMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1187",
    ...
    @enforce_parameter_types
    def proportional_method_for_tip_clearance(
        self: "Self", value: "_1187.TipAlterationCoefficientMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.TipAlterationCoefficientMethod",
