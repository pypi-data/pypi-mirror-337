...
from mastapy._private.system_model.connections_and_sockets import _2462
...
class _Cast_ComponentConnection:
    ...
    @property
    def component_measurer(self: "CastSelf") -> "_2462.ComponentMeasurer":
        return self.__parent__._cast(_2462.ComponentMeasurer)
...
class ComponentConnection(_2462.ComponentMeasurer):
    """ComponentConnection
    ...
    @property
    def connected_component(self: "Self") -> "_2639.Component":
