...
def load_and_process_input(loader, splitter, remove_stopwords=False):
    try:
        ...
        if isinstance(inputs, str):
            ...
            if remove_stopwords:
                from indoxArcg.data_loader_splitter.utils.clean import remove_stopwords
            ...
            isinstance(doc, Document) for doc in inputs
        ):
            ...
            raise ValueError(
                "Unsupported input type. Expected string or list of Document objects."
            )
