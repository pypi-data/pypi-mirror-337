...
create_script_path = "/image_article_comprehension/aiddit/create/打工人发现紧跟孙主席时间表的一周自律生活记录.json"
...
utils.save(image_material_result,
           "/image_article_comprehension/aiddit/create/image_material_result.json")
