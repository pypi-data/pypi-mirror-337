...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _540, _541
...
class _Cast_GearFlankRating:
    ...
    def cylindrical_gear_flank_duty_cycle_rating(
        self: "CastSelf",
    ) -> "_540.CylindricalGearFlankDutyCycleRating":
        from mastapy._private.gears.rating.cylindrical import _540

        return self.__parent__._cast(_540.CylindricalGearFlankDutyCycleRating)

    @property
    def cylindrical_gear_flank_rating(
        self: "CastSelf",
    ) -> "_541.CylindricalGearFlankRating":
        from mastapy._private.gears.rating.cylindrical import _541

        return self.__parent__._cast(_541.CylindricalGearFlankRating)
