...
# TODO Change to OPENCAGE_API_KEY
...
class CountriesLocal(GenericCRUD):
    ...
    def get_country_name(self, location: str) -> str:
        ...
        if self.geocoder:
            # geocoder.geocode(location) can cause NotAuthorizedError exception with message "Your API key is not authorized. You may have entered it incorrectly."
            try:
