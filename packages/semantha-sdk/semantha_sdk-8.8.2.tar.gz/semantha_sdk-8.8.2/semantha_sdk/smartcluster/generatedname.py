...
class GeneratednameEndpoint(RestEndpoint):
    """
    Class to access resource: "/api/smartcluster/domains/{domainname}/clusterings/{id}/clusters/{clusterid}/generatedname"
    ...
    def _endpoint(self) -> str:
        return self._parent_endpoint + "/generatedname"
