...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1378, _1439, _1440
...
class ElectricMachineSetup(_1388.ElectricMachineSetupBase):
    """ElectricMachineSetup
    ...
    @property
    def eccentricity(self: "Self") -> "_1378.Eccentricity":
