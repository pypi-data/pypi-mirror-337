...
public(
    ...
    ExternalVolumeCollection=ExternalVolumeCollection,
    ExternalVolumeResource=ExternalVolumeResource,
    StorageLocationS3=StorageLocationS3,
    StorageLocationAzure=StorageLocationAzure,
    StorageLocationGcs=StorageLocationGcs,
    Encryption=Encryption,
    StorageLocationS3Gov=StorageLocationS3Gov,
)
