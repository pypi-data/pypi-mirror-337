...
from mastapy._private.gears.micro_geometry import _657, _658, _659, _660
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.micro_geometry import _655, _661, _662, _664, _665
...
class CylindricalGearMicroGeometrySettingsItem(_2011.NamedDatabaseItem):
    """CylindricalGearMicroGeometrySettingsItem
    ...
    @property
    def default_flank_side_with_zero_face_width(self: "Self") -> "_655.FlankSide":
    ...
    @enforce_parameter_types
    def default_location_of_evaluation_lower_limit(
        self: "Self", value: "_657.LocationOfEvaluationLowerLimit"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @enforce_parameter_types
    def default_location_of_evaluation_upper_limit(
        self: "Self", value: "_658.LocationOfEvaluationUpperLimit"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @enforce_parameter_types
    def default_location_of_root_relief_evaluation(
        self: "Self", value: "_659.LocationOfRootReliefEvaluation"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @enforce_parameter_types
    def default_location_of_tip_relief_evaluation(
        self: "Self", value: "_660.LocationOfTipReliefEvaluation"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def default_micro_geometry_lead_tolerance_chart_view(
        self: "Self",
    ) -> "_1230.MicroGeometryLeadToleranceChartView":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical.micro_geometry._1230",
    ...
    @enforce_parameter_types
    def default_micro_geometry_lead_tolerance_chart_view(
        self: "Self", value: "_1230.MicroGeometryLeadToleranceChartView"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.MicroGeometry.MicroGeometryLeadToleranceChartView",
    ...
    def default_scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1148",
    ...
    @enforce_parameter_types
    def default_scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts(
        self: "Self", value: "_1148.DoubleAxisScaleAndRange"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def ltca_root_stress_surface_chart_option(
        self: "Self",
    ) -> "_1175.RootStressSurfaceChartOption":
    ...
    @enforce_parameter_types
    def ltca_root_stress_surface_chart_option(
        self: "Self", value: "_1175.RootStressSurfaceChartOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.RootStressSurfaceChartOption",
    ...
    def main_profile_modification_ends_at_the_start_of_root_relief_by_default(
        self: "Self",
    ) -> "_661.MainProfileReliefEndsAtTheStartOfRootReliefOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.micro_geometry._661",
    ...
    @enforce_parameter_types
    def main_profile_modification_ends_at_the_start_of_root_relief_by_default(
        self: "Self", value: "_661.MainProfileReliefEndsAtTheStartOfRootReliefOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.MicroGeometry.MainProfileReliefEndsAtTheStartOfRootReliefOption",
    ...
    def main_profile_modification_ends_at_the_start_of_tip_relief_by_default(
        self: "Self",
    ) -> "_662.MainProfileReliefEndsAtTheStartOfTipReliefOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.micro_geometry._662",
    ...
    @enforce_parameter_types
    def main_profile_modification_ends_at_the_start_of_tip_relief_by_default(
        self: "Self", value: "_662.MainProfileReliefEndsAtTheStartOfTipReliefOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.MicroGeometry.MainProfileReliefEndsAtTheStartOfTipReliefOption",
    ...
    def micro_geometry_lead_relief_definition(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1164",
    ...
    @enforce_parameter_types
    def micro_geometry_lead_relief_definition(
        self: "Self", value: "_1164.MicroGeometryConvention"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def micro_geometry_profile_relief_definition(
        self: "Self",
    ) -> "_1165.MicroGeometryProfileConvention":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1165",
    ...
    @enforce_parameter_types
    def micro_geometry_profile_relief_definition(
        self: "Self", value: "_1165.MicroGeometryProfileConvention"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.MicroGeometryProfileConvention",
    ...
    def parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default(
        self: "Self",
    ) -> "_664.ParabolicRootReliefStartsTangentToMainProfileRelief":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.micro_geometry._664",
    ...
    @enforce_parameter_types
    def parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default(
        self: "Self", value: "_664.ParabolicRootReliefStartsTangentToMainProfileRelief"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.MicroGeometry.ParabolicRootReliefStartsTangentToMainProfileRelief",
    ...
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default(
        self: "Self",
    ) -> "_665.ParabolicTipReliefStartsTangentToMainProfileRelief":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.micro_geometry._665",
    ...
    @enforce_parameter_types
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default(
        self: "Self", value: "_665.ParabolicTipReliefStartsTangentToMainProfileRelief"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.MicroGeometry.ParabolicTipReliefStartsTangentToMainProfileRelief",
