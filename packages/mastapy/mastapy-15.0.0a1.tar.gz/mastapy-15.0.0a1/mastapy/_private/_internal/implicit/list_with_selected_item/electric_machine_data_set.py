...
class ListWithSelectedItem_ElectricMachineDataSet(
    _2565.ElectricMachineDataSet, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2565.ElectricMachineDataSet.TYPE

    @property
    def selected_value(self: "Self") -> "_2565.ElectricMachineDataSet":
    ...
    @property
    def available_values(self: "Self") -> "List[_2565.ElectricMachineDataSet]":
