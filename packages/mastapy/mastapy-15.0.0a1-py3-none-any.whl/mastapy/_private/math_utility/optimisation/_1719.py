...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1718, _1730
...
class _Cast_OptimizationVariable:
    ...
    @property
    def optimization_input(self: "CastSelf") -> "_1718.OptimizationInput":
        from mastapy._private.math_utility.optimisation import _1718

        return self.__parent__._cast(_1718.OptimizationInput)

    @property
    def reporting_optimization_input(
        self: "CastSelf",
    ) -> "_1730.ReportingOptimizationInput":
        from mastapy._private.math_utility.optimisation import _1730

        return self.__parent__._cast(_1730.ReportingOptimizationInput)
...
class OptimizationVariable(_0.APIBase):
    ...
    @property
    def measurement(self: "Self") -> "_1780.MeasurementBase":
    ...
    def measurement(self: "Self", value: "_1780.MeasurementBase") -> None:
