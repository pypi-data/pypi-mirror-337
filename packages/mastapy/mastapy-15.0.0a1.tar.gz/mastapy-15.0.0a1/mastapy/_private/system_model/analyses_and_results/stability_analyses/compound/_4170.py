...
class CylindricalGearSetCompoundStabilityAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4034.CylindricalGearSetStabilityAnalysis]":
    ...
    def cylindrical_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4168.CylindricalGearCompoundStabilityAnalysis]":
    ...
    def cylindrical_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4169.CylindricalGearMeshCompoundStabilityAnalysis]":
