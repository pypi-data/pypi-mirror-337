...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.fe_model.conical import _1320
...
class ConicalSetFEModel(_1313.GearSetFEModel):
    """ConicalSetFEModel
    ...
    @property
    def flank_data_source(self: "Self") -> "_1320.FlankDataSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.fe_model.conical._1320", "FlankDataSource"
        )(value)

    @flank_data_source.setter
    @enforce_parameter_types
    def flank_data_source(self: "Self", value: "_1320.FlankDataSource") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def selected_design(
        self: "Self", value: "_887.ConicalSetManufacturingConfig"
    ) -> None:
