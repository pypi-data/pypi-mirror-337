...
class EnumWithSelectedValue_ComponentOrientationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ComponentOrientationOption]",
    ) -> "_2557.ComponentOrientationOption":
        ...
        Returns:
            _2557.ComponentOrientationOption
        """
        return _2557.ComponentOrientationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2557.ComponentOrientationOption.type_()

    @property
    def selected_value(self: "Self") -> "_2557.ComponentOrientationOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2557.ComponentOrientationOption]":
