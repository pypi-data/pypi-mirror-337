...
class AssemblyPowerFlow(_4258.AbstractAssemblyPowerFlow):
    """AssemblyPowerFlow
    ...
    @property
    def bearings(self: "Self") -> "List[_4266.BearingPowerFlow]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_4268.BeltDrivePowerFlow]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_4277.BoltedJointPowerFlow]":
    ...
    @property
    def bolts(self: "Self") -> "List[_4278.BoltPowerFlow]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_4299.CVTPowerFlow]":
    ...
    @property
    def clutches(self: "Self") -> "List[_4281.ClutchPowerFlow]":
    ...
    @property
    def concept_couplings(self: "Self") -> "List[_4286.ConceptCouplingPowerFlow]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_4289.ConceptGearSetPowerFlow]":
    ...
    @property
    def cycloidal_assemblies(self: "Self") -> "List[_4301.CycloidalAssemblyPowerFlow]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_4304.CycloidalDiscPowerFlow]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_4308.CylindricalGearSetPowerFlow]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_4317.FEPartPowerFlow]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_4314.FaceGearSetPowerFlow]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_4325.HypoidGearSetPowerFlow]":
    ...
    @property
    def loaded_gear_sets(self: "Self") -> "List[_4321.GearSetPowerFlow]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_4336.MassDiscPowerFlow]":
    ...
    @property
    def microphones(self: "Self") -> "List[_4339.MicrophonePowerFlow]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_4341.OilSealPowerFlow]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_4348.PlanetCarrierPowerFlow]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_4349.PointLoadPowerFlow]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_4352.PowerLoadPowerFlow]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_4354.RingPinsPowerFlow]":
    ...
    @property
    def shafts(self: "Self") -> "List[_4361.ShaftPowerFlow]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_4369.SpringDamperPowerFlow]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_4380.SynchroniserPowerFlow]":
    ...
    @property
    def torque_converters(self: "Self") -> "List[_4384.TorqueConverterPowerFlow]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_4387.UnbalancedMassPowerFlow]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_4391.WormGearSetPowerFlow]":
    ...
    @property
    def zerol_bevel_gear_sets(self: "Self") -> "List[_4394.ZerolBevelGearSetPowerFlow]":
