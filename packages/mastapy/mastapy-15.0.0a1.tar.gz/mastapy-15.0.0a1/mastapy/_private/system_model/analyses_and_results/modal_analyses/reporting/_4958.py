...
class PerModeResultsReport(_1934.CustomReportChart):
    """PerModeResultsReport
    ...
    @property
    def display_option(self: "Self") -> "_2001.TableAndChartOptions":
    ...
    def display_option(self: "Self", value: "_2001.TableAndChartOptions") -> None:
