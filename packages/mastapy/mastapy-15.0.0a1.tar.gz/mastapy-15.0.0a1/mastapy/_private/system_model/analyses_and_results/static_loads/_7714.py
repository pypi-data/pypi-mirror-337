...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2550
...
class FEPartLoadCase(_7635.AbstractShaftOrHousingLoadCase):
    """FEPartLoadCase
    ...
    @property
    def angle_source(self: "Self") -> "_2550.AngleSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2550", "AngleSource"
        )(value)
    ...
    @enforce_parameter_types
    def fe_substructure(self: "Self", value: "_2575.FESubstructure") -> None:
        wrapper_type = (
    ...
    def surfaces_for_data_logging(
        self: "Self",
    ) -> "List[_7662.CMSElementFaceGroupWithSelectionOption]":
