...
class Overridable_HelicalGearMicroGeometryOption(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _594.HelicalGearMicroGeometryOption
        """
        return _594.HelicalGearMicroGeometryOption
    ...
    def implicit_type(cls: "Type[Overridable_HelicalGearMicroGeometryOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _594.HelicalGearMicroGeometryOption.type_()

    @property
    def value(self: "Self") -> "_594.HelicalGearMicroGeometryOption":
    ...
    @property
    def override_value(self: "Self") -> "_594.HelicalGearMicroGeometryOption":
        """mastapy.gears.rating.cylindrical.iso6336.HelicalGearMicroGeometryOption
    ...
    @property
    def calculated_value(self: "Self") -> "_594.HelicalGearMicroGeometryOption":
        """mastapy.gears.rating.cylindrical.iso6336.HelicalGearMicroGeometryOption
