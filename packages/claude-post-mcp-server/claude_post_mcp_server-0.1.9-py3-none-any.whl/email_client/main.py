...
logging.debug(f"Logging in as {EMAIL_CONFIG['password']}")
logging.debug(f"Logging in as {EMAIL_CONFIG['imap_server']}")
logging.debug(f"Logging in as {EMAIL_CONFIG['smtp_port']}")
