...
class ShaftCompoundHarmonicAnalysis(_6144.AbstractShaftCompoundHarmonicAnalysis):
    """ShaftCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6064.ShaftHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6064.ShaftHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.ShaftHarmonicAnalysis]
