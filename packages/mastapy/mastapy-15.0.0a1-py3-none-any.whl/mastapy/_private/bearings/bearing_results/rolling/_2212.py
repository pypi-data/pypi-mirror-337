...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2181, _2196, _2235
...
class LoadedNonBarrelRollerBearingDutyCycle(_2146.LoadedRollingBearingDutyCycle):
    """LoadedNonBarrelRollerBearingDutyCycle
