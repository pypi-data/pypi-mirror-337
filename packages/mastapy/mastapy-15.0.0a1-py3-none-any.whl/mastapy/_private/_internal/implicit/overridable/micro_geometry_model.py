...
class Overridable_MicroGeometryModel(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _420.MicroGeometryModel
        """
        return _420.MicroGeometryModel
    ...
    def implicit_type(cls: "Type[Overridable_MicroGeometryModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _420.MicroGeometryModel.type_()

    @property
    def value(self: "Self") -> "_420.MicroGeometryModel":
    ...
    @property
    def override_value(self: "Self") -> "_420.MicroGeometryModel":
        """mastapy.gears.MicroGeometryModel
    ...
    @property
    def calculated_value(self: "Self") -> "_420.MicroGeometryModel":
        """mastapy.gears.MicroGeometryModel
