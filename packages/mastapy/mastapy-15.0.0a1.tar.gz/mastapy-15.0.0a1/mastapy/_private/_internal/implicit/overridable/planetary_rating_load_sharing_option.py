...
class Overridable_PlanetaryRatingLoadSharingOption(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _424.PlanetaryRatingLoadSharingOption
        """
        return _424.PlanetaryRatingLoadSharingOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _424.PlanetaryRatingLoadSharingOption.type_()

    @property
    def value(self: "Self") -> "_424.PlanetaryRatingLoadSharingOption":
    ...
    @property
    def override_value(self: "Self") -> "_424.PlanetaryRatingLoadSharingOption":
        """mastapy.gears.PlanetaryRatingLoadSharingOption
    ...
    @property
    def calculated_value(self: "Self") -> "_424.PlanetaryRatingLoadSharingOption":
        """mastapy.gears.PlanetaryRatingLoadSharingOption
