...
from mastapy._private.gears.gear_set_pareto_optimiser import _1003
...
class _Cast_MicroGeometryDesignSpaceSearchCandidate:
    ...
    def design_space_search_candidate_base(
        self: "CastSelf",
    ) -> "_1003.DesignSpaceSearchCandidateBase":
        pass

        return self.__parent__._cast(_1003.DesignSpaceSearchCandidateBase)
...
class MicroGeometryDesignSpaceSearchCandidate(
    ...
    @property
    def candidate(self: "Self") -> "_956.CylindricalGearSetLoadDistributionAnalysis":
    ...
    @property
    def candidate_for_slider(self: "Self") -> "_1213.CylindricalGearSetMicroGeometry":
