...
from mastapy._private.nodal_analysis.geometry_modeller_link import _237
...
class _Cast_ShaftProfileFromImport:
    ...
    @property
    def profile_from_import(self: "CastSelf") -> "_237.ProfileFromImport":
        return self.__parent__._cast(_237.ProfileFromImport)
...
class ShaftProfileFromImport(_237.ProfileFromImport):
    """ShaftProfileFromImport
