...
class LarkdocsClient:
    ...
    def get_the_worksheet(self, spreadsheet_token):
        ...
        try:
            ...
            # 处理业务结果
            self.lark_client.logger.info(lark.JSON.marshal(response.data, indent=4))
        except Exception as e:
            self.lark_client.logger.error(f"[lark]get user id by email failed, err: {e}")
            return None, e
