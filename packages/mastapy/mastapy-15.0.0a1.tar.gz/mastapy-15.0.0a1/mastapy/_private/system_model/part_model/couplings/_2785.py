...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2787
...
class ConceptCoupling(_2788.Coupling):
    """ConceptCoupling
    ...
    @property
    def efficiency_vs_speed_ratio(self: "Self") -> "_1709.Vector2DListAccessor":
    ...
    @property
    def half_positioning(self: "Self") -> "_2787.ConceptCouplingHalfPositioning":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.couplings._2787",
    ...
    def half_positioning(
        self: "Self", value: "_2787.ConceptCouplingHalfPositioning"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.ConceptCouplingHalfPositioning",
