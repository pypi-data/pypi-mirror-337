...
from mastapy._private.bearings.bearing_designs.rolling import _2342
...
class EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum]",
    ) -> "_2342.FatigueLoadLimitCalculationMethodEnum":
        ...
        Returns:
            _2342.FatigueLoadLimitCalculationMethodEnum
        """
        return _2342.FatigueLoadLimitCalculationMethodEnum
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2342.FatigueLoadLimitCalculationMethodEnum.type_()

    @property
    def selected_value(self: "Self") -> "_2342.FatigueLoadLimitCalculationMethodEnum":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2342.FatigueLoadLimitCalculationMethodEnum]":
