...
def visualize_directed_graph_styled_communities(graph, title="Character Relationships Directed Graph", edge_annotation="none"):
    ...
    then nodes are colored by community and sized by a centrality measure.
    ...
    ax.text(0.80, 0.06, "node size = centrality measure", horizontalalignment="center", transform=ax.transAxes, fontdict=font)
