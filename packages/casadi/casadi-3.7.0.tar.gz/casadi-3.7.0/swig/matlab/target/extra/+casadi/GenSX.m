classdef  GenSX < casadi.GenericMatrixCommon & casadi.SparsityInterfaceCommon
  ...
  methods
    ...
    %
    %
      out = casadiMEX(326, self, varargin{:});
      if nargout<=1
        varargout{1}=out;
      else
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(339, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(340, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(341, varargin{:});
    end
  end
end
