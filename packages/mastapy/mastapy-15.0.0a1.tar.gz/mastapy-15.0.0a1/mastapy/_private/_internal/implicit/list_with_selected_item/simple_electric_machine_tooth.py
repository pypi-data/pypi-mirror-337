...
from mastapy._private.electric_machines.harmonic_load_data import _1558
...
class ListWithSelectedItem_SimpleElectricMachineTooth(
    _1558.SimpleElectricMachineTooth, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1558.SimpleElectricMachineTooth.TYPE

    @property
    def selected_value(self: "Self") -> "_1558.SimpleElectricMachineTooth":
    ...
    @property
    def available_values(self: "Self") -> "List[_1558.SimpleElectricMachineTooth]":
