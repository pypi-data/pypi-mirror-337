...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.virtual_cylindrical_gears import _468, _469, _473
...
class KlingelnbergVirtualCylindricalGear(_472.VirtualCylindricalGear):
    """KlingelnbergVirtualCylindricalGear
