...
from mastapy._private.gears.manufacturing.cylindrical import _719, _720
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical import _707
    ...
    from mastapy._private.gears.manufacturing.cylindrical.process_simulation import _735
...
class CylindricalGearManufacturingConfig(_1334.GearImplementationDetail):
    """CylindricalGearManufacturingConfig
    ...
    @enforce_parameter_types
    def finishing_method(
        self: "Self", value: "_719.CylindricalMftFinishingMethods"
    ) -> None:
    ...
    @enforce_parameter_types
    def roughing_method(
        self: "Self", value: "_720.CylindricalMftRoughingMethods"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def design(self: "Self") -> "_1115.CylindricalGearDesign":
    ...
    @property
    def finish_cutter(self: "Self") -> "_809.CylindricalGearRealCutterDesign":
    ...
    @property
    def finish_cutter_simulation(self: "Self") -> "_835.GearCutterSimulation":
    ...
    def finish_manufacturing_process_controls(
        self: "Self",
    ) -> "_838.ManufacturingProcessControls":
    ...
    @property
    def finish_process_simulation(self: "Self") -> "_735.CutterProcessSimulation":
    ...
    def finished_gear_specification(
        self: "Self",
    ) -> "_829.CylindricalGearSpecification":
    ...
    @property
    def gear_blank(self: "Self") -> "_707.CylindricalGearBlank":
    ...
    @property
    def rough_cutter(self: "Self") -> "_809.CylindricalGearRealCutterDesign":
        """mastapy.gears.manufacturing.cylindrical.cutters.CylindricalGearRealCutterDesign
    ...
    @property
    def rough_cutter_simulation(self: "Self") -> "_835.GearCutterSimulation":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.GearCutterSimulation
    ...
    @property
    def rough_gear_specification(self: "Self") -> "_829.CylindricalGearSpecification":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.CylindricalGearSpecification
    ...
    @property
    def rough_process_simulation(self: "Self") -> "_735.CutterProcessSimulation":
        """mastapy.gears.manufacturing.cylindrical.process_simulation.CutterProcessSimulation
