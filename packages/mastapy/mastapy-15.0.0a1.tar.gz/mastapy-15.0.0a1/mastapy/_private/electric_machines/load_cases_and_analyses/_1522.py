...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.load_cases_and_analyses import _1521, _1531
...
class DynamicForceAnalysis(
    _1527.ElectricMachineAnalysis, _1514.IHaveDynamicForceResults
):
    """DynamicForceAnalysis
    ...
    @property
    def load_case(self: "Self") -> "_1521.BasicDynamicForceLoadCase":
    ...
    @property
    def results(self: "Self") -> "_1496.DynamicForceResults":
    ...
    def single_operating_point_analyses(
        self: "Self",
    ) -> "List[_1531.ElectricMachineFEAnalysis]":
