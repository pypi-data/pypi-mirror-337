...
def generate_technical_roles(
    ...
    create_roles_incremental: bool = False,
) -> None:
    ...
    Args:
        ...
        Defaults to None.
        create_roles_incremental (bool, optional): _description_.
        Defaults to False.

    Raises:
        SystemExit: _description_
    """
    if create_roles_incremental and git_tag_regex is None:
        raise ValueError(
            "If create_roles_incremental is used, a git_tag_regex has to be supplied!"
        )
