...
class PowerLoadCompoundParametricStudyTool(
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7768.PowerLoadLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4634.PowerLoadParametricStudyTool]":
    ...
    @property
    def load_cases(self: "Self") -> "List[_7768.PowerLoadLoadCase]":
