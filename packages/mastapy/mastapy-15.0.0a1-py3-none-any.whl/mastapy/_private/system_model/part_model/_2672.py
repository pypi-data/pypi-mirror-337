...
from mastapy._private.system_model.part_model import _2655
...
class _Cast_RadialInternalClearanceTolerance:
    ...
    def internal_clearance_tolerance(
        self: "CastSelf",
    ) -> "_2655.InternalClearanceTolerance":
        return self.__parent__._cast(_2655.InternalClearanceTolerance)
...
class RadialInternalClearanceTolerance(_2655.InternalClearanceTolerance):
    """RadialInternalClearanceTolerance
