...
from mastapy._private.bearings.tolerances import _2088
...
class EnumWithSelectedValue_InternalClearanceClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _2088.InternalClearanceClass
        """
        return _2088.InternalClearanceClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2088.InternalClearanceClass.type_()

    @property
    def selected_value(self: "Self") -> "_2088.InternalClearanceClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_2088.InternalClearanceClass]":
