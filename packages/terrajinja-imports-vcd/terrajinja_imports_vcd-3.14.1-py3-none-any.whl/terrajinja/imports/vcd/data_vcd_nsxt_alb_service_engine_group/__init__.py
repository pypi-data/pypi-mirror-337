...
class DataVcdNsxtAlbServiceEngineGroup(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: NSX-T ALB Service Engine Group name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/data-sources/nsxt_alb_service_engine_group#name DataVcdNsxtAlbServiceEngineGroup#name}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/data-sources/nsxt_alb_service_engine_group#id DataVcdNsxtAlbServiceEngineGroup#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param overallocated: Boolean value that shows if virtual services are overallocated. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/data-sources/nsxt_alb_service_engine_group#overallocated DataVcdNsxtAlbServiceEngineGroup#overallocated}
        :param sync_on_refresh: Boolean value that shows if sync should be performed on every refresh. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/data-sources/nsxt_alb_service_engine_group#sync_on_refresh DataVcdNsxtAlbServiceEngineGroup#sync_on_refresh}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataVcdNsxtAlbServiceEngineGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/data-sources/nsxt_alb_service_engine_group#import import section} in the documentation of this resource for the id to use
