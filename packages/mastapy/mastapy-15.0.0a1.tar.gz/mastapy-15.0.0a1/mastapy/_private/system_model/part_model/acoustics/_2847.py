...
from mastapy._private.system_model.part_model.acoustics import _2850
...
class _Cast_ResultPlaneOptions:
    ...
    @property
    def result_surface_options(self: "CastSelf") -> "_2850.ResultSurfaceOptions":
        return self.__parent__._cast(_2850.ResultSurfaceOptions)
...
class ResultPlaneOptions(_2850.ResultSurfaceOptions):
    """ResultPlaneOptions
    ...
    @property
    def axis_for_plane_normal(self: "Self") -> "_1667.Axis":
    ...
    def axis_for_plane_normal(self: "Self", value: "_1667.Axis") -> None:
