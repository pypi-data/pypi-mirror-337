...
class HypoidGearSetStabilityAnalysis(_3990.AGMAGleasonConicalGearSetStabilityAnalysis):
    """HypoidGearSetStabilityAnalysis
    ...
    def agma_gleason_conical_gears_stability_analysis(
        self: "Self",
    ) -> "List[_4051.HypoidGearStabilityAnalysis]":
    ...
    def agma_gleason_conical_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_4049.HypoidGearMeshStabilityAnalysis]":
