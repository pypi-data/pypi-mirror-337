...
class _Cast_ResultsForOrderIncludingSurfaces:
    ...
    @property
    def results_for_order(self: "CastSelf") -> "_6133.ResultsForOrder":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _6133,
        )

        return self.__parent__._cast(_6133.ResultsForOrder)
...
class ResultsForOrderIncludingSurfaces(_6135.ResultsForOrderIncludingNodes):
    """ResultsForOrderIncludingSurfaces
    ...
    def fe_surfaces(
        self: "Self",
    ) -> "List[_6128.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]":
