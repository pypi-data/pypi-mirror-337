...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.fluid_film import _2317, _2318
...
class LoadedPadFluidFilmBearingResults(_2309.LoadedFluidFilmBearingResults):
    """LoadedPadFluidFilmBearingResults
