...
class MaterialPropertiesReporting(_0.APIBase):
    ...
    def class_(self: "Self", value: "_1357.MaterialPropertyClass") -> None:
    ...
    def elastic_modulus_components(
        self: "Self",
    ) -> "_286.ElasticModulusOrthotropicComponents":
    ...
    def poissons_ratio_components(
        self: "Self",
    ) -> "_299.PoissonRatioOrthotropicComponents":
    ...
    def shear_modulus_components(
        self: "Self",
    ) -> "_301.ShearModulusOrthotropicComponents":
    ...
    def thermal_expansion_coefficient_components(
        self: "Self",
    ) -> "_302.ThermalExpansionOrthotropicComponents":
