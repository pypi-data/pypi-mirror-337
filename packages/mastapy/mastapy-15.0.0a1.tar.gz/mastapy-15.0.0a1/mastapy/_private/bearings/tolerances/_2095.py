...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2074
...
class InterferenceTolerance(_2087.BearingConnectionComponent):
    """InterferenceTolerance
    ...
    @property
    def definition_option(self: "Self") -> "_2090.BearingToleranceDefinitionOptions":
    ...
    def mounting_point_surface_finish(
        self: "Self",
    ) -> "_2074.MountingPointSurfaceFinishes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2074", "MountingPointSurfaceFinishes"
        )(value)

    @mounting_point_surface_finish.setter
    @enforce_parameter_types
    def mounting_point_surface_finish(
        self: "Self", value: "_2074.MountingPointSurfaceFinishes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
