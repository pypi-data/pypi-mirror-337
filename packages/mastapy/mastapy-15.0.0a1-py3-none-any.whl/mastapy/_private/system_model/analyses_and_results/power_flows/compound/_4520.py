...
class WormGearCompoundPowerFlow(_4453.GearCompoundPowerFlow):
    """WormGearCompoundPowerFlow
    ...
    @property
    def gear_duty_cycle_rating(self: "Self") -> "_456.WormGearDutyCycleRating":
    ...
    @property
    def worm_gear_duty_cycle_rating(self: "Self") -> "_456.WormGearDutyCycleRating":
        """mastapy.gears.rating.worm.WormGearDutyCycleRating
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4390.WormGearPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4390.WormGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearPowerFlow]
