...
from mastapy._private.system_model.part_model.couplings import _2802
...
class EnumWithSelectedValue_RigidConnectorTypes(
    ...
    def wrapped_type(
        ...
        Returns:
            _2802.RigidConnectorTypes
        """
        return _2802.RigidConnectorTypes
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_RigidConnectorTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2802.RigidConnectorTypes.type_()

    @property
    def selected_value(self: "Self") -> "_2802.RigidConnectorTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_2802.RigidConnectorTypes]":
