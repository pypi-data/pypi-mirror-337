...
class WormGrindingProcessPitchCalculation(_790.WormGrindingProcessCalculation):
    """WormGrindingProcessPitchCalculation
    ...
    @property
    def pitch_modification_chart(self: "Self") -> "_2053.TwoDChartDefinition":
    ...
    @property
    def left_flank(self: "Self") -> "_757.CalculatePitchDeviationAccuracy":
    ...
    @property
    def right_flank(self: "Self") -> "_757.CalculatePitchDeviationAccuracy":
        """mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new.CalculatePitchDeviationAccuracy
