...
from mastapy._private.gears.manufacturing.cylindrical import _705
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutters import _816, _817
...
class _Cast_MutableCommon:
    ...
    @property
    def mutable_curve(self: "CastSelf") -> "_816.MutableCurve":
        from mastapy._private.gears.manufacturing.cylindrical.cutters import _816

        return self.__parent__._cast(_816.MutableCurve)

    @property
    def mutable_fillet(self: "CastSelf") -> "_817.MutableFillet":
        from mastapy._private.gears.manufacturing.cylindrical.cutters import _817

        return self.__parent__._cast(_817.MutableFillet)
...
class MutableCommon(_799.CurveInLinkedList):
    """MutableCommon
    ...
    @section.setter
    @enforce_parameter_types
    def section(self: "Self", value: "_705.CutterFlankSections") -> None:
