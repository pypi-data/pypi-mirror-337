...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2381, _2383
...
class PlainGreaseFilledJournalBearing(_2382.PlainJournalBearing):
    """PlainGreaseFilledJournalBearing
    ...
    def housing_type(
        self: "Self",
    ) -> "_2381.PlainGreaseFilledJournalBearingHousingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_designs.fluid_film._2381",
    ...
    def housing_type(
        self: "Self", value: "_2381.PlainGreaseFilledJournalBearingHousingType"
    ) -> None:
    ...
    @property
    def housing_detail(self: "Self") -> "_2383.PlainJournalHousing":
