...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _877, _879
...
class _Cast_ConicalMeshFlankMicroGeometryConfig:
    ...
    def conical_mesh_flank_manufacturing_config(
        ...
        from mastapy._private.gears.manufacturing.bevel import _877

        return self.__parent__._cast(_877.ConicalMeshFlankManufacturingConfig)
    ...
    def conical_mesh_flank_nurbs_micro_geometry_config(
        ...
        return self.__parent__._cast(_879.ConicalMeshFlankNURBSMicroGeometryConfig)
