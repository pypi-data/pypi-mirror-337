...
from mastapy._private.detailed_rigid_connectors.splines import _1570
...
class EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption]",
    ) -> "_1570.DudleyEffectiveLengthApproximationOption":
        ...
        Returns:
            _1570.DudleyEffectiveLengthApproximationOption
        """
        return _1570.DudleyEffectiveLengthApproximationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1570.DudleyEffectiveLengthApproximationOption.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1570.DudleyEffectiveLengthApproximationOption]":
