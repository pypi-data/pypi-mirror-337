...
T = TypeVar("T", bound="_2394.DesignEntity")
...
class _Cast_GenericClutchEngagementStatus:
    ...
    @property
    def clutch_engagement_status(self: "CastSelf") -> "_5915.ClutchEngagementStatus":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5915,
        )

        return self.__parent__._cast(_5915.ClutchEngagementStatus)
    ...
    def concept_synchro_gear_engagement_status(
        ...
        return self.__parent__._cast(_5916.ConceptSynchroGearEngagementStatus)
