...
class ConceptGearSetSystemDeflection(_2966.GearSetSystemDeflection):
    """ConceptGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4289.ConceptGearSetPowerFlow":
    ...
    def gears_system_deflection(
        self: "Self",
    ) -> "List[_2928.ConceptGearSystemDeflection]":
    ...
    def meshes_system_deflection(
        self: "Self",
    ) -> "List[_2926.ConceptGearMeshSystemDeflection]":
