...
class CylindricalGearCompoundSystemDeflection(_3118.GearCompoundSystemDeflection):
    """CylindricalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self: "Self") -> "_539.CylindricalGearDutyCycleRating":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2953.CylindricalGearSystemDeflectionWithLTCAResults]":
