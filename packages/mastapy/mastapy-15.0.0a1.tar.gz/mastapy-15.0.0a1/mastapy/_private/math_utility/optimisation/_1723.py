...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1721, _1722, _1725
...
class ParetoOptimisationStrategy(_2011.NamedDatabaseItem):
    """ParetoOptimisationStrategy
    ...
    def charts(
        self: "Self",
    ) -> "List[_1725.ParetoOptimisationStrategyChartInformation]":
    ...
    @property
    def inputs(self: "Self") -> "List[_1721.ParetoOptimisationInput]":
    ...
    @property
    def outputs(self: "Self") -> "List[_1722.ParetoOptimisationOutput]":
