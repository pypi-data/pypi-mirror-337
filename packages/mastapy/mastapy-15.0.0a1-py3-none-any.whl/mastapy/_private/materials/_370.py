...
T = TypeVar("T", bound="_1780.MeasurementBase")
...
class TemperatureDependentProperty(
    _1761.IndependentReportablePropertiesBase["TemperatureDependentProperty"[T]]
):
    """TemperatureDependentProperty
    ...
    @property
    def vs_temperature(self: "Self") -> "_1709.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def vs_temperature(self: "Self", value: "_1709.Vector2DListAccessor") -> None:
