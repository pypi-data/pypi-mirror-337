...
from pdldb import LocalLakeManager, S3BackupManager
...
@stopwatch
def generate_test_data(filename="synthetic_data_aws.parquet"):
...
if __name__ == "__main__":
    print("=== DELTA LAKE BACKUP AND RESTORE EXAMPLE ===")

    base_dir = "examples/example_data/s3_backup_delta_example"
    ...
    try:
        ...
        print("\n3. mirror Backup")
        backup_mgr = initialize_backup_manager()
        ...
        print("\n4. Restore mirror Backup Pre-Merge")
        ...
        print("\n8. Restore mirror Backup Post-Merge")
