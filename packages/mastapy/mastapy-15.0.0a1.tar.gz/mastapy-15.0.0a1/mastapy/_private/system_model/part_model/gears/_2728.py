...
from mastapy._private.gears import _405
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2727, _2744
...
class CylindricalGearSet(_2734.GearSet):
    """CylindricalGearSet
    ...
    def axial_contact_ratio_requirement(
        self: "Self",
        value: "Union[_405.ContactRatioRequirements, Tuple[_405.ContactRatioRequirements, bool]]",
    ) -> None:
    ...
    @property
    def active_gear_set_design(self: "Self") -> "_1131.CylindricalGearSetDesign":
    ...
    @property
    def cylindrical_gear_set_design(self: "Self") -> "_1131.CylindricalGearSetDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearSetDesign
    ...
    @property
    def supercharger_rotor_set(self: "Self") -> "_2766.SuperchargerRotorSet":
    ...
    @property
    def cylindrical_gears(self: "Self") -> "List[_2727.CylindricalGear]":
    ...
    @property
    def cylindrical_meshes(self: "Self") -> "List[_2500.CylindricalGearMesh]":
    ...
    @property
    def gear_set_designs(self: "Self") -> "List[_1131.CylindricalGearSetDesign]":
    ...
    def add_gear(self: "Self") -> "_2727.CylindricalGear":
