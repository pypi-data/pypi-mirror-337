classdef  GenDM < casadi.GenericMatrixCommon & casadi.SparsityInterfaceCommon
  ...
  methods
    ...
    %
    %
      out = casadiMEX(298, self, varargin{:});
      if nargout<=1
        varargout{1}=out;
      else
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(311, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(312, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(313, varargin{:});
    end
  end
end
