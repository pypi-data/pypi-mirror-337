...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.zerol_bevel import _1049, _1050
...
class ZerolBevelGearSetDesign(_1295.BevelGearSetDesign):
    """ZerolBevelGearSetDesign
    ...
    @property
    def tooth_taper_zerol(self: "Self") -> "_435.ZerolBevelGleasonToothTaperOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._435", "ZerolBevelGleasonToothTaperOption"
        )(value)

    @tooth_taper_zerol.setter
    @enforce_parameter_types
    def tooth_taper_zerol(
        self: "Self", value: "_435.ZerolBevelGleasonToothTaperOption"
    ) -> None:
    ...
    @property
    def gears(self: "Self") -> "List[_1049.ZerolBevelGearDesign]":
    ...
    @property
    def zerol_bevel_meshes(self: "Self") -> "List[_1050.ZerolBevelGearMeshDesign]":
