    ...
    def make_instance(self, include_optional) -> V0042OpenapiReservationResp:
        ...
        if include_optional:
            return V0042OpenapiReservationResp(
                reservations = [
                    slurmrestpy.models.v0/0/42_reservation_info.v0.0.42_reservation_info(
                        accounts = '',
                        burst_buffer = '',
                        core_count = 56,
                        core_specializations = [
                            slurmrestpy.models.v0/0/42_reservation_core_spec.v0.0.42_reservation_core_spec(
                                node = '',
                                core = '', )
                            ],
                        ...
                        node_list = '',
                        partition = '',
                        purge_completed = slurmrestpy.models.v0_0_42_reservation_info_purge_completed.v0_0_42_reservation_info_purge_completed(
                        ...
                        start_time = slurmrestpy.models.v0/0/42_uint64_no_val_struct.v0.0.42_uint64_no_val_struct(
                            ...
                            infinite = True,
                            number = 56, ),
                        watts = slurmrestpy.models.v0/0/42_uint32_no_val_struct.v0.0.42_uint32_no_val_struct(
                            set = True,
                            infinite = True,
                            number = 56, ),
                        tres = '',
