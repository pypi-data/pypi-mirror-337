...
class V0040StatsRec(BaseModel):
    ...
    rollups: Optional[List[V0040RollupStatsInner]] = Field(
        default=None, description="list of recorded rollup statistics"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "rollups": [
                    V0040RollupStatsInner.from_dict(_item) for _item in obj["rollups"]
                ]
                if obj.get("rollups") is not None
                else None,
                "RPCs": [V0040StatsRpc.from_dict(_item) for _item in obj["RPCs"]]
                if obj.get("RPCs") is not None
                else None,
                "users": [V0040StatsUser.from_dict(_item) for _item in obj["users"]]
