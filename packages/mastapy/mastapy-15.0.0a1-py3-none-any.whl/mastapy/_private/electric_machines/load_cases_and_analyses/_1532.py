...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1499
...
class ElectricMachineFEMechanicalAnalysis(_1527.ElectricMachineAnalysis):
    """ElectricMachineFEMechanicalAnalysis
    ...
    def electric_machine_mechanical_results(
        self: "Self",
    ) -> "_1499.ElectricMachineMechanicalResults":
    ...
    @property
    def load_case(self: "Self") -> "_1536.ElectricMachineMechanicalLoadCase":
