...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1101, _1102
...
class _Cast_CrossedAxisCylindricalGearPair:
    ...
    def crossed_axis_cylindrical_gear_pair_line_contact(
        self: "CastSelf",
    ) -> "_1101.CrossedAxisCylindricalGearPairLineContact":
        from mastapy._private.gears.gear_designs.cylindrical import _1101

        return self.__parent__._cast(_1101.CrossedAxisCylindricalGearPairLineContact)

    @property
    def crossed_axis_cylindrical_gear_pair_point_contact(
        self: "CastSelf",
    ) -> "_1102.CrossedAxisCylindricalGearPairPointContact":
        from mastapy._private.gears.gear_designs.cylindrical import _1102

        return self.__parent__._cast(_1102.CrossedAxisCylindricalGearPairPointContact)
...
class CrossedAxisCylindricalGearPair(_0.APIBase):
    ...
    @property
    def shaver(self: "Self") -> "_828.CylindricalCutterSimulatableGear":
