...
from mastapy._private.utility_gui.charts import _2039
...
class _Cast_ModeConstantLine:
    ...
    @property
    def constant_line(self: "CastSelf") -> "_2039.ConstantLine":
        return self.__parent__._cast(_2039.ConstantLine)
...
class ModeConstantLine(_2039.ConstantLine):
    """ModeConstantLine
