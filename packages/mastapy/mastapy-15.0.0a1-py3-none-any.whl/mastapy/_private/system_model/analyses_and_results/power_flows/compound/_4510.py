...
class SynchroniserCompoundPowerFlow(_4495.SpecialisedAssemblyCompoundPowerFlow):
    """SynchroniserCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2813.Synchroniser":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4380.SynchroniserPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4380.SynchroniserPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SynchroniserPowerFlow]
