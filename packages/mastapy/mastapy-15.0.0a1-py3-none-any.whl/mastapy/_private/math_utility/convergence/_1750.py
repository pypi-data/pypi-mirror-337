...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.convergence import _1749
...
class _Cast_DataLogger:
    ...
    @property
    def convergence_logger(self: "CastSelf") -> "_1749.ConvergenceLogger":
        from mastapy._private.math_utility.convergence import _1749

        return self.__parent__._cast(_1749.ConvergenceLogger)

    @property
    def data_logger_with_charts(self: "CastSelf") -> "_2036.DataLoggerWithCharts":
        from mastapy._private.utility_gui import _2036

        return self.__parent__._cast(_2036.DataLoggerWithCharts)
