...
class FaceGearMeshCompoundPowerFlow(_4454.GearMeshCompoundPowerFlow):
    """FaceGearMeshCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2502.FaceGearMesh":
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4312.FaceGearMeshPowerFlow]":
    ...
    @property
    def connection_analysis_cases(self: "Self") -> "List[_4312.FaceGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearMeshPowerFlow]
