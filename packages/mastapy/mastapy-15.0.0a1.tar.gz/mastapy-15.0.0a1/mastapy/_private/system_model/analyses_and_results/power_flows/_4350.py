...
class PowerFlow(_7850.StaticLoadAnalysisCase):
    """PowerFlow
    ...
    @property
    def torsional_system_deflection(self: "Self") -> "_3040.TorsionalSystemDeflection":
