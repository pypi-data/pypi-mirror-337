classdef  MX < casadi.GenericExpressionCommon & casadi.PrintableCommon & casadi.GenMX & casadi.SharedObject
  ...
  methods
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(711, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(712, varargin{:});
    end
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(637, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(681, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(701, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(702, varargin{:});
    end
