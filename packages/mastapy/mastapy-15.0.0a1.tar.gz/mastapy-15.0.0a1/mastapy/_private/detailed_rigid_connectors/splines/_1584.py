...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.splines import _1571, _1591
...
class SAESplineJointDesign(_1596.StandardSplineJointDesign):
    """SAESplineJointDesign
    ...
    @property
    def fit_type(self: "Self") -> "_1571.FitTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.detailed_rigid_connectors.splines._1571", "FitTypes"
        )(value)

    @fit_type.setter
    @enforce_parameter_types
    def fit_type(self: "Self", value: "_1571.FitTypes") -> None:
