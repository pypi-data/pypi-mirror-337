...
class EnumWithSelectedValue_ThreeDViewContourOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _2002.ThreeDViewContourOption
        """
        return _2002.ThreeDViewContourOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2002.ThreeDViewContourOption.type_()

    @property
    def selected_value(self: "Self") -> "_2002.ThreeDViewContourOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2002.ThreeDViewContourOption]":
