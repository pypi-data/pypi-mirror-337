...
class FaceGearCompoundModalAnalysis(_5023.GearCompoundModalAnalysis):
    """FaceGearCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4865.FaceGearModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4865.FaceGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearModalAnalysis]
