...
from .base import AgentforceBase
from ..models.agent import Agent
from ..models.topic import Topic
from ..models.action import Action, Input, Output
from ..exceptions import MetadataDeploymentError, AgentforceApiError, AgentforceAuthError, ValidationError
from ..config import Config
from .deploy_tools.generate_metadata import generate_agent_metadata, MetadataGenerator
from .deploy_tools.deploy_zipfile import deploy_and_monitor
...
class Agentforce(AgentforceBase):
    ...
    DEFAULT_POLLING_MAX_RETRIES = Config.POLLING_MAX_RETRIES
