...
from mastapy._private.bearings.bearing_results.rolling.iso_rating_results import _2296
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling.abma import _2305, _2306
...
class _Cast_ANSIABMAResults:
    ...
    @property
    def iso_results(self: "CastSelf") -> "_2296.ISOResults":
        return self.__parent__._cast(_2296.ISOResults)
...
class ANSIABMAResults(_2296.ISOResults):
    """ANSIABMAResults
