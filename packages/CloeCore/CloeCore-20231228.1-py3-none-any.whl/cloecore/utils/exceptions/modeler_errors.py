...
class ModelerError:
    def __init__(self) -> None:
        self.power_pipe_error: list[PowerPipeError | ValidationError] = []
        self.simple_pipe_error: list[SimplePipeError | ValidationError] = []
            ...
            if attribute == "power_pipe_error":
                if any(
                    [
                        ...
                        if isinstance(pipe, PowerPipeError)
                    ]
                ):
                    return True
                ...
                if any(
                    [
                        ...
                        if isinstance(pipe, SimplePipeError)
                    ]
                ):
                    return True
            else:
