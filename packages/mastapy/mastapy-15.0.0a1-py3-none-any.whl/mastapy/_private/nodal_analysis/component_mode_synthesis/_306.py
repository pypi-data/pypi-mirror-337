...
class CMSModel(_0.APIBase):
    ...
    def software_used_for_reduction(
        self: "Self",
    ) -> "_315.SoftwareUsedForReductionType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.component_mode_synthesis._315",
    ...
    @property
    def fe_model(self: "Self") -> "_263.FEModel":
    ...
    @property
    def reduction_information(self: "Self") -> "_1753.AnalysisRunInformation":
    ...
    @property
    def reduction_options(self: "Self") -> "_308.CMSOptions":
    ...
    @property
    def element_face_groups(self: "Self") -> "List[_304.CMSElementFaceGroup]":
