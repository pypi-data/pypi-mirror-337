...
class TiffAnalysisSettings(
    _1761.IndependentReportablePropertiesBase["TiffAnalysisSettings"]
):
    """TiffAnalysisSettings
    ...
    @property
    def core_material_properties(self: "Self") -> "_1154.HardenedMaterialProperties":
    ...
    @property
    def surface_material_properties(self: "Self") -> "_1154.HardenedMaterialProperties":
        """mastapy.gears.gear_designs.cylindrical.HardenedMaterialProperties
