...
class V0042QosLimitsMaxJobs(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "count": V0042Uint32NoValStruct.from_dict(obj["count"])
                if obj.get("count") is not None
                else None,
                "active_jobs": V0042QosLimitsMaxJobsActiveJobs.from_dict(
                    obj["active_jobs"]
                )
                if obj.get("active_jobs") is not None
                else None,
                "per": V0042QosLimitsMaxJobsActiveJobsPer.from_dict(obj["per"])
