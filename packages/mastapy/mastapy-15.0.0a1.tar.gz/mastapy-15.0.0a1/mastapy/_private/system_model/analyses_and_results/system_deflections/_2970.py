...
class HypoidGearSetSystemDeflection(_2896.AGMAGleasonConicalGearSetSystemDeflection):
    """HypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4325.HypoidGearSetPowerFlow":
    ...
    def agma_gleason_conical_gears_system_deflection(
        self: "Self",
    ) -> "List[_2971.HypoidGearSystemDeflection]":
