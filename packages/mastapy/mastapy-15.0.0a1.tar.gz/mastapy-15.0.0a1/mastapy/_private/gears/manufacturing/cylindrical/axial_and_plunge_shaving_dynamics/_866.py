...
from mastapy._private.gears.gear_designs.cylindrical import _1185
...
class _Cast_ShavingDynamicsViewModel:
    ...
    def gear_manufacturing_configuration_view_model(
        self: "CastSelf",
    ) -> "_724.GearManufacturingConfigurationViewModel":
        from mastapy._private.gears.manufacturing.cylindrical import _724

        return self.__parent__._cast(_724.GearManufacturingConfigurationViewModel)
...
class ShavingDynamicsViewModel(_867.ShavingDynamicsViewModelBase, Generic[T]):
    """ShavingDynamicsViewModel
    ...
    def active_profile_range_calculation_source(
        self: "Self",
    ) -> "_845.ActiveProfileRangeCalculationSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics._845",
    ...
    def active_profile_range_calculation_source(
        self: "Self", value: "_845.ActiveProfileRangeCalculationSource"
    ) -> None:
    ...
    @property
    def redressing_chart(self: "Self") -> "_2053.TwoDChartDefinition":
    ...
    @enforce_parameter_types
    def selected_measurement_method(self: "Self", value: "_1185.ThicknessType") -> None:
    ...
    @property
    def calculation(self: "Self") -> "_862.ShavingDynamicsCalculation[T]":
