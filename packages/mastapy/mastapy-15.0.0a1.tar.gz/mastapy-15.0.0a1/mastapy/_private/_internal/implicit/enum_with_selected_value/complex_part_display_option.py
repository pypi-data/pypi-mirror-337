...
from mastapy._private.math_utility import _1670
...
class EnumWithSelectedValue_ComplexPartDisplayOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ComplexPartDisplayOption]",
    ) -> "_1670.ComplexPartDisplayOption":
        ...
        Returns:
            _1670.ComplexPartDisplayOption
        """
        return _1670.ComplexPartDisplayOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1670.ComplexPartDisplayOption.type_()

    @property
    def selected_value(self: "Self") -> "_1670.ComplexPartDisplayOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1670.ComplexPartDisplayOption]":
