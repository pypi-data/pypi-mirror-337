...
class DataExportServiceTest(TestCase):
    ...
    def test_echo_data_exports(self, click_mock):
        ...
        click_mock.echo.assert_called_once_with(
            "Data Export (Name)           Description\nAll monitors (ALL_MONITORS)  "
            "All monitors with aggregated properties, excluding deleted monitors.\n"
            "All assets (ALL_ASSETS)      All assets with aggregated properties, excluding deleted assets.\n"
            "All alerts (ALL_ALERTS)      All alerts in the last 90 days with aggregated properties.\n"
            "All events (ALL_EVENTS)      All events in the last 90 days with aggregated properties."
        )
