# Author: Yu-Xin Tian, 2025-04-01 Version 2.1.0
...
def makefig():
    ...
    # 初始化主窗口
    root = tk.Tk()
    root.title("EasyFig仿真绘图向导 V2.1.0 - 作者：东北大学 田雨鑫博士 - 让天下没有难用的工具！")
    ...
    def save_code():
        ...
        try:
            file_path = filedialog.asksaveasfilename(defaultextension=".py",
                                                     filetypes=[("Python Files", "*.py"), ("Double-click Python", "*.pyw"), ("Text Files", "*.txt")])
            if file_path:
