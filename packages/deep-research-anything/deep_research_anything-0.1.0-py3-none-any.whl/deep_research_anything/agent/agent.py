...
class ExecutionResult:
    def __init__(self, agent_code, status="success", result=None, message="", ext=None):
    ...
    @classmethod
    def error(cls, agent_code: str, message: str, ext: object = None) -> object:
        return cls(agent_code=agent_code, status="error", message=message, ext=ext)

    @classmethod
    def success(cls, agent_code, result=None, message="", ext=None):
        return cls(
...
class Agent:
    ...
    async def _execute(self, agent_args: AgentArgs):
        ...
        return ExecutionResult.success(
            agent_code=self.code, message="Agent executed successfully"
        )
