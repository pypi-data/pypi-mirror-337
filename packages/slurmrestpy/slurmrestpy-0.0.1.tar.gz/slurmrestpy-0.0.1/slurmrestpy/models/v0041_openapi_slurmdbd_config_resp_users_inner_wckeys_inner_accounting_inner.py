...
class V0041OpenapiSlurmdbdConfigRespUsersInnerWckeysInnerAccountingInner(BaseModel):
    ...
    start: Optional[StrictInt] = Field(
        default=None, description="When the record was started"
    )
    tres: Optional[
        V0041OpenapiSlurmdbdConfigRespUsersInnerWckeysInnerAccountingInnerTRES
    ] = Field(default=None, alias="TRES")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "allocated": V0040AccountingAllocated.from_dict(obj["allocated"])
                if obj.get("allocated") is not None
                else None,
                "id": obj.get("id"),
                "start": obj.get("start"),
                "TRES": V0041OpenapiSlurmdbdConfigRespUsersInnerWckeysInnerAccountingInnerTRES.from_dict(
                    obj["TRES"]
                )
