...
class FlightCollectionUpdate(BaseModel):
    """
    FlightCollectionUpdate
    """ # noqa: E501
    ...
    flight: Optional[List[StrictInt]] = None
    __properties: ClassVar[List[str]] = ["name", "description", "private", "flight"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FlightCollectionUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FlightCollectionUpdate from a dict"""
        if obj is None:
            return None
