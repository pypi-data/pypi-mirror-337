...
if __name__ == '__main__':
    ...
    configs = {
        ...
        "openai": {
            ...
            "api_key": "sk-p9ufUGxEltT2UFA1ywI9VJkhJKD9ScF15qWPIlbxXYTAUrJ1"
        }
    }
    ...
    results = agent.generate(messages_list)
    print("output list", results)

    results = agent.generate("Hello, how are you?")
    print(results)

    results = agent.generate(["Hello, how are you?", "I'm doing great, how about you?"])
    print(results)

    results = agent.generate([{"role": "user", "content": "Hello, how are you?"}])
    print(results)
