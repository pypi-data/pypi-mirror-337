...
from mastapy._private.electric_machines.load_cases_and_analyses import _1521, _1547
...
class _Cast_DynamicForceLoadCase:
    ...
    def electric_machine_load_case_base(
        self: "CastSelf",
    ) -> "_1534.ElectricMachineLoadCaseBase":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1534

        return self.__parent__._cast(_1534.ElectricMachineLoadCaseBase)
...
class DynamicForceLoadCase(_1521.BasicDynamicForceLoadCase):
    """DynamicForceLoadCase
    ...
    @property
    def control_strategy(self: "Self") -> "_1529.ElectricMachineControlStrategy":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines.load_cases_and_analyses._1529",
    ...
    def control_strategy(
        self: "Self", value: "_1529.ElectricMachineControlStrategy"
    ) -> None:
    ...
    @enforce_parameter_types
    def load_specification(self: "Self", value: "_1547.SpecifyTorqueOrCurrent") -> None:
    ...
    def operating_points_specification_method(
        self: "Self",
    ) -> "_1544.OperatingPointsSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines.load_cases_and_analyses._1544",
    ...
    @enforce_parameter_types
    def operating_points_specification_method(
        self: "Self", value: "_1544.OperatingPointsSpecificationMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.OperatingPointsSpecificationMethod",
    ...
    @property
    def speed_points_distribution(self: "Self") -> "_1548.SpeedPointsDistribution":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines.load_cases_and_analyses._1548",
    ...
    def speed_points_distribution(
        self: "Self", value: "_1548.SpeedPointsDistribution"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.SpeedPointsDistribution",
    ...
    def basic_mechanical_loss_settings(
        self: "Self",
    ) -> "_1528.ElectricMachineBasicMechanicalLossSettings":
    ...
    ) -> "_1524.DynamicForcesOperatingPoint":
