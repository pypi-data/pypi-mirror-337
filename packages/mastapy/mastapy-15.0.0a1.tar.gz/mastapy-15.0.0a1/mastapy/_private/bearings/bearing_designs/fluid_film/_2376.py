...
from mastapy._private.bearings.bearing_designs.fluid_film import _2383
...
class _Cast_CylindricalHousingJournalBearing:
    ...
    @property
    def plain_journal_housing(self: "CastSelf") -> "_2383.PlainJournalHousing":
        return self.__parent__._cast(_2383.PlainJournalHousing)
...
class CylindricalHousingJournalBearing(_2383.PlainJournalHousing):
    """CylindricalHousingJournalBearing
