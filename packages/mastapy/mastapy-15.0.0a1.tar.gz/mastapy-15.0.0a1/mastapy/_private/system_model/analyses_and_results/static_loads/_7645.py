...
class AssemblyLoadCase(_7633.AbstractAssemblyLoadCase):
    """AssemblyLoadCase
    ...
    @property
    def bearings(self: "Self") -> "List[_7646.BearingLoadCase]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_7648.BeltDriveLoadCase]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_7651.BevelDifferentialGearSetLoadCase]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_7657.BoltedJointLoadCase]":
    ...
    @property
    def bolts(self: "Self") -> "List[_7658.BoltLoadCase]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_7682.CVTLoadCase]":
    ...
    @property
    def clutch_connections(self: "Self") -> "List[_7659.ClutchConnectionLoadCase]":
    ...
    @property
    def clutches(self: "Self") -> "List[_7661.ClutchLoadCase]":
    ...
    @property
    def concept_couplings(self: "Self") -> "List[_7667.ConceptCouplingLoadCase]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_7670.ConceptGearSetLoadCase]":
    ...
    @property
    def cycloidal_assemblies(self: "Self") -> "List[_7684.CycloidalAssemblyLoadCase]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_7686.CycloidalDiscLoadCase]":
    ...
    @property
    def cylindrical_gear_sets(self: "Self") -> "List[_7692.CylindricalGearSetLoadCase]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_7714.FEPartLoadCase]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_7713.FaceGearSetLoadCase]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_7715.FlexiblePinAssemblyLoadCase]":
    ...
    @property
    def gear_meshes(self: "Self") -> "List[_7719.GearMeshLoadCase]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_7734.HypoidGearSetLoadCase]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_7744.KlingelnbergCycloPalloidHypoidGearSetLoadCase]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7747.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_7748.MassDiscLoadCase]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_7749.MeasurementComponentLoadCase]":
    ...
    @property
    def microphones(self: "Self") -> "List[_7752.MicrophoneLoadCase]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_7755.OilSealLoadCase]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_7760.PartToPartShearCouplingLoadCase]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_7764.PlanetCarrierLoadCase]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_7767.PointLoadLoadCase]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_7772.RingPinsLoadCase]":
    ...
    def ring_pins_to_cycloidal_disc_connections(
        self: "Self",
    ) -> "List[_7773.RingPinsToDiscConnectionLoadCase]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_7774.RollingRingAssemblyLoadCase]":
    ...
    @property
    def shaft_hub_connections(self: "Self") -> "List[_7778.ShaftHubConnectionLoadCase]":
    ...
    @property
    def shafts(self: "Self") -> "List[_7779.ShaftLoadCase]":
    ...
    def shafts_and_housings(
        self: "Self",
    ) -> "List[_7635.AbstractShaftOrHousingLoadCase]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7784.SpiralBevelGearSetLoadCase]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_7787.SpringDamperLoadCase]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_7790.StraightBevelDiffGearSetLoadCase]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7793.StraightBevelGearSetLoadCase]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_7797.SynchroniserLoadCase]":
    ...
    @property
    def torque_converters(self: "Self") -> "List[_7803.TorqueConverterLoadCase]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_7810.UnbalancedMassLoadCase]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_7814.WormGearSetLoadCase]":
    ...
    @property
    def zerol_bevel_gear_sets(self: "Self") -> "List[_7817.ZerolBevelGearSetLoadCase]":
