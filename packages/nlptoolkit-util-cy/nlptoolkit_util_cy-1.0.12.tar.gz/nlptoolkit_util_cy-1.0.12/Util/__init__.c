...
#define __Pyx_MODULE_NAME "Util.__init__"
extern int __pyx_module_is_main_Util____init__;
int __pyx_module_is_main_Util____init__ = 0;
...
static const char __pyx_k_Util___init[] = "Util.__init__";
...
typedef struct {
  ...
  #endif
  PyObject *__pyx_n_s_;
  PyObject *__pyx_kp_u_Util___init;
...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_kp_u_Util___init);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_kp_u_Util___init);
...
#define __pyx_kp_u_Util___init __pyx_mstate_global->__pyx_kp_u_Util___init
...
static int __Pyx_CreateStringTabAndInitStrings(void) {
  __Pyx_StringTabEntry __pyx_string_tab[] = {
    ...
    {&__pyx_kp_u_Util___init, __pyx_k_Util___init, sizeof(__pyx_k_Util___init), 0, 1, 0, 0},
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_Util____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_kp_u_Util___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
