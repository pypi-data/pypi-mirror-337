...
class RootAssemblyCompoundParametricStudyTool(
    ...
    @property
    def compound_load_case(self: "Self") -> "_5913.AbstractLoadCaseGroup":
    ...
    def results_for_reporting(
        self: "Self",
    ) -> "_4622.ParametricStudyToolResultsForReporting":
    ...
    def root_assembly_duty_cycle_results(
        self: "Self",
    ) -> "_3111.DutyCycleEfficiencyResults":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4641.RootAssemblyParametricStudyTool]":
