...
class HypoidGearMesh(_2490.AGMAGleasonConicalGearMesh):
    """HypoidGearMesh
    ...
    @property
    def active_gear_mesh_design(self: "Self") -> "_1083.HypoidGearMeshDesign":
    ...
    @property
    def hypoid_gear_mesh_design(self: "Self") -> "_1083.HypoidGearMeshDesign":
        """mastapy.gears.gear_designs.hypoid.HypoidGearMeshDesign
