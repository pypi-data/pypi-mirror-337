...
class IncomeListRequest(BaseSchema):
    ...
    type: StatementType = Field(..., description="The type of statement for the request.")
...
class ComprehensiveGrowthGetRequest(BaseSchema):
    symbol: str = Field(..., description="The stock symbol for the request.")

class ComprehensiveGrowthGetResponse(ComprehensiveGrowth):
    pass
