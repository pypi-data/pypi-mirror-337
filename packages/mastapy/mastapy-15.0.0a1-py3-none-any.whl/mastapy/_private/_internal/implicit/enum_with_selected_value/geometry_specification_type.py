...
class EnumWithSelectedValue_GeometrySpecificationType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_GeometrySpecificationType]",
    ) -> "_1153.GeometrySpecificationType":
        ...
        Returns:
            _1153.GeometrySpecificationType
        """
        return _1153.GeometrySpecificationType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1153.GeometrySpecificationType.type_()

    @property
    def selected_value(self: "Self") -> "_1153.GeometrySpecificationType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1153.GeometrySpecificationType]":
