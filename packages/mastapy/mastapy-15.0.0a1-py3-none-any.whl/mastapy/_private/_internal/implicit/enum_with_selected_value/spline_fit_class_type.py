...
from mastapy._private.detailed_rigid_connectors.splines import _1588
...
class EnumWithSelectedValue_SplineFitClassType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1588.SplineFitClassType
        """
        return _1588.SplineFitClassType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_SplineFitClassType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1588.SplineFitClassType.type_()

    @property
    def selected_value(self: "Self") -> "_1588.SplineFitClassType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1588.SplineFitClassType]":
