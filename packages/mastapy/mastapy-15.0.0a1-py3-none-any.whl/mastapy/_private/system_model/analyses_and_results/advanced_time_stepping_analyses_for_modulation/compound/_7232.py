...
class BevelDifferentialGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    def assembly_analysis_cases_ready(
        ...
        "List[_7100.BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation]"
    ):
    ...
    def bevel_differential_gears_compound_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7230.BevelDifferentialGearCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def bevel_differential_meshes_compound_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7231.BevelDifferentialGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]":
