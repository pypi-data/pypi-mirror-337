...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.worm import _458, _459
...
class WormGearDutyCycleRating(_441.GearDutyCycleRating):
    """WormGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self: "Self") -> "_459.WormGearSetDutyCycleRating":
