...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1117, _1188
    from mastapy._private.gears.rating.cylindrical import _538, _562
...
class GearSetDesignGroup(_0.APIBase):
    ...
    def default_rough_toleranced_metal_measurement(
        self: "Self",
    ) -> "_1188.TolerancedMetalMeasurements":
    ...
    @enforce_parameter_types
    def default_rough_toleranced_metal_measurement(
        self: "Self", value: "_1188.TolerancedMetalMeasurements"
    ) -> None:
    ...
    @enforce_parameter_types
    def micro_geometry_model_for_simple_mesh_stiffness(
        self: "Self", value: "_420.MicroGeometryModel"
    ) -> None:
    ...
    def general_transmission_properties(
        self: "Self",
    ) -> "_339.GeneralTransmissionProperties":
    ...
    @property
    def settings(self: "Self") -> "_538.CylindricalGearDesignAndRatingSettingsItem":
