...
from mastapy._private.detailed_rigid_connectors.splines import _1580
...
class EnumWithSelectedValue_PressureAngleTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1580.PressureAngleTypes
        """
        return _1580.PressureAngleTypes
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_PressureAngleTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1580.PressureAngleTypes.type_()

    @property
    def selected_value(self: "Self") -> "_1580.PressureAngleTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_1580.PressureAngleTypes]":
