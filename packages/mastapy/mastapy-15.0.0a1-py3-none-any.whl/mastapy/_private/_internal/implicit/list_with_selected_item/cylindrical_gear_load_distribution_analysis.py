...
class ListWithSelectedItem_CylindricalGearLoadDistributionAnalysis(
    _952.CylindricalGearLoadDistributionAnalysis, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _952.CylindricalGearLoadDistributionAnalysis.TYPE

    @property
    def selected_value(self: "Self") -> "_952.CylindricalGearLoadDistributionAnalysis":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_952.CylindricalGearLoadDistributionAnalysis]":
