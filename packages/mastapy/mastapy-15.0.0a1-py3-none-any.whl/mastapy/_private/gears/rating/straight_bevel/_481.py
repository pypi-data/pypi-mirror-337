...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.straight_bevel import _479, _480
...
class StraightBevelGearSetRating(_640.BevelGearSetRating):
    """StraightBevelGearSetRating
    ...
    def straight_bevel_mesh_ratings(
        self: "Self",
    ) -> "List[_479.StraightBevelGearMeshRating]":
