...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _887, _888
...
class ConicalSetMicroGeometryConfigBase(_1344.GearSetImplementationDetail):
    """ConicalSetMicroGeometryConfigBase
    ...
    @enforce_parameter_types
    def contact_chart_results_type(
        self: "Self", value: "_923.ContactResultType"
    ) -> None:
    ...
    def deflection_from_bending_option(
        self: "Self",
    ) -> "_408.DeflectionFromBendingOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._408", "DeflectionFromBendingOption"
        )(value)

    @deflection_from_bending_option.setter
    @enforce_parameter_types
    def deflection_from_bending_option(
        self: "Self", value: "_408.DeflectionFromBendingOption"
    ) -> None:
