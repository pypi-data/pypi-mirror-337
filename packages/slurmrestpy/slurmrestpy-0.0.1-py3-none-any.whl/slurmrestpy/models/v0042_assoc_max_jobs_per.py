        ...
        _obj = cls.model_validate(
            {
                ...
                "accruing": V0042Uint32NoValStruct.from_dict(obj["accruing"])
                if obj.get("accruing") is not None
                else None,
                "submitted": V0042Uint32NoValStruct.from_dict(obj["submitted"])
                if obj.get("submitted") is not None
                else None,
                "wall_clock": V0042Uint32NoValStruct.from_dict(obj["wall_clock"])
