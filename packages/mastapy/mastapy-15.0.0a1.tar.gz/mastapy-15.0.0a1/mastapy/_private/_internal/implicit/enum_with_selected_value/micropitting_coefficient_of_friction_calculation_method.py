...
class EnumWithSelectedValue_MicropittingCoefficientOfFrictionCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_MicropittingCoefficientOfFrictionCalculationMethod]",
    ) -> "_421.MicropittingCoefficientOfFrictionCalculationMethod":
        ...
        Returns:
            _421.MicropittingCoefficientOfFrictionCalculationMethod
        """
        return _421.MicropittingCoefficientOfFrictionCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _421.MicropittingCoefficientOfFrictionCalculationMethod.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_421.MicropittingCoefficientOfFrictionCalculationMethod]":
