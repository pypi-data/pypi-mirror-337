...
class ContextLogger:
    ...
    def _log_with_context(self, level, msg, connection_id=None, statement_id=None, source_object=None):
        """
    ...
    def debug(self, msg, connection_id=None, statement_id=None, source_object=None):
        """
        Debug level logging
        """

        self._log_with_context(logging.DEBUG, msg, connection_id=connection_id, statement_id=statement_id, source_object=source_object)

    def info(self, msg, connection_id=None, statement_id=None, source_object=None):
        """
        Info level logging
        """

        self._log_with_context(logging.INFO, msg, connection_id=connection_id, statement_id=statement_id, source_object=source_object)

    def warning(self, msg, connection_id=None, statement_id=None, source_object=None):
        """
        Warning level logging
        """

        self._log_with_context(logging.WARNING, msg, connection_id=connection_id, statement_id=statement_id, source_object=source_object)

    def error(self, msg, connection_id=None, statement_id=None, source_object=None):
        """
        Error level logging
        """

        self._log_with_context(logging.ERROR, msg, connection_id=connection_id, statement_id=statement_id, source_object=source_object)
