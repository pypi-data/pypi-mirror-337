...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _875, _891
...
class ConicalMeshManufacturingAnalysis(_1336.GearMeshImplementationAnalysis):
    """ConicalMeshManufacturingAnalysis
    ...
    @property
    def tca(self: "Self") -> "_891.EaseOffBasedTCA":
    ...
    def meshed_gears(
        self: "Self",
    ) -> "List[_875.ConicalMeshedGearManufacturingAnalysis]":
