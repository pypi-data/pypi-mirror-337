...
class WormGearMeshSystemDeflection(_2965.GearMeshSystemDeflection):
    """WormGearMeshSystemDeflection
    ...
    @property
    def rating(self: "Self") -> "_457.WormGearMeshRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_457.WormGearMeshRating":
        """mastapy.gears.rating.worm.WormGearMeshRating
    ...
    @property
    def power_flow_results(self: "Self") -> "_4389.WormGearMeshPowerFlow":
