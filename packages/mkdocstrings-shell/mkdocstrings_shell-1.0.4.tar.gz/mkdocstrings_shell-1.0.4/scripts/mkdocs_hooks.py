# Generate a JSON schema of the Shell handler configuration.
...
from mkdocstrings_handlers.shell._internal.config import ShellInputConfig, ShellInputOptions
...
def on_post_build(config: MkDocsConfig, **kwargs: Any) -> None:  # noqa: ARG001
    ...
    @dataclass
    class ShellHandlerSchema:
        shell: ShellInputConfig

    adapter = TypeAdapter(ShellHandlerSchema)
