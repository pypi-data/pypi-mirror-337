...
class _Cast_ShavingDynamicsCalculationForDesignedGears:
    ...
    def shaving_dynamics_calculation(
        self: "CastSelf",
    ) -> "_862.ShavingDynamicsCalculation":
        return self.__parent__._cast(_862.ShavingDynamicsCalculation)
...
class ShavingDynamicsCalculationForDesignedGears(_862.ShavingDynamicsCalculation[T]):
    """ShavingDynamicsCalculationForDesignedGears
    ...
    @property
    def redressing(self: "Self") -> "_860.ShaverRedressing[T]":
