...
class _Cast_BaseFEWithSelection:
    ...
    def race_bearing_fe_with_selection(
        self: "CastSelf",
    ) -> "_2603.RaceBearingFEWithSelection":
        from mastapy._private.system_model.fe import _2603

        return self.__parent__._cast(_2603.RaceBearingFEWithSelection)
...
class BaseFEWithSelection(_0.APIBase):
    ...
    @property
    def component_draw_style(self: "Self") -> "_264.FEModelComponentDrawStyle":
    ...
    @property
    def draw_style(self: "Self") -> "_256.DrawStyleForFE":
    ...
    @property
    def node_selection(self: "Self") -> "_273.FENodeSelectionDrawStyle":
    ...
    @property
    def transparency_draw_style(self: "Self") -> "_272.FEModelTransparencyDrawStyle":
    ...
    def select_component(self: "Self", component: "_2639.Component") -> None:
