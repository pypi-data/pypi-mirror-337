...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials.efficiency import _378, _380
...
class _Cast_PowerLoss:
    ...
    @property
    def independent_power_loss(self: "CastSelf") -> "_378.IndependentPowerLoss":
        from mastapy._private.materials.efficiency import _378

        return self.__parent__._cast(_378.IndependentPowerLoss)

    @property
    def load_and_speed_combined_power_loss(
        self: "CastSelf",
    ) -> "_380.LoadAndSpeedCombinedPowerLoss":
        from mastapy._private.materials.efficiency import _380

        return self.__parent__._cast(_380.LoadAndSpeedCombinedPowerLoss)
