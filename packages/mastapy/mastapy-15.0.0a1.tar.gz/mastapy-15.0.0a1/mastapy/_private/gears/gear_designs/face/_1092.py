...
class FaceGearSetDesign(_1047.GearSetDesign):
    """FaceGearSetDesign
    ...
    @property
    def face_gear(self: "Self") -> "_1094.FaceGearWheelDesign":
    ...
    @property
    def pinion(self: "Self") -> "_1091.FaceGearPinionDesign":
    ...
    @property
    def gears(self: "Self") -> "List[_1086.FaceGearDesign]":
    ...
    @property
    def face_gears(self: "Self") -> "List[_1086.FaceGearDesign]":
        """List[mastapy.gears.gear_designs.face.FaceGearDesign]
    ...
    @property
    def face_meshes(self: "Self") -> "List[_1088.FaceGearMeshDesign]":
