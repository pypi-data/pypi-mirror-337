...
class V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerCPURequestedFrequency(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "min": V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerCPURequestedFrequencyMin.from_dict(
                    obj["min"]
                )
                if obj.get("min") is not None
                else None,
                "max": V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerCPURequestedFrequencyMax.from_dict(
                    obj["max"]
                )
