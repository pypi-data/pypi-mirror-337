...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _939, _945
...
class _Cast_GearMeshLoadDistributionAtRotation:
    ...
    def cylindrical_mesh_load_distribution_at_rotation(
        self: "CastSelf",
    ) -> "_957.CylindricalMeshLoadDistributionAtRotation":
        from mastapy._private.gears.ltca.cylindrical import _957

        return self.__parent__._cast(_957.CylindricalMeshLoadDistributionAtRotation)

    @property
    def conical_mesh_load_distribution_at_rotation(
        self: "CastSelf",
    ) -> "_967.ConicalMeshLoadDistributionAtRotation":
        from mastapy._private.gears.ltca.conical import _967

        return self.__parent__._cast(_967.ConicalMeshLoadDistributionAtRotation)
...
class GearMeshLoadDistributionAtRotation(_0.APIBase):
    ...
    def gear_a_in_mesh(
        self: "Self",
    ) -> "_945.MeshedGearLoadDistributionAnalysisAtRotation":
    ...
    @property
    def loaded_contact_lines(self: "Self") -> "List[_939.GearMeshLoadedContactLine]":
    ...
    def meshed_gears(
        self: "Self",
    ) -> "List[_945.MeshedGearLoadDistributionAnalysisAtRotation]":
