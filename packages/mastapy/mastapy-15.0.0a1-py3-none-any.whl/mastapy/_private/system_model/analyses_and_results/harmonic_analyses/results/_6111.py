...
class _Cast_ExcitationSourceSelectionGroup:
    ...
    def excitation_source_selection_base(
        self: "CastSelf",
    ) -> "_6110.ExcitationSourceSelectionBase":
        return self.__parent__._cast(_6110.ExcitationSourceSelectionBase)
...
class ExcitationSourceSelectionGroup(_6110.ExcitationSourceSelectionBase):
    """ExcitationSourceSelectionGroup
    ...
    @property
    def sub_items(self: "Self") -> "List[_6110.ExcitationSourceSelectionBase]":
    ...
    def include_only_harmonics_with_order(
        self: "Self", order: "_1704.RoundedOrder"
    ) -> None:
