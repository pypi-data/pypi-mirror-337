...
class EnumWithSelectedValue_AlignmentAxis(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_AlignmentAxis]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1666.AlignmentAxis.type_()

    @property
    def selected_value(self: "Self") -> "_1666.AlignmentAxis":
    ...
    @property
    def available_values(self: "Self") -> "List[_1666.AlignmentAxis]":
