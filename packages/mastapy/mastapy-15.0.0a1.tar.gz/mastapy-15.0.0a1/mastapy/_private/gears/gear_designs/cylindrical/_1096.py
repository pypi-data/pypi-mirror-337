...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1140, _1161
...
class _Cast_BacklashSpecification:
    ...
    def relative_values_specification(
        self: "CastSelf",
    ) -> "_1173.RelativeValuesSpecification":
        pass

        return self.__parent__._cast(_1173.RelativeValuesSpecification)
...
class BacklashSpecification(_1173.RelativeValuesSpecification["BacklashSpecification"]):
    """BacklashSpecification
    ...
    @property
    def left_flank(self: "Self") -> "_1161.LinearBacklashSpecification":
    ...
    @property
    def right_flank(self: "Self") -> "_1161.LinearBacklashSpecification":
        """mastapy.gears.gear_designs.cylindrical.LinearBacklashSpecification
    ...
    @property
    def angular_backlash(self: "Self") -> "List[_1140.CylindricalMeshAngularBacklash]":
    ...
    @property
    def flanks(self: "Self") -> "List[_1161.LinearBacklashSpecification]":
    ...
    @property
    def both_flanks(self: "Self") -> "_1161.LinearBacklashSpecification":
        """mastapy.gears.gear_designs.cylindrical.LinearBacklashSpecification
