...
class EnumWithSelectedValue_CoilPositionInSlot(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1370.CoilPositionInSlot
        """
        return _1370.CoilPositionInSlot
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_CoilPositionInSlot]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1370.CoilPositionInSlot.type_()

    @property
    def selected_value(self: "Self") -> "_1370.CoilPositionInSlot":
    ...
    @property
    def available_values(self: "Self") -> "List[_1370.CoilPositionInSlot]":
