...
class GearCompoundStabilityAnalysis(_4200.MountableComponentCompoundStabilityAnalysis):
    """GearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4047.GearStabilityAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4047.GearStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.GearStabilityAnalysis]
