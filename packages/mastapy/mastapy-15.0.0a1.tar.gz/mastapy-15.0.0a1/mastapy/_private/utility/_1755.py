...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility import _1754, _1767
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self: "Self") -> "_1767.NumberFormatInfoSummary":
    ...
    @property
    def dispatchers(self: "Self") -> "List[_1754.DispatcherHelper]":
