...
class WormGearSystemDeflection(_2967.GearSystemDeflection):
    """WormGearSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_458.WormGearRating":
    ...
    @property
    def component_load_case(self: "Self") -> "_7812.WormGearLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4390.WormGearPowerFlow":
