...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1497
...
class EfficiencyMapAnalysis(_1527.ElectricMachineAnalysis):
    """EfficiencyMapAnalysis
    ...
    @property
    def efficiency_map_results(self: "Self") -> "_1497.EfficiencyResults":
    ...
    @property
    def load_case(self: "Self") -> "_1526.EfficiencyMapLoadCase":
