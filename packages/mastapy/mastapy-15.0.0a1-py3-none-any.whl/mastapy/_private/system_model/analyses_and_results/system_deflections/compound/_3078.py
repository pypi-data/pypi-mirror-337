...
class BoltCompoundSystemDeflection(_3084.ComponentCompoundSystemDeflection):
    """BoltCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2916.BoltSystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_2916.BoltSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BoltSystemDeflection]
