...
class StraightBevelDiffGearSetHarmonicAnalysis(_5951.BevelGearSetHarmonicAnalysis):
    """StraightBevelDiffGearSetHarmonicAnalysis
    ...
    def bevel_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_6077.StraightBevelDiffGearHarmonicAnalysis]":
    ...
    def bevel_meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_6078.StraightBevelDiffGearMeshHarmonicAnalysis]":
