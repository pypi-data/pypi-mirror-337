...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2733
...
class ConceptGear(_2732.Gear):
    ...
    @property
    def active_gear_design(self: "Self") -> "_1289.ConceptGearDesign":
    ...
    @property
    def concept_gear_design(self: "Self") -> "_1289.ConceptGearDesign":
        """mastapy.gears.gear_designs.concept.ConceptGearDesign
