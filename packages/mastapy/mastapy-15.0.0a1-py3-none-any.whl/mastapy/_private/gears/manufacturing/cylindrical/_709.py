...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical import _730, _731
...
class CylindricalGearSpecifiedMicroGeometry(_0.APIBase):
    ...
    @property
    def lead_micro_geometry(self: "Self") -> "_730.MicroGeometryInputsLead":
    ...
    @property
    def profile_micro_geometry(self: "Self") -> "List[_731.MicroGeometryInputsProfile]":
