...
def refine(results, parameters, met_data, timer=False):
    ...
    conc_0_FT, conc_z_FT = ade_ft_refine(results.C0_FT, results.Cz_FT, kx, ky, fxy_f, cheby, parameters, velocities)
