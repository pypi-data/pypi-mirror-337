...
from mastapy._private.gears.gear_designs import _1041
...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.property import _2022
...
class DesignConstraintsCollection(_2011.NamedDatabaseItem):
    """DesignConstraintsCollection
    ...
    def design_constraints(
        self: "Self",
    ) -> "List[_2022.DeletableCollectionMember[_1041.DesignConstraint]]":
