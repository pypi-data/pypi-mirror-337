...
class BoltCompoundParametricStudyTool(_4701.ComponentCompoundParametricStudyTool):
    """BoltCompoundParametricStudyTool
    ...
    @property
    def component_design(self: "Self") -> "_2637.Bolt":
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7658.BoltLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4546.BoltParametricStudyTool]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4546.BoltParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.BoltParametricStudyTool]
