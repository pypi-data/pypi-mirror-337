...
class FlexiblePinAssemblySystemDeflection(_3014.SpecialisedAssemblySystemDeflection):
    """FlexiblePinAssemblySystemDeflection
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7715.FlexiblePinAssemblyLoadCase":
    ...
    @property
    def flexible_pin_shaft_details(self: "Self") -> "_3012.ShaftSystemDeflection":
    ...
    @property
    def pin_analysis(self: "Self") -> "_3012.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4318.FlexiblePinAssemblyPowerFlow":
    ...
    @property
    def spindle_analyses(self: "Self") -> "_3012.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    def bearing_static_analyses(self: "Self") -> "List[_2904.BearingSystemDeflection]":
    ...
    def load_sharing_factor_reporters(
        self: "Self",
    ) -> "List[_2984.LoadSharingFactorReporter]":
    ...
    def observed_pin_stiffness_reporters(
        self: "Self",
    ) -> "List[_2991.ObservedPinStiffnessReporter]":
