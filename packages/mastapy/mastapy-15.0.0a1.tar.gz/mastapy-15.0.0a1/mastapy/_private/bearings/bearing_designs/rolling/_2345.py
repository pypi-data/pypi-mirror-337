...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.rolling import _2346, _2347
...
class GeometricConstants(_0.APIBase):
    ...
    def geometric_constants_for_rolling_frictional_moments(
        self: "Self",
    ) -> "_2346.GeometricConstantsForRollingFrictionalMoments":
    ...
    def geometric_constants_for_sliding_frictional_moments(
        self: "Self",
    ) -> "_2347.GeometricConstantsForSlidingFrictionalMoments":
