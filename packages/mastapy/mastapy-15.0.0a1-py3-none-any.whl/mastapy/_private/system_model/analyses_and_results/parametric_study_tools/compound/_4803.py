...
class WormGearSetCompoundParametricStudyTool(_4736.GearSetCompoundParametricStudyTool):
    """WormGearSetCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7814.WormGearSetLoadCase":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4672.WormGearSetParametricStudyTool]":
    ...
    def worm_gears_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4801.WormGearCompoundParametricStudyTool]":
    ...
    def worm_meshes_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4802.WormGearMeshCompoundParametricStudyTool]":
