...
class HypoidGearSetParetoOptimiser(_1008.GearSetParetoOptimiser):
    """HypoidGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self: "Self") -> "_1084.HypoidGearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: "Self") -> "List[_1084.HypoidGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: "Self") -> "List[_1084.HypoidGearSetDesign]":
        """List[mastapy.gears.gear_designs.hypoid.HypoidGearSetDesign]
