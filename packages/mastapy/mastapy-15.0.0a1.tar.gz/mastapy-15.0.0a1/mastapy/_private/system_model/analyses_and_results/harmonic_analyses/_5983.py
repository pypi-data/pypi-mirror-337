...
class CylindricalGearSetHarmonicAnalysis(_6013.GearSetHarmonicAnalysis):
    """CylindricalGearSetHarmonicAnalysis
    ...
    def gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5981.CylindricalGearHarmonicAnalysis]":
    ...
    def meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5982.CylindricalGearMeshHarmonicAnalysis]":
