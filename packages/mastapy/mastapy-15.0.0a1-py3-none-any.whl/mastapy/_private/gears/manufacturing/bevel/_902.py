...
from mastapy._private.gears import _403
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.conical import _1284
...
class _Cast_PinionFinishMachineSettings:
    ...
    @property
    def conical_gear_tooth_surface(self: "CastSelf") -> "_403.ConicalGearToothSurface":
        return self.__parent__._cast(_403.ConicalGearToothSurface)
...
class PinionFinishMachineSettings(_403.ConicalGearToothSurface):
    """PinionFinishMachineSettings
    ...
    @property
    def toprem_letter(self: "Self") -> "_1284.TopremLetter":
