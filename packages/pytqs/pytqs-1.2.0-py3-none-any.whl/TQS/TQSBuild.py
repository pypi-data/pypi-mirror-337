...
def BuildingContext ():
        ...
        nprjpv          // -> Numero do projeto do pavimento
        nprjed          // -> Numero do projeto do edificio
...
class File ():
    ...
    def SaveAs (self, filename):
        ...
        istat           = 0
        paristat        = ctypes.c_int (istat)
        self.m_building.m_edilib.EDILIB_EDIFICIO_GRAVAR (parfilename, ctypes.byref (paristat))
        istat           = paristat.value
        return          (istat)
