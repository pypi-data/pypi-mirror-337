...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5913
...
from mastapy._private.system_model.connections_and_sockets.gears import _2500, _2504
from mastapy._private.system_model.part_model import _2634, _2649, _2670, _2671
from mastapy._private.system_model.part_model.gears import _2727, _2728, _2732, _2734
...
class _Cast_AbstractStaticLoadCaseGroup:
    ...
    def abstract_design_state_load_case_group(
        self: "CastSelf",
    ) -> "_5912.AbstractDesignStateLoadCaseGroup":
        return self.__parent__._cast(_5912.AbstractDesignStateLoadCaseGroup)
    ...
    @property
    def duty_cycle(self: "CastSelf") -> "_5918.DutyCycle":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5918,
        )

        return self.__parent__._cast(_5918.DutyCycle)
...
class AbstractStaticLoadCaseGroup(_5913.AbstractLoadCaseGroup):
    """AbstractStaticLoadCaseGroup
    ...
    def bearings(
        ...
        "List[_5927.ComponentStaticLoadCaseGroup[_2634.Bearing, _7646.BearingLoadCase]]"
    ):
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5930.GearSetStaticLoadCaseGroup[_2728.CylindricalGearSet, _2727.CylindricalGear, _7688.CylindricalGearLoadCase, _2500.CylindricalGearMesh, _7690.CylindricalGearMeshLoadCase, _7692.CylindricalGearSetLoadCase]]":
    ...
    @property
    def design_states(self: "Self") -> "List[_5912.AbstractDesignStateLoadCaseGroup]":
    ...
    def fe_parts(
        self: "Self",
    ) -> "List[_5927.ComponentStaticLoadCaseGroup[_2649.FEPart, _7714.FEPartLoadCase]]":
    ...
    def gear_sets(
        self: "Self",
    ) -> "List[_5930.GearSetStaticLoadCaseGroup[_2734.GearSet, _2732.Gear, _7717.GearLoadCase, _2504.GearMesh, _7719.GearMeshLoadCase, _7722.GearSetLoadCase]]":
    ...
    @property
    def parts_with_excitations(self: "Self") -> "List[_5931.PartStaticLoadCaseGroup]":
    ...
    def point_loads(
        self: "Self",
    ) -> "List[_5927.ComponentStaticLoadCaseGroup[_2670.PointLoad, _7767.PointLoadLoadCase]]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_5927.ComponentStaticLoadCaseGroup[_2671.PowerLoad, _7768.PowerLoadLoadCase]]":
    ...
    @property
    def compound_system_deflection(self: "Self") -> "_2887.CompoundSystemDeflection":
    ...
    @property
    def compound_power_flow(self: "Self") -> "_2882.CompoundPowerFlow":
    ...
    @property
    def compound_harmonic_analysis(self: "Self") -> "_2874.CompoundHarmonicAnalysis":
    ...
    @property
    def compound_modal_analysis(self: "Self") -> "_2877.CompoundModalAnalysis":
    ...
    @property
    def compound_stability_analysis(self: "Self") -> "_2883.CompoundStabilityAnalysis":
    ...
    @enforce_parameter_types
    def analysis_of(
        self: "Self", analysis_type: "_7644.AnalysisType"
    ) -> "_2853.CompoundAnalysis":
