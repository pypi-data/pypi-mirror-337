...
class EnumWithSelectedValue_ITDesignation(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ITDesignation]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2096.ITDesignation.type_()

    @property
    def selected_value(self: "Self") -> "_2096.ITDesignation":
    ...
    @property
    def available_values(self: "Self") -> "List[_2096.ITDesignation]":
