...
class V0041OpenapiSharesRespShares(BaseModel):
    ...
    shares: Optional[List[V0041OpenapiSharesRespSharesSharesInner]] = Field(
        default=None, description="Association shares"
    )
    total_shares: Optional[StrictInt] = Field(
        default=None, description="Total number of shares"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "shares": [
                    V0041OpenapiSharesRespSharesSharesInner.from_dict(_item)
                    for _item in obj["shares"]
                ]
