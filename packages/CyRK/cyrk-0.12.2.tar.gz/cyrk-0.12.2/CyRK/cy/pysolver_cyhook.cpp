...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "include_dirs": [
            "CyRK/cy",
            "/tmp/build-env-45h2g_y0/lib/python3.12/site-packages/numpy/core/include",
            "/usr/lib/python312.zip",
            "/usr/lib/python3.12",
            "/usr/lib/python3.12/lib-dynload",
            "/tmp/build-env-45h2g_y0/lib/python3.12/site-packages",
            "/tmp/build-env-45h2g_y0/lib/python3.12/site-packages/setuptools/_vendor"
        ],
        "language": "c++",
