...
class _Cast_ProfileModificationSegment:
    ...
    @property
    def modification_segment(self: "CastSelf") -> "_732.ModificationSegment":
        return self.__parent__._cast(_732.ModificationSegment)
...
class ProfileModificationSegment(_732.ModificationSegment):
    """ProfileModificationSegment
