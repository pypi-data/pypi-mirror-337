...
class MeasurementSettings(_1768.PerMachineSettings):
    """MeasurementSettings
    ...
    @enforce_parameter_types
    def selected_measurement(self: "Self", value: "_1780.MeasurementBase") -> None:
        wrapper_type = (
    ...
    @property
    def current_selected_measurement(self: "Self") -> "_1780.MeasurementBase":
    ...
    @enforce_parameter_types
    def find_measurement_by_name(self: "Self", name: "str") -> "_1780.MeasurementBase":
        """mastapy.utility.units_and_measurements.MeasurementBase
    ...
    @enforce_parameter_types
    def get_measurement(
        self: "Self", measurement_type: "_7860.MeasurementType"
    ) -> "_1780.MeasurementBase":
        """mastapy.utility.units_and_measurements.MeasurementBase
