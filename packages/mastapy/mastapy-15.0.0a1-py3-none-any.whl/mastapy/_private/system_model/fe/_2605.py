...
from mastapy._private.nodal_analysis.fe_export_utility import _239, _240
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2599, _2600
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @enforce_parameter_types
    def default_type_of_result_to_export(
        self: "Self", value: "_239.BoundaryConditionType"
    ) -> None:
    ...
    @property
    def links(self: "Self") -> "List[_2599.PerLinkExportOptions]":
    ...
    @property
    def nodes(self: "Self") -> "List[_2600.PerNodeExportOptions]":
