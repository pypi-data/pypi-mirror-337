...
class _Cast_ConicalMeshLoadDistributionAtRotation:
    ...
    def gear_mesh_load_distribution_at_rotation(
        self: "CastSelf",
    ) -> "_938.GearMeshLoadDistributionAtRotation":
        return self.__parent__._cast(_938.GearMeshLoadDistributionAtRotation)
...
class ConicalMeshLoadDistributionAtRotation(_938.GearMeshLoadDistributionAtRotation):
    """ConicalMeshLoadDistributionAtRotation
