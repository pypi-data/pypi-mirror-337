...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.nodal_entities.external_force import _166, _169
...
class GearMeshBothFlankContacts(_0.APIBase):
    ...
    @property
    def left_flank(self: "Self") -> "_166.ExternalForceLineContactEntity":
    ...
    @property
    def left_flank_gear(self: "Self") -> "_169.GearMeshDirectSingleFlankContact":
    ...
    @property
    def right_flank(self: "Self") -> "_166.ExternalForceLineContactEntity":
        """mastapy.nodal_analysis.nodal_entities.external_force.ExternalForceLineContactEntity
    ...
    @property
    def right_flank_gear(self: "Self") -> "_169.GearMeshDirectSingleFlankContact":
        """mastapy.nodal_analysis.nodal_entities.external_force.GearMeshDirectSingleFlankContact
