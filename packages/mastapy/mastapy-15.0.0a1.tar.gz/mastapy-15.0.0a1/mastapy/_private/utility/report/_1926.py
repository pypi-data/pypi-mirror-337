...
class _Cast_ChartDefinition:
    ...
    @property
    def simple_chart_definition(self: "CastSelf") -> "_1964.SimpleChartDefinition":
        from mastapy._private.utility.report import _1964

        return self.__parent__._cast(_1964.SimpleChartDefinition)
    ...
    def legacy_chart_math_chart_definition(
        self: "CastSelf",
    ) -> "_2042.LegacyChartMathChartDefinition":
        from mastapy._private.utility_gui.charts import _2042

        return self.__parent__._cast(_2042.LegacyChartMathChartDefinition)
