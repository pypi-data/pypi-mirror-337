...
class V0041OpenapiSlurmdbdConfigRespQosInner(BaseModel):
    ...
    usage_threshold: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "flags": obj.get("flags"),
                "id": obj.get("id"),
                "limits": V0041OpenapiSlurmdbdConfigRespQosInnerLimits.from_dict(
                    obj["limits"]
                )
                if obj.get("limits") is not None
                else None,
                "name": obj.get("name"),
                "preempt": V0041OpenapiSlurmdbdConfigRespQosInnerPreempt.from_dict(
                    obj["preempt"]
                )
                if obj.get("preempt") is not None
                else None,
                "priority": V0041OpenapiSlurmdbdConfigRespQosInnerPriority.from_dict(
                    obj["priority"]
                )
                if obj.get("priority") is not None
                else None,
                "usage_factor": V0041OpenapiSlurmdbdConfigRespQosInnerUsageFactor.from_dict(
                    obj["usage_factor"]
                )
                if obj.get("usage_factor") is not None
                else None,
                "usage_threshold": V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold.from_dict(
                    obj["usage_threshold"]
                )
