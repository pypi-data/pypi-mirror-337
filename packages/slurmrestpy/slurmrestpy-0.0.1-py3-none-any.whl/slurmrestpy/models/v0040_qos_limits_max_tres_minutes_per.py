...
class V0040QosLimitsMaxTresMinutesPer(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "qos": [V0040Tres.from_dict(_item) for _item in obj["qos"]]
                if obj.get("qos") is not None
                else None,
                "job": [V0040Tres.from_dict(_item) for _item in obj["job"]]
                if obj.get("job") is not None
                else None,
                "account": [V0040Tres.from_dict(_item) for _item in obj["account"]]
                if obj.get("account") is not None
                else None,
                "user": [V0040Tres.from_dict(_item) for _item in obj["user"]]
