    ...
    def make_instance(self, include_optional) -> V0041OpenapiUsersAddCondResp:
        ...
        if include_optional:
            return V0041OpenapiUsersAddCondResp(
                association_condition = slurmrestpy.models.v0_0_41_openapi_users_add_cond_resp_association_condition.v0_0_41_openapi_users_add_cond_resp_association_condition(
                    accounts = [
                        ''
                        ],
                ...
                user = slurmrestpy.models.v0_0_41_openapi_users_add_cond_resp_user.v0_0_41_openapi_users_add_cond_resp_user(
                    adminlevel = [
                        'Not Set'
                        ],
                    defaultaccount = '',
