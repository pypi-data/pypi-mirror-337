...
from mastapy._private.system_model.part_model.couplings import _2798, _2801, _2802
...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.splines import _1586, _1591
...
class ShaftHubConnection(_2642.Connector):
    """ShaftHubConnection
    ...
    @property
    def spline_type(self: "Self") -> "_1586.SplineDesignTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.detailed_rigid_connectors.splines._1586",
            "SplineDesignTypes",
        )(value)

    @spline_type.setter
    @enforce_parameter_types
    def spline_type(self: "Self", value: "_1586.SplineDesignTypes") -> None:
    ...
    @enforce_parameter_types
    def stiffness_type(
        self: "Self", value: "_2798.RigidConnectorStiffnessType"
    ) -> None:
    ...
    @property
    def tilt_stiffness_type(self: "Self") -> "_2799.RigidConnectorTiltStiffnessTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.couplings._2799",
    ...
    def tilt_stiffness_type(
        self: "Self", value: "_2799.RigidConnectorTiltStiffnessTypes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.RigidConnectorTiltStiffnessTypes",
    ...
    @enforce_parameter_types
    def tooth_spacing_type(
        self: "Self", value: "_2801.RigidConnectorToothSpacingType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: "Self", value: "_2802.RigidConnectorTypes") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def external_half_manufacturing_error(
        self: "Self",
    ) -> "_2807.SplineHalfManufacturingError":
    ...
    @property
    def interference_fit_design(self: "Self") -> "_1621.InterferenceFitDesign":
    ...
    @property
    def left_flank_lead_relief(self: "Self") -> "_2808.SplineLeadRelief":
    ...
    @property
    def major_fit_options(self: "Self") -> "_2806.SplineFitOptions":
    ...
    @property
    def minor_fit_options(self: "Self") -> "_2806.SplineFitOptions":
        """mastapy.system_model.part_model.couplings.SplineFitOptions
    ...
    @property
    def right_flank_lead_relief(self: "Self") -> "_2808.SplineLeadRelief":
        """mastapy.system_model.part_model.couplings.SplineLeadRelief
    ...
    @property
    def spline_joint_design(self: "Self") -> "_1591.SplineJointDesign":
    ...
    @property
    def spline_pitch_error_options(self: "Self") -> "_2810.SplinePitchErrorOptions":
    ...
    @property
    def fit_options(self: "Self") -> "List[_2806.SplineFitOptions]":
    ...
    @property
    def lead_reliefs(self: "Self") -> "List[_2808.SplineLeadRelief]":
    ...
    def spline_half_manufacturing_errors(
        self: "Self",
    ) -> "List[_2807.SplineHalfManufacturingError]":
    ...
    def tooth_locations_external_spline_half(
        self: "Self",
    ) -> "List[_2800.RigidConnectorToothLocation]":
