...
class EnumWithSelectedValue_ShearAreaFactorMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _135.ShearAreaFactorMethod
        """
        return _135.ShearAreaFactorMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _135.ShearAreaFactorMethod.type_()

    @property
    def selected_value(self: "Self") -> "_135.ShearAreaFactorMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_135.ShearAreaFactorMethod]":
