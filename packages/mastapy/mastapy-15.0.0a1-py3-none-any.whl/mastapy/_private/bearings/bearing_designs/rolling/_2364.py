...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2075
...
class ThrustBallBearing(_2330.BallBearing):
    """ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self: "Self") -> "_2075.OuterRingMounting":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2075", "OuterRingMounting"
        )(value)

    @outer_ring_mounting.setter
    @enforce_parameter_types
    def outer_ring_mounting(self: "Self", value: "_2075.OuterRingMounting") -> None:
