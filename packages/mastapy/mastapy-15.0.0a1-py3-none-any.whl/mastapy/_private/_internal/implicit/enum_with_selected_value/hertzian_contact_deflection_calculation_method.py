...
class EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod]",
    ) -> "_1748.HertzianContactDeflectionCalculationMethod":
        ...
        Returns:
            _1748.HertzianContactDeflectionCalculationMethod
        """
        return _1748.HertzianContactDeflectionCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1748.HertzianContactDeflectionCalculationMethod.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1748.HertzianContactDeflectionCalculationMethod]":
