...
from mastapy._private.system_model.analyses_and_results.rotor_dynamics import _4253
...
class _Cast_ShaftModalComplexShape:
    ...
    @property
    def shaft_complex_shape(self: "CastSelf") -> "_4253.ShaftComplexShape":
        return self.__parent__._cast(_4253.ShaftComplexShape)
...
class ShaftModalComplexShape(_4253.ShaftComplexShape[_1864.Number, _1864.Number]):
    """ShaftModalComplexShape
