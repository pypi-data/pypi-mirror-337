...
class Frequencies(_2286.SKFCalculationResult):
    """Frequencies
    ...
    @property
    def frequency_of_over_rolling(self: "Self") -> "_2272.FrequencyOfOverRolling":
    ...
    @property
    def rotational_frequency(self: "Self") -> "_2284.RotationalFrequency":
