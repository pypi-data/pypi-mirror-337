...
class SpiralBevelGearSetSystemDeflection(_2913.BevelGearSetSystemDeflection):
    """SpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4366.SpiralBevelGearSetPowerFlow":
    ...
    def bevel_meshes_system_deflection(
        self: "Self",
    ) -> "List[_3015.SpiralBevelGearMeshSystemDeflection]":
