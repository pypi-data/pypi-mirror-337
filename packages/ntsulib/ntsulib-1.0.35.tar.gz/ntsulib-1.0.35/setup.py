...
# 将 hook-ntsulib.py 复制到 PyInstaller 的 hooks 目录
def install_hook():
    hook_content = """
from PyInstaller.utils.hooks import collect_dynamic_libs
binaries = collect_dynamic_libs("ntsulib", destdir=".")
"""
    pyinstaller_hooks_dir = os.path.join(os.path.dirname(__file__), "Lib", "site-packages", "PyInstaller", "hooks")
    os.makedirs(pyinstaller_hooks_dir, exist_ok=True)
    with open(os.path.join(pyinstaller_hooks_dir, "hook-ntsulib.py"), "w") as f:
