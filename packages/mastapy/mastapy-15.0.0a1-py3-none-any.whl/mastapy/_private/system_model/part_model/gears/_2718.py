...
class BevelDifferentialGearSet(_2722.BevelGearSet):
    """BevelDifferentialGearSet
    ...
    @property
    def conical_gear_set_design(self: "Self") -> "_1295.BevelGearSetDesign":
    ...
    @property
    def bevel_gear_set_design(self: "Self") -> "_1295.BevelGearSetDesign":
        """mastapy.gears.gear_designs.bevel.BevelGearSetDesign
    ...
    @property
    def bevel_gears(self: "Self") -> "List[_2721.BevelGear]":
    ...
    @property
    def bevel_meshes(self: "Self") -> "List[_2494.BevelGearMesh]":
