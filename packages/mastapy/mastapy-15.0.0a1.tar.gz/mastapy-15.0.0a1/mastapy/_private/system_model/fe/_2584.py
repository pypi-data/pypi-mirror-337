...
class FESubstructureWithSelectionForHarmonicAnalysis(_2582.FESubstructureWithSelection):
    """FESubstructureWithSelectionForHarmonicAnalysis
    ...
    @property
    def harmonic_draw_style(self: "Self") -> "_265.FEModelHarmonicAnalysisDrawStyle":
