...
class EnumWithSelectedValue_FEExportFormat(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_FEExportFormat]") -> "Any":
        ...
        Returns:
            Any
        """
        return _240.FEExportFormat.type_()

    @property
    def selected_value(self: "Self") -> "_240.FEExportFormat":
    ...
    @property
    def available_values(self: "Self") -> "List[_240.FEExportFormat]":
