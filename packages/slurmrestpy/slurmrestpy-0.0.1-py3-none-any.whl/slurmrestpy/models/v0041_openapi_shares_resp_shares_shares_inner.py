...
class V0041OpenapiSharesRespSharesSharesInner(BaseModel):
    ...
    type: Optional[List[StrictStr]] = Field(
        default=None, description="User or account association"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "shares_normalized": V0041OpenapiSharesRespSharesSharesInnerSharesNormalized.from_dict(
                    obj["shares_normalized"]
                )
                if obj.get("shares_normalized") is not None
                else None,
                "shares": V0041OpenapiSharesRespSharesSharesInnerShares.from_dict(
                    obj["shares"]
                )
                if obj.get("shares") is not None
                else None,
                "tres": V0041OpenapiSharesRespSharesSharesInnerTres.from_dict(
                    obj["tres"]
                )
                if obj.get("tres") is not None
                else None,
                "effective_usage": obj.get("effective_usage"),
                "usage_normalized": V0041OpenapiSharesRespSharesSharesInnerUsageNormalized.from_dict(
