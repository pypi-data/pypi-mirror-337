...
class _Cast_IndependentResistiveTorque:
    ...
    @property
    def resistive_torque(self: "CastSelf") -> "_386.ResistiveTorque":
        return self.__parent__._cast(_386.ResistiveTorque)
...
class IndependentResistiveTorque(_386.ResistiveTorque):
    """IndependentResistiveTorque
