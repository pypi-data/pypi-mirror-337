...
class _Cast_PartDetailConfiguration:
    ...
    def active_gear_set_design_selection_group(
        ...
        return self.__parent__._cast(_2714.ActiveGearSetDesignSelectionGroup)

    @property
    def active_fe_substructure_selection_group(
        self: "CastSelf",
    ) -> "_2823.ActiveFESubstructureSelectionGroup":
        from mastapy._private.system_model.part_model.configurations import _2823

        return self.__parent__._cast(_2823.ActiveFESubstructureSelectionGroup)

    @property
    def active_shaft_design_selection_group(
        self: "CastSelf",
    ) -> "_2825.ActiveShaftDesignSelectionGroup":
        from mastapy._private.system_model.part_model.configurations import _2825

        return self.__parent__._cast(_2825.ActiveShaftDesignSelectionGroup)

    @property
    def bearing_detail_configuration(
        self: "CastSelf",
    ) -> "_2826.BearingDetailConfiguration":
        from mastapy._private.system_model.part_model.configurations import _2826

        return self.__parent__._cast(_2826.BearingDetailConfiguration)
