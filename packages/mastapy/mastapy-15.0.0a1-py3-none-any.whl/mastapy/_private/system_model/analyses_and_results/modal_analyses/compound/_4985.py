...
class BoltedJointCompoundModalAnalysis(_5065.SpecialisedAssemblyCompoundModalAnalysis):
    """BoltedJointCompoundModalAnalysis
    ...
    @property
    def component_design(self: "Self") -> "_2638.BoltedJoint":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4826.BoltedJointModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4826.BoltedJointModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BoltedJointModalAnalysis]
