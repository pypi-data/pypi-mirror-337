...
class UserGroupUpdate(BaseModel):
    ...
    pilot: Optional[List[StrictInt]] = None
    __properties: ClassVar[List[str]] = ["name", "description", "pilot"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if pilot (nullable) is None
        # and model_fields_set contains the field
        if self.pilot is None and "pilot" in self.model_fields_set:
            _dict['pilot'] = None
