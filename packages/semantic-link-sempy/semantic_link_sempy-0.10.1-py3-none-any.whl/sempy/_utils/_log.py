        ...
        if on_aiskill:
            ...
            if 'FIRSTPARTY_LOGGING_GRPC_ENDPOINT' in os.environ:
                ...
                mds_attributes = MdsAttributes(
                    component_name=mds_fields["mds_ComponentName"],
                    application_name=mds_fields["mds_TelemetryApplicationInfo"]["ApplicationName"],
                    application_type=mds_fields["mds_TelemetryApplicationInfo"]["ApplicationType"],
                    application_version=mds_fields["mds_TelemetryApplicationInfo"]["ApplicationVersion"],
                    artifact_id=mds_fields["mds_TelemetryApplicationInfo"]["ArtifactId"],
                    artifact_type=mds_fields["mds_TelemetryApplicationInfo"]["ArtifactType"],
                    workspace_id=mds_fields["mds_TelemetryApplicationInfo"]["WorkspaceId"],
                    fabric_run_id=mds_fields["mds_TelemetryApplicationInfo"]["FabricRunId"],
                    root_activity_id=mds_fields["mds_TelemetryApplicationInfo"]["RootActivityId"],
                )
