...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.thermal import _1476, _1479
...
class ThermalStator(_0.APIBase):
    ...
    @property
    def housing(self: "Self") -> "_1476.ThermalHousing":
    ...
    @property
    def liner_to_stator_wedge_interface_gap(self: "Self") -> "_202.InterfaceGap":
    ...
    @property
    def wedge_to_stator_slot_interface_gap(self: "Self") -> "_202.InterfaceGap":
        """mastapy.nodal_analysis.lumped_parameter_thermal_analysis.InterfaceGap
    ...
    @property
    def windings(self: "Self") -> "_1479.ThermalWindings":
