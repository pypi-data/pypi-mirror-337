...
from mastapy._private.gears.micro_geometry import _658
...
class EnumWithSelectedValue_LocationOfEvaluationUpperLimit(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfEvaluationUpperLimit]",
    ) -> "_658.LocationOfEvaluationUpperLimit":
        ...
        Returns:
            _658.LocationOfEvaluationUpperLimit
        """
        return _658.LocationOfEvaluationUpperLimit
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _658.LocationOfEvaluationUpperLimit.type_()

    @property
    def selected_value(self: "Self") -> "_658.LocationOfEvaluationUpperLimit":
    ...
    @property
    def available_values(self: "Self") -> "List[_658.LocationOfEvaluationUpperLimit]":
