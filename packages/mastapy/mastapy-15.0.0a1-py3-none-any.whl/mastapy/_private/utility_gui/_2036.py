...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility_gui import _2035
...
class _Cast_DataLoggerWithCharts:
    ...
    @property
    def data_logger(self: "CastSelf") -> "_1750.DataLogger":
        return self.__parent__._cast(_1750.DataLogger)
...
class DataLoggerWithCharts(_1750.DataLogger):
    """DataLoggerWithCharts
    ...
    @property
    def logged_items(self: "Self") -> "List[_2035.DataLoggerItem]":
