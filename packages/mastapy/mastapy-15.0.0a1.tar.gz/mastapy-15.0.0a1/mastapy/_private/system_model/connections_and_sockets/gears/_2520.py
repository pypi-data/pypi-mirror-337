...
class WormGearMesh(_2504.GearMesh):
    """WormGearMesh
    ...
    @property
    def active_gear_mesh_design(self: "Self") -> "_1055.WormGearMeshDesign":
    ...
    @property
    def worm_gear_mesh_design(self: "Self") -> "_1055.WormGearMeshDesign":
        """mastapy.gears.gear_designs.worm.WormGearMeshDesign
