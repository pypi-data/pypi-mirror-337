...
class EnumWithSelectedValue_ElectricMachineAnalysisPeriod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ElectricMachineAnalysisPeriod]",
    ) -> "_243.ElectricMachineAnalysisPeriod":
        ...
        Returns:
            _243.ElectricMachineAnalysisPeriod
        """
        return _243.ElectricMachineAnalysisPeriod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _243.ElectricMachineAnalysisPeriod.type_()

    @property
    def selected_value(self: "Self") -> "_243.ElectricMachineAnalysisPeriod":
    ...
    @property
    def available_values(self: "Self") -> "List[_243.ElectricMachineAnalysisPeriod]":
