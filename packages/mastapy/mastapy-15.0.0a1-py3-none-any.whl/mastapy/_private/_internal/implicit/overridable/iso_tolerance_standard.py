...
class Overridable_ISOToleranceStandard(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _417.ISOToleranceStandard
        """
        return _417.ISOToleranceStandard
    ...
    def implicit_type(cls: "Type[Overridable_ISOToleranceStandard]") -> "Any":
        ...
        Returns:
            Any
        """
        return _417.ISOToleranceStandard.type_()

    @property
    def value(self: "Self") -> "_417.ISOToleranceStandard":
    ...
    @property
    def override_value(self: "Self") -> "_417.ISOToleranceStandard":
        """mastapy.gears.ISOToleranceStandard
    ...
    @property
    def calculated_value(self: "Self") -> "_417.ISOToleranceStandard":
        """mastapy.gears.ISOToleranceStandard
