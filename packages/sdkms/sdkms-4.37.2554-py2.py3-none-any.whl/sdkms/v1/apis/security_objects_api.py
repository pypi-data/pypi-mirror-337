...
class SecurityObjectsApi(object):
    ...
    def get_key_attestation(self, body, async_call=False, **kwargs):
        """
        Retrieve key attestation statement for a security object. 
        @type async_call: bool
        @param async_call: Whether the call should be performed asynchronously. (Default is False).
        @type body: L{KeyAttestationRequest}
        @param body: Request to retrieve key attestation statement for a security object. (required)
        @rtype: L{KeyAttestationResponse}
        @return:
        ...
        kwargs['_return_http_data_only'] = True
        if async_call:
            return self.get_key_attestation_with_http_info(body, async_call=async_call, **kwargs)
        else:
            (data) = self.get_key_attestation_with_http_info(body, async_call=async_call, **kwargs)
            return data

    def get_key_attestation_with_http_info(self, body, async_call=False, **kwargs):
        """
        Retrieve key attestation statement for a security object. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_call=True::
            >>> thread = api.get_key_attestation_with_http_info(body, async_call=True)
            >>> result = thread.get()
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_key_attestation" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `get_key_attestation`")
        ...
        return self.api_client.call_api('/crypto/v1/keys/key_attestation', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='KeyAttestationResponse',
                                        auth_settings=auth_settings,
                                        async_call=params.get('async_call'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_security_object_ex(self, body, view=None, show_destroyed=None, show_deleted=None, async_call=False, **kwargs):
        """
        Get the details of a particular security object. 
        @type async_call: bool
        @param async_call: Whether the call should be performed asynchronously. (Default is False).
        @type body: L{SobjectDescriptor}
        @param body: Request to get a security object (required)
        @type view: L{str}
        @param view: The encoding the value of an opaque object or certificate
        @type show_destroyed: L{bool}
        @param show_destroyed: Whether security objects in the `Destroyed` state should be returned
        ...
        kwargs['_return_http_data_only'] = True
        if async_call:
            return self.get_security_object_ex_with_http_info(body, view=view, show_destroyed=show_destroyed, show_deleted=show_deleted, async_call=async_call, **kwargs)
        else:
            (data) = self.get_security_object_ex_with_http_info(body, view=view, show_destroyed=show_destroyed, show_deleted=show_deleted, async_call=async_call, **kwargs)
            return data

    def get_security_object_ex_with_http_info(self, body, view=None, show_destroyed=None, show_deleted=None, async_call=False, **kwargs):
        """
        Get the details of a particular security object. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_call=True::
            >>> thread = api.get_security_object_ex_with_http_info(body, async_call=True)
            >>> result = thread.get()
        ...
        all_params = ['body', 'view', 'show_destroyed', 'show_deleted']
        all_params.append('async_call')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_security_object_ex" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `get_security_object_ex`")
        ...
        return self.api_client.call_api('/crypto/v1/keys/info', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
