...
from mastapy._private.gears import _402, _417
from mastapy._private.gears.rating.cylindrical import _565, _566
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears import _398, _427
    ...
    from mastapy._private.utility.units_and_measurements import _1782
...
class CylindricalGearDesignAndRatingSettingsItem(_2011.NamedDatabaseItem):
    """CylindricalGearDesignAndRatingSettingsItem
    ...
    @property
    def agma_quality_grade_type(self: "Self") -> "_427.QualityGradeTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._427", "QualityGradeTypes"
        )(value)

    @agma_quality_grade_type.setter
    @enforce_parameter_types
    def agma_quality_grade_type(self: "Self", value: "_427.QualityGradeTypes") -> None:
    ...
    @property
    def agma_tolerances_standard(self: "Self") -> "_398.AGMAToleranceStandard":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._398", "AGMAToleranceStandard"
        )(value)

    @agma_tolerances_standard.setter
    @enforce_parameter_types
    def agma_tolerances_standard(
        self: "Self", value: "_398.AGMAToleranceStandard"
    ) -> None:
    ...
    def chosen_tooth_thickness_for_bending_strength(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._571", "ToothThicknesses"
        )(value)

    @chosen_tooth_thickness_for_bending_strength.setter
    @enforce_parameter_types
    def chosen_tooth_thickness_for_bending_strength(
        self: "Self", value: "_571.ToothThicknesses"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def cylindrical_gear_profile_measurement(
        self: "Self",
    ) -> "_1129.CylindricalGearProfileMeasurementType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1129",
    ...
    @enforce_parameter_types
    def cylindrical_gear_profile_measurement(
        self: "Self", value: "_1129.CylindricalGearProfileMeasurementType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.CylindricalGearProfileMeasurementType",
    ...
    @property
    def dynamic_factor_method(self: "Self") -> "_556.DynamicFactorMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._556", "DynamicFactorMethods"
        )(value)

    @dynamic_factor_method.setter
    @enforce_parameter_types
    def dynamic_factor_method(self: "Self", value: "_556.DynamicFactorMethods") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def film_thickness_equation_for_scuffing(self: "Self") -> "_567.ScuffingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._567", "ScuffingMethods"
        )(value)

    @film_thickness_equation_for_scuffing.setter
    @enforce_parameter_types
    def film_thickness_equation_for_scuffing(
        self: "Self", value: "_567.ScuffingMethods"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def gear_blank_factor_calculation_option(
        self: "Self",
    ) -> "_557.GearBlankFactorCalculationOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._557",
    ...
    @enforce_parameter_types
    def gear_blank_factor_calculation_option(
        self: "Self", value: "_557.GearBlankFactorCalculationOptions"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Cylindrical.GearBlankFactorCalculationOptions",
    ...
    def iso_tolerances_standard(
        self: "Self",
        value: "Union[_417.ISOToleranceStandard, Tuple[_417.ISOToleranceStandard, bool]]",
    ) -> None:
    ...
    @property
    def micropitting_rating_method(self: "Self") -> "_560.MicropittingRatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._560", "MicropittingRatingMethod"
        )(value)

    @micropitting_rating_method.setter
    @enforce_parameter_types
    def micropitting_rating_method(
        self: "Self", value: "_560.MicropittingRatingMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def permissible_bending_stress_method(self: "Self") -> "_563.RatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._563", "RatingMethod"
        )(value)

    @permissible_bending_stress_method.setter
    @enforce_parameter_types
    def permissible_bending_stress_method(
        self: "Self", value: "_563.RatingMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def rating_method(self: "Self", value: "_332.CylindricalGearRatingMethods") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @enforce_parameter_types
    def scuffing_rating_method_flash_temperature_method(
        self: "Self", value: "_565.ScuffingFlashTemperatureRatingMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @enforce_parameter_types
    def scuffing_rating_method_integral_temperature_method(
        self: "Self", value: "_566.ScuffingIntegralTemperatureRatingMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def tip_relief_in_scuffing_calculation(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._570", "TipReliefScuffingOptions"
        )(value)

    @tip_relief_in_scuffing_calculation.setter
    @enforce_parameter_types
    def tip_relief_in_scuffing_calculation(
        self: "Self", value: "_570.TipReliefScuffingOptions"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def tolerance_rounding_system(self: "Self") -> "_1782.MeasurementSystem":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.units_and_measurements._1782", "MeasurementSystem"
        )(value)

    @tolerance_rounding_system.setter
    @enforce_parameter_types
    def tolerance_rounding_system(
        self: "Self", value: "_1782.MeasurementSystem"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def vdi_rating_geometry_calculation_method(
        self: "Self",
        value: "Union[_332.CylindricalGearRatingMethods, Tuple[_332.CylindricalGearRatingMethods, bool]]",
    ) -> None:
        wrapper_type = (
