...
class EnumWithSelectedValue_DoeValueSpecificationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DoeValueSpecificationOption]",
    ) -> "_4579.DoeValueSpecificationOption":
        ...
        Returns:
            _4579.DoeValueSpecificationOption
        """
        return _4579.DoeValueSpecificationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _4579.DoeValueSpecificationOption.type_()

    @property
    def selected_value(self: "Self") -> "_4579.DoeValueSpecificationOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_4579.DoeValueSpecificationOption]":
