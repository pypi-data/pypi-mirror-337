...
from mastapy._private.system_model.part_model import _2630, _2651
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2575
...
class Shaft(_2630.AbstractShaft):
    """Shaft
    ...
    @cad_model.setter
    @enforce_parameter_types
    def cad_model(self: "Self", value: "_2651.GuideDxfModel") -> None:
        wrapper_type = (
    ...
    @property
    def guide_image(self: "Self") -> "_2652.GuideImage":
    ...
    @property
    def fe_substructure_replacing_this(self: "Self") -> "_2575.FESubstructure":
    ...
    @enforce_parameter_types
    def mount_component(
        self: "Self", component: "_2662.MountableComponent", offset: "float"
    ) -> None:
        """Method does not return.
