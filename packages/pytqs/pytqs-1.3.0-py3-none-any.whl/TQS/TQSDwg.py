...
#
    ...
    def IsModified (self):
        """
        Retorna (1) se o desenho foi modificado
        """
        parpedmv     = ctypes.c_void_p (self.m_dwg.m_pedmv)
        istat       = 0
        paristat    = ctypes.c_int (istat)
...
class SmartRebar ():
    ...
    def bendType (self):
        """
        Tipo de dobra:
            (ICPTPDOBGAN) Gancho de tração NBR6118:2003 9.4.2.3
            (ICPTPDOBNOP) Nó de pórtico NBR6118:2003 18.2.2
        """
    ...
    def bendTotalLengthMode (self):
        ...
        Modo de desconto de raios de dobra do comprimento total:
            ICPDEF: Conforme o arquivo de critérios
            ICPSRA: Faces externas sem desconto
            ICPCRA: Comprimento desenvolvido com desconto de raio de dobra
            ICPSMS: Soma simples dos trechos
        """
        icftpdob, cfrrai, icfrai, icfraa, icfrad, icfrcurcotrai, icfrcurcotdes, icfrcurdestic, cfrrcurtamtic = self._LerRaiosCurv ()
        return           icfrai
    ...
    def bendBendLengthMode (self):
        ...
        Modo representação de desconto das dobras:
            ICPDEF:    Conforme o arquivo de critérios
            ICPDOBSRA: Faces externas, sem desconto
            ICPDOBCRA: Desenvolvimento com raios de dobras
            ICPDOBSMS: Comprimento do trecho
        """
        icftpdob, cfrrai, icfrai, icfraa, icfrad, icfrcurcotrai, icfrcurcotdes, icfrcurdestic, cfrrcurtamtic = self._LerRaiosCurv ()
        return           icfrad
