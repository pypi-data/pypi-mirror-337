...
class ManualService:
            ...
            if should_clone:
                ...
                try:
                    ...
                    if hasattr(self, "_current_job_context"):
                        ...
                        job.message = f"Failed to clone repository: {str(e)}"
                    return False
    ...
    async def get_notifications(
        ...
        # Check if the user has admin privileges (for simplified implementation, we'll assume not)
        # In a real implementation, you would check user roles from the token
        is_admin = user_id in ["cloudzcp-admin", "admin"]  # Example admin users
