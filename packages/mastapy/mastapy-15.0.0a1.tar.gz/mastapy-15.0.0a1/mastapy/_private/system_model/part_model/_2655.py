...
from mastapy._private.bearings.tolerances import _2088, _2090
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2633, _2672
...
class _Cast_InternalClearanceTolerance:
    ...
    def axial_internal_clearance_tolerance(
        ...
        from mastapy._private.system_model.part_model import _2633

        return self.__parent__._cast(_2633.AxialInternalClearanceTolerance)
    ...
    def radial_internal_clearance_tolerance(
        ...
        return self.__parent__._cast(_2672.RadialInternalClearanceTolerance)
...
class InternalClearanceTolerance(_0.APIBase):
    ...
    def clearance_class(self: "Self", value: "_2088.InternalClearanceClass") -> None:
