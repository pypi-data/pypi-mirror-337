...
from eventix.pydantic.task import TEventixTask, task_model_status, EventixTaskStatusEnum
...
def task_by_unique_key(unique_key: str,namespace:str=None, stati:str=None) -> TEventixTask:
