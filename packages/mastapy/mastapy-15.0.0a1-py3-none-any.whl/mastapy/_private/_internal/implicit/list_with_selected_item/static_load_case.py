...
class ListWithSelectedItem_StaticLoadCase(
    _7632.StaticLoadCase, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_StaticLoadCase]") -> "Any":
        ...
        Returns:
            Any
        """
        return _7632.StaticLoadCase.TYPE

    @property
    def selected_value(self: "Self") -> "_7632.StaticLoadCase":
    ...
    @property
    def available_values(self: "Self") -> "List[_7632.StaticLoadCase]":
