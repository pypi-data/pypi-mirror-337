...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.zerol_bevel import _453, _454
...
class ZerolBevelGearSetRating(_640.BevelGearSetRating):
    """ZerolBevelGearSetRating
    ...
    @property
    def zerol_bevel_mesh_ratings(self: "Self") -> "List[_453.ZerolBevelGearMeshRating]":
