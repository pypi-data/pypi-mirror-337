...
class DecryptRequest(object):
    ...
    def __init__(self, alg=None, cipher=None, mode=None, iv=None, ad=None, tag=None, masked=None):
        """
    ...
    def masked(self):
        """
        Gets the masked of this DecryptRequest.
        This flag is only useful with DECRYPT permission. When this flag is true, decryption returns masked output. Setting it to false is equivalent to not using this flag. With MASKDECRYPT permission, this flag is ignored. 
    ...
    def masked(self, masked):
        """
        Sets the masked of this DecryptRequest.
        This flag is only useful with DECRYPT permission. When this flag is true, decryption returns masked output. Setting it to false is equivalent to not using this flag. With MASKDECRYPT permission, this flag is ignored. 
        """
