...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _929, _931, _943
...
class _Cast_FEStiffness:
    ...
    @property
    def gear_stiffness(self: "CastSelf") -> "_943.GearStiffness":
        from mastapy._private.gears.ltca import _943

        return self.__parent__._cast(_943.GearStiffness)
    ...
    @property
    def fe_substructure(self: "CastSelf") -> "_2575.FESubstructure":
        from mastapy._private.system_model.fe import _2575

        return self.__parent__._cast(_2575.FESubstructure)
