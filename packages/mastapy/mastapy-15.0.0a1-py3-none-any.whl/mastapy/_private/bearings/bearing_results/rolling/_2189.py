...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.vectors import _2020, _2021
...
class LoadedBallBearingElement(_2203.LoadedElement):
    """LoadedBallBearingElement
    ...
    @property
    def contact_patch_sliding_speed_inner(self: "Self") -> "_2021.PlaneScalarFieldData":
        """mastapy.utility.vectors.PlaneScalarFieldData
    ...
    @property
    def contact_patch_sliding_speed_outer(self: "Self") -> "_2021.PlaneScalarFieldData":
        """mastapy.utility.vectors.PlaneScalarFieldData
    ...
    def inner_race_contact_geometries(
        self: "Self",
    ) -> "List[_2155.BallBearingRaceContactGeometry]":
