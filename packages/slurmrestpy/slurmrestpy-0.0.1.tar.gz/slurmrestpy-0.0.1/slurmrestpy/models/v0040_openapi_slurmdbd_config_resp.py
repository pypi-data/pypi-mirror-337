...
class V0040OpenapiSlurmdbdConfigResp(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "clusters": [
                    V0040ClusterRec.from_dict(_item) for _item in obj["clusters"]
                ]
                if obj.get("clusters") is not None
                else None,
                "tres": [V0040Tres.from_dict(_item) for _item in obj["tres"]]
                if obj.get("tres") is not None
                else None,
                "accounts": [V0040Account.from_dict(_item) for _item in obj["accounts"]]
                if obj.get("accounts") is not None
                else None,
                "users": [V0040User.from_dict(_item) for _item in obj["users"]]
                if obj.get("users") is not None
                else None,
                "qos": [V0040Qos.from_dict(_item) for _item in obj["qos"]]
                if obj.get("qos") is not None
                else None,
                "wckeys": [V0040Wckey.from_dict(_item) for _item in obj["wckeys"]]
                ...
                "instances": [
                    V0040Instance.from_dict(_item) for _item in obj["instances"]
                ]
