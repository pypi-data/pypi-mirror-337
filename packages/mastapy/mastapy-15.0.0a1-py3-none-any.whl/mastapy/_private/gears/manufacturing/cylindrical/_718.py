...
class CylindricalMeshManufacturingConfig(_1338.GearMeshImplementationDetail):
    """CylindricalMeshManufacturingConfig
    ...
    @property
    def gear_a_as_manufactured(self: "Self") -> "List[_827.CutterSimulationCalc]":
    ...
    @property
    def gear_b_as_manufactured(self: "Self") -> "List[_827.CutterSimulationCalc]":
        """List[mastapy.gears.manufacturing.cylindrical.cutter_simulation.CutterSimulationCalc]
