...
class WormGearSetSystemDeflection(_2966.GearSetSystemDeflection):
    """WormGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4391.WormGearSetPowerFlow":
    ...
    @property
    def gears_system_deflection(self: "Self") -> "List[_3046.WormGearSystemDeflection]":
    ...
    def worm_gears_system_deflection(
        self: "Self",
    ) -> "List[_3046.WormGearSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.WormGearSystemDeflection]
