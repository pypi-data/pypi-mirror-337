...
from mastapy._private.math_utility.measured_vectors import _1733
...
class _Cast_ForceAndDisplacementResults:
    ...
    def abstract_force_and_displacement_results(
        self: "CastSelf",
    ) -> "_1733.AbstractForceAndDisplacementResults":
        return self.__parent__._cast(_1733.AbstractForceAndDisplacementResults)
...
class ForceAndDisplacementResults(_1733.AbstractForceAndDisplacementResults):
    """ForceAndDisplacementResults
    ...
    @property
    def displacement(self: "Self") -> "_1738.VectorWithLinearAndAngularComponents":
