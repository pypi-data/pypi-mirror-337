...
class SynchroniserSystemDeflection(_3014.SpecialisedAssemblySystemDeflection):
    """SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4380.SynchroniserPowerFlow":
    ...
    @property
    def cones(self: "Self") -> "List[_3029.SynchroniserHalfSystemDeflection]":
