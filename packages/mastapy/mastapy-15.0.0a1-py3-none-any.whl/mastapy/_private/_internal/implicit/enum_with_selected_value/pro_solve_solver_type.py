...
from mastapy._private.fe_tools.vfx_tools.vfx_enums import _1355
...
class EnumWithSelectedValue_ProSolveSolverType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1355.ProSolveSolverType
        """
        return _1355.ProSolveSolverType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ProSolveSolverType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1355.ProSolveSolverType.type_()

    @property
    def selected_value(self: "Self") -> "_1355.ProSolveSolverType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1355.ProSolveSolverType]":
