...
class _Cast_PlasticSNCurveForTheSpecifiedOperatingConditions:
    ...
    @property
    def plastic_sn_curve(self: "CastSelf") -> "_699.PlasticSNCurve":
        return self.__parent__._cast(_699.PlasticSNCurve)
...
class PlasticSNCurveForTheSpecifiedOperatingConditions(_699.PlasticSNCurve):
    """PlasticSNCurveForTheSpecifiedOperatingConditions
