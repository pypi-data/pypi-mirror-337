...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueConverterLockupRule]",
    ) -> "_5760.TorqueConverterLockupRule":
        ...
        Returns:
            _5760.TorqueConverterLockupRule
        """
        return _5760.TorqueConverterLockupRule
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5760.TorqueConverterLockupRule.type_()

    @property
    def selected_value(self: "Self") -> "_5760.TorqueConverterLockupRule":
    ...
    @property
    def available_values(self: "Self") -> "List[_5760.TorqueConverterLockupRule]":
