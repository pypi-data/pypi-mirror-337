...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2249, _2250
...
class _Cast_MaximumStaticContactStressResultsAbstract:
    ...
    def maximum_static_contact_stress(
        ...
        return self.__parent__._cast(_2249.MaximumStaticContactStress)
    ...
    def maximum_static_contact_stress_duty_cycle(
        ...
        return self.__parent__._cast(_2250.MaximumStaticContactStressDutyCycle)
