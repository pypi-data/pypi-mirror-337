...
class CylindricalGearSetAdvancedSystemDeflection(_7415.GearSetAdvancedSystemDeflection):
    """CylindricalGearSetAdvancedSystemDeflection
    ...
    @property
    def gear_set_design(self: "Self") -> "_1131.CylindricalGearSetDesign":
    ...
    @property
    def micro_geometry(self: "Self") -> "_1213.CylindricalGearSetMicroGeometry":
