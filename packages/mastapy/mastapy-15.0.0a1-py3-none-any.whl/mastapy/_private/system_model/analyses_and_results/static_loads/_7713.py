...
class FaceGearSetLoadCase(_7722.GearSetLoadCase):
    """FaceGearSetLoadCase
    ...
    @property
    def gears_load_case(self: "Self") -> "List[_7711.FaceGearLoadCase]":
    ...
    @property
    def face_gears_load_case(self: "Self") -> "List[_7711.FaceGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.FaceGearLoadCase]
    ...
    @property
    def meshes_load_case(self: "Self") -> "List[_7712.FaceGearMeshLoadCase]":
    ...
    @property
    def face_meshes_load_case(self: "Self") -> "List[_7712.FaceGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.FaceGearMeshLoadCase]
