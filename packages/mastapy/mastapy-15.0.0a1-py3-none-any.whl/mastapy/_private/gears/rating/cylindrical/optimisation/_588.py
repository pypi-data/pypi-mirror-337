...
class _Cast_SafetyFactorOptimisationStepResult:
    ...
    def safety_factor_optimisation_step_result_angle(
        ...
        from mastapy._private.gears.rating.cylindrical.optimisation import _589

        return self.__parent__._cast(_589.SafetyFactorOptimisationStepResultAngle)

    @property
    def safety_factor_optimisation_step_result_number(
        self: "CastSelf",
    ) -> "_590.SafetyFactorOptimisationStepResultNumber":
        from mastapy._private.gears.rating.cylindrical.optimisation import _590

        return self.__parent__._cast(_590.SafetyFactorOptimisationStepResultNumber)

    @property
    def safety_factor_optimisation_step_result_short_length(
        self: "CastSelf",
    ) -> "_591.SafetyFactorOptimisationStepResultShortLength":
        from mastapy._private.gears.rating.cylindrical.optimisation import _591

        return self.__parent__._cast(_591.SafetyFactorOptimisationStepResultShortLength)
...
class SafetyFactorOptimisationStepResult(_0.APIBase):
    ...
    @property
    def normalised_safety_factors(self: "Self") -> "_452.SafetyFactorResults":
    ...
    @property
    def safety_factors(self: "Self") -> "_452.SafetyFactorResults":
        """mastapy.gears.rating.SafetyFactorResults
