...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results import _2135, _2143
...
class LoadedBallBearingDutyCycle(_2146.LoadedRollingBearingDutyCycle):
    """LoadedBallBearingDutyCycle
    ...
    def track_truncation_inner_summary(
        self: "Self",
    ) -> "_2025.DutyCyclePropertySummaryPercentage[_2191.LoadedBallBearingResults]":
