...
class EnumWithSelectedValue_DestinationDesignState(
    ...
    def wrapped_type(
        ...
        Returns:
            _7821.DestinationDesignState
        """
        return _7821.DestinationDesignState
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7821.DestinationDesignState.type_()

    @property
    def selected_value(self: "Self") -> "_7821.DestinationDesignState":
    ...
    @property
    def available_values(self: "Self") -> "List[_7821.DestinationDesignState]":
