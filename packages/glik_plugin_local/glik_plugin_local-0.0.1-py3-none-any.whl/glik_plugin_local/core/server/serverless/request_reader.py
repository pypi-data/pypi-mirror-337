...
from glik_plugin_local.core.server.serverless.response_writer import ServerlessResponseWriter
...
class ServerlessRequestReader(RequestReader):
    ...
    def _run(self):
        ...
        if socket.socket is gevent.socket.socket:
            ...
            print("* Serving Flask app 'glik_plugin_local.core.server.serverless.request_reader'")
