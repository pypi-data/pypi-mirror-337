...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1666
    from mastapy._private.system_model import _2412
...
T = TypeVar("T", bound="_2639.Component")
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def alignment_axis(self: "Self") -> "_1666.AlignmentAxis":
    ...
    def alignment_axis(self: "Self", value: "_1666.AlignmentAxis") -> None:
    ...
    @property
    def axial_offset(self: "Self") -> "_2412.RelativeOffsetOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2412", "RelativeOffsetOption"
        )(value)

    @axial_offset.setter
    @enforce_parameter_types
    def axial_offset(self: "Self", value: "_2412.RelativeOffsetOption") -> None:
        value = conversion.mp_to_pn_enum(
