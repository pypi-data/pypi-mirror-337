...
class _Cast_WormGrindingProcessProfileCalculation:
    ...
    def worm_grinding_process_calculation(
        self: "CastSelf",
    ) -> "_790.WormGrindingProcessCalculation":
        return self.__parent__._cast(_790.WormGrindingProcessCalculation)
...
class WormGrindingProcessProfileCalculation(_790.WormGrindingProcessCalculation):
    """WormGrindingProcessProfileCalculation
    ...
    @property
    def left_flank(self: "Self") -> "_758.CalculateProfileDeviationAccuracy":
    ...
    @property
    def right_flank(self: "Self") -> "_758.CalculateProfileDeviationAccuracy":
        """mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new.CalculateProfileDeviationAccuracy
