...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical import _708, _718
...
class CylindricalSetManufacturingConfig(_1344.GearSetImplementationDetail):
    """CylindricalSetManufacturingConfig
    ...
    def cylindrical_mesh_manufacturing_configurations(
        self: "Self",
    ) -> "List[_718.CylindricalMeshManufacturingConfig]":
