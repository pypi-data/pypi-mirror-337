...
class _Cast_AbstractLoadCaseGroup:
    ...
    def time_series_load_case_group(
        ...
        return self.__parent__._cast(_5925.TimeSeriesLoadCaseGroup)
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    @property
    def parametric_analysis_options(self: "Self") -> "_4621.ParametricStudyToolOptions":
    ...
    @property
    def load_case_root_assemblies(self: "Self") -> "List[_7777.RootAssemblyLoadCase]":
    ...
    def create_load_cases(
        self: "Self", number_of_load_cases: "int", token: "_7859.TaskProgress"
    ) -> "List[_7631.LoadCase]":
    ...
    @enforce_parameter_types
    def perform_pst_with_progress(self: "Self", progress: "_7859.TaskProgress") -> None:
        """Method does not return.
