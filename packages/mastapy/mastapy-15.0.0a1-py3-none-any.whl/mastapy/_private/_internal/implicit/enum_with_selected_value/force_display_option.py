...
from mastapy._private.electric_machines.harmonic_load_data import _1554
...
class EnumWithSelectedValue_ForceDisplayOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1554.ForceDisplayOption
        """
        return _1554.ForceDisplayOption
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ForceDisplayOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1554.ForceDisplayOption.type_()

    @property
    def selected_value(self: "Self") -> "_1554.ForceDisplayOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1554.ForceDisplayOption]":
