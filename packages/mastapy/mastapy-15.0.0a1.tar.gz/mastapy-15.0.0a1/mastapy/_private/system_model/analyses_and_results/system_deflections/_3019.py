...
class SpringDamperHalfSystemDeflection(_2936.CouplingHalfSystemDeflection):
    """SpringDamperHalfSystemDeflection
    ...
    @property
    def component_design(self: "Self") -> "_2812.SpringDamperHalf":
    ...
    @property
    def component_load_case(self: "Self") -> "_7786.SpringDamperHalfLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4368.SpringDamperHalfPowerFlow":
