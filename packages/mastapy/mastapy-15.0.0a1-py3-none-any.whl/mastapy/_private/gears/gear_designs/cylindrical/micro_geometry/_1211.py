...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.micro_geometry import _663
...
class CylindricalGearProfileModification(_666.ProfileModification):
    """CylindricalGearProfileModification
    ...
    @property
    def profile_modification_chart(self: "Self") -> "_2053.TwoDChartDefinition":
    ...
    def profile_modification_for_customer_102cad(
        self: "Self",
    ) -> "_1235.ProfileModificationForCustomer102CAD":
