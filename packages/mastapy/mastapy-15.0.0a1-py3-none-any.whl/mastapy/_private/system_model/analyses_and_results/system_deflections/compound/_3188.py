...
class WormGearSetCompoundSystemDeflection(_3120.GearSetCompoundSystemDeflection):
    """WormGearSetCompoundSystemDeflection
    ...
    @property
    def worm_gear_set_rating(self: "Self") -> "_459.WormGearSetDutyCycleRating":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3045.WormGearSetSystemDeflection]":
    ...
    def worm_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_3186.WormGearCompoundSystemDeflection]":
    ...
    def worm_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_3187.WormGearMeshCompoundSystemDeflection]":
