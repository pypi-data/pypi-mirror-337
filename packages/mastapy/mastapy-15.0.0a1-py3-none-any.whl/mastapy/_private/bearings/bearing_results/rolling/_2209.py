...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2203, _2216, _2217
...
class LoadedNeedleRollerBearingElement(_2197.LoadedCylindricalRollerBearingElement):
    """LoadedNeedleRollerBearingElement
