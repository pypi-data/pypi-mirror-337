...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials import _335, _363
...
class _Cast_CompositeFatigueSafetyFactorItem:
    ...
    @property
    def safety_factor_item(self: "CastSelf") -> "_363.SafetyFactorItem":
        from mastapy._private.materials import _363

        return self.__parent__._cast(_363.SafetyFactorItem)
...
class CompositeFatigueSafetyFactorItem(_334.FatigueSafetyFactorItem):
    """CompositeFatigueSafetyFactorItem
