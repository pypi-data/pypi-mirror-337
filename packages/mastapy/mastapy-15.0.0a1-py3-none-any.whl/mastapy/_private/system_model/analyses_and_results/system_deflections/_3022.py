...
class StraightBevelDiffGearSetSystemDeflection(_2913.BevelGearSetSystemDeflection):
    """StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4372.StraightBevelDiffGearSetPowerFlow":
    ...
    def bevel_gears_system_deflection(
        self: "Self",
    ) -> "List[_3023.StraightBevelDiffGearSystemDeflection]":
    ...
    def bevel_meshes_system_deflection(
        self: "Self",
    ) -> "List[_3021.StraightBevelDiffGearMeshSystemDeflection]":
