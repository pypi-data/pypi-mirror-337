...
class Utils:
    ...
    '''
        @description: 
        @params: project_file 当前项目地址
        @author: MR.阿辉
        @datetime: 2024-03-12 16:01:35
        @return: 
    '''
    @staticmethod
    def get_project_info(project_file:Optional[str]=None) -> Tuple[str,str,str]:
        ...
        # 所属项目
        project_dir = project_file.split('src')[0]
        # 资源目录
        source_dir = f'{project_dir}source'
        
        return project_name,project_dir,source_dir
    ...
    def get_headers(device:str) -> dict:
        ...
        _,_,source_dir = Utils.get_project_info(os.path.abspath(__file__))
        
        print('source_dir:',source_dir)
        
        headers_config_file = f'{source_dir}/json/headers.json'
