    ...
    **kwargs: optional
    ...
    if isinstance(cell_bounds, xr.core.dataset.Dataset):
        if 'XC_bnds' in cell_bounds.data_vars:
            ecco_dataset = ecco_dataset.assign_coords({"XC_bnds": (("tile","j","i","nb"), cell_bounds['XC_bnds'].data)})
        if 'YC_bnds' in cell_bounds.data_vars:
            ecco_dataset = ecco_dataset.assign_coords({"YC_bnds": (("tile","j","i","nb"), cell_bounds['YC_bnds'].data)})
