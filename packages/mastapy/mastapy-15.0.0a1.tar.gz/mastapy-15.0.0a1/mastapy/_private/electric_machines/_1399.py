...
class _Cast_HairpinConductor:
    ...
    @property
    def winding_conductor(self: "CastSelf") -> "_1443.WindingConductor":
        return self.__parent__._cast(_1443.WindingConductor)
...
class HairpinConductor(_1443.WindingConductor):
    """HairpinConductor
