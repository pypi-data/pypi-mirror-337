...
class PlungeShaverCalculationInputs(_0.APIBase):
    ...
    @property
    def shaver_hand(self: "Self") -> "_416.Hand":
        """mastapy.gears.Hand"""
    ...
    @shaver_hand.setter
    @enforce_parameter_types
    def shaver_hand(self: "Self", value: "_416.Hand") -> None:
    ...
    @property
    def input_gear_geometry(self: "Self") -> "_828.CylindricalCutterSimulatableGear":
    ...
    @property
    def tooth_thickness(self: "Self") -> "_1192.ToothThicknessSpecificationBase":
