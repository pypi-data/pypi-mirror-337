...
class SingleOperatingPointAnalysis(_1527.ElectricMachineAnalysis):
    """SingleOperatingPointAnalysis
    ...
    def electric_machine_results(
        self: "Self",
    ) -> "_1505.ElectricMachineResultsForOpenCircuitAndOnLoad":
    ...
    @property
    def load_case(self: "Self") -> "_1533.ElectricMachineLoadCase":
    ...
    def slot_section_details_for_analysis(
        self: "Self",
    ) -> "List[_1546.SlotDetailForAnalysis]":
