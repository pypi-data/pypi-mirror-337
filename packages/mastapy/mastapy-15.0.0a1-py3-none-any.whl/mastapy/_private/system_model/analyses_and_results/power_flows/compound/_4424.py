...
class ConceptGearCompoundPowerFlow(_4453.GearCompoundPowerFlow):
    """ConceptGearCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4288.ConceptGearPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4288.ConceptGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearPowerFlow]
