...
class _Cast_GearMeshLoadedContactLine:
    ...
    def cylindrical_gear_mesh_loaded_contact_line(
        self: "CastSelf",
    ) -> "_954.CylindricalGearMeshLoadedContactLine":
        from mastapy._private.gears.ltca.cylindrical import _954

        return self.__parent__._cast(_954.CylindricalGearMeshLoadedContactLine)

    @property
    def conical_mesh_loaded_contact_line(
        self: "CastSelf",
    ) -> "_968.ConicalMeshLoadedContactLine":
        from mastapy._private.gears.ltca.conical import _968

        return self.__parent__._cast(_968.ConicalMeshLoadedContactLine)
...
class GearMeshLoadedContactLine(_0.APIBase):
    ...
    def loaded_contact_strip_end_points(
        self: "Self",
    ) -> "List[_940.GearMeshLoadedContactPoint]":
