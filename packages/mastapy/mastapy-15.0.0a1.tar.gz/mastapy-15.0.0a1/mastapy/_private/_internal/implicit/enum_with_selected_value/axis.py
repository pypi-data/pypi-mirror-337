...
class EnumWithSelectedValue_Axis(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[EnumWithSelectedValue_Axis]") -> "_1667.Axis":
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_Axis]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1667.Axis.type_()

    @property
    def selected_value(self: "Self") -> "_1667.Axis":
    ...
    @property
    def available_values(self: "Self") -> "List[_1667.Axis]":
