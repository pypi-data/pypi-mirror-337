...
class ImageGenerationHandler:
    ...
    def create(self, model: str, prompt: str, resolution: str = "1024x1024", **kwargs):
        ...
        url = f"{self.client.base_url}/images/generations"  # Correct URL for image generations
        data = {
            "model": model,
            "prompt": prompt,
        ...
        return ImageGeneration(url=response.json().get("url"))  # Adjust based on actual response structure