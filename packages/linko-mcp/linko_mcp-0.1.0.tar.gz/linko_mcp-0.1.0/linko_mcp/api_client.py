        ...
        try:
            ...
            if response.status_code == 401 and attempt == 1:
                ...
                if new_token:
                    ...
                    raise LinkoAuthError() # Raise specific auth error after failed refresh
            ...
            try:
                ...
                logger.error(f"Failed to decode JSON response from {method} {url}. Response text: {response.text[:500]}")
            ...
            if e.response.status_code == 401 and attempt == 2:
                 logger.error("Authentication failed even after token refresh attempt.")
                 raise LinkoAuthError()
