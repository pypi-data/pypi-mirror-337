...
DIACRITICS = {### Diacritics # As they are combining chars, i use the hex value of the unicode table point
...
LATIN = latin_c|latin_l
CYRILLIC = cyrillic_c|cyrillic_l
GREEK = greek_c|greek_l
