...
from mastapy._private.system_model.analyses_and_results.stability_analyses import _3987
...
class ShaftStabilityAnalysis(_3987.AbstractShaftStabilityAnalysis):
    """ShaftStabilityAnalysis
    ...
    @property
    def critical_speeds(self: "Self") -> "List[_4025.CriticalSpeed]":
