...
class EnumWithSelectedValue_DynamicsResponseScaling(
    ...
    def wrapped_type(
        ...
        Returns:
            _1681.DynamicsResponseScaling
        """
        return _1681.DynamicsResponseScaling
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1681.DynamicsResponseScaling.type_()

    @property
    def selected_value(self: "Self") -> "_1681.DynamicsResponseScaling":
    ...
    @property
    def available_values(self: "Self") -> "List[_1681.DynamicsResponseScaling]":
