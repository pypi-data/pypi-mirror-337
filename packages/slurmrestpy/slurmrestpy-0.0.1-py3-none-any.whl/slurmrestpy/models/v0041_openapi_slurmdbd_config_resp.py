...
class V0041OpenapiSlurmdbdConfigResp(BaseModel):
    ...
    clusters: Optional[List[V0041OpenapiSlurmdbdConfigRespClustersInner]] = Field(
        default=None, description="Clusters"
    )
    tres: Optional[
        List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]
    ] = Field(default=None, description="TRES")
    accounts: Optional[List[V0041OpenapiSlurmdbdConfigRespAccountsInner]] = Field(
        default=None, description="Accounts"
    )
    users: Optional[List[V0041OpenapiSlurmdbdConfigRespUsersInner]] = Field(
        default=None, description="Users"
    )
    qos: Optional[List[V0041OpenapiSlurmdbdConfigRespQosInner]] = Field(
    ...
    errors: Optional[List[V0041OpenapiSlurmdbdJobsRespErrorsInner]] = Field(
        default=None, description="Query errors"
    )
    warnings: Optional[List[V0041OpenapiSlurmdbdJobsRespWarningsInner]] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "clusters": [
                    V0041OpenapiSlurmdbdConfigRespClustersInner.from_dict(_item)
                    for _item in obj["clusters"]
                ]
                if obj.get("clusters") is not None
                else None,
                "tres": [
                    V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner.from_dict(
                        _item
                    )
                ...
                "accounts": [
                    V0041OpenapiSlurmdbdConfigRespAccountsInner.from_dict(_item)
                    for _item in obj["accounts"]
                ]
                if obj.get("accounts") is not None
                else None,
                "users": [
                    V0041OpenapiSlurmdbdConfigRespUsersInner.from_dict(_item)
                    for _item in obj["users"]
                ]
                if obj.get("users") is not None
                else None,
                "qos": [
                    V0041OpenapiSlurmdbdConfigRespQosInner.from_dict(_item)
                ...
                "meta": V0041OpenapiSlurmdbdJobsRespMeta.from_dict(obj["meta"])
                if obj.get("meta") is not None
                else None,
                "errors": [
                    V0041OpenapiSlurmdbdJobsRespErrorsInner.from_dict(_item)
                    for _item in obj["errors"]
                ]
                if obj.get("errors") is not None
                else None,
                "warnings": [
                    V0041OpenapiSlurmdbdJobsRespWarningsInner.from_dict(_item)
