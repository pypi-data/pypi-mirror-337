...
class _Cast_ToothThicknessSpecification:
    ...
    def tooth_thickness_specification_base(
        self: "CastSelf",
    ) -> "_1192.ToothThicknessSpecificationBase":
        return self.__parent__._cast(_1192.ToothThicknessSpecificationBase)
...
class ToothThicknessSpecification(_1192.ToothThicknessSpecificationBase):
    """ToothThicknessSpecification
