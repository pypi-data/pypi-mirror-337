...
class ListWithSelectedItem_GearSetDesign(
    _1047.GearSetDesign, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_GearSetDesign]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1047.GearSetDesign.TYPE

    @property
    def selected_value(self: "Self") -> "_1047.GearSetDesign":
    ...
    @property
    def available_values(self: "Self") -> "List[_1047.GearSetDesign]":
