...
class MonitorDeviceAtomModuleBase(AndroidDeviceAtomModuleBase):
    """
   MonitorDevice设备资源原子接口模块基类
    """
    def __init__(self, resource, *args: tuple, **kwargs: dict):
        super(MonitorDeviceAtomModuleBase, self).__init__(resource, *args, **kwargs)
