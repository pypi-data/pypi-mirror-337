...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1115, _1121, _1142
...
class CylindricalMeshedGear(_0.APIBase):
    ...
    @property
    def left_flank(self: "Self") -> "_1142.CylindricalMeshedGearFlank":
    ...
    @property
    def right_flank(self: "Self") -> "_1142.CylindricalMeshedGearFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalMeshedGearFlank
    ...
    @property
    def flanks(self: "Self") -> "List[_1142.CylindricalMeshedGearFlank]":
    ...
    @property
    def both_flanks(self: "Self") -> "_1142.CylindricalMeshedGearFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalMeshedGearFlank
    ...
    @property
    def mesh(self: "Self") -> "_1121.CylindricalGearMeshDesign":
