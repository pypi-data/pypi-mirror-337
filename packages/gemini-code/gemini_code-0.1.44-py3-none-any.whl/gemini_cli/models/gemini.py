...
Includes Test Runner tool. Prompt v8 (Context & Expectation). Syntax FIXED AGAIN.
"""
...
class GeminiModel:
    ...
    def __init__(self, api_key, model_name="gemini-2.5-pro-exp-03-25"):
        ...
        self.system_instruction = self._create_system_prompt() # Using v8 prompt
    ...
    def _create_system_prompt(self) -> str:
        ...
        # ... (V8 prompt remains the same as previous step) ...
        tools_description = []
        if AVAILABLE_TOOLS:
...
1.  **Orient & Analyze:** **First, understand your surroundings.** Use `ls` (and potentially `glob '*'` or specific patterns) to see the files and directories in the current project directory. Then, analyze the user's request in the context of this project structure. Identify necessary information you might lack.
