...
class EnumWithSelectedValue_ExcitationAnalysisViewOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ExcitationAnalysisViewOption]",
    ) -> "_2453.ExcitationAnalysisViewOption":
        ...
        Returns:
            _2453.ExcitationAnalysisViewOption
        """
        return _2453.ExcitationAnalysisViewOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2453.ExcitationAnalysisViewOption.type_()

    @property
    def selected_value(self: "Self") -> "_2453.ExcitationAnalysisViewOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2453.ExcitationAnalysisViewOption]":
