...
class V0041OpenapiPartitionRespPartitionsInner(BaseModel):
    ...
    select_type: Optional[List[StrictStr]] = Field(
        default=None, description="Scheduler consumable resource selection type"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "defaults": V0041OpenapiPartitionRespPartitionsInnerDefaults.from_dict(
                    obj["defaults"]
                )
                if obj.get("defaults") is not None
                else None,
                "grace_time": obj.get("grace_time"),
                "maximums": V0041OpenapiPartitionRespPartitionsInnerMaximums.from_dict(
                    obj["maximums"]
                )
                ...
                "timeouts": V0041OpenapiPartitionRespPartitionsInnerTimeouts.from_dict(
                    obj["timeouts"]
                )
                if obj.get("timeouts") is not None
                else None,
                "partition": V0041OpenapiPartitionRespPartitionsInnerPartition.from_dict(
                    obj["partition"]
                )
                if obj.get("partition") is not None
                else None,
                "suspend_time": V0041OpenapiPartitionRespPartitionsInnerSuspendTime.from_dict(
                    obj["suspend_time"]
                )
