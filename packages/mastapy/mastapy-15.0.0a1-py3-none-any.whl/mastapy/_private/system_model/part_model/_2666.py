...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.import_export import _2433
...
class Part(_2394.DesignEntity):
    ...
    @property
    def mass_properties_from_design(self: "Self") -> "_1693.MassProperties":
    ...
    @property
    def local_connections(self: "Self") -> "List[_2463.Connection]":
        """List[mastapy.system_model.connections_and_sockets.Connection]
    ...
    @enforce_parameter_types
    def connections_to(self: "Self", part: "Part") -> "List[_2463.Connection]":
        """List[mastapy.system_model.connections_and_sockets.Connection]
    ...
    @enforce_parameter_types
    def copy_to(self: "Self", container: "_2628.Assembly") -> "Part":
    ...
    def create_geometry_export_options(self: "Self") -> "_2433.GeometryExportOptions":
