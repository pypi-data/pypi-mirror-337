...
from mastapy._private.gears.ltca import _933
...
class _Cast_CylindricalGearFilletNodeStressResults:
    ...
    def gear_fillet_node_stress_results(
        self: "CastSelf",
    ) -> "_933.GearFilletNodeStressResults":
        return self.__parent__._cast(_933.GearFilletNodeStressResults)
...
class CylindricalGearFilletNodeStressResults(_933.GearFilletNodeStressResults):
    """CylindricalGearFilletNodeStressResults
