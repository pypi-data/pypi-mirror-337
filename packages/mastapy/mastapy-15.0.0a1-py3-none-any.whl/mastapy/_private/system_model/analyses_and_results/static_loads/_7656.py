...
class BevelGearSetLoadCase(_7642.AGMAGleasonConicalGearSetLoadCase):
    """BevelGearSetLoadCase
    ...
    @property
    def bevel_gears_load_case(self: "Self") -> "List[_7654.BevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.BevelGearLoadCase]
    ...
    def agma_gleason_conical_meshes_load_case(
        self: "Self",
    ) -> "List[_7655.BevelGearMeshLoadCase]":
    ...
    @property
    def bevel_meshes_load_case(self: "Self") -> "List[_7655.BevelGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.BevelGearMeshLoadCase]
