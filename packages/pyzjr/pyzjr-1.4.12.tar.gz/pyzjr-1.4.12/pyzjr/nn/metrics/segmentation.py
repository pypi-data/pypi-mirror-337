...
class SegmentationIndex():
    ...
    def apply_reduction_to_score(self, metricfn, **kwargs):
        if self.class_weights is None and self.reduction is not None and "weighted" in self.reduction:
        ...
        class_weights = class_weights.clone().detach().to(self.tp.device)
...
if __name__=="__main__":
    ...
    index = SegmentationIndex(tp, fn, fp, tn, reduction='micro', class_weights=class_weights)
