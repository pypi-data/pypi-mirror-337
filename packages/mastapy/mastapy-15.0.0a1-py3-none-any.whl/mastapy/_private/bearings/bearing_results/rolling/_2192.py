...
class LoadedBallBearingRow(_2223.LoadedRollingBearingRow):
    """LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2191.LoadedBallBearingResults":
    ...
    @property
    def race_results(self: "Self") -> "List[_2190.LoadedBallBearingRaceResults]":
