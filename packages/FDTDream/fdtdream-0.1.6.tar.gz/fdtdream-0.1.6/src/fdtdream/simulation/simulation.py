...
def read_construction_code(line: str, sim, current_object: ScriptedStructure,
                           objects: list[ScriptedStructure]) -> ScriptedStructure:
...
def read_construction_group(cg: structures.StructureGroup, code_lines: List[str],
    ...
    # Assign the parent construction group to all objects:
    for obj in objects:
        obj._closest_parent = cg
        obj._parents.append(cg)
