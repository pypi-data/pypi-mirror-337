...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.fe_model import _1312
...
class GearFEModel(_1334.GearImplementationDetail):
    """GearFEModel
    ...
    @property
    def element_settings(self: "Self") -> "_1312.GearMeshingElementOptions":
    ...
    def get_stress_influence_coefficients_from_fe(
        self: "Self", flank: "_409.GearFlanks"
    ) -> None:
        """Method does not return.
