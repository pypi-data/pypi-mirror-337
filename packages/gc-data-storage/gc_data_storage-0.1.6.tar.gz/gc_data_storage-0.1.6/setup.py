...
setup(
    ...
    long_description= """
gc_data_storage lets you easily move data between your development environment (e.g. Jupyter Notebook) and your Google Cloud Workspace bucket. It integrates the ccommand line too gsutil.
...
gc_data_storage was originally written to be used within the Research All od Us Researcher Workbench environment
code snippet:
...
""",
   ...
   install_requires=['pyarrow', 'openpyxl'],   
