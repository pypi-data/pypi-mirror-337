...
class ConicalGearSetPowerFlow(_4321.GearSetPowerFlow):
    """ConicalGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4291.ConicalGearPowerFlow]":
    ...
    @property
    def conical_gears_power_flow(self: "Self") -> "List[_4291.ConicalGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConicalGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4290.ConicalGearMeshPowerFlow]":
