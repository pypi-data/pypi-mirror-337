...
from mastapy._private.gears.gear_designs.creation_options import _1260
...
class _Cast_CylindricalGearPairCreationOptions:
    ...
    @property
    def gear_set_creation_options(self: "CastSelf") -> "_1260.GearSetCreationOptions":
        return self.__parent__._cast(_1260.GearSetCreationOptions)
...
class CylindricalGearPairCreationOptions(
    _1260.GearSetCreationOptions[_1131.CylindricalGearSetDesign]
):
    """CylindricalGearPairCreationOptions
