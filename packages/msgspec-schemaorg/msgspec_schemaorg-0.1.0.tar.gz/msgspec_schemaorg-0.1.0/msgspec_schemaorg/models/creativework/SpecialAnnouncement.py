...
class SpecialAnnouncement(Struct, frozen=True):
...
"""
    ...
    webFeed: str | 'DataFeed' | None = None
    datePosted: datetime | date | None = None
    schoolClosuresInfo: str | 'WebContent' | None = None
    diseaseSpreadStatistics: 'Dataset' | str | 'Observation' | 'WebContent' | None = None
    diseasePreventionInfo: str | 'WebContent' | None = None
    category: 'CategoryCode' | str | 'Thing' | 'PhysicalActivityCategory' | str | None = None
    newsUpdatesAndGuidelines: str | 'WebContent' | None = None
    gettingTestedInfo: 'WebContent' | str | None = None
    announcementLocation: 'LocalBusiness' | 'CivicStructure' | None = None
    publicTransportClosuresInfo: 'WebContent' | str | None = None
    quarantineGuidelines: str | 'WebContent' | None = None
    governmentBenefitsInfo: 'GovernmentService' | None = None
    travelBans: str | 'WebContent' | None = None