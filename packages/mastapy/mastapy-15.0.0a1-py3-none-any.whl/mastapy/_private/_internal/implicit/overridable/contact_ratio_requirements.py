...
class Overridable_ContactRatioRequirements(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _405.ContactRatioRequirements
        """
        return _405.ContactRatioRequirements
    ...
    def implicit_type(cls: "Type[Overridable_ContactRatioRequirements]") -> "Any":
        ...
        Returns:
            Any
        """
        return _405.ContactRatioRequirements.type_()

    @property
    def value(self: "Self") -> "_405.ContactRatioRequirements":
    ...
    @property
    def override_value(self: "Self") -> "_405.ContactRatioRequirements":
        """mastapy.gears.ContactRatioRequirements
    ...
    @property
    def calculated_value(self: "Self") -> "_405.ContactRatioRequirements":
        """mastapy.gears.ContactRatioRequirements
