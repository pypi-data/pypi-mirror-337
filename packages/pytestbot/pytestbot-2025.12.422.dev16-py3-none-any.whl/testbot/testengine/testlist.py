...
class TestList(object):
    ...
    def __init__(self, filepath):
        ...
        self.filename = os.path.basename(self.setting_file_path)
    ...
    def load(self):
        ...
        try:
            ...
            self.iterations = testlist_obj['iterations']
            from testbot.config import CONFIG_PATH
            self.setting_file_path = testlist_obj.get('setting_path', None)
            if not self.setting_file_path:
                self.setting_file_path = os.path.join(os.path.dirname(self.filepath), Path(self.filepath).stem + "Setting.json")
    ...
    def save(self):
        ...
        json_obj['iterations'] = self.iterations
