...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears import _406, _407
...
class CylindricalMeshLoadCase(_971.MeshLoadCase):
    """CylindricalMeshLoadCase
    ...
    @property
    def misalignment_source(self: "Self") -> "_407.CylindricalMisalignmentDataSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._407", "CylindricalMisalignmentDataSource"
        )(value)

    @misalignment_source.setter
    @enforce_parameter_types
    def misalignment_source(
        self: "Self", value: "_407.CylindricalMisalignmentDataSource"
    ) -> None:
