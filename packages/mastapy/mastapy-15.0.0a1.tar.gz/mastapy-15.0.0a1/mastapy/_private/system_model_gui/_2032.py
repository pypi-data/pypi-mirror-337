...
from mastapy._private.nodal_analysis.geometry_modeller_link import _228
...
if TYPE_CHECKING:
    ...
    from mastapy._private.geometry.two_d import _394
    from mastapy._private.math_utility import _1668, _1686
    ...
    from mastapy._private.utility.operation_modes import _1968
...
class MASTAGUI(_0.APIBase):
    ...
    @property
    def active_design(self: "Self") -> "_2391.Design":
    ...
    @enforce_parameter_types
    def active_design(self: "Self", value: "_2391.Design") -> None:
    ...
    @enforce_parameter_types
    def gear_tip_radius_clash_test_request(
        self: "Self", value: "_224.GearTipRadiusClashTest"
    ) -> None:
        pythonnet_property_set(
    ...
    @property
    def open_designs(self: "Self") -> "List[_2391.Design]":
    ...
    @property
    def operation_mode(self: "Self") -> "_1968.OperationMode":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.operation_modes._1968", "OperationMode"
        )(value)

    @operation_mode.setter
    @enforce_parameter_types
    def operation_mode(self: "Self", value: "_1968.OperationMode") -> None:
    ...
    @property
    def selected_design_entity(self: "Self") -> "_2394.DesignEntity":
    ...
    @enforce_parameter_types
    def selected_design_entity(self: "Self", value: "_2394.DesignEntity") -> None:
    ...
    def add_electric_machine_from_cad_face_group(
        self: "Self",
        cad_face_group: "_394.CADFaceGroup",
        geometry_modeller_design_information: "_227.GeometryModellerDesignInformation",
        dimensions: "Dict[str, _228.GeometryModellerDimension]",
    ) -> None:
        """Method does not return.
    ...
    def add_fe_substructure_from_data(
        self: "Self",
        vertices_and_facets: "_1686.FacetedBody",
        geometry_modeller_design_information: "_227.GeometryModellerDesignInformation",
        dimensions: "Dict[str, _228.GeometryModellerDimension]",
    ...
    def add_line_from_geometry_modeller(
        self: "Self", circles_on_axis: "_1668.CirclesOnAxis"
    ) -> None:
        """Method does not return.
    ...
    def are_new_input_available(self: "Self") -> "_235.MeshRequest":
    ...
    def circle_pairs_from_geometry_modeller(
        self: "Self",
        preselection_circles: "_1668.CirclesOnAxis",
        selected_circles: "List[_1668.CirclesOnAxis]",
    ) -> None:
        """Method does not return.
    ...
    def create_geometry_modeller_dimension(
        self: "Self",
    ) -> "_228.GeometryModellerDimension":
    ...
    def create_mesh_request_result(self: "Self") -> "_236.MeshRequestResult":
    ...
    def create_new_cad_face_group(self: "Self") -> "_394.CADFaceGroup":
    ...
    def create_new_circles_on_axis(self: "Self") -> "_1668.CirclesOnAxis":
    ...
    def create_new_faceted_body(self: "Self") -> "_1686.FacetedBody":
    ...
    @enforce_parameter_types
    def open_design_in_new_tab(self: "Self", design: "_2391.Design") -> None:
        """Method does not return.
    ...
    def set_gear_tip_diameter_clash_test_result(
        self: "Self", result: "_224.GearTipRadiusClashTest"
    ) -> None:
        """Method does not return.
    ...
    def set_mesh_request_result(
        self: "Self", mesh_request_result: "_236.MeshRequestResult"
    ) -> None:
        """Method does not return.
