...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2167, _2169
...
class _Cast_ISOTR141792001Results:
    ...
    @property
    def isotr1417912001_results(self: "CastSelf") -> "_2167.ISOTR1417912001Results":
        from mastapy._private.bearings.bearing_results.rolling import _2167

        return self.__parent__._cast(_2167.ISOTR1417912001Results)

    @property
    def isotr1417922001_results(self: "CastSelf") -> "_2169.ISOTR1417922001Results":
        from mastapy._private.bearings.bearing_results.rolling import _2169

        return self.__parent__._cast(_2169.ISOTR1417922001Results)
