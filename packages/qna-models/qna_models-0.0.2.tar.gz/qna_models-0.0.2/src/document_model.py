...
class tasklist(BaseModel):
    ...
    task_created_at: datetime = Field(default_factory=datetime.now(datetime.timezone.utc), description="Task creation timestamp")
    task_updated_at: datetime = Field(default_factory=datetime.now(datetime.timezone.utc), description="Task update timestamp")
    task_completed_at: Optional[datetime] = Field(default=None, description="Task completion timestamp")
...
class Document(BaseModel):
    ...
    created_at: datetime = Field(default_factory=datetime.now(datetime.timezone.utc), description="Creation timestamp")
