...
class TabDriver:
    ...
    def __getattr__(self, name):
        # Handle attributes not found on self (delegation to the driver)
        ...
        if callable(attr):
            ...
            def wrapped(*args, **kwargs):
                ...
                return attr(*args, **kwargs)
            return wrapped
        # For non-callables, just switch tabs before returning the value
        self.driver.switch_to.window(self.handle)
...
if __name__=="__main__":
    ...
    swagger, google, pan = setupDriver(numTabs=3)
    ...
    pan.get("https://universidadedocorrespondente.bancopan.com.br/lms/#/aula/121437/c/79#topico_73")
    
    pan2 = swagger.window_handles[2]
    
    google.switch_to.window(pan2)
    input("####")