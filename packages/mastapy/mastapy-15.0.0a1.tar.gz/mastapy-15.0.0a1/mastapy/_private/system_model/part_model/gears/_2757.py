...
class ZerolBevelGearSet(_2722.BevelGearSet):
    """ZerolBevelGearSet
    ...
    @property
    def conical_gear_set_design(self: "Self") -> "_1051.ZerolBevelGearSetDesign":
    ...
    @property
    def zerol_bevel_gear_set_design(self: "Self") -> "_1051.ZerolBevelGearSetDesign":
        """mastapy.gears.gear_designs.zerol_bevel.ZerolBevelGearSetDesign
    ...
    @property
    def zerol_bevel_gears(self: "Self") -> "List[_2756.ZerolBevelGear]":
    ...
    @property
    def zerol_bevel_meshes(self: "Self") -> "List[_2522.ZerolBevelGearMesh]":
