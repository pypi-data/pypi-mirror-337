...
class EnumWithSelectedValue_LubricantDefinition(
    ...
    def wrapped_type(
        ...
        Returns:
            _344.LubricantDefinition
        """
        return _344.LubricantDefinition
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_LubricantDefinition]") -> "Any":
        ...
        Returns:
            Any
        """
        return _344.LubricantDefinition.type_()

    @property
    def selected_value(self: "Self") -> "_344.LubricantDefinition":
    ...
    @property
    def available_values(self: "Self") -> "List[_344.LubricantDefinition]":
