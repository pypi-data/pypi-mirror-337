...
class StraightBevelGearSetParetoOptimiser(_1008.GearSetParetoOptimiser):
    """StraightBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self: "Self") -> "_1060.StraightBevelGearSetDesign":
    ...
    def all_candidate_gear_sets(
        self: "Self",
    ) -> "List[_1060.StraightBevelGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: "Self") -> "List[_1060.StraightBevelGearSetDesign]":
        """List[mastapy.gears.gear_designs.straight_bevel.StraightBevelGearSetDesign]
