...
from mastapy._private.gears import _402, _420, _424
...
class CylindricalGearSetLoadCase(_7722.GearSetLoadCase):
    """CylindricalGearSetLoadCase
    ...
    def efficiency_rating_method(
        self: "Self",
        value: "Union[_443.GearMeshEfficiencyRatingMethod, Tuple[_443.GearMeshEfficiencyRatingMethod, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    def planetary_rating_load_sharing_method(
        self: "Self",
        value: "Union[_424.PlanetaryRatingLoadSharingOption, Tuple[_424.PlanetaryRatingLoadSharingOption, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    @property
    def reset_micro_geometry(self: "Self") -> "_7770.ResetMicroGeometryOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7770",
    ...
    def reset_micro_geometry(
        self: "Self", value: "_7770.ResetMicroGeometryOptions"
    ) -> None:
    ...
    @property
    def ltca(self: "Self") -> "_1162.LTCALoadCaseModifiableSettings":
    ...
    @property
    def gears_load_case(self: "Self") -> "List[_7688.CylindricalGearLoadCase]":
    ...
    def cylindrical_gears_load_case(
        self: "Self",
    ) -> "List[_7688.CylindricalGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.CylindricalGearLoadCase]
    ...
    @property
    def meshes_load_case(self: "Self") -> "List[_7690.CylindricalGearMeshLoadCase]":
    ...
    def cylindrical_meshes_load_case(
        self: "Self",
    ) -> "List[_7690.CylindricalGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.CylindricalGearMeshLoadCase]
    ...
    def get_harmonic_load_data_for_import(
        self: "Self",
    ) -> "_7691.CylindricalGearSetHarmonicLoadData":
