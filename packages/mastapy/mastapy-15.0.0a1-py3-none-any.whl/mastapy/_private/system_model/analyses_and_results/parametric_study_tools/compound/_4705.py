...
class ConceptGearCompoundParametricStudyTool(_4734.GearCompoundParametricStudyTool):
    """ConceptGearCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7668.ConceptGearLoadCase":
