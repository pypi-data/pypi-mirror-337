...
class _Cast_AbstractShaftToMountableComponentConnectionCompoundModalAnalysis:
    ...
    def cycloidal_disc_planetary_bearing_connection_compound_modal_analysis(
        self: "CastSelf",
    ) -> "_5011.CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysis":
        from mastapy._private.system_model.analyses_and_results.modal_analyses.compound import (
            _5011,
        )
    ...
    def shaft_to_mountable_component_connection_compound_modal_analysis(
        self: "CastSelf",
    ) -> "_5064.ShaftToMountableComponentConnectionCompoundModalAnalysis":
        from mastapy._private.system_model.analyses_and_results.modal_analyses.compound import (
            _5064,
        )
...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysis(
    ...
    def connection_analysis_cases(
        self: "Self",
    ) -> "List[_4810.AbstractShaftToMountableComponentConnectionModalAnalysis]":
