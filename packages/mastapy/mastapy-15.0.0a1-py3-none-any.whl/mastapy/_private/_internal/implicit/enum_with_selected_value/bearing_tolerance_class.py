...
class EnumWithSelectedValue_BearingToleranceClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _2089.BearingToleranceClass
        """
        return _2089.BearingToleranceClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2089.BearingToleranceClass.type_()

    @property
    def selected_value(self: "Self") -> "_2089.BearingToleranceClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_2089.BearingToleranceClass]":
