...
class Volatility():
    ...
    def visualize(self, **kwargs):
        ...
        if self.params['graphtype'] == 'line':
            ...
            self.svi_data_dict = GraphData.surface_3d(
                params=self.params, tables=self.tables)
            ...
            self.int_svi_data_dict = GraphData.surface_3d(
                    params=self.params, tables=self.tables)
        else:
    ...
    def data(self, **kwargs):
        ...
        surfacetype : Str
            The type of 3D surface to display from 'trisurf', 'mesh',
            spline', 'svi', 'interactive_mesh', 'interactive_spline' and 'interactive_svi'. The
            default is 'mesh'.
        smoothing : Bool
            Whether to apply polynomial smoothing. The default is False.
        scatter : Bool
