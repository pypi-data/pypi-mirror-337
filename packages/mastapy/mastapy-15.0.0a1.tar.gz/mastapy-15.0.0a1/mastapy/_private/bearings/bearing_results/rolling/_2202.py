...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2201, _2223
...
class LoadedDeepGrooveBallBearingRow(_2192.LoadedBallBearingRow):
    """LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2201.LoadedDeepGrooveBallBearingResults":
