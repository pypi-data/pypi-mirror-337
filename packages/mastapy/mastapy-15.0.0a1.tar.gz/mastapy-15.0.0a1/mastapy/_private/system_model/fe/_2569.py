...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2567, _2596
...
class _Cast_FEEntityGroupWithSelection:
    ...
    def element_face_group_with_selection(
        self: "CastSelf",
    ) -> "_2567.ElementFaceGroupWithSelection":
        from mastapy._private.system_model.fe import _2567

        return self.__parent__._cast(_2567.ElementFaceGroupWithSelection)

    @property
    def node_group_with_selection(self: "CastSelf") -> "_2596.NodeGroupWithSelection":
        from mastapy._private.system_model.fe import _2596

        return self.__parent__._cast(_2596.NodeGroupWithSelection)
