...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1364, _1409
...
class _Cast_MagnetDesign:
    ...
    @property
    def cad_magnets_for_layer(self: "CastSelf") -> "_1364.CADMagnetsForLayer":
        from mastapy._private.electric_machines import _1364

        return self.__parent__._cast(_1364.CADMagnetsForLayer)

    @property
    def magnet_for_layer(self: "CastSelf") -> "_1409.MagnetForLayer":
        from mastapy._private.electric_machines import _1409

        return self.__parent__._cast(_1409.MagnetForLayer)
