...
class EnumWithSelectedValue_LubricantViscosityClassISO(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LubricantViscosityClassISO]",
    ) -> "_348.LubricantViscosityClassISO":
        ...
        Returns:
            _348.LubricantViscosityClassISO
        """
        return _348.LubricantViscosityClassISO
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _348.LubricantViscosityClassISO.type_()

    @property
    def selected_value(self: "Self") -> "_348.LubricantViscosityClassISO":
    ...
    @property
    def available_values(self: "Self") -> "List[_348.LubricantViscosityClassISO]":
