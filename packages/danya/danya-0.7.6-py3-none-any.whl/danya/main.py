...
class Client:
    ...
    def get_response(self, message):
        ...
        # --- Add reasoning_effort specifically for o3-mini and o1 ---
        if self.model in ['o3-mini', 'o1']:
            # You might want to make 'medium' configurable too
            data['reasoning_effort'] = 'medium'

        try:
            response = requests.post(self.url, headers=headers, json=data, timeout=120) # Added timeout
            response.raise_for_status() # Raise an exception for bad status codes (4xx or 5xx)

            # --- Standard response parsing for ALL models ---
            ...
            if 'choices' in json_response and \
               ...
               'content' in json_response['choices'][0]['message']:
                return json_response['choices'][0]['message']['content']
                 ...
                 # Fallback for the structure you originally had for o3-mini/o1
                 # Might indicate the custom endpoint IS inconsistent
            ...
            # Attempt to get raw response text if possible
