...
class V0041OpenapiJobInfoResp(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "jobs": [
                    V0041OpenapiJobInfoRespJobsInner.from_dict(_item)
                    for _item in obj["jobs"]
                ]
                if obj.get("jobs") is not None
                else None,
                "last_backfill": V0041OpenapiJobInfoRespLastBackfill.from_dict(
                    obj["last_backfill"]
                )
                if obj.get("last_backfill") is not None
                else None,
                "last_update": V0041OpenapiJobInfoRespLastUpdate.from_dict(
                    obj["last_update"]
                )
