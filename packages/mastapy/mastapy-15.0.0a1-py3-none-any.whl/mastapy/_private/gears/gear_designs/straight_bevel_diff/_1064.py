...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.straight_bevel_diff import _1062, _1063
...
class StraightBevelDiffGearSetDesign(_1295.BevelGearSetDesign):
    """StraightBevelDiffGearSetDesign
    ...
    @property
    def gears(self: "Self") -> "List[_1062.StraightBevelDiffGearDesign]":
    ...
    def straight_bevel_diff_meshes(
        self: "Self",
    ) -> "List[_1063.StraightBevelDiffGearMeshDesign]":
