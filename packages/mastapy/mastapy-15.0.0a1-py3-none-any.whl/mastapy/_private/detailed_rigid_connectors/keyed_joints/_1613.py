...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.keyed_joints import _1614, _1616
...
class KeyedJointDesign(_1621.InterferenceFitDesign):
    """KeyedJointDesign
    ...
    @property
    def geometry_type(self: "Self") -> "_1614.KeyTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.detailed_rigid_connectors.keyed_joints._1614", "KeyTypes"
        )(value)

    @geometry_type.setter
    @enforce_parameter_types
    def geometry_type(self: "Self", value: "_1614.KeyTypes") -> None:
    ...
    @property
    def number_of_keys(self: "Self") -> "_1616.NumberOfKeys":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.detailed_rigid_connectors.keyed_joints._1616",
            "NumberOfKeys",
        )(value)

    @number_of_keys.setter
    @enforce_parameter_types
    def number_of_keys(self: "Self", value: "_1616.NumberOfKeys") -> None:
        value = conversion.mp_to_pn_enum(
