...
class SKFModuleResults(_0.APIBase):
    ...
    @property
    def adjusted_speed(self: "Self") -> "_2266.AdjustedSpeed":
    ...
    @property
    def bearing_loads(self: "Self") -> "_2268.BearingLoads":
    ...
    @property
    def bearing_rating_life(self: "Self") -> "_2269.BearingRatingLife":
    ...
    @property
    def frequencies(self: "Self") -> "_2271.Frequencies":
    ...
    @property
    def friction(self: "Self") -> "_2273.Friction":
    ...
    @property
    def minimum_load(self: "Self") -> "_2281.MinimumLoad":
    ...
    @property
    def static_safety_factors(self: "Self") -> "_2289.StaticSafetyFactors":
    ...
    @property
    def viscosities(self: "Self") -> "_2290.Viscosities":
