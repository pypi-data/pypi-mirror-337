        ...
        _obj = cls.model_validate(
            {
                ...
                "max": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMax.from_dict(
                    obj["max"]
                )
                if obj.get("max") is not None
                else None,
                "factor": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsFactor.from_dict(
                    obj["factor"]
                )
                if obj.get("factor") is not None
                else None,
                "min": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMin.from_dict(
                    obj["min"]
                )
