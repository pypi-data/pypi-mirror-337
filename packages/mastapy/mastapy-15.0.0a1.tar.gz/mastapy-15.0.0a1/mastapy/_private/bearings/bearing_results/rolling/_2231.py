...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2220, _2248
...
class _Cast_LoadedSphericalRollerRadialBearingStripLoadResults:
    ...
    def loaded_roller_strip_load_results(
        self: "CastSelf",
    ) -> "_2220.LoadedRollerStripLoadResults":
        from mastapy._private.bearings.bearing_results.rolling import _2220

        return self.__parent__._cast(_2220.LoadedRollerStripLoadResults)
