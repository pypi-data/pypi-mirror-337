...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1429, _1435
...
class _Cast_Stator:
    ...
    @property
    def abstract_stator(self: "CastSelf") -> "_1358.AbstractStator":
        return self.__parent__._cast(_1358.AbstractStator)
...
class Stator(_1358.AbstractStator):
    """Stator
    ...
    def stator_cutout_specifications(
        self: "Self",
    ) -> "List[_1429.StatorCutoutSpecification]":
    ...
    @property
    def tooth_and_slot(self: "Self") -> "_1435.ToothAndSlot":
