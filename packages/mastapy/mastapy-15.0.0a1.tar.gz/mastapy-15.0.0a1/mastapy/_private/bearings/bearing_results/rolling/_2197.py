...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2203, _2209, _2217
...
class LoadedCylindricalRollerBearingElement(_2216.LoadedNonBarrelRollerElement):
    """LoadedCylindricalRollerBearingElement
