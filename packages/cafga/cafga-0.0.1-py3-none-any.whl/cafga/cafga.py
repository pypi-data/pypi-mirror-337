...
class CAFGA:
    ...
    def _explain(
        ...
        if partition_tree is not None:
            ...
            self.shap_values = shap.KernelExplainer(self.mask_to_output, empty_mask).shap_values(
                full_mask, 
    ...
    def evaluate(
        ...
        for scalarizer_index, attributions in enumerate(explained_input.attributions):
            ...
            print("Perturbations: ", input_perturbations)
    ...
    def edit_assignments(self,input : str, parser : str):
        ...
        try:
            ...
            raise ImportError("The demo module is required to run this function. It is currently not part of the PyPI release.")
        match parser.lower():
            case "word":
