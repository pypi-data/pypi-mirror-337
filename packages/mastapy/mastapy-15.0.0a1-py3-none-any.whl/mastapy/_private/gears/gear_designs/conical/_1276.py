...
from mastapy._private.gears.gear_designs.conical import _1266
...
class _Cast_DummyConicalGearCutter:
    ...
    @property
    def conical_gear_cutter(self: "CastSelf") -> "_1266.ConicalGearCutter":
        return self.__parent__._cast(_1266.ConicalGearCutter)
...
class DummyConicalGearCutter(_1266.ConicalGearCutter):
    """DummyConicalGearCutter
