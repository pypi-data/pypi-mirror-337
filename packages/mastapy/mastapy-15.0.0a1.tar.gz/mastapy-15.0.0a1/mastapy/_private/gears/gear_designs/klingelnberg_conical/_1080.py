...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.conical import _1281
...
class KlingelnbergConicalGearSetDesign(_1269.ConicalGearSetDesign):
    """KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self: "Self") -> "_1281.KlingelnbergFinishingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.conical._1281",
            "KlingelnbergFinishingMethods",
        )(value)

    @gear_finish.setter
    @enforce_parameter_types
    def gear_finish(self: "Self", value: "_1281.KlingelnbergFinishingMethods") -> None:
    ...
    @property
    def conical_meshes(self: "Self") -> "List[_1079.KlingelnbergConicalGearMeshDesign]":
    ...
    def klingelnberg_conical_meshes(
        self: "Self",
    ) -> "List[_1079.KlingelnbergConicalGearMeshDesign]":
        """List[mastapy.gears.gear_designs.klingelnberg_conical.KlingelnbergConicalGearMeshDesign]
