...
from mastapy._private.nodal_analysis.fe_export_utility import _241
...
class EnumWithSelectedValue_FESubstructuringFileFormat(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_FESubstructuringFileFormat]",
    ) -> "_241.FESubstructuringFileFormat":
        ...
        Returns:
            _241.FESubstructuringFileFormat
        """
        return _241.FESubstructuringFileFormat
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _241.FESubstructuringFileFormat.type_()

    @property
    def selected_value(self: "Self") -> "_241.FESubstructuringFileFormat":
    ...
    @property
    def available_values(self: "Self") -> "List[_241.FESubstructuringFileFormat]":
