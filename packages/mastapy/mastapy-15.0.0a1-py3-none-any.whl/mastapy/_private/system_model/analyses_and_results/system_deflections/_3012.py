...
class ShaftSystemDeflection(_2893.AbstractShaftSystemDeflection):
    """ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4361.ShaftPowerFlow":
    ...
    def shaft_section_end_with_worst_fatigue_safety_factor(
        self: "Self",
    ) -> "_3010.ShaftSectionEndResultsSystemDeflection":
    ...
    @property
    def mounted_components_applying_torque(self: "Self") -> "List[_1735.ForceResults]":
    ...
    def shaft_section_end_results_by_offset_with_worst_safety_factor(
        self: "Self",
    ) -> "List[_3010.ShaftSectionEndResultsSystemDeflection]":
    ...
    def shaft_section_results(
        self: "Self",
    ) -> "List[_3011.ShaftSectionSystemDeflection]":
