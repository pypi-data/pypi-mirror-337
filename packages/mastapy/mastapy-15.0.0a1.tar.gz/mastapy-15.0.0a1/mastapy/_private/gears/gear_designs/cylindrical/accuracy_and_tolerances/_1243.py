...
class _Cast_AGMA2000A88AccuracyGrader:
    ...
    def customer_102agma2000_accuracy_grader(
        self: "CastSelf",
    ) -> "_1247.Customer102AGMA2000AccuracyGrader":
        from mastapy._private.gears.gear_designs.cylindrical.accuracy_and_tolerances import (
            _1247,
        )

        return self.__parent__._cast(_1247.Customer102AGMA2000AccuracyGrader)
...
class AGMA2000A88AccuracyGrader(_1248.CylindricalAccuracyGrader):
    """AGMA2000A88AccuracyGrader
    ...
    @property
    def allowable_pitch_variation(self: "Self") -> "_1257.OverridableTolerance":
    ...
    @property
    def profile_tolerance(self: "Self") -> "_1257.OverridableTolerance":
        """mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances.OverridableTolerance
    ...
    @property
    def radial_runout_tolerance(self: "Self") -> "_1257.OverridableTolerance":
        """mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances.OverridableTolerance
    ...
    @property
    def tooth_alignment_tolerance(self: "Self") -> "_1257.OverridableTolerance":
        """mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances.OverridableTolerance
    ...
    @property
    def toothto_tooth_composite_tolerance(self: "Self") -> "_1257.OverridableTolerance":
        """mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances.OverridableTolerance
    ...
    @property
    def total_composite_tolerance(self: "Self") -> "_1257.OverridableTolerance":
        """mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances.OverridableTolerance
