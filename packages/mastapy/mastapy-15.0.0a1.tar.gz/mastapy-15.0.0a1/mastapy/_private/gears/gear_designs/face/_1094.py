...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.face import _1087
...
class FaceGearWheelDesign(_1086.FaceGearDesign):
    """FaceGearWheelDesign
    ...
    def face_width_and_diameters_specification_method(
        self: "Self",
    ) -> "_1087.FaceGearDiameterFaceWidthSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.face._1087",
    ...
    @enforce_parameter_types
    def face_width_and_diameters_specification_method(
        self: "Self", value: "_1087.FaceGearDiameterFaceWidthSpecificationMethod"
    ) -> None:
