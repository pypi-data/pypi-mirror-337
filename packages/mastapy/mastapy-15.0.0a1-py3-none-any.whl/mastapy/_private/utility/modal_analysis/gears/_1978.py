...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.modal_analysis.gears import _1979, _1982
...
class _Cast_GearOrderForTE:
    ...
    @property
    def order_for_te(self: "CastSelf") -> "_1982.OrderForTE":
        return self.__parent__._cast(_1982.OrderForTE)
...
class GearOrderForTE(_1984.OrderWithRadius):
    """GearOrderForTE
    ...
    @property
    def position(self: "Self") -> "_1979.GearPositions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.modal_analysis.gears._1979", "GearPositions"
        )(value)

    @property
    def additional_orders_and_harmonics(self: "Self") -> "List[_1982.OrderForTE]":
