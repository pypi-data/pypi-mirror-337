...
class StraightBevelDiffGearSetStabilityAnalysis(_4002.BevelGearSetStabilityAnalysis):
    """StraightBevelDiffGearSetStabilityAnalysis
    ...
    def bevel_gears_stability_analysis(
        self: "Self",
    ) -> "List[_4099.StraightBevelDiffGearStabilityAnalysis]":
    ...
    def bevel_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_4097.StraightBevelDiffGearMeshStabilityAnalysis]":
