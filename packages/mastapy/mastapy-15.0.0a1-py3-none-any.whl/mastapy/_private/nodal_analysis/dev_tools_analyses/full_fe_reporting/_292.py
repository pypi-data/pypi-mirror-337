...
from mastapy._private.nodal_analysis.dev_tools_analyses.full_fe_reporting import _288
...
class ElementPropertiesRigid(_288.ElementPropertiesBase):
    """ElementPropertiesRigid
    ...
    def degrees_of_freedom_list(
        self: "Self",
    ) -> "List[_300.RigidElementNodeDegreesOfFreedom]":
