...
class GeometryModellerDimension(_0.APIBase):
    ...
    @property
    def type_(self: "Self") -> "_230.GeometryModellerDimensionType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.geometry_modeller_link._230",
            "GeometryModellerDimensionType",
        )(value)

    @type_.setter
    @enforce_parameter_types
    def type_(self: "Self", value: "_230.GeometryModellerDimensionType") -> None:
