...
TReal = TypeVar("TReal", bound="_2639.Component")
TComponentStaticLoad = TypeVar("TComponentStaticLoad", bound="_7664.ComponentLoadCase")
...
class ComponentStaticLoadCaseGroup(
    _5931.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]
):
    """ComponentStaticLoadCaseGroup
