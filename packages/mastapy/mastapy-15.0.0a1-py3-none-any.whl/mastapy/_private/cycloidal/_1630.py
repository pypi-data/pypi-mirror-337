...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1631, _1634
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def crowning_chart(self: "Self") -> "_2053.TwoDChartDefinition":
    ...
    @property
    def exporter(self: "Self") -> "_1631.CycloidalDiscDesignExporter":
    ...
    def modifications_specification(
        self: "Self",
    ) -> "_1634.CycloidalDiscModificationsSpecification":
