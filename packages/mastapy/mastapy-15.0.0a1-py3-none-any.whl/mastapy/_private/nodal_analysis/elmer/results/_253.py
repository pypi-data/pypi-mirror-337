...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.elmer.results import _254, _255
...
class _Cast_Data:
    ...
    @property
    def data_1d(self: "CastSelf") -> "_254.Data1D":
        from mastapy._private.nodal_analysis.elmer.results import _254

        return self.__parent__._cast(_254.Data1D)

    @property
    def data_3d(self: "CastSelf") -> "_255.Data3D":
        from mastapy._private.nodal_analysis.elmer.results import _255

        return self.__parent__._cast(_255.Data3D)
