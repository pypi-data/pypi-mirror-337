...
class _Cast_CylindricalGearRootFilletStressResults:
    ...
    def gear_root_fillet_stress_results(
        self: "CastSelf",
    ) -> "_941.GearRootFilletStressResults":
        return self.__parent__._cast(_941.GearRootFilletStressResults)
...
class CylindricalGearRootFilletStressResults(_941.GearRootFilletStressResults):
    """CylindricalGearRootFilletStressResults
