...
class EnumWithSelectedValue_EndWindingCoolingFlowSource(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_EndWindingCoolingFlowSource]",
    ) -> "_1458.EndWindingCoolingFlowSource":
        ...
        Returns:
            _1458.EndWindingCoolingFlowSource
        """
        return _1458.EndWindingCoolingFlowSource
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1458.EndWindingCoolingFlowSource.type_()

    @property
    def selected_value(self: "Self") -> "_1458.EndWindingCoolingFlowSource":
    ...
    @property
    def available_values(self: "Self") -> "List[_1458.EndWindingCoolingFlowSource]":
