...
from pytessng.UserInterface.public import BaseUIVirtual, BaseMouse, TextWindowItem
...
class NetEditModifyLinkPoints(BaseUIVirtual):
    ...
    def __init__(self):
        super().__init__()
        # 按钮
        self.action: QAction = GlobalVar.actions_related_to_mouse_event["modify_link_points"]
        # 将按钮与状态改变函数关联
