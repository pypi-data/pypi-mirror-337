...
class CLIController:
    ...
    def parse_args(self, args=None):
        ...
        updateparser = parser.add_subparsers(required=False, dest='updatedb')

        update_parser = updateparser.add_parser('update', help='Database operations')
    ...
    def main(self, args=None):
        ...
        try:
            ...
            if parsed_args.updatedb == 'update':
