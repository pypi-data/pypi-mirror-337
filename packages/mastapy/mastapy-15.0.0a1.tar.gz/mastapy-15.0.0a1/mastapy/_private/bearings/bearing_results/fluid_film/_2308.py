...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.fluid_film import _2316, _2319
...
class _Cast_LoadedFluidFilmBearingPad:
    ...
    @property
    def loaded_tilting_journal_pad(self: "CastSelf") -> "_2316.LoadedTiltingJournalPad":
        from mastapy._private.bearings.bearing_results.fluid_film import _2316

        return self.__parent__._cast(_2316.LoadedTiltingJournalPad)

    @property
    def loaded_tilting_thrust_pad(self: "CastSelf") -> "_2319.LoadedTiltingThrustPad":
        from mastapy._private.bearings.bearing_results.fluid_film import _2319

        return self.__parent__._cast(_2319.LoadedTiltingThrustPad)
