...
from glik_plugin_local.entities.model import EmbeddingInputType, ModelPropertyKey, ModelType
from glik_plugin_local.entities.model.text_embedding import TextEmbeddingResult
