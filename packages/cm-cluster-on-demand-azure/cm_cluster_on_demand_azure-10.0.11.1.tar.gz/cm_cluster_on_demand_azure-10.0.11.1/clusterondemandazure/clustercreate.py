...
class ClusterCreate(ClusterCommand):
    ...
    def deploy_private_endpoint_for_storage_account(self):
        ...
        plink_deployment_parameters = {
            ...
            "private_dns_deployment_name": {"value": f"{self.cluster_name}-pdns"},
            "private_dns_zone_name": {"value": f"{self.cluster_name}-pdns-zone"},
            "dns_zone_group_name": {"value": f"{self.cluster_name}-dns-zone-group"},
            "private_dns_zone_config_name": {"value": f"{self.cluster_name}-pdns-zone_config"},
        }
