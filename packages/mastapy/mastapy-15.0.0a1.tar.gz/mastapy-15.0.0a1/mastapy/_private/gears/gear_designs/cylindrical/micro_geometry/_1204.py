...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.analysis import _1329, _1335
    from mastapy._private.gears.gear_designs.cylindrical import _1121, _1129
...
class CylindricalGearMeshMicroGeometry(_1338.GearMeshImplementationDetail):
    """CylindricalGearMeshMicroGeometry
    ...
    @property
    def left_flank_lead_modification_chart(self: "Self") -> "_2053.TwoDChartDefinition":
    ...
    @property
    def cylindrical_mesh(self: "Self") -> "_1121.CylindricalGearMeshDesign":
    ...
    def cylindrical_gear_micro_geometries_specified_per_tooth(
        self: "Self",
    ) -> "List[_1210.CylindricalGearMicroGeometryPerTooth]":
    ...
    @property
    def gear_a(self: "Self") -> "_1207.CylindricalGearMicroGeometryBase":
    ...
    @property
    def gear_b(self: "Self") -> "_1207.CylindricalGearMicroGeometryBase":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearMicroGeometryBase
