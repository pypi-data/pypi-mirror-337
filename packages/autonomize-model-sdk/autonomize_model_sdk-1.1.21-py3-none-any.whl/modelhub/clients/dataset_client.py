...
class DatasetClient(BaseClient):
    ...
    def __init__(
        ...
        Args:
            ...
            sa_client_id (str, optional): The client ID for authentication. Defaults to None.
            sa_client_secret (str, optional): The client secret for authentication. Defaults to None.
