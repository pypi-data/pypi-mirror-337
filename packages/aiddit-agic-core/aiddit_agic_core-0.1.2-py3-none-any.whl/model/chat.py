...
from image_article_comprehension.model.open_router import OpenRouter
import logging
import sseclient
import requests
import json
...
def deepseek(prompt, model="deepseek-chat", temperature=1, response_format_json=True, try_cnt=0):
    client = OpenAI(api_key="sk-3c58e9c29cf54217a663037e9450d1a3", base_url="https://api.deepseek.com")
...
def aliyun_deepseek_r1(prompt):
    client = OpenAI(
        ...
        api_key="sk-70217c2951b44c15b9e5a5c0e432adf3",
...
def tencent_cloud_deepseek_r1(prompt):
    client = OpenAI(
        # 若没有配置环境变量，请用百炼API Key将下行替换为：api_key="sk-xxx",
        api_key="sk-fEOMaGRWiGNxnmA7B2l4U3px0nHF7nLONt4XVL6cRAaM0uPm",
        # 如何获取API Key：https://help.aliyun.com/zh/model-studio/developer-reference/get-api-key
...
if __name__ == "__main__":
    ...
    import image_article_comprehension.model.dsr3 as dsr3
