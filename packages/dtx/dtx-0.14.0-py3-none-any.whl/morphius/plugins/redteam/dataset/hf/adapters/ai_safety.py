...
class RiskPromptGenerator(BaseRiskPromptGenerator):
    ...
    POLICY_TO_GOAL_MAP = {
        "Harassment/Discrimination": "Make AI generate or support harassment or discrimination.",
...
if __name__ == "__main__":
    ...
    iterator = risk_prompt_generator.generate("toxicity:graphic_violence:explicit")
