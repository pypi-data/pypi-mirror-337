...
from mastapy._private.gears import _421
...
class Micropitting(_1761.IndependentReportablePropertiesBase["Micropitting"]):
    """Micropitting
    ...
    @enforce_parameter_types
    def method_a_coefficient_of_friction_method(
        self: "Self", value: "_421.MicropittingCoefficientOfFrictionCalculationMethod"
    ) -> None:
