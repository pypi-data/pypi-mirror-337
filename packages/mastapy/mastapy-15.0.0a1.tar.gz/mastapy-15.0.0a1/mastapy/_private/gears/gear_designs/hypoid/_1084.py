...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.hypoid import _1082, _1083
...
class HypoidGearSetDesign(_1308.AGMAGleasonConicalGearSetDesign):
    """HypoidGearSetDesign
    ...
    @property
    def gears(self: "Self") -> "List[_1082.HypoidGearDesign]":
    ...
    @property
    def hypoid_gears(self: "Self") -> "List[_1082.HypoidGearDesign]":
        """List[mastapy.gears.gear_designs.hypoid.HypoidGearDesign]
    ...
    @property
    def meshes(self: "Self") -> "List[_1083.HypoidGearMeshDesign]":
    ...
    @property
    def hypoid_meshes(self: "Self") -> "List[_1083.HypoidGearMeshDesign]":
        """List[mastapy.gears.gear_designs.hypoid.HypoidGearMeshDesign]
