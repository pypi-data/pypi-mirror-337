...
class GeneralTransmissionProperties(_0.APIBase):
    ...
    def bearing_iso762006_static_safety_factor_limit(
        self: "Self",
    ) -> "_342.ISO76StaticSafetyFactorLimits":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._342", "ISO76StaticSafetyFactorLimits"
        )(value)

    @bearing_iso762006_static_safety_factor_limit.setter
    @enforce_parameter_types
    def bearing_iso762006_static_safety_factor_limit(
        self: "Self", value: "_342.ISO76StaticSafetyFactorLimits"
    ) -> None:
    ...
    @property
    def driven_machine_characteristics(self: "Self") -> "_375.WorkingCharacteristics":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._375", "WorkingCharacteristics"
        )(value)

    @driven_machine_characteristics.setter
    @enforce_parameter_types
    def driven_machine_characteristics(
        self: "Self", value: "_375.WorkingCharacteristics"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def driving_machine_characteristics(self: "Self") -> "_375.WorkingCharacteristics":
        """mastapy.materials.WorkingCharacteristics"""
    ...
    @property
    def gearing_type(self: "Self") -> "_338.GearingTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._338", "GearingTypes"
        )(value)

    @gearing_type.setter
    @enforce_parameter_types
    def gearing_type(self: "Self", value: "_338.GearingTypes") -> None:
    ...
    @property
    def transmission_application(self: "Self") -> "_371.TransmissionApplications":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._371", "TransmissionApplications"
        )(value)

    @transmission_application.setter
    @enforce_parameter_types
    def transmission_application(
        self: "Self", value: "_371.TransmissionApplications"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def wind_turbine_standard(self: "Self") -> "_374.WindTurbineStandards":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._374", "WindTurbineStandards"
        )(value)

    @wind_turbine_standard.setter
    @enforce_parameter_types
    def wind_turbine_standard(self: "Self", value: "_374.WindTurbineStandards") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def air_properties(self: "Self") -> "_324.AirProperties":
    ...
    @property
    def vehicle_dynamics(self: "Self") -> "_373.VehicleDynamicsProperties":
