...
class File(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "revisions", "archive_status_history", "resource_id", "resource_type", "created_by_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "revisions": [FileRevision.from_dict(_item) for _item in obj["revisions"]] if obj.get("revisions") is not None else None,
            "archive_status_history": [FileArchiveStatus.from_dict(_item) for _item in obj["archive_status_history"]] if obj.get("archive_status_history") is not None else None,
