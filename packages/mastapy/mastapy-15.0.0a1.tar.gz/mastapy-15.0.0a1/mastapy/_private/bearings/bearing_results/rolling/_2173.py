...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2172, _2176, _2223
...
class LoadedAngularContactBallBearingRow(_2192.LoadedBallBearingRow):
    """LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2172.LoadedAngularContactBallBearingResults":
