...
async def router_task_by_unique_key_for_namespace_get(unique_key: str,namespace:str) -> TEventixTask:
    ret= task_by_unique_key(unique_key=unique_key,namespace=namespace)
    return ret
