...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_set_pareto_optimiser import _1007, _1013
...
class _Cast_DesignSpaceSearchCandidateBase:
    ...
    def gear_set_optimiser_candidate(
        self: "CastSelf",
    ) -> "_1007.GearSetOptimiserCandidate":
        from mastapy._private.gears.gear_set_pareto_optimiser import _1007

        return self.__parent__._cast(_1007.GearSetOptimiserCandidate)
    ...
    def micro_geometry_design_space_search_candidate(
        ...
        return self.__parent__._cast(_1013.MicroGeometryDesignSpaceSearchCandidate)
