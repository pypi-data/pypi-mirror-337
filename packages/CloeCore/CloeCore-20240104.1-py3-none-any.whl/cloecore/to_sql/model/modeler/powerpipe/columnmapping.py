...
class PPColumnMappingGenerator:
    """Generates and controls powerpipe column level snippet generation."""

    def __init__(self, column_mapping: PPColumnMapping, sql_syntax: SQLSyntax) -> None:
        self.bk_order = column_mapping.bk_order
        self.sink_table_id = column_mapping.sink_table_id
        self.source_column_name = column_mapping.source_column_name
        self._sink_column_name = column_mapping.sink_column_name
        self.calculation = column_mapping.calculation
        self.convert_to_datatype = column_mapping.convert_to_datatype
        self.is_insert = column_mapping.is_insert
        self.is_update = column_mapping.is_update
        self.is_load_on_convert_error = column_mapping.is_load_on_convert_error
        self.is_logging_on_convert_error = column_mapping.is_logging_on_convert_error
        self.on_convert_error_value = column_mapping.on_convert_error_value
        self.on_null_value = column_mapping.on_null_value
        self.sink_table = column_mapping.sink_table
        self.sql_syntax = sql_syntax
        self.null_check_template: Template
    ...
    def _get_column_base(
        ...
        Args:
            prioritize_name (bool | None, optional): _description_. Defaults to True.
            with_alias (bool | None, optional): _description_. Defaults to False.
        ...
        raise ValueError("Neither calculation nor source_column_name are set")
    ...
    def _get_on_null(self, prioritize_calculation: bool | None = None) -> str:
        ...
        Args:
            prioritize_calculation (bool | None, optional): _description_. Defaults
            to False.
        ...
        if self.on_null_value and prioritize_calculation is None:
            return self.sql_syntax.column_null_handling(
    ...
    def _get_dq_handling(
        ...
        Args:
            error_handling (bool): _description_
            prioritize_calculation (bool | None, optional): _description_.
            Defaults to False.
    ...
    def gen_all(
        ...
        template_artifacts: utils.Artifacts,
    ) -> None:
        ...
        Args:
            ...
            null_check_template (Template): _description_
