...
class TokenWithProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "sha", "salt", "name", "extension", "size", "description", "mime", "version_name", "external_identifier", "display_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TokenWithProperties from a JSON string"""
