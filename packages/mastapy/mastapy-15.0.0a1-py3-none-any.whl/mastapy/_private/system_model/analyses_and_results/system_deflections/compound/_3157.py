...
class ShaftCompoundSystemDeflection(_3060.AbstractShaftCompoundSystemDeflection):
    """ShaftCompoundSystemDeflection
    ...
    def shaft_duty_cycle_damage_results(
        self: "Self",
    ) -> "_3158.ShaftDutyCycleSystemDeflection":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3012.ShaftSystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_3012.ShaftSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection]
