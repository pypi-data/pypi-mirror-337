...
class EmaModel(EmaObject):
    ...
    def __init__(self, base, groups, rng):
        """
        :param base: global constant EmaParamBase object, used by all model parts
        ...
        """
        self.base = base   # needed? use ref to ema_base.EMA_BASE instead?
        self.groups = groups
        self.rng = rng
    ...
    def initialize(cls, ds, effects,
        ...
        # base_OLD = EmaParamBase.initialize(ds.emf, effects, rv_class,
