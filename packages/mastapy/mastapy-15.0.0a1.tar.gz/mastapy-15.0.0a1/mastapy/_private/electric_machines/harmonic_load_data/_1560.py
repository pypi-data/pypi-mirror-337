...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.harmonic_load_data import _1561, _1562
...
class _Cast_StatorToothInterpolator:
    ...
    def stator_tooth_load_interpolator(
        ...
        from mastapy._private.electric_machines.harmonic_load_data import _1561

        return self.__parent__._cast(_1561.StatorToothLoadInterpolator)
    ...
    def stator_tooth_moment_interpolator(
        ...
        return self.__parent__._cast(_1562.StatorToothMomentInterpolator)
