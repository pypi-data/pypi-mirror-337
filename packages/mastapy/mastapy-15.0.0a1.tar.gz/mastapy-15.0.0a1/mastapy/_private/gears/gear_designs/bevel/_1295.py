...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.bevel import _1302, _1304
    from mastapy._private.gears.gear_designs.conical import _1264, _1269
...
class BevelGearSetDesign(_1308.AGMAGleasonConicalGearSetDesign):
    """BevelGearSetDesign
    ...
    @property
    def backlash_distribution_rule(self: "Self") -> "_1264.BacklashDistributionRule":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.conical._1264",
    ...
    def backlash_distribution_rule(
        self: "Self", value: "_1264.BacklashDistributionRule"
    ) -> None:
    ...
    def backlash_used_for_tooth_thickness_calculation(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1694", "MaxMinMean"
        )(value)

    @backlash_used_for_tooth_thickness_calculation.setter
    @enforce_parameter_types
    def backlash_used_for_tooth_thickness_calculation(
        self: "Self", value: "_1694.MaxMinMean"
    ) -> None:
    ...
    def round_cutter_specifications(
        self: "Self",
    ) -> "_1304.WheelFinishCutterPointWidthRestrictionMethod":
    ...
    @enforce_parameter_types
    def round_cutter_specifications(
        self: "Self", value: "_1304.WheelFinishCutterPointWidthRestrictionMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Bevel.WheelFinishCutterPointWidthRestrictionMethod",
    ...
    def tooth_proportions_input_method(
        self: "Self",
    ) -> "_1302.ToothProportionsInputMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.bevel._1302",
    ...
    @enforce_parameter_types
    def tooth_proportions_input_method(
        self: "Self", value: "_1302.ToothProportionsInputMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def tooth_taper_root_line_tilt_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._430", "SpiralBevelRootLineTilt"
        )(value)

    @tooth_taper_root_line_tilt_method.setter
    @enforce_parameter_types
    def tooth_taper_root_line_tilt_method(
        self: "Self", value: "_430.SpiralBevelRootLineTilt"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def tooth_thickness_specification_method(
        self: "Self", value: "_1303.ToothThicknessSpecificationMethod"
    ) -> None:
