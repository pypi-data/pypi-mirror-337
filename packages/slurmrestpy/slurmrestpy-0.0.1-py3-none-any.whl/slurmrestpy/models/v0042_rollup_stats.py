...
class V0042RollupStats(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "hourly": V0042RollupStatsHourly.from_dict(obj["hourly"])
                if obj.get("hourly") is not None
                else None,
                "daily": V0042RollupStatsDaily.from_dict(obj["daily"])
                if obj.get("daily") is not None
                else None,
                "monthly": V0042RollupStatsMonthly.from_dict(obj["monthly"])
                if obj.get("monthly") is not None
                else None,
            }
        )
        return _obj
