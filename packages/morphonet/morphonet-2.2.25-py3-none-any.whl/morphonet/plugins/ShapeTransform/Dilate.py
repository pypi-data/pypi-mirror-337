...
class Dilate(MorphoPlugin):
    ...
    def __init__(self): #PLUGIN DEFINITION
        ...
        self.set_icon_name("Dilate.png")
        self.set_image_name("Dilate.png")
        self.set_name("Dilate : Dilate the selected objects")
            ...
            for t in dataset.get_times(objects):#For each time points in selected object
                ...
                if data is not None:
                    ...
                    for o in dataset.get_objects_at(objects,t):
                        printv('Dilate the object ' + str(o.get_name()), 0)
                        ...
                        dilate_box = np.uint8(binary_dilation(databox==o.id,np.ones(kernel)))
                        if background_only:
                        ...
                        databox[where] = dilate_box[where]*o.id
