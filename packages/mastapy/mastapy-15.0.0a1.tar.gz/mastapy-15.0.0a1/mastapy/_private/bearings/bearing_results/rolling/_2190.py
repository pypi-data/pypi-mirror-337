...
class _Cast_LoadedBallBearingRaceResults:
    ...
    def loaded_rolling_bearing_race_results(
        self: "CastSelf",
    ) -> "_2221.LoadedRollingBearingRaceResults":
        return self.__parent__._cast(_2221.LoadedRollingBearingRaceResults)

    @property
    def loaded_four_point_contact_ball_bearing_race_results(
        self: "CastSelf",
    ) -> "_2205.LoadedFourPointContactBallBearingRaceResults":
        from mastapy._private.bearings.bearing_results.rolling import _2205

        return self.__parent__._cast(_2205.LoadedFourPointContactBallBearingRaceResults)
...
class LoadedBallBearingRaceResults(_2221.LoadedRollingBearingRaceResults):
    """LoadedBallBearingRaceResults
