...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import _837
...
class RoughCutterCreationSettings(_0.APIBase):
    ...
    def finish_tool_clearances(
        self: "Self",
    ) -> "_837.ManufacturingOperationConstraints":
    ...
    @property
    def rough_tool_clearances(self: "Self") -> "_837.ManufacturingOperationConstraints":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.ManufacturingOperationConstraints
