...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2205, _2206, _2223
...
class LoadedFourPointContactBallBearingRow(_2192.LoadedBallBearingRow):
    """LoadedFourPointContactBallBearingRow
    ...
    def race_results(
        self: "Self",
    ) -> "List[_2205.LoadedFourPointContactBallBearingRaceResults]":
