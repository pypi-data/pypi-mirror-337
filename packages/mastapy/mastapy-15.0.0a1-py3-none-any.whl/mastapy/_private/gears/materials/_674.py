...
class _Cast_CoefficientOfFrictionCalculator:
    ...
    def instantaneous_coefficient_of_friction_calculator(
        self: "CastSelf",
    ) -> "_684.InstantaneousCoefficientOfFrictionCalculator":
        from mastapy._private.gears.materials import _684

        return self.__parent__._cast(_684.InstantaneousCoefficientOfFrictionCalculator)

    @property
    def iso14179_part_1_coefficient_of_friction_calculator(
        self: "CastSelf",
    ) -> "_685.ISO14179Part1CoefficientOfFrictionCalculator":
        from mastapy._private.gears.materials import _685

        return self.__parent__._cast(_685.ISO14179Part1CoefficientOfFrictionCalculator)

    @property
    def iso14179_part_2_coefficient_of_friction_calculator(
        self: "CastSelf",
    ) -> "_686.ISO14179Part2CoefficientOfFrictionCalculator":
        from mastapy._private.gears.materials import _686

        return self.__parent__._cast(_686.ISO14179Part2CoefficientOfFrictionCalculator)

    @property
    def iso14179_part_2_coefficient_of_friction_calculator_base(
        self: "CastSelf",
    ) -> "_687.ISO14179Part2CoefficientOfFrictionCalculatorBase":
    ...
    def iso14179_part_2_coefficient_of_friction_calculator_with_martins_modification(
        self: "CastSelf",
    ) -> "_688.ISO14179Part2CoefficientOfFrictionCalculatorWithMartinsModification":
