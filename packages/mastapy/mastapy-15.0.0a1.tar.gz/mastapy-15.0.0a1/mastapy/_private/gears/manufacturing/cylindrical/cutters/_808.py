...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears import _416, _434
    from mastapy._private.gears.manufacturing.cylindrical.cutters import (
        _802,
        _804,
        _805,
    )
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _826
...
class CylindricalGearRackDesign(_809.CylindricalGearRealCutterDesign):
    """CylindricalGearRackDesign
    ...
    @property
    def worm_type(self: "Self") -> "_434.WormType":
        ...
        return constructor.new_from_mastapy("mastapy._private.gears._434", "WormType")(
            value
        )

    @worm_type.setter
    @enforce_parameter_types
    def worm_type(self: "Self", value: "_434.WormType") -> None:
