...
class FaceGearMicroGeometry(_1334.GearImplementationDetail):
    """FaceGearMicroGeometry
    ...
    @property
    def face_gear(self: "Self") -> "_1086.FaceGearDesign":
    ...
    @property
    def micro_geometry(self: "Self") -> "_1207.CylindricalGearMicroGeometryBase":
