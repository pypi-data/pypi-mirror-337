from setuptools import setup    # Эта библиотека используется для создания пакетов


# Вызываем импортированную библиотеку:
setup(
  name = 'invoicing-2-pdf-from-excel',         #* Your package will have this name
