...
from .utils import download_file, is_device_connected, is_port_using, str2byte
...
class MNTServer(object):
    ...
    def isconnected(self):
        line = self.mnt_process.stdout.readline()
        logger.debug(f"minitouch server stdout: {line}")
        self._connected = "Connection established" in line
