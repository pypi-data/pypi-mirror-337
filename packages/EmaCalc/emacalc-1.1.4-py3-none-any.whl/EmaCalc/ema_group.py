...
from EmaCalc import ema_base

# -------------------------------------------------------------------
__ModelVersion__ = "2025-03-30"
...
class EmaGroupModel(EmaObject):
    ...
    """
    def __init__(self, participants, pop_gmm):
        """
    ...
    def adapt(self, g_name):
        ...
        if usePool:
            ...
            with Pool(n_pool) as p:
                ...
                # for s in self.participants.values():  # **** not needed in v 1.1.3
...
class PopulationModel:  # (EmaObject):
    ...
    """
    def __init__(self, mix_weight, comp, rng):
        """
    ...
    def merge(cls, p_models, weight):
        ...
        return cls(mix_weight, comp, rng)
    ...
    def predictive_population_ind(self):
        ...
        return PredictivePopulationModel(comp, self.mix_weight.mean, self.rng)
