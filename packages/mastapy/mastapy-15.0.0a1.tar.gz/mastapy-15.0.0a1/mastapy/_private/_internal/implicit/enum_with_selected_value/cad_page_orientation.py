...
from mastapy._private.utility.report import _1923
...
class EnumWithSelectedValue_CadPageOrientation(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1923.CadPageOrientation
        """
        return _1923.CadPageOrientation
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_CadPageOrientation]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1923.CadPageOrientation.type_()

    @property
    def selected_value(self: "Self") -> "_1923.CadPageOrientation":
    ...
    @property
    def available_values(self: "Self") -> "List[_1923.CadPageOrientation]":
