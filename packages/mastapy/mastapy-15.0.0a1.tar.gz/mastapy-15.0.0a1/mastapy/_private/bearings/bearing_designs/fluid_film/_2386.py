...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2063, _2086
...
class TiltingPadThrustBearing(_2378.PadFluidFilmBearing):
    """TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self: "Self") -> "_2086.TiltingPadTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2086", "TiltingPadTypes"
        )(value)

    @tilting_pad_type.setter
    @enforce_parameter_types
    def tilting_pad_type(self: "Self", value: "_2086.TiltingPadTypes") -> None:
