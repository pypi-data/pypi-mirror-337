...
from PySide2.QtWidgets import QMenu, QAction, QWidget, QToolBar
...
from .public import Utils, MousePanHandler, MouseZoomHandler
...
from .ui1_net_import.NetImportAnnex import NetImportAnnex
...
from .ui6_net_edit.NetEditComplicateLinkPoints import NetEditComplicateLinkPoints
...
from .ui8_other.OpenInstruction import OpenInstruction
...
class MyMenu(BaseTess):
    ...
    action_name_and_class_mapping: Dict[str, Dict[str, tuple]] = {
        "net_import": {
            ...
            "annex": ("action_net_import_annex", NetImportAnnex),
        },
        "net_export": {
        ...
        "net_edit": {
            ...
            "complicate_link_points": ("action_net_edit_complicate_link_points", NetEditComplicateLinkPoints),
        ...
        "other": {
            "open_instruction": ("action_other_open_instruction", OpenInstruction),
    ...
    def _create_actions(self) -> None:
        ...
        self.action_net_import_annex = QAction("导入路网元素 (.json)")
        ...
        self.action_net_edit_complicate_link_points = QAction("加密路段点位（路网级）")
        ...
        # =============== 8.帮助 ===============
        self.action_other_open_instruction = QAction("打开说明书")
    ...
    def _create_menus(self) -> None:
        ...
        self.menu_net_edit = QMenu("路网编辑")
        self.menu_net_view = QMenu("路网查看")
    ...
    def _add_action_to_menu(self):
        ...
        action_network_edit_list = [
            ...
            self.action_net_edit_complicate_link_points,
        ...
        self.menu_net_edit.addActions(action_network_edit_list[:5])
        self.menu_net_edit.addSeparator()
        self.menu_net_edit.addActions(action_network_edit_list[5:])
        ...
        # 其他
        action_other_list = [
            self.action_other_open_instruction,
    ...
    def _apply_action(self, first_class: str, second_class: str) -> None:
        # =============== 特殊情况特殊处理 ===============
        if first_class == "net_import" and second_class == "osm":
            messages = {
                "title": "OSM导入模式",
            ...
            result: int = self.utils.show_confirm_dialog(messages)
