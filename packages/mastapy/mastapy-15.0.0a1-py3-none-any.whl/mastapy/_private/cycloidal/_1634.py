...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1628, _1635
...
class CycloidalDiscModificationsSpecification(_0.APIBase):
    ...
    def crowning_specification_method(
        self: "Self",
    ) -> "_1628.CrowningSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.cycloidal._1628", "CrowningSpecificationMethod"
        )(value)

    @crowning_specification_method.setter
    @enforce_parameter_types
    def crowning_specification_method(
        self: "Self", value: "_1628.CrowningSpecificationMethod"
    ) -> None:
    ...
    def direction_of_measured_modifications(
        self: "Self",
    ) -> "_1635.DirectionOfMeasuredModifications":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.cycloidal._1635", "DirectionOfMeasuredModifications"
        )(value)

    @direction_of_measured_modifications.setter
    @enforce_parameter_types
    def direction_of_measured_modifications(
        self: "Self", value: "_1635.DirectionOfMeasuredModifications"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def measured_profile_modification(self: "Self") -> "_1709.Vector2DListAccessor":
