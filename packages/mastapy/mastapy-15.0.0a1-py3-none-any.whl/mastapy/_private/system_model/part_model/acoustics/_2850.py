...
from mastapy._private.system_model import _2395
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2847, _2848
...
class _Cast_ResultSurfaceOptions:
    ...
    @property
    def result_plane_options(self: "CastSelf") -> "_2847.ResultPlaneOptions":
        from mastapy._private.system_model.part_model.acoustics import _2847

        return self.__parent__._cast(_2847.ResultPlaneOptions)

    @property
    def result_sphere_options(self: "CastSelf") -> "_2848.ResultSphereOptions":
        from mastapy._private.system_model.part_model.acoustics import _2848

        return self.__parent__._cast(_2848.ResultSphereOptions)
...
class ResultSurfaceOptions(_0.APIBase):
    ...
    @enforce_parameter_types
    def reference_component(self: "Self", value: "_2639.Component") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def reference_component_type(self: "Self", value: "_2395.DesignEntityId") -> None:
