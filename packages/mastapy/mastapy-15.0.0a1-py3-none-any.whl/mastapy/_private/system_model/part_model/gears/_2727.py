...
class CylindricalGear(_2732.Gear):
    """CylindricalGear
    ...
    @property
    def active_gear_design(self: "Self") -> "_1115.CylindricalGearDesign":
    ...
    @property
    def cylindrical_gear_design(self: "Self") -> "_1115.CylindricalGearDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearDesign
