...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.property import _2024, _2025, _2026, _2027, _2028
...
TMeasurement = TypeVar("TMeasurement", bound="_1780.MeasurementBase")
T = TypeVar("T")
...
class _Cast_DutyCyclePropertySummary:
    ...
    def duty_cycle_property_summary_force(
        self: "CastSelf",
    ) -> "_2024.DutyCyclePropertySummaryForce":
        from mastapy._private.utility.property import _2024

        return self.__parent__._cast(_2024.DutyCyclePropertySummaryForce)

    @property
    def duty_cycle_property_summary_percentage(
        self: "CastSelf",
    ) -> "_2025.DutyCyclePropertySummaryPercentage":
        from mastapy._private.utility.property import _2025

        return self.__parent__._cast(_2025.DutyCyclePropertySummaryPercentage)

    @property
    def duty_cycle_property_summary_small_angle(
        self: "CastSelf",
    ) -> "_2026.DutyCyclePropertySummarySmallAngle":
        from mastapy._private.utility.property import _2026

        return self.__parent__._cast(_2026.DutyCyclePropertySummarySmallAngle)

    @property
    def duty_cycle_property_summary_stress(
        self: "CastSelf",
    ) -> "_2027.DutyCyclePropertySummaryStress":
        from mastapy._private.utility.property import _2027

        return self.__parent__._cast(_2027.DutyCyclePropertySummaryStress)

    @property
    def duty_cycle_property_summary_very_short_length(
        self: "CastSelf",
    ) -> "_2028.DutyCyclePropertySummaryVeryShortLength":
        from mastapy._private.utility.property import _2028

        return self.__parent__._cast(_2028.DutyCyclePropertySummaryVeryShortLength)
