...
class CylindricalGearPinionTypeCutter(_1109.CylindricalGearAbstractRack):
    """CylindricalGearPinionTypeCutter
    ...
    @property
    def left_flank(self: "Self") -> "_1127.CylindricalGearPinionTypeCutterFlank":
    ...
    @property
    def right_flank(self: "Self") -> "_1127.CylindricalGearPinionTypeCutterFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearPinionTypeCutterFlank
