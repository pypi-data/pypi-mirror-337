...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.worm import _457, _458
...
class WormGearSetRating(_447.GearSetRating):
    """WormGearSetRating
    ...
    @property
    def worm_gear_set(self: "Self") -> "_1056.WormGearSetDesign":
    ...
    @property
    def gear_ratings(self: "Self") -> "List[_458.WormGearRating]":
    ...
    @property
    def worm_gear_ratings(self: "Self") -> "List[_458.WormGearRating]":
        """List[mastapy.gears.rating.worm.WormGearRating]
    ...
    @property
    def gear_mesh_ratings(self: "Self") -> "List[_457.WormGearMeshRating]":
    ...
    @property
    def worm_mesh_ratings(self: "Self") -> "List[_457.WormGearMeshRating]":
        """List[mastapy.gears.rating.worm.WormGearMeshRating]
