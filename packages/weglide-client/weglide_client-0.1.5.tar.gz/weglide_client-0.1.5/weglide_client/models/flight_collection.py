...
class FlightCollection(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "private", "image", "hex_color", "created", "flight_count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FlightCollection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FlightCollection from a dict"""
        if obj is None:
            return None
