...
class StraightBevelGearSetModalAnalysis(_4825.BevelGearSetModalAnalysis):
    """StraightBevelGearSetModalAnalysis
    ...
    def bevel_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4930.StraightBevelGearModalAnalysis]":
    ...
    def bevel_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4929.StraightBevelGearMeshModalAnalysis]":
