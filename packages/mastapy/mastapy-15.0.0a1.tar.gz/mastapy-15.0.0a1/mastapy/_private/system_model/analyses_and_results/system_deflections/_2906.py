...
class BeltDriveSystemDeflection(_3014.SpecialisedAssemblySystemDeflection):
    """BeltDriveSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4268.BeltDrivePowerFlow":
    ...
    @property
    def belts(self: "Self") -> "List[_2905.BeltConnectionSystemDeflection]":
