        ...
        if include_optional:
            return V0042AssocSharesObjWrap(
                ...
                effective_usage = slurmrestpy.models.v0/0/42_float64_no_val_struct.v0.0.42_float64_no_val_struct(
                    ...
                    infinite = True,
                    number = 1.337, ),
                usage_normalized = slurmrestpy.models.v0/0/42_float64_no_val_struct.v0.0.42_float64_no_val_struct(
                    set = True,
                    infinite = True,
                    number = 1.337, ),
                usage = 56,
                fairshare = slurmrestpy.models.v0_0_42_assoc_shares_obj_wrap_fairshare.v0_0_42_assoc_shares_obj_wrap_fairshare(
                    factor = slurmrestpy.models.v0/0/42_float64_no_val_struct.v0.0.42_float64_no_val_struct(
                        ...
                        infinite = True,
                        number = 1.337, ),
                    level = slurmrestpy.models.v0/0/42_float64_no_val_struct.v0.0.42_float64_no_val_struct(
                        set = True,
                        infinite = True,
                        number = 1.337, ), ),
                type = [
