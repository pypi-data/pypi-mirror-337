...
class FaceGearMesh(_2504.GearMesh):
    """FaceGearMesh
    ...
    @property
    def active_gear_mesh_design(self: "Self") -> "_1088.FaceGearMeshDesign":
    ...
    @property
    def face_gear_mesh_design(self: "Self") -> "_1088.FaceGearMeshDesign":
        """mastapy.gears.gear_designs.face.FaceGearMeshDesign
