...
class ConceptGearSet(_2734.GearSet):
    """ConceptGearSet
    ...
    @property
    def active_gear_set_design(self: "Self") -> "_1291.ConceptGearSetDesign":
    ...
    @property
    def concept_gear_set_design(self: "Self") -> "_1291.ConceptGearSetDesign":
        """mastapy.gears.gear_designs.concept.ConceptGearSetDesign
    ...
    @property
    def concept_gears(self: "Self") -> "List[_2723.ConceptGear]":
    ...
    @property
    def concept_meshes(self: "Self") -> "List[_2496.ConceptGearMesh]":
