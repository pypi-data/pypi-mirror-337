...
def run_normal_command(qtdArgs, cmd):
    if qtdArgs==3:
        ...
        translated_output = translate_log(cmd[1],cmd[2], output)
...
def run_help(qtdArgs, cmd):
    if qtdArgs==3:
        ...
        translated_help = translate_log(cmd[1],cmd[2], output)
...
def run_scripts(qtdArgs, cmd):
    if qtdArgs==2:
        ...
        output = python_script(cmd[1])
        translated_script_python = translate_log(cmd[2], cmd[3], output)
