...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1515, _1517
...
class _Cast_ElectricMachineDQModel:
    ...
    @property
    def linear_dq_model(self: "CastSelf") -> "_1515.LinearDQModel":
        from mastapy._private.electric_machines.results import _1515

        return self.__parent__._cast(_1515.LinearDQModel)

    @property
    def non_linear_dq_model(self: "CastSelf") -> "_1517.NonLinearDQModel":
        from mastapy._private.electric_machines.results import _1517

        return self.__parent__._cast(_1517.NonLinearDQModel)
