...
class FaceGearSetParetoOptimiser(_1008.GearSetParetoOptimiser):
    """FaceGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self: "Self") -> "_1092.FaceGearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: "Self") -> "List[_1092.FaceGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: "Self") -> "List[_1092.FaceGearSetDesign]":
        """List[mastapy.gears.gear_designs.face.FaceGearSetDesign]
