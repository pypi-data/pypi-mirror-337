...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.spiral_bevel import _486, _487
...
class SpiralBevelGearSetRating(_640.BevelGearSetRating):
    """SpiralBevelGearSetRating
    ...
    @property
    def spiral_bevel_gear_ratings(self: "Self") -> "List[_487.SpiralBevelGearRating]":
    ...
    def spiral_bevel_mesh_ratings(
        self: "Self",
    ) -> "List[_486.SpiralBevelGearMeshRating]":
