...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1172, _1189
...
class CylindricalMeshAngularBacklash(_1143.CylindricalMeshLinearBacklashSpecification):
    """CylindricalMeshAngularBacklash
