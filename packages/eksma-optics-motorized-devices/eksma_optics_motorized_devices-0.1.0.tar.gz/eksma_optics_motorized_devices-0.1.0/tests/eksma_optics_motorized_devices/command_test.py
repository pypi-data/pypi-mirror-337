...
basic_command_and_query_testdata = [
    ...
    (
        Lens1Minimum,
        pytest.raises(TypeError),
        nullcontext(":LENS1:MIN?\r\n"),
    ),
    (
        Lens1Maximum,
        pytest.raises(TypeError),
        nullcontext(":LENS1:MAX?\r\n"),
    ),
    (
        Lens2Minimum,
        pytest.raises(TypeError),
        nullcontext(":LENS2:MIN?\r\n"),
    ),
    (
        Lens2Maximum,
        pytest.raises(TypeError),
        nullcontext(":LENS2:MAX?\r\n"),
    ),
    (
        Configuration,
        nullcontext(":CONF\r\n"),
...
command_float_three_testdata = [
    (Lens1, ":LENS1"),
    (Lens2, ":LENS2"),
    (Lens1Minimum, ":LENS1:MIN"),
    (Lens1Maximum, ":LENS1:MAX"),
    (Lens2Minimum, ":LENS2:MIN"),
    (Lens2Maximum, ":LENS2:MAX"),
]
