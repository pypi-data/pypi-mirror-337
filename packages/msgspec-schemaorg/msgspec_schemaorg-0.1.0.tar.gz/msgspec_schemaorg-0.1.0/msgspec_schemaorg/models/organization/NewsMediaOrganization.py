...
class NewsMediaOrganization(Struct, frozen=True):
    ...
    email: str | None = None
    missionCoveragePrioritiesPolicy: str | 'CreativeWork' | None = None
    verificationFactCheckingPolicy: 'CreativeWork' | str | None = None
    noBylinesPolicy: str | 'CreativeWork' | None = None
    masthead: 'CreativeWork' | str | None = None