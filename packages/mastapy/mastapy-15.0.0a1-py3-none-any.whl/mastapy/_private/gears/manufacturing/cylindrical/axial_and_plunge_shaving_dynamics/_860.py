...
class _Cast_ShaverRedressing:
    ...
    @property
    def axial_shaver_redressing(self: "CastSelf") -> "_846.AxialShaverRedressing":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _846,
        )

        return self.__parent__._cast(_846.AxialShaverRedressing)

    @property
    def plunge_shaver_redressing(self: "CastSelf") -> "_853.PlungeShaverRedressing":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _853,
        )

        return self.__parent__._cast(_853.PlungeShaverRedressing)
