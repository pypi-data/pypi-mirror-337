...
class TestBotSoftwareWrapModuleBase(TestBotSoftwareAtomModuleBase):
    """
    TestBot测试软件资源封装接口模块基类
    """
    def __init__(self, resource, *args: tuple, **kwargs: dict):
        super(TestBotSoftwareWrapModuleBase, self).__init__(resource, *args, **kwargs)
