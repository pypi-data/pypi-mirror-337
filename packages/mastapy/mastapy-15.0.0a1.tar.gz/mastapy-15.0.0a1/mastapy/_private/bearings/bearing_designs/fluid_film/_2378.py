...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2385, _2386
...
class PadFluidFilmBearing(_2321.DetailedBearing):
    """PadFluidFilmBearing
    ...
    @enforce_parameter_types
    def rotational_direction(self: "Self", value: "_2083.RotationalDirections") -> None:
