...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.iso_10300 import _508, _509
...
class HypoidGearMeshRating(_649.AGMAGleasonConicalGearMeshRating):
    """HypoidGearMeshRating
    ...
    @property
    def hypoid_gear_mesh(self: "Self") -> "_1083.HypoidGearMeshDesign":
