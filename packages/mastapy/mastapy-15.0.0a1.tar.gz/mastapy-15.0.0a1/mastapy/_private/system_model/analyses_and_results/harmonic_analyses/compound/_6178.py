...
class _Cast_ConnectionCompoundHarmonicAnalysis:
    ...
    def cycloidal_disc_planetary_bearing_connection_compound_harmonic_analysis(
        self: "CastSelf",
    ) -> "_6189.CycloidalDiscPlanetaryBearingConnectionCompoundHarmonicAnalysis":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.compound import (
            _6189,
        )
...
class ConnectionCompoundHarmonicAnalysis(_7839.ConnectionCompoundAnalysis):
    """ConnectionCompoundHarmonicAnalysis
    ...
    def connection_analysis_cases(
        self: "Self",
    ) -> "List[_5969.ConnectionHarmonicAnalysis]":
