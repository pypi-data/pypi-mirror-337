...
from mastapy._private.bearings.bearing_results.fluid_film import _2308
...
class _Cast_LoadedTiltingJournalPad:
    ...
    def loaded_fluid_film_bearing_pad(
        self: "CastSelf",
    ) -> "_2308.LoadedFluidFilmBearingPad":
        return self.__parent__._cast(_2308.LoadedFluidFilmBearingPad)
...
class LoadedTiltingJournalPad(_2308.LoadedFluidFilmBearingPad):
    """LoadedTiltingJournalPad
