...
log_level = os.environ.get("LOG_LEVEL", "DEBUG").upper() # Default to DEBUG, allow override via env var
...
def start_interactive_session(model_name: str, console: Console):
    ...
    while True:
        try:
            ...
            with console.status("[yellow]Assistant processing...", spinner="dots"):
