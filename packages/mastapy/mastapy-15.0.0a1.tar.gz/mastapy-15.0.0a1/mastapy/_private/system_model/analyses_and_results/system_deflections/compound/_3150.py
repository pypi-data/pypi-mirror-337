...
class PulleyCompoundSystemDeflection(_3098.CouplingHalfCompoundSystemDeflection):
    """PulleyCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3001.PulleySystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_3001.PulleySystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.PulleySystemDeflection]
