...
class BeltDriveCompoundModalAnalysis(_5065.SpecialisedAssemblyCompoundModalAnalysis):
    """BeltDriveCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4817.BeltDriveModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4817.BeltDriveModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BeltDriveModalAnalysis]
