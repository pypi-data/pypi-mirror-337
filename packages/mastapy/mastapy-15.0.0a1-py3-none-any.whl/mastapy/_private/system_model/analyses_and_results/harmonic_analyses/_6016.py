...
class HarmonicAnalysis(_7837.CompoundAnalysisCase):
    """HarmonicAnalysis
    ...
    @property
    def acoustic_analysis(self: "Self") -> "_7623.HarmonicAcousticAnalysis":
