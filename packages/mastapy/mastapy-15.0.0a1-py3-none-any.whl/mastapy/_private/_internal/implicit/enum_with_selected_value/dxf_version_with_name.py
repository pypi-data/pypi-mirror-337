...
from mastapy._private.utility.cad_export import _2018
...
class EnumWithSelectedValue_DxfVersionWithName(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2018.DxfVersionWithName
        """
        return _2018.DxfVersionWithName
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DxfVersionWithName]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2018.DxfVersionWithName.type_()

    @property
    def selected_value(self: "Self") -> "_2018.DxfVersionWithName":
    ...
    @property
    def available_values(self: "Self") -> "List[_2018.DxfVersionWithName]":
