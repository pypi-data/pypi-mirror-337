...
class StockSimilarity(BaseModel):
    ...
    def __str__(self):
        return f"<StockSimilarity(symbol_1={self.symbol_1}, symbol_2={self.symbol_2}, similarity_market_cap={self.similarity_market_cap}, similarity_description={self.similarity_description})>"
