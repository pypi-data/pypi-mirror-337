...
class QTest(Shiboken.Object):
    ...
    @staticmethod
    def currentAppName() -> typing.Union[bytes, bytearray, memoryview]: ...
    @staticmethod
    def currentDataTag() -> typing.Union[bytes, bytearray, memoryview]: ...
    @staticmethod
    def currentTestFailed() -> bool: ...
    @staticmethod
    def currentTestFunction() -> typing.Union[bytes, bytearray, memoryview]: ...
    @staticmethod
    ...
    @staticmethod
    def formatString(prefix: bytes | bytearray | memoryview, suffix: bytes | bytearray | memoryview, numArguments: int, /) -> typing.Union[bytes, bytearray, memoryview]: ...
    @typing.overload
    @staticmethod
