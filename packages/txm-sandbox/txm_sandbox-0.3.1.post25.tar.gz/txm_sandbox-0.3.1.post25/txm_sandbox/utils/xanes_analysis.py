...
class xanes_analysis:
    def __init__(
        ...
        self.lcf_fit_rlt = None
        self.lcf_fit_err = None
        self.lcf_model = {
            "constr": self.lcf_constr_use,
            "ref": self.lcf_ref_spec,
            "rlt": None,
        }
    ...
    def lcf(self):
        ...
        self.lcf_model["ref"] = self.lcf_ref_spec
        self.lcf_model["rlt"] = xm.lcf(
            self.norm_spec, self.lcf_ref_spec, use_constr=self.lcf_constr_use
        )
    ...
    def smooth_spec(self):
        if self.flt_use:
            wlen = min(21, int(round(self.spec.shape[0] / 2.0)))
            if wlen % 2 == 0:
                wlen += 1
            podr = min(2, wlen - 1)
