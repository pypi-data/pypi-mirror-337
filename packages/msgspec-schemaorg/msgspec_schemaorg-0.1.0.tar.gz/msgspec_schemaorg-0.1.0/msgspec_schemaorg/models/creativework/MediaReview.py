...
if TYPE_CHECKING:
    ...
    from msgspec_schemaorg.models.intangible.MediaManipulationRatingEnumeration import MediaManipulationRatingEnumeration
...
class MediaReview(Struct, frozen=True):
    ...
    originalMediaLink: 'MediaObject' | str | 'WebPage' | None = None
