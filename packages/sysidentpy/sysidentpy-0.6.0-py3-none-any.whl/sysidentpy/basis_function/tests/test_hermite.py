...
def test_hermite_init():
    """Test that Hermite class initializes correctly."""
    h = Hermite(degree=3, include_bias=False, ensemble=True)
    assert h.degree == 3
...
def test_hermite_fit_predefined_regressors():
