...
def scpi_error_check(func):
    ...
    @wraps(func)
    def decorator_wrapper(self: "Cluster", *args, **kwargs):
        if self._debug > 1:
...
class Cluster(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int = 0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.11.0 fwBuild=05/03/2025-10:35:36 fwHash=0x475C42A4 fwDirty=0 kmodVersion=0.11.0 kmodBuild=19/03/2025-09:52:04 kmodHash=0x8C778775 kmodDirty=0 swVersion=0.11.0 swBuild=19/03/2025-09:52:04 swHash=0x8C778775 swDirty=0 cfgManVersion=0.5.0 cfgManBuild=19/03/2025-09:52:04 cfgManHash=0x8C778775 cfgManDirty=0"
            if build != build_ref:
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def get_ip_status(self, slot: int) -> Any:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def sync_dac(self, slot: int, tile_bitmask: int, tile_target_latency: int) -> Any:
        """
        MTS sync for DACs
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def sync_adc(self, slot: int, tile_bitmask: int, tile_target_latency: int) -> Any:
        """
        MTS sync for ADCs
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def set_sysref_state(self, slot: int, state: bool) -> Any:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def reset_duc_phase_dac(self, slot: int, tile_id: int, block_id: int) -> Any:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def reset_duc_phase_adc(self, slot: int, tile_id: int, block_id: int) -> Any:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def reset_duc_phase_all(self, slot: int) -> Any:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def set_mixer_settings_freq_dac(
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def set_mixer_settings_freq_adc(
        self, slot: int, tile_id: int, block_id: int, NCO_frequency: int
    ) -> Any:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def set_mixer_settings_coarse_delay_dac(
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def set_mixer_settings_coarse_delay_adc(
        self, slot: int, tile_id: int, block_id: int, delay: int
    ) -> Any:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def set_mixer_settings_nco_phase_offset(
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def set_fsample(self, slot: int, bypass: bool) -> None:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def set_gpio_value(self, slot: int, i2c_dev: str, addr: int, value: int) -> Any:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def read_gpio_value(self, slot: int, i2c_dev: str, addr: int) -> Any:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def set_gpio_dir(self, slot: int, i2c_dev: str, addr: int, value: int) -> Any:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def set_lmx_power(self, slot: int, channel: int, db: int) -> Any:
        """
        Set LMX2594 power in db steps up to 31
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:SET:LMX:POWER {channel},{db}")

        return json.loads(var0.decode("utf-8"))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def get_lmx_power(self, slot: int, channel: int) -> Any:
        """
        Get LMX2594 power in steps up to 31
        ...
        -------
        Any
            Execution result combined with OUTA and OUTB power.
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:GET:LMX:POWER {channel}")

        return json.loads(var0.decode("utf-8"))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def config_lmx(self, slot: int, channel: int) -> Any:
        """
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:CONFIG:LMX {channel}")

        return json.loads(var0.decode("utf-8"))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def set_lmx_frequency(self, slot: int, channel: int, frequency: int) -> Any:
        """
        Configure the LMX2594 output frequency
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:SET:LMX:FREQ {channel},{frequency}")

        return json.loads(var0.decode("utf-8"))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def set_decoder_mode(
        self, slot: int, tile_id: int, block_id: int, mode: int
    ) -> Any:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_bsp_status(self, slot: int) -> Any:
        """
        Get the status of the AFE high BSP
        ...
        -------
        Any
            AFE High initialization status
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:AFE:BSP:STATus:DEBUG?")

        return json.loads(var0.decode("utf-8"))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_nyquist_filter(self, slot: int, channel_id: int, value: int) -> str:
        """
        Set Nyquist zone filter for a given channel
        ...
        # SCPI call
        var0 = self._read(f"SLOT{slot}:AFE:NYQ:FILTer:SET:DEBUG? {channel_id},{value}")

        return var0

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _enable_mixer_path(self, slot: int, channel_id: int, enable: bool) -> str:
        """
        Enable mixer path
        ...
        # SCPI call
        var0 = self._read(
            f"SLOT{slot}:AFE:MIXer:PAth:ENable:DEBUG? {channel_id},{0 if enable == False else 1}"
        )
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _enable_mixer_doubler(self, slot: int, channel_id: int, enable: bool) -> str:
        """
        Enable mixer doubler for a given channel
        ...
        # SCPI call
        var0 = self._read(
            f"SLOT{slot}:AFE:MIXer:DOUBler:ENable:DEBUG? {channel_id},{0 if enable == False else 1}"
        )
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _select_mixer_filter_bank(self, slot: int, channel: int, value: int) -> str:
        """
        Select a filter bank for a mixer of a given channel
        ...
        # SCPI call
        var0 = self._read(f"SLOT{slot}:AFE:FILTer:BANK:SELect:DEBUG? {channel},{value}")

        return var0

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_lo_frequency(self, slot: int, channel: int, frequency: float) -> str:
        """
        ...
        # SCPI call
        var0 = self._read(
            f"SLOT{slot}:AFE:LO:FREQuency:SET:DEBUG? {channel},{frequency}"
        )
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_lo_power(self, slot: int, channel: int, frequency: int) -> str:
        """
        ...
        # SCPI call
        var0 = self._read(f"SLOT{slot}:AFE:LO:POWer:SET:DEBUG? {channel},{frequency}")

        return var0

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _software_sync_all_pll(self, slot: int, incl_div: int) -> str:
        """
        ...
        # SCPI call
        var0 = self._read(f"SLOT{slot}:AFE:PLL:SOFT:SYNC:DEBUG? {incl_div}")

        return var0

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_dsa_1(self, slot: int, channel: int, attentuation: int) -> str:
        """
        Set the digital step attenuation settings for a given channel
        ...
        # SCPI call
        var0 = self._read(f"SLOT{slot}:AFE:DSA1:SET:DEBUG? {channel},{attentuation}")

        return var0

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_out_att(self, slot: int, channel: int, attentuation: float) -> bool:
        """
        ...
        # SCPI call
        var0 = self._read(f"SLOT{slot}:AFE:OUT:ATT:SET? {channel},{attentuation}")
    ...
    def _get_max_out_att(self, slot: int, channel: int) -> float:
        ...
        # SCPI call
        var0 = self._read(f"SLOT{slot}:AFE:MAX:OUT:ATT:GET? {channel}")
    ...
    def _set_output_configuration(
        ...
        channel: int,
        output_select: int,
        channel_combine_selection: bool,
    ) -> str:
        """
        Set output select lines and channel combination
        ...
        # Check input types.
        self._check_in_type(locals(), ["int", "int", "int", "bool"])

        # SCPI call
        var0 = self._read(
            f"SLOT{slot}:AFE:OUT:CONFig:SET:DEBUG? {channel},{output_select},{0 if channel_combine_selection == False else 1}"
        )
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _enable_channel_combine(
        self, slot: int, channel: int, channel_combine_selection: bool
    ) -> str:
        """
        Enable channel combine for a given output channel
        ...
        # SCPI call
        var0 = self._read(
            f"SLOT{slot}:AFE:OUT:CHannel:COMBine:ENable? {channel},{0 if channel_combine_selection == False else 1}"
        )
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _print_gpio_configuration(self, slot: int, channel: int) -> bool:
        """
        Print channel GPIO configuration
        ...
        # SCPI call
        var0 = self._read(f"SLOT{slot}:AFE:OUT:CONFIG:PRINT:DEBUG? {channel}")

        return bool(int(var0))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_out_freq(self, slot: int, channel: int, frequency: int) -> bool:
        """
        ...
        # SCPI call
        var0 = self._read(f"SLOT{slot}:AFE:OUTput:SET:FREQuency? {channel},{frequency}")

        return bool(int(var0))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _power_down_lo_output(self, slot: int, channel: int, mode: int) -> Any:
        """
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:AFE:OUTput:POWERDOWN? {channel},{mode}")
