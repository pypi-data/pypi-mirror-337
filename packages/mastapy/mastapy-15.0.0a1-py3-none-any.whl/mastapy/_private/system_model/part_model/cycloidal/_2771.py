...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1629
...
class CycloidalAssembly(_2676.SpecialisedAssembly):
    """CycloidalAssembly
    ...
    @property
    def cycloidal_assembly_design(self: "Self") -> "_1629.CycloidalAssemblyDesign":
    ...
    @property
    def ring_pins(self: "Self") -> "_2773.RingPins":
    ...
    @property
    def known_designs(self: "Self") -> "List[_1629.CycloidalAssemblyDesign]":
    ...
    def add_disc(self: "Self") -> "_2772.CycloidalDisc":
    ...
    def design_named(self: "Self", name: "str") -> "_1629.CycloidalAssemblyDesign":
        """mastapy.cycloidal.CycloidalAssemblyDesign
    ...
    def set_active_cycloidal_assembly_design(
        self: "Self", cycloidal_assembly_design: "_1629.CycloidalAssemblyDesign"
    ) -> None:
        """Method does not return.
    ...
    def try_remove_design(
        self: "Self", design: "_1629.CycloidalAssemblyDesign"
    ) -> "bool":
        """bool
