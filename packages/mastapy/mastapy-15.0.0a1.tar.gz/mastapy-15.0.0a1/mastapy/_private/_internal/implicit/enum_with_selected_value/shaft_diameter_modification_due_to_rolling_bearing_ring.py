...
class EnumWithSelectedValue_ShaftDiameterModificationDueToRollingBearingRing(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ShaftDiameterModificationDueToRollingBearingRing]",
    ) -> "_2675.ShaftDiameterModificationDueToRollingBearingRing":
        ...
        Returns:
            _2675.ShaftDiameterModificationDueToRollingBearingRing
        """
        return _2675.ShaftDiameterModificationDueToRollingBearingRing
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2675.ShaftDiameterModificationDueToRollingBearingRing.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2675.ShaftDiameterModificationDueToRollingBearingRing]":
