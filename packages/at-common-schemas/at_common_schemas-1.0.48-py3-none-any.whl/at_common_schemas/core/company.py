...
class CompanyProfile(BaseSchema):
    ...
    cik: str | None = Field(None, description="Central Index Key assigned by the SEC")
    isin: str | None = Field(None, description="International Securities Identification Number")
    cusip: str | None = Field(None, description="Committee on Uniform Securities Identification Procedures number")
    ...
    website: str | None = Field(None, description="Company's official website URL")
    description: str | None = Field(None, description="Brief overview of the company's business")
    ceo: str | None = Field(None, description="Name of the Chief Executive Officer")
