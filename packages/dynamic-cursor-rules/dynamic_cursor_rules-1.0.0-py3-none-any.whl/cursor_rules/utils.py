...
def generate_cursorrules_file(ruleset: RuleSet, project_info: Optional[Dict[str, Any]] = None) -> str:
    """
    ...
    Returns:
        String content for a .cursorrules file
    """
...
def save_cursorrules_file(ruleset: RuleSet, filepath: str, project_info: Optional[Dict[str, Any]] = None) -> None:
    """
