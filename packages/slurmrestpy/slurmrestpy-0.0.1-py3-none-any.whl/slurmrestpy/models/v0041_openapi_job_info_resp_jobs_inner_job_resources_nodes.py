...
class V0041OpenapiJobInfoRespJobsInnerJobResourcesNodes(BaseModel):
    ...
    select_type: Optional[List[StrictStr]] = Field(
        default=None, description="Node scheduling selection method"
    )
    ...
    allocation: Optional[
        List[V0041OpenapiJobInfoRespJobsInnerJobResourcesNodesAllocationInner]
        ...
        _obj = cls.model_validate(
            {
                ...
                "whole": obj.get("whole"),
                "allocation": [
                    V0041OpenapiJobInfoRespJobsInnerJobResourcesNodesAllocationInner.from_dict(
                        _item
                    )
                    for _item in obj["allocation"]
                ]
