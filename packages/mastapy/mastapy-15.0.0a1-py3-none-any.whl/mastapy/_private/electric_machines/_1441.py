...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1394, _1405, _1406, _1409
...
class _Cast_UShapedLayerSpecification:
    ...
    def rotor_internal_layer_specification(
        self: "CastSelf",
    ) -> "_1423.RotorInternalLayerSpecification":
        return self.__parent__._cast(_1423.RotorInternalLayerSpecification)
...
class UShapedLayerSpecification(_1423.RotorInternalLayerSpecification):
    """UShapedLayerSpecification
    ...
    @property
    def flux_barrier_configuration(self: "Self") -> "_1394.FluxBarriers":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1394", "FluxBarriers"
        )(value)

    @flux_barrier_configuration.setter
    @enforce_parameter_types
    def flux_barrier_configuration(self: "Self", value: "_1394.FluxBarriers") -> None:
    ...
    @property
    def inner_magnet_clearance(self: "Self") -> "_1405.MagnetClearance":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1405", "MagnetClearance"
        )(value)

    @inner_magnet_clearance.setter
    @enforce_parameter_types
    def inner_magnet_clearance(self: "Self", value: "_1405.MagnetClearance") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def magnet_configuration(self: "Self") -> "_1406.MagnetConfiguration":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1406", "MagnetConfiguration"
        )(value)

    @magnet_configuration.setter
    @enforce_parameter_types
    def magnet_configuration(self: "Self", value: "_1406.MagnetConfiguration") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def outer_magnet_lower_clearance(self: "Self") -> "_1405.MagnetClearance":
        """mastapy.electric_machines.MagnetClearance"""
    ...
    def outer_magnet_lower_clearance(
        self: "Self", value: "_1405.MagnetClearance"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.ElectricMachines.MagnetClearance"
        )
    ...
    @property
    def outer_magnets(self: "Self") -> "_1409.MagnetForLayer":
