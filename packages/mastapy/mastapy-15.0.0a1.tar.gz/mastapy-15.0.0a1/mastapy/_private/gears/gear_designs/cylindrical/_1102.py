...
class _Cast_CrossedAxisCylindricalGearPairPointContact:
    ...
    def crossed_axis_cylindrical_gear_pair(
        self: "CastSelf",
    ) -> "_1100.CrossedAxisCylindricalGearPair":
        return self.__parent__._cast(_1100.CrossedAxisCylindricalGearPair)
...
class CrossedAxisCylindricalGearPairPointContact(_1100.CrossedAxisCylindricalGearPair):
    """CrossedAxisCylindricalGearPairPointContact
