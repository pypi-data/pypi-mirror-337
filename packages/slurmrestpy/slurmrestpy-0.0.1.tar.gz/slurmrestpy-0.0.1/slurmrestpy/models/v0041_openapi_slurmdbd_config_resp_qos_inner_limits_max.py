...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMax(BaseModel):
    ...
    active_jobs: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobs] = (
        None
    )
    tres: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxTres] = None
    wall_clock: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClock] = (
        None
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "active_jobs": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobs.from_dict(
                    obj["active_jobs"]
                )
                if obj.get("active_jobs") is not None
                else None,
                "tres": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxTres.from_dict(
                    obj["tres"]
                )
                if obj.get("tres") is not None
                else None,
                "wall_clock": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClock.from_dict(
                    obj["wall_clock"]
                )
                if obj.get("wall_clock") is not None
                else None,
                "jobs": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobs.from_dict(
                    obj["jobs"]
                )
                if obj.get("jobs") is not None
                else None,
                "accruing": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxAccruing.from_dict(
                    obj["accruing"]
                )
