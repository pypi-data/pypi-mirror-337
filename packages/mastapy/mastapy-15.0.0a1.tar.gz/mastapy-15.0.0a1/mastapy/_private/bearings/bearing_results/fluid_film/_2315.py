...
from mastapy._private.bearings.bearing_results.fluid_film import _2313
...
class _Cast_LoadedPlainOilFedJournalBearingRow:
    ...
    def loaded_plain_journal_bearing_row(
        self: "CastSelf",
    ) -> "_2313.LoadedPlainJournalBearingRow":
        return self.__parent__._cast(_2313.LoadedPlainJournalBearingRow)
...
class LoadedPlainOilFedJournalBearingRow(_2313.LoadedPlainJournalBearingRow):
    """LoadedPlainOilFedJournalBearingRow
