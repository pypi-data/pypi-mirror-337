...
def main(argv):
    if len(argv) >= 2 and argv[1] in ('gen', 'clean'):
        ...
        setup(
            name='UltraFastTelethon',
            version=version,
            description="Full-featured Telegram client library for Python 3",
            long_description=long_description,

            url='https://github.com/orShadxw/UltraFastTelethon',
            download_url='https://github.com/orShadxw/UltraFastTelethon/releases',
            ...
            install_requires=['aiohttp', 'pyaes', 'rsa'],
            extras_require={
                'cryptg': ['cryptg'],
                'fastest': ['uvloop','cryptg']
            }
        )
