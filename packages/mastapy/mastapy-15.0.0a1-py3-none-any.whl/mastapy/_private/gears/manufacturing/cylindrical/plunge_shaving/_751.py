...
from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _738
...
class _Cast_ShaverPointCalculationError:
    ...
    @property
    def calculation_error(self: "CastSelf") -> "_738.CalculationError":
        return self.__parent__._cast(_738.CalculationError)
...
class ShaverPointCalculationError(_738.CalculationError):
    """ShaverPointCalculationError
