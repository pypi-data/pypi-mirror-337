...
class Overridable_CoefficientOfFrictionCalculationMethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _402.CoefficientOfFrictionCalculationMethod
        """
        return _402.CoefficientOfFrictionCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _402.CoefficientOfFrictionCalculationMethod.type_()

    @property
    def value(self: "Self") -> "_402.CoefficientOfFrictionCalculationMethod":
    ...
    @property
    def override_value(self: "Self") -> "_402.CoefficientOfFrictionCalculationMethod":
        """mastapy.gears.CoefficientOfFrictionCalculationMethod
    ...
    @property
    def calculated_value(self: "Self") -> "_402.CoefficientOfFrictionCalculationMethod":
        """mastapy.gears.CoefficientOfFrictionCalculationMethod
