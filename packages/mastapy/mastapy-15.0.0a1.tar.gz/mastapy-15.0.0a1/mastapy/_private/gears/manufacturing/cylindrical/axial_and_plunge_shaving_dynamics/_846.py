...
class _Cast_AxialShaverRedressing:
    ...
    @property
    def shaver_redressing(self: "CastSelf") -> "_860.ShaverRedressing":
        return self.__parent__._cast(_860.ShaverRedressing)
...
class AxialShaverRedressing(_860.ShaverRedressing[_847.ConventionalShavingDynamics]):
    """AxialShaverRedressing
