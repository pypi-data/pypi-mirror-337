classdef  Sparsity < casadi.SharedObject & casadi.SparsityInterfaceCommon & casadi.PrintableCommon
  ...
  methods
    ...
    %COMPRESS 
    %
    %  [int] = COMPRESS(self, bool canonical)
    %
    %
    ...
    %
    %
      out = casadiMEX(115, self, varargin{:});
      if nargout<=1
        varargout{1}=out;
      else
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(87, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(88, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(89, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(118, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(120, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(190, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(192, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(193, varargin{:});
    end
