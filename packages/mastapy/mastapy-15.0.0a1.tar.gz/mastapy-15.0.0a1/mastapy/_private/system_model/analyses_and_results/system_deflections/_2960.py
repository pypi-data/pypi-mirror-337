...
class FaceGearMeshSystemDeflection(_2965.GearMeshSystemDeflection):
    """FaceGearMeshSystemDeflection
    ...
    @property
    def rating(self: "Self") -> "_531.FaceGearMeshRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_531.FaceGearMeshRating":
        """mastapy.gears.rating.face.FaceGearMeshRating
    ...
    @property
    def power_flow_results(self: "Self") -> "_4312.FaceGearMeshPowerFlow":
