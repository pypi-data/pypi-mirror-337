...
class _Cast_MethodOutcomeWithResult:
    ...
    @property
    def method_outcome(self: "CastSelf") -> "_1764.MethodOutcome":
        return self.__parent__._cast(_1764.MethodOutcome)
...
class MethodOutcomeWithResult(_1764.MethodOutcome, Generic[T]):
    """MethodOutcomeWithResult
