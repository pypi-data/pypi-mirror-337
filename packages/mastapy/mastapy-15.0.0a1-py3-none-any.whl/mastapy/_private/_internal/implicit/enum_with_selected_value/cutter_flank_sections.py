...
class EnumWithSelectedValue_CutterFlankSections(
    ...
    def wrapped_type(
        ...
        Returns:
            _705.CutterFlankSections
        """
        return _705.CutterFlankSections
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_CutterFlankSections]") -> "Any":
        ...
        Returns:
            Any
        """
        return _705.CutterFlankSections.type_()

    @property
    def selected_value(self: "Self") -> "_705.CutterFlankSections":
    ...
    @property
    def available_values(self: "Self") -> "List[_705.CutterFlankSections]":
