...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2725, _2732
...
class HypoidGear(_2715.AGMAGleasonConicalGear):
    """HypoidGear
    ...
    @property
    def conical_gear_design(self: "Self") -> "_1082.HypoidGearDesign":
    ...
    @property
    def hypoid_gear_design(self: "Self") -> "_1082.HypoidGearDesign":
        """mastapy.gears.gear_designs.hypoid.HypoidGearDesign
