...
class _Cast_StraightBevelDiffMeshedGearRating:
    ...
    @property
    def conical_meshed_gear_rating(self: "CastSelf") -> "_629.ConicalMeshedGearRating":
        return self.__parent__._cast(_629.ConicalMeshedGearRating)
...
class StraightBevelDiffMeshedGearRating(_629.ConicalMeshedGearRating):
    """StraightBevelDiffMeshedGearRating
