...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2218, _2222
...
class LoadedTaperRollerBearingResults(_2213.LoadedNonBarrelRollerBearingResults):
    """LoadedTaperRollerBearingResults
