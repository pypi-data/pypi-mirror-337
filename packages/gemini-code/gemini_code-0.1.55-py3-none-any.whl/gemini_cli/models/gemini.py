...
Includes Test Runner tool. Prompt v11.1. Syntax FIXED FINAL ATTEMPT.
"""
...
FALLBACK_MODEL = "gemini-1.5-pro-latest" # Define fallback model (not used in this version's logic, but kept for ref)
...
class GeminiModel:
    ...
    # Accepts console object for status updates
    def __init__(self, api_key: str, console: Console, model_name: str ="gemini-2.5-pro-exp-03-25"):
        ...
        # Use the V11.1 prompt for agentic loop
        ...
        try:
            ...
            # Connectivity test can be simplified or removed
            ...
            # History managed manually within generate()
    ...
    def generate(self, prompt: str, conversation=None) -> str | None:
        # ... (generate function logic remains the same as previous - Agent Loop w/ Orientation & Status) ...
    ...
    def _parse_and_execute_tool_calls(self, text: str) -> list[dict]:
        ...
        for match in matches:
            ...
            args = {}; status_message = f"⚙️ Executing: {func_name}"
            try:
                ...
                elif func_name == 'ls' and 'path' in args: status_message = f" Listing directory [cyan]{args.get('path', '.')}[/cyan]..."
