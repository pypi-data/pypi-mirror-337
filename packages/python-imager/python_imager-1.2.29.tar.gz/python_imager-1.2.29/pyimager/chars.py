...
class UnassignedChar(Exception):pass
class UnknownChar(Exception):pass
...
def draw_char(img, char, pts, colour=COL.red, fontSize=1, thickness=1, lineType=0, angle=0, help=False, errors=False):
    ## VARS ##
