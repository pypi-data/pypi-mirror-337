...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.concept import _1289, _1290
...
class ConceptGearSetDesign(_1047.GearSetDesign):
    """ConceptGearSetDesign
    ...
    @property
    def gears(self: "Self") -> "List[_1289.ConceptGearDesign]":
    ...
    @property
    def concept_gears(self: "Self") -> "List[_1289.ConceptGearDesign]":
        """List[mastapy.gears.gear_designs.concept.ConceptGearDesign]
    ...
    @property
    def concept_meshes(self: "Self") -> "List[_1290.ConceptGearMeshDesign]":
