...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2064
    from mastapy._private.bearings.bearing_results.fluid_film import _2315
...
class _Cast_LoadedPlainJournalBearingRow:
    ...
    def loaded_plain_oil_fed_journal_bearing_row(
        self: "CastSelf",
    ) -> "_2315.LoadedPlainOilFedJournalBearingRow":
        from mastapy._private.bearings.bearing_results.fluid_film import _2315

        return self.__parent__._cast(_2315.LoadedPlainOilFedJournalBearingRow)
...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    @property
    def row(self: "Self") -> "_2064.BearingRow":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2064", "BearingRow"
        )(value)
