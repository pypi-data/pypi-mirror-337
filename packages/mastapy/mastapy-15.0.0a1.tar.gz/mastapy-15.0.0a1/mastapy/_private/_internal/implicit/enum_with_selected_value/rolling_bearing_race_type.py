...
from mastapy._private.bearings import _2081
...
class EnumWithSelectedValue_RollingBearingRaceType(
    ...
    def wrapped_type(
        ...
        Returns:
            _2081.RollingBearingRaceType
        """
        return _2081.RollingBearingRaceType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2081.RollingBearingRaceType.type_()

    @property
    def selected_value(self: "Self") -> "_2081.RollingBearingRaceType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2081.RollingBearingRaceType]":
