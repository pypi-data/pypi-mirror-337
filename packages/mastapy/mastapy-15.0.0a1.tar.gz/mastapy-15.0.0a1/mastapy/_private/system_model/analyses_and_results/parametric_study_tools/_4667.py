...
class TorqueConverterTurbineParametricStudyTool(_4564.CouplingHalfParametricStudyTool):
    """TorqueConverterTurbineParametricStudyTool
    ...
    @property
    def component_load_case(self: "Self") -> "_7805.TorqueConverterTurbineLoadCase":
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_3039.TorqueConverterTurbineSystemDeflection]":
