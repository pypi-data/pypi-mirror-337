...
class ExasolService(object):
    ...
    def get_row_count_from_table(self, object:DatabaseObject) -> int:
    ...
    def create_pandas_df_from_group_by(self, object : DatabaseObject, object_type: str, column_intersections: list, group_by_column: str) -> List[Dict]:
        ...
        query_group_by_aggregation = f"select {group_by_column}, count(*) as COUNT_OF_GROUP_BY_VALUE, {aggregates[1:]} from {object.schema}.{object} group by {group_by_column};"
