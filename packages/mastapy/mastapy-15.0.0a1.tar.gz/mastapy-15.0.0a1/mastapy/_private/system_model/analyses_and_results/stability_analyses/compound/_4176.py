...
class FaceGearSetCompoundStabilityAnalysis(_4181.GearSetCompoundStabilityAnalysis):
    """FaceGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4041.FaceGearSetStabilityAnalysis]":
    ...
    def face_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4174.FaceGearCompoundStabilityAnalysis]":
    ...
    def face_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4175.FaceGearMeshCompoundStabilityAnalysis]":
