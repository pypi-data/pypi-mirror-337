...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1109, _1134
...
class CylindricalGearCuttingOptions(_0.APIBase):
    ...
    def geometry_specification_type(
        self: "Self", value: "_1153.GeometrySpecificationType"
    ) -> None:
    ...
    @property
    def cylindrical_gear_cutter(self: "Self") -> "_1109.CylindricalGearAbstractRack":
    ...
    def manufacturing_configuration_selection(
        self: "Self",
    ) -> "_1134.CylindricalGearSetManufacturingConfigurationSelection":
