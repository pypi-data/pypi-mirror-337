...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1719
...
class _Cast_ReportingOptimizationInput:
    ...
    @property
    def optimization_variable(self: "CastSelf") -> "_1719.OptimizationVariable":
        from mastapy._private.math_utility.optimisation import _1719

        return self.__parent__._cast(_1719.OptimizationVariable)
...
class ReportingOptimizationInput(_1718.OptimizationInput):
    """ReportingOptimizationInput
