...
class ConicalGearSetModalAnalysisAtASpeed(_5420.GearSetModalAnalysisAtASpeed):
    """ConicalGearSetModalAnalysisAtASpeed
    ...
    def gears_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5393.ConicalGearModalAnalysisAtASpeed]":
    ...
    def meshes_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5392.ConicalGearMeshModalAnalysisAtASpeed]":
