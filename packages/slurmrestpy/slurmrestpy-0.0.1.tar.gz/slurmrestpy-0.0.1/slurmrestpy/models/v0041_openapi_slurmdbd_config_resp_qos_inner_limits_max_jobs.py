...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobs(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "active_jobs": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobs.from_dict(
                    obj["active_jobs"]
                )
                if obj.get("active_jobs") is not None
                else None,
                "per": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPer.from_dict(
                    obj["per"]
                )
