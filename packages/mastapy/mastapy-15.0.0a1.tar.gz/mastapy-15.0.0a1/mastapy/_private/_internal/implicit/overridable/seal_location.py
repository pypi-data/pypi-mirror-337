...
class Overridable_SealLocation(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[Overridable_SealLocation]") -> "_2084.SealLocation":
    ...
    def implicit_type(cls: "Type[Overridable_SealLocation]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2084.SealLocation.type_()

    @property
    def value(self: "Self") -> "_2084.SealLocation":
    ...
    @property
    def override_value(self: "Self") -> "_2084.SealLocation":
        """mastapy.bearings.SealLocation
    ...
    @property
    def calculated_value(self: "Self") -> "_2084.SealLocation":
        """mastapy.bearings.SealLocation
