...
class _Cast_CylindricalAccuracyGrades:
    ...
    @property
    def accuracy_grades(self: "CastSelf") -> "_397.AccuracyGrades":
        return self.__parent__._cast(_397.AccuracyGrades)
...
class CylindricalAccuracyGrades(_397.AccuracyGrades):
    """CylindricalAccuracyGrades
