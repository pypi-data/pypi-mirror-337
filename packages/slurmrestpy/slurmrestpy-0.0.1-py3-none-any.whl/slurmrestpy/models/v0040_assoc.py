...
class V0040Assoc(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "accounting": [
                    V0040Accounting.from_dict(_item) for _item in obj["accounting"]
                ]
                ...
                "flags": obj.get("flags"),
                "max": V0040AssocMax.from_dict(obj["max"])
                if obj.get("max") is not None
                else None,
                "id": V0040AssocShort.from_dict(obj["id"])
                if obj.get("id") is not None
                else None,
                "is_default": obj.get("is_default"),
                "lineage": obj.get("lineage"),
                "min": V0040AssocMin.from_dict(obj["min"])
