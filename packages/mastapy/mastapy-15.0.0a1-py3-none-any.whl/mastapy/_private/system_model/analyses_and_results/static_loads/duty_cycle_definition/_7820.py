...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5917
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2398
...
class DesignStateOptions(_2033.ColumnInputOptions):
    """DesignStateOptions
    ...
    @design_state.setter
    @enforce_parameter_types
    def design_state(self: "Self", value: "_5917.DesignState") -> None:
        wrapper_type = (
    ...
    def design_state_destinations(
        self: "Self",
    ) -> "List[_2398.DutyCycleImporterDesignEntityMatch[_5917.DesignState]]":
