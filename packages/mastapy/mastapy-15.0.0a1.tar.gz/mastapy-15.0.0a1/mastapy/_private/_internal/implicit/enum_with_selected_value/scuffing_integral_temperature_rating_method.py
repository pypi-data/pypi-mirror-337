...
class EnumWithSelectedValue_ScuffingIntegralTemperatureRatingMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _566.ScuffingIntegralTemperatureRatingMethod
        """
        return _566.ScuffingIntegralTemperatureRatingMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _566.ScuffingIntegralTemperatureRatingMethod.type_()

    @property
    def selected_value(self: "Self") -> "_566.ScuffingIntegralTemperatureRatingMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_566.ScuffingIntegralTemperatureRatingMethod]":
