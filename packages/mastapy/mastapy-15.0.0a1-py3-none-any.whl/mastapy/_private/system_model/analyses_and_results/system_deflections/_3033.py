...
class SystemDeflection(_7844.FEAnalysis):
    """SystemDeflection
    ...
    @property
    def analysis_options(self: "Self") -> "_3035.SystemDeflectionOptions":
    ...
    def overall_efficiency_results(
        self: "Self",
    ) -> "_2983.LoadCaseOverallEfficiencyResult":
