...
class _Cast_ConicalGearManufacturingControlParameters:
    ...
    def conical_manufacturing_sgm_control_parameters(
        self: "CastSelf",
    ) -> "_914.ConicalManufacturingSGMControlParameters":
        from mastapy._private.gears.manufacturing.bevel.control_parameters import _914

        return self.__parent__._cast(_914.ConicalManufacturingSGMControlParameters)

    @property
    def conical_manufacturing_sgt_control_parameters(
        self: "CastSelf",
    ) -> "_915.ConicalManufacturingSGTControlParameters":
        from mastapy._private.gears.manufacturing.bevel.control_parameters import _915

        return self.__parent__._cast(_915.ConicalManufacturingSGTControlParameters)

    @property
    def conical_manufacturing_smt_control_parameters(
        self: "CastSelf",
    ) -> "_916.ConicalManufacturingSMTControlParameters":
        from mastapy._private.gears.manufacturing.bevel.control_parameters import _916

        return self.__parent__._cast(_916.ConicalManufacturingSMTControlParameters)
