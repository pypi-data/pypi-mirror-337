...
class EnumWithSelectedValue_RaceRadialMountingType(
    ...
    def wrapped_type(
        ...
        Returns:
            _2151.RaceRadialMountingType
        """
        return _2151.RaceRadialMountingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2151.RaceRadialMountingType.type_()

    @property
    def selected_value(self: "Self") -> "_2151.RaceRadialMountingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2151.RaceRadialMountingType]":
