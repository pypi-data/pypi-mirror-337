...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2190, _2205
...
class _Cast_LoadedRollingBearingRaceResults:
    ...
    def loaded_ball_bearing_race_results(
        self: "CastSelf",
    ) -> "_2190.LoadedBallBearingRaceResults":
        from mastapy._private.bearings.bearing_results.rolling import _2190

        return self.__parent__._cast(_2190.LoadedBallBearingRaceResults)
