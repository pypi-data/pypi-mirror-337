...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.iso6336 import _608, _610, _612
...
class _Cast_ToothFlankFractureAnalysisContactPointCommon:
    ...
    def tooth_flank_fracture_analysis_contact_point(
        self: "CastSelf",
    ) -> "_608.ToothFlankFractureAnalysisContactPoint":
        from mastapy._private.gears.rating.cylindrical.iso6336 import _608

        return self.__parent__._cast(_608.ToothFlankFractureAnalysisContactPoint)

    @property
    def tooth_flank_fracture_analysis_contact_point_method_a(
        self: "CastSelf",
    ) -> "_610.ToothFlankFractureAnalysisContactPointMethodA":
        from mastapy._private.gears.rating.cylindrical.iso6336 import _610

        return self.__parent__._cast(_610.ToothFlankFractureAnalysisContactPointMethodA)
...
class ToothFlankFractureAnalysisContactPointCommon(_0.APIBase):
    ...
    def analysis_point_with_maximum_local_material_exposure(
        self: "Self",
    ) -> "_612.ToothFlankFractureAnalysisPoint":
    ...
    @property
    def watch_points(self: "Self") -> "List[_612.ToothFlankFractureAnalysisPoint]":
