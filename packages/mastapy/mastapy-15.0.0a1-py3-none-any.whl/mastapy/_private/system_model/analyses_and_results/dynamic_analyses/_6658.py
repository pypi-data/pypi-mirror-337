...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6565
...
class StraightBevelDiffGearSetDynamicAnalysis(_6565.BevelGearSetDynamicAnalysis):
    """StraightBevelDiffGearSetDynamicAnalysis
    ...
    def bevel_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6656.StraightBevelDiffGearDynamicAnalysis]":
    ...
    def bevel_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6657.StraightBevelDiffGearMeshDynamicAnalysis]":
