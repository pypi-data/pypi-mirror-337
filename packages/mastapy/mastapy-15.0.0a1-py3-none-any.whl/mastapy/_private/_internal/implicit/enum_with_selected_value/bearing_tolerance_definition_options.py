...
from mastapy._private.bearings.tolerances import _2090
...
class EnumWithSelectedValue_BearingToleranceDefinitionOptions(
    ...
    def wrapped_type(
        ...
        Returns:
            _2090.BearingToleranceDefinitionOptions
        """
        return _2090.BearingToleranceDefinitionOptions
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2090.BearingToleranceDefinitionOptions.type_()

    @property
    def selected_value(self: "Self") -> "_2090.BearingToleranceDefinitionOptions":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2090.BearingToleranceDefinitionOptions]":
