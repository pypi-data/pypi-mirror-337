      ...
      {((isVPCDomain && enableVPCSetting) || isDisabled) && (
        <>
          <MultiSelectContainer
            required
            name={'vpc_subnets'}
            disabled={isDisabled || (pluginEnvironment.isStudio && availableSubnets.length === 0)}
          ...
          <MultiSelectContainer
            ...
            disabled={isDisabled || (pluginEnvironment.isStudio && availableSecurityGroups.length === 0)}
