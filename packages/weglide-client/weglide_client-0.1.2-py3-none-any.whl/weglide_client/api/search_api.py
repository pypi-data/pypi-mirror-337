...
class SearchApi:
    ...
    @validate_call
    def search_handler_v1_search_post(
        self,
        ...
        _param = self._search_handler_v1_search_post_serialize(
    ...
    @validate_call
    def search_handler_v1_search_post_with_http_info(
        self,
        search_query: SearchQuery,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def search_handler_v1_search_post_without_preload_content(
        self,
        search_query: SearchQuery,
        _request_timeout: Union[
            None,
    ...
    def _search_handler_v1_search_post_serialize(
        self,
        search_query,
        _request_auth,
        _content_type,
