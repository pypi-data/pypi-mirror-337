...
class EnumWithSelectedValue_ProfileToothDrawingMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ProfileToothDrawingMethod]",
    ) -> "_2745.ProfileToothDrawingMethod":
        ...
        Returns:
            _2745.ProfileToothDrawingMethod
        """
        return _2745.ProfileToothDrawingMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2745.ProfileToothDrawingMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2745.ProfileToothDrawingMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_2745.ProfileToothDrawingMethod]":
