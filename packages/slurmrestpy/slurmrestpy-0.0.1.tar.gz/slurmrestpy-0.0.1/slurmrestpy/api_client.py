...
import slurmrestpy.models
from slurmrestpy import rest
from slurmrestpy.api_response import ApiResponse
from slurmrestpy.api_response import T as ApiResponseT
from slurmrestpy.configuration import Configuration
from slurmrestpy.exceptions import (
    ApiException,
    ApiValueError,
    BadRequestException,
    ForbiddenException,
...
class ApiClient:
    ...
    def response_deserialize(
        ...
        if (
            ...
            response_type = (
                response_types_map.get(str(response_data.status)[0] + "XX", None)
                if response_types_map
                else None
            )
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(slurmrestpy.models, klass)
