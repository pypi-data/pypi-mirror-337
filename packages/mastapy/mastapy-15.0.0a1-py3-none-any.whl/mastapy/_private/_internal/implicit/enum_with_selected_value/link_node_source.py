...
from mastapy._private.system_model.fe import _2593
...
class EnumWithSelectedValue_LinkNodeSource(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_LinkNodeSource]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2593.LinkNodeSource.type_()

    @property
    def selected_value(self: "Self") -> "_2593.LinkNodeSource":
    ...
    @property
    def available_values(self: "Self") -> "List[_2593.LinkNodeSource]":
