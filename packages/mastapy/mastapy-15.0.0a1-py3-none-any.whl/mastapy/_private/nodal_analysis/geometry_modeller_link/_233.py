...
from mastapy._private.nodal_analysis.geometry_modeller_link import _223
...
class _Cast_GeometryModellerUnitlessDimension:
    ...
    def base_geometry_modeller_dimension(
        self: "CastSelf",
    ) -> "_223.BaseGeometryModellerDimension":
        return self.__parent__._cast(_223.BaseGeometryModellerDimension)
...
class GeometryModellerUnitlessDimension(_223.BaseGeometryModellerDimension):
    """GeometryModellerUnitlessDimension
