...
class CylindricalGearSetParametricStudyTool(_4593.GearSetParametricStudyTool):
    """CylindricalGearSetParametricStudyTool
    ...
    def gears_parametric_study_tool(
        self: "Self",
    ) -> "List[_4574.CylindricalGearParametricStudyTool]":
    ...
    def meshes_parametric_study_tool(
        self: "Self",
    ) -> "List[_4573.CylindricalGearMeshParametricStudyTool]":
