...
class TokenApi:
    ...
    @validate_call
    def create_multipart_upload_with_http_info(
        self,
        create_multipart_upload_request: CreateMultipartUploadRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateMultipartUploadResponse]:
        """Returns the metadata needed to perform a multipart upload for a given token with the SHA
    ...
    @validate_call
    def create_multipart_upload_without_preload_content(
        self,
        create_multipart_upload_request: CreateMultipartUploadRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def finalize_multipart_upload_with_http_info(
        self,
        finalize_multipart_upload_request: FinalizeMultipartUploadRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def finalize_multipart_upload_without_preload_content(
        self,
        finalize_multipart_upload_request: FinalizeMultipartUploadRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def generate_download_url_with_http_info(
        self,
        sha: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def generate_download_url_without_preload_content(
        self,
        sha: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def generate_upload_url_without_preload_content(
        self,
        sha: StrictStr,
        _request_timeout: Union[
            None,
