...
from cryptographer.CAST5.CAST5_method import CAST5EncryptionMethod, CAST5DecryptionMethod
...
window = tk.Tk()
EasyAutoWindow(window, window_title="CAST5Method", minimum_value_x=1312, minimum_value_y=876,
