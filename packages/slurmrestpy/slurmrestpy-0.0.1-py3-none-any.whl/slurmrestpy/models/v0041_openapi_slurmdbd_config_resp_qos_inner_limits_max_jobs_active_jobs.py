...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobs(BaseModel):
    ...
    per: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobsPer] = (
        None
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "per": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobsPer.from_dict(
                    obj["per"]
                )
