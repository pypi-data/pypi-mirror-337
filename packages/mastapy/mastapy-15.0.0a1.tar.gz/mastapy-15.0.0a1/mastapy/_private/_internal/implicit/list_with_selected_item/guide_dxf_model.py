...
class ListWithSelectedItem_GuideDxfModel(
    _2651.GuideDxfModel, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_GuideDxfModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2651.GuideDxfModel.TYPE

    @property
    def selected_value(self: "Self") -> "_2651.GuideDxfModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_2651.GuideDxfModel]":
