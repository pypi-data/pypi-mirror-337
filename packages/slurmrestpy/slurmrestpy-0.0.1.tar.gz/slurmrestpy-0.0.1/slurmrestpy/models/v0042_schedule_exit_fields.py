...
class V0042ScheduleExitFields(BaseModel):
    ...
    default_queue_depth: Optional[StrictInt] = Field(
        default=None, description="Reached number of jobs allowed to be tested"
    )
    max_job_start: Optional[StrictInt] = Field(
        default=None, description="Reached number of jobs allowed to start"
    )
    max_rpc_cnt: Optional[StrictInt] = Field(
        default=None, description="Reached RPC limit"
    )
    max_sched_time: Optional[StrictInt] = Field(
        default=None, description="Reached maximum allowed scheduler time"
    )
    licenses: Optional[StrictInt] = Field(
        default=None, description="Blocked on licenses"
    )
