...
from mastapy._private.gears.micro_geometry import _657, _658, _659, _660, _663
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.micro_geometry import _661, _662, _664, _665
...
class _Cast_ProfileModification:
    ...
    @property
    def modification(self: "CastSelf") -> "_663.Modification":
        return self.__parent__._cast(_663.Modification)
...
class ProfileModification(_663.Modification):
    """ProfileModification
    ...
    @property
    def measured_data(self: "Self") -> "_1709.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def measured_data(self: "Self", value: "_1709.Vector2DListAccessor") -> None:
