...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _925, _933
...
class _Cast_GearFilletNodeStressResultsColumn:
    ...
    def cylindrical_gear_fillet_node_stress_results_column(
        self: "CastSelf",
    ) -> "_925.CylindricalGearFilletNodeStressResultsColumn":
        from mastapy._private.gears.ltca import _925

        return self.__parent__._cast(_925.CylindricalGearFilletNodeStressResultsColumn)
...
class GearFilletNodeStressResultsColumn(_0.APIBase):
    ...
    @property
    def node_results(self: "Self") -> "List[_933.GearFilletNodeStressResults]":
