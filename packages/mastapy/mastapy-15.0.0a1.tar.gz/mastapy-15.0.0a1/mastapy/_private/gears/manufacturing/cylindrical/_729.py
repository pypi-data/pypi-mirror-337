...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical import _730, _731, _732
...
T = TypeVar("T", bound="_732.ModificationSegment")
...
class _Cast_MicroGeometryInputs:
    ...
    @property
    def micro_geometry_inputs_lead(self: "CastSelf") -> "_730.MicroGeometryInputsLead":
        from mastapy._private.gears.manufacturing.cylindrical import _730

        return self.__parent__._cast(_730.MicroGeometryInputsLead)

    @property
    def micro_geometry_inputs_profile(
        self: "CastSelf",
    ) -> "_731.MicroGeometryInputsProfile":
        from mastapy._private.gears.manufacturing.cylindrical import _731

        return self.__parent__._cast(_731.MicroGeometryInputsProfile)
