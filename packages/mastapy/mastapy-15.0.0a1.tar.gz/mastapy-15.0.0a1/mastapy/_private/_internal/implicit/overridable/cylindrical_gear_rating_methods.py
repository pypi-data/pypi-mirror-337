...
class Overridable_CylindricalGearRatingMethods(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
    ...
    ) -> "_332.CylindricalGearRatingMethods":
        ...
        Returns:
            _332.CylindricalGearRatingMethods
        """
        return _332.CylindricalGearRatingMethods
    ...
    def implicit_type(cls: "Type[Overridable_CylindricalGearRatingMethods]") -> "Any":
        ...
        Returns:
            Any
        """
        return _332.CylindricalGearRatingMethods.type_()

    @property
    def value(self: "Self") -> "_332.CylindricalGearRatingMethods":
    ...
    @property
    def override_value(self: "Self") -> "_332.CylindricalGearRatingMethods":
        """mastapy.materials.CylindricalGearRatingMethods
    ...
    @property
    def calculated_value(self: "Self") -> "_332.CylindricalGearRatingMethods":
        """mastapy.materials.CylindricalGearRatingMethods
