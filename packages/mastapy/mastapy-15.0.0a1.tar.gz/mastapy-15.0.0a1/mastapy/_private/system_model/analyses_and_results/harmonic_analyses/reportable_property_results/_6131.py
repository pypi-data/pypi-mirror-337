...
class _Cast_ResultsForMultipleOrdersForFESurface:
    ...
    def results_for_multiple_orders(
        self: "CastSelf",
    ) -> "_6130.ResultsForMultipleOrders":
        return self.__parent__._cast(_6130.ResultsForMultipleOrders)
...
class ResultsForMultipleOrdersForFESurface(_6130.ResultsForMultipleOrders):
    """ResultsForMultipleOrdersForFESurface
