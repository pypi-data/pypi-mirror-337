...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _822
...
class ShaperSimulationCalculator(_827.CutterSimulationCalc):
    """ShaperSimulationCalculator
    ...
    @property
    def shaper(self: "Self") -> "_822.CylindricalGearShaperTangible":
