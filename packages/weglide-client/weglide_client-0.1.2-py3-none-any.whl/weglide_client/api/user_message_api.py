...
class UserMessageApi:
    ...
    @validate_call
    def send_message_v1_usermessage_post(
        self,
        ...
        _param = self._send_message_v1_usermessage_post_serialize(
    ...
    @validate_call
    def send_message_v1_usermessage_post_with_http_info(
        self,
        user_message: UserMessage,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def send_message_v1_usermessage_post_without_preload_content(
        self,
        user_message: UserMessage,
        _request_timeout: Union[
            None,
    ...
    def _send_message_v1_usermessage_post_serialize(
        self,
        user_message,
        _request_auth,
        _content_type,
