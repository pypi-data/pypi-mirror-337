...
from mastapy._private.math_utility import _1669
...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1672, _1673, _1689
...
class _Cast_ComplexVector:
    ...
    @property
    def complex_matrix(self: "CastSelf") -> "_1669.ComplexMatrix":
        return self.__parent__._cast(_1669.ComplexMatrix)
...
class ComplexVector(_1669.ComplexMatrix):
    """ComplexVector
