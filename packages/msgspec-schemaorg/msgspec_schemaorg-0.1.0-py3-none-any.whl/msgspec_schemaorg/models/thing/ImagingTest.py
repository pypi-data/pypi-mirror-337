...
if TYPE_CHECKING:
    ...
    from msgspec_schemaorg.models.intangible.MedicalImagingTechnique import MedicalImagingTechnique
...
class ImagingTest(Struct, frozen=True):
    ...
    normalRange: str | 'MedicalEnumeration' | None = None
