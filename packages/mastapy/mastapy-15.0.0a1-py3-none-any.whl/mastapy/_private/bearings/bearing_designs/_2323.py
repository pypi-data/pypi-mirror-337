...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2063, _2068
...
class LinearBearing(_2320.BearingDesign):
    """LinearBearing
    ...
    @property
    def stiffness_options(self: "Self") -> "_2068.BearingStiffnessMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2068", "BearingStiffnessMatrixOption"
        )(value)

    @stiffness_options.setter
    @enforce_parameter_types
    def stiffness_options(
        self: "Self", value: "_2068.BearingStiffnessMatrixOption"
    ) -> None:
