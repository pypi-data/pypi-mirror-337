...
from mastapy._private.bearings.bearing_results.rolling.fitting import _2303
...
class _Cast_OuterRingFittingThermalResults:
    ...
    def ring_fitting_thermal_results(
        self: "CastSelf",
    ) -> "_2303.RingFittingThermalResults":
        return self.__parent__._cast(_2303.RingFittingThermalResults)
...
class OuterRingFittingThermalResults(_2303.RingFittingThermalResults):
    """OuterRingFittingThermalResults
