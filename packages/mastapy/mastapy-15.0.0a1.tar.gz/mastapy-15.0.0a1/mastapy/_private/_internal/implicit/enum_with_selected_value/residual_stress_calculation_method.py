...
class EnumWithSelectedValue_ResidualStressCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ResidualStressCalculationMethod]",
    ) -> "_1174.ResidualStressCalculationMethod":
        ...
        Returns:
            _1174.ResidualStressCalculationMethod
        """
        return _1174.ResidualStressCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1174.ResidualStressCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1174.ResidualStressCalculationMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_1174.ResidualStressCalculationMethod]":
