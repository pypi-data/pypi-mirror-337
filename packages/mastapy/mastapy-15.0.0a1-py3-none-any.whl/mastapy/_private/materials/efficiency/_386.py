...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials.efficiency import _377, _379
...
class _Cast_ResistiveTorque:
    ...
    @property
    def combined_resistive_torque(self: "CastSelf") -> "_377.CombinedResistiveTorque":
        from mastapy._private.materials.efficiency import _377

        return self.__parent__._cast(_377.CombinedResistiveTorque)

    @property
    def independent_resistive_torque(
        self: "CastSelf",
    ) -> "_379.IndependentResistiveTorque":
        from mastapy._private.materials.efficiency import _379

        return self.__parent__._cast(_379.IndependentResistiveTorque)
