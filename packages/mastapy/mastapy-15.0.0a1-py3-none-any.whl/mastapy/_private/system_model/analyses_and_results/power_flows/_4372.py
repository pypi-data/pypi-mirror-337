...
class StraightBevelDiffGearSetPowerFlow(_4276.BevelGearSetPowerFlow):
    """StraightBevelDiffGearSetPowerFlow
    ...
    def bevel_gears_power_flow(
        self: "Self",
    ) -> "List[_4371.StraightBevelDiffGearPowerFlow]":
    ...
    def bevel_meshes_power_flow(
        self: "Self",
    ) -> "List[_4370.StraightBevelDiffGearMeshPowerFlow]":
