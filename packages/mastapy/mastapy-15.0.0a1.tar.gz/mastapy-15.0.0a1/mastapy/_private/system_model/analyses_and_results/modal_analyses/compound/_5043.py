...
class MicrophoneCompoundModalAnalysis(_4990.ComponentCompoundModalAnalysis):
    """MicrophoneCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4890.MicrophoneModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4890.MicrophoneModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.MicrophoneModalAnalysis]
