...
def extract_SHM_features( output_directory, file_data, data, first_derivative_data, name_appendage = "" ):
    ...
    df.to_csv( output_directory + "SHM/Features/Features" + name_appendage + ".csv" )

def read_and_analyse_SHM_features( ip, file_data, name_appendage = "" ):
    ...
    feature_names, features = gu.csv_to_df_to_array_and_column_titles( ip.output_directory + "SHM/Features/Features" + name_appendage + ".csv" )
    ...
    df.to_csv( ip.output_directory + "SHM/Features/Mean_Features_Unnormalised" + name_appendage + ".csv" )
    ...
    df.to_csv( ip.output_directory + "SHM/Features/Std_of_Features_Unnormalised" + name_appendage + ".csv" )
    ...
    df.to_csv( ip.output_directory + "SHM/Features/Mean_Features" + name_appendage + ".csv" )

    std_of_features_plus_sample_mask = np.hstack( (np.array( sample_mask )[:, np.newaxis], std_of_features) )

    df = gu.array_with_column_titles_to_df( std_of_features_plus_sample_mask, ["sample"] + mean_feature_names )

    df.to_csv( ip.output_directory + "SHM/Features/Std_of_Features" + name_appendage + ".csv" )
