...
class BevelDifferentialGearMeshSystemDeflection(_2912.BevelGearMeshSystemDeflection):
    """BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def rating(self: "Self") -> "_638.BevelGearMeshRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_638.BevelGearMeshRating":
        """mastapy.gears.rating.bevel.BevelGearMeshRating
    ...
    @property
    def power_flow_results(self: "Self") -> "_4269.BevelDifferentialGearMeshPowerFlow":
