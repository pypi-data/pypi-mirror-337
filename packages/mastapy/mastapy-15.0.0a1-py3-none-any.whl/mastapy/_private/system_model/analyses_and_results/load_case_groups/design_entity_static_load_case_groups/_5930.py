...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2732, _2734
...
TGearSet = TypeVar("TGearSet", bound="_2734.GearSet")
TGear = TypeVar("TGear", bound="_2732.Gear")
TGearStaticLoad = TypeVar("TGearStaticLoad", bound="_7717.GearLoadCase")
TGearMesh = TypeVar("TGearMesh", bound="_2504.GearMesh")
TGearMeshStaticLoad = TypeVar("TGearMeshStaticLoad", bound="_7719.GearMeshLoadCase")
TGearSetStaticLoad = TypeVar("TGearSetStaticLoad", bound="_7722.GearSetLoadCase")
...
class _Cast_GearSetStaticLoadCaseGroup:
    ...
    def part_static_load_case_group(
        self: "CastSelf",
    ) -> "_5931.PartStaticLoadCaseGroup":
        return self.__parent__._cast(_5931.PartStaticLoadCaseGroup)
...
class GearSetStaticLoadCaseGroup(
    ...
    def gears_load_cases(
        self: "Self",
    ) -> "List[_5927.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]":
    ...
    def meshes_load_cases(
        self: "Self",
    ) -> "List[_5928.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]":
