...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2815, _2817
...
class Synchroniser(_2676.SpecialisedAssembly):
    """Synchroniser
    ...
    @property
    def clutch_connection_left(self: "Self") -> "_2533.ClutchConnection":
    ...
    @property
    def clutch_connection_right(self: "Self") -> "_2533.ClutchConnection":
        """mastapy.system_model.connections_and_sockets.couplings.ClutchConnection
    ...
    @property
    def hub_and_sleeve(self: "Self") -> "_2817.SynchroniserSleeve":
    ...
    @property
    def left_cone(self: "Self") -> "_2815.SynchroniserHalf":
    ...
    @property
    def right_cone(self: "Self") -> "_2815.SynchroniserHalf":
        """mastapy.system_model.part_model.couplings.SynchroniserHalf
