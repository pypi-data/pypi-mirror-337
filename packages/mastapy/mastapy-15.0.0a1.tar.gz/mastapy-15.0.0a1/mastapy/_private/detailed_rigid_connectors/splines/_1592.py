...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.splines import _1574
...
class SplineMaterial(_352.Material):
    """SplineMaterial
    ...
    @property
    def heat_treatment_type(self: "Self") -> "_1574.HeatTreatmentTypes":
    ...
    @enforce_parameter_types
    def heat_treatment_type(self: "Self", value: "_1574.HeatTreatmentTypes") -> None:
