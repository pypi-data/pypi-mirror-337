...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1157, _1159, _1160
...
class _Cast_ISO6336GeometryBase:
    ...
    @property
    def iso6336_geometry(self: "CastSelf") -> "_1157.ISO6336Geometry":
        from mastapy._private.gears.gear_designs.cylindrical import _1157

        return self.__parent__._cast(_1157.ISO6336Geometry)

    @property
    def iso6336_geometry_for_shaped_gears(
        self: "CastSelf",
    ) -> "_1159.ISO6336GeometryForShapedGears":
        from mastapy._private.gears.gear_designs.cylindrical import _1159

        return self.__parent__._cast(_1159.ISO6336GeometryForShapedGears)

    @property
    def iso6336_geometry_manufactured(
        self: "CastSelf",
    ) -> "_1160.ISO6336GeometryManufactured":
        from mastapy._private.gears.gear_designs.cylindrical import _1160

        return self.__parent__._cast(_1160.ISO6336GeometryManufactured)
