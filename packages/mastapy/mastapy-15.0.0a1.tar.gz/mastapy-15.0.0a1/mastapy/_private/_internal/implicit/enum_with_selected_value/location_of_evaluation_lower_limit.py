...
from mastapy._private.gears.micro_geometry import _657
...
class EnumWithSelectedValue_LocationOfEvaluationLowerLimit(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfEvaluationLowerLimit]",
    ) -> "_657.LocationOfEvaluationLowerLimit":
        ...
        Returns:
            _657.LocationOfEvaluationLowerLimit
        """
        return _657.LocationOfEvaluationLowerLimit
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _657.LocationOfEvaluationLowerLimit.type_()

    @property
    def selected_value(self: "Self") -> "_657.LocationOfEvaluationLowerLimit":
    ...
    @property
    def available_values(self: "Self") -> "List[_657.LocationOfEvaluationLowerLimit]":
