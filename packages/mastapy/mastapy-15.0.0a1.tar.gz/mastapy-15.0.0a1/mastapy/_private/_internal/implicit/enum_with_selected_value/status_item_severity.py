...
from mastapy._private.utility.model_validation import _1973
...
class EnumWithSelectedValue_StatusItemSeverity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1973.StatusItemSeverity
        """
        return _1973.StatusItemSeverity
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_StatusItemSeverity]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1973.StatusItemSeverity.type_()

    @property
    def selected_value(self: "Self") -> "_1973.StatusItemSeverity":
    ...
    @property
    def available_values(self: "Self") -> "List[_1973.StatusItemSeverity]":
