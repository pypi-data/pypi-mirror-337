classdef  OptiSol < casadi.PrintableCommon
  ...
  methods
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1359, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1360, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1361, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1362, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1363, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1364, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1365, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1366, self, varargin{:});
    end
