...
class RollingRingAssemblySystemDeflection(_3014.SpecialisedAssemblySystemDeflection):
    """RollingRingAssemblySystemDeflection
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7774.RollingRingAssemblyLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4356.RollingRingAssemblyPowerFlow":
