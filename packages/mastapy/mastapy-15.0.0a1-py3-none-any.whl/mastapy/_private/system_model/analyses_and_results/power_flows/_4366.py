...
class SpiralBevelGearSetPowerFlow(_4276.BevelGearSetPowerFlow):
    """SpiralBevelGearSetPowerFlow
    ...
    @property
    def rating(self: "Self") -> "_488.SpiralBevelGearSetRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_488.SpiralBevelGearSetRating":
        """mastapy.gears.rating.spiral_bevel.SpiralBevelGearSetRating
    ...
    @property
    def bevel_gears_power_flow(self: "Self") -> "List[_4365.SpiralBevelGearPowerFlow]":
    ...
    def spiral_bevel_gears_power_flow(
        self: "Self",
    ) -> "List[_4365.SpiralBevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SpiralBevelGearPowerFlow]
    ...
    def bevel_meshes_power_flow(
        self: "Self",
    ) -> "List[_4364.SpiralBevelGearMeshPowerFlow]":
