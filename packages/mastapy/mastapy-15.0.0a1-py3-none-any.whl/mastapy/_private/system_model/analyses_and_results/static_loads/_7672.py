...
class ConicalGearManufactureError(_7718.GearManufactureError):
    """ConicalGearManufactureError
    ...
    @property
    def pitch_errors_concave_flank(self: "Self") -> "_1709.Vector2DListAccessor":
    ...
    @property
    def pitch_errors_convex_flank(self: "Self") -> "_1709.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
