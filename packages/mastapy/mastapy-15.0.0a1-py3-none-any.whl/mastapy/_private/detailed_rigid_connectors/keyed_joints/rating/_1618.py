...
from mastapy._private.detailed_rigid_connectors.interference_fits.rating import _1625
...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.keyed_joints.rating import _1617
    from mastapy._private.detailed_rigid_connectors.rating import _1612
...
class _Cast_KeywayRating:
    ...
    def shaft_hub_connection_rating(
        self: "CastSelf",
    ) -> "_1612.ShaftHubConnectionRating":
        from mastapy._private.detailed_rigid_connectors.rating import _1612

        return self.__parent__._cast(_1612.ShaftHubConnectionRating)
...
class KeywayRating(_1625.InterferenceFitRating):
    """KeywayRating
    ...
    @property
    def keyed_joint_design(self: "Self") -> "_1613.KeyedJointDesign":
    ...
    @property
    def keyway_half_ratings(self: "Self") -> "List[_1617.KeywayHalfRating]":
