...
class _Cast_RelativeValuesSpecification:
    ...
    @property
    def backlash_specification(self: "CastSelf") -> "_1096.BacklashSpecification":
        from mastapy._private.gears.gear_designs.cylindrical import _1096

        return self.__parent__._cast(_1096.BacklashSpecification)

    @property
    def finish_stock_specification(
        self: "CastSelf",
    ) -> "_1195.FinishStockSpecification":
        from mastapy._private.gears.gear_designs.cylindrical.thickness_stock_and_backlash import (
            _1195,
        )

        return self.__parent__._cast(_1195.FinishStockSpecification)
