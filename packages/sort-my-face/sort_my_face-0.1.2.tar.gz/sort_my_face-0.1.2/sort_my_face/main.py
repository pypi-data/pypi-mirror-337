...
def sort_my_face(folder_to_sort, seuil_type = None, ia_model="ED" ):
    """ 
    ...
    #Verification 
    assert os.path.isdir(folder_to_sort), f"Error : the folder '{folder_to_sort}' does not exist or is not a valid folder"
...
def main():
    ...
    sort_my_face(args.folder_to_sort, args.seuil_type, args.ia_model)
