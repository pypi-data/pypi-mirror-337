...
class EnumWithSelectedValue_RotationalDirections(
    ...
    def wrapped_type(
        ...
        Returns:
            _2083.RotationalDirections
        """
        return _2083.RotationalDirections
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_RotationalDirections]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2083.RotationalDirections.type_()

    @property
    def selected_value(self: "Self") -> "_2083.RotationalDirections":
    ...
    @property
    def available_values(self: "Self") -> "List[_2083.RotationalDirections]":
