...
class ConceptGearSetCompoundSystemDeflection(_3120.GearSetCompoundSystemDeflection):
    """ConceptGearSetCompoundSystemDeflection
    ...
    def concept_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_3088.ConceptGearCompoundSystemDeflection]":
    ...
    def concept_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_3089.ConceptGearMeshCompoundSystemDeflection]":
