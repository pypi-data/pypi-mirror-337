...
class EnumWithSelectedValue_ModalCorrectionMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _6043.ModalCorrectionMethod
        """
        return _6043.ModalCorrectionMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _6043.ModalCorrectionMethod.type_()

    @property
    def selected_value(self: "Self") -> "_6043.ModalCorrectionMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_6043.ModalCorrectionMethod]":
