...
class StraightBevelGearSet(_2722.BevelGearSet):
    """StraightBevelGearSet
    ...
    @property
    def conical_gear_set_design(self: "Self") -> "_1060.StraightBevelGearSetDesign":
    ...
    @property
    def straight_bevel_gears(self: "Self") -> "List[_2750.StraightBevelGear]":
    ...
    @property
    def straight_bevel_meshes(self: "Self") -> "List[_2518.StraightBevelGearMesh]":
