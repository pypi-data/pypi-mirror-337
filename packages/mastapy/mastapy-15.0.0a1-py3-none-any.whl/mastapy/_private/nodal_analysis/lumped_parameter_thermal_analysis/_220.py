...
class UserDefinedNodeLoadCaseInformation(_0.APIBase):
    ...
    @property
    def constraint(self: "Self") -> "_218.UserDefinedNodeConstraint":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.lumped_parameter_thermal_analysis._218",
            "UserDefinedNodeConstraint",
        )(value)

    @constraint.setter
    @enforce_parameter_types
    def constraint(self: "Self", value: "_218.UserDefinedNodeConstraint") -> None:
