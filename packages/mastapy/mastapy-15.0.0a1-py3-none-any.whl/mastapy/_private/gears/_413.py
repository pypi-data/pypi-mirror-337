...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1717
...
class GearSetOptimisationResult(_0.APIBase):
    ...
    @property
    def gear_set(self: "Self") -> "_1047.GearSetDesign":
    ...
    @property
    def optimisation_history(self: "Self") -> "_1717.OptimisationHistory":
    ...
    def optimisation_history(self: "Self", value: "_1717.OptimisationHistory") -> None:
        pythonnet_property_set(self.wrapped, "OptimisationHistory", value.wrapped)

    @property
    def rating(self: "Self") -> "_438.AbstractGearSetRating":
