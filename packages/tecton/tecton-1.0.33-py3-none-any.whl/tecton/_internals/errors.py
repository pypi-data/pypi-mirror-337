...
GET_HISTORICAL_FEATURES_DEPRECATION_REASON = "get_historical_features() is replaced by get_features_for_events() and get_features_in_range(). See https://docs.tecton.ai/docs/reading-feature-data/reading-feature-data-for-training/offline-retrieval-methods for details."
