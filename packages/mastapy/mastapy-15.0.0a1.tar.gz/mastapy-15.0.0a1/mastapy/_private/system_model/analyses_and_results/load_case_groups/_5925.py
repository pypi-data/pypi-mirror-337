...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2853, _2881
...
class TimeSeriesLoadCaseGroup(_5913.AbstractLoadCaseGroup):
    """TimeSeriesLoadCaseGroup
    ...
    @property
    def load_cases(self: "Self") -> "List[_7801.TimeSeriesLoadCase]":
