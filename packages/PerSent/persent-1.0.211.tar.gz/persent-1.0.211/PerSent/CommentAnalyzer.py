...
class CommentAnalyzer:
    def __init__(self, model_dir='PerSent/model/CommentAnalyzer'):
    ...
    def _try_load_default_models(self):
        ...
        try:
            ...
            if classifier_path.exists() and word2vec_path.exists():
                ...
                warnings.warn(
                    "Default models not found. You need to train or provide models. "
                    f"Expected paths:\n- {classifier_path}\n- {word2vec_path}",
                    RuntimeWarning
                )
        except Exception as e:
            warnings.warn(
                f"Failed to load default models: {str(e)}",
                RuntimeWarning
            )
