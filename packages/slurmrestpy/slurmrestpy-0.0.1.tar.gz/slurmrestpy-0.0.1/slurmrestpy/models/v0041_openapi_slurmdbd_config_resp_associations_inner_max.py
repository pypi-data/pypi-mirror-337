...
class V0041OpenapiSlurmdbdConfigRespAssociationsInnerMax(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "jobs": V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobs.from_dict(
                    obj["jobs"]
                )
                if obj.get("jobs") is not None
                else None,
                "tres": V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxTres.from_dict(
                    obj["tres"]
                )
                if obj.get("tres") is not None
                else None,
                "per": V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxPer.from_dict(
                    obj["per"]
                )
