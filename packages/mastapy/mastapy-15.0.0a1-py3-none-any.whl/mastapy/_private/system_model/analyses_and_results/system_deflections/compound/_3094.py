...
class _Cast_ConnectionCompoundSystemDeflection:
    ...
    def coaxial_connection_compound_system_deflection(
        self: "CastSelf",
    ) -> "_3083.CoaxialConnectionCompoundSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.system_deflections.compound import (
            _3083,
        )

        return self.__parent__._cast(_3083.CoaxialConnectionCompoundSystemDeflection)
    ...
    def cycloidal_disc_central_bearing_connection_compound_system_deflection(
        self: "CastSelf",
    ) -> "_3103.CycloidalDiscCentralBearingConnectionCompoundSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.system_deflections.compound import (
            _3103,
        )
    ...
    def cycloidal_disc_planetary_bearing_connection_compound_system_deflection(
        self: "CastSelf",
    ) -> "_3105.CycloidalDiscPlanetaryBearingConnectionCompoundSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.system_deflections.compound import (
            _3105,
        )
    ...
    def planetary_connection_compound_system_deflection(
        self: "CastSelf",
    ) -> "_3145.PlanetaryConnectionCompoundSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.system_deflections.compound import (
            _3145,
        )

        return self.__parent__._cast(_3145.PlanetaryConnectionCompoundSystemDeflection)
...
class ConnectionCompoundSystemDeflection(_7839.ConnectionCompoundAnalysis):
    """ConnectionCompoundSystemDeflection
