...
class StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3305.StraightBevelDiffGearSetSteadyStateSynchronousResponse]":
    ...
    def straight_bevel_diff_gears_compound_steady_state_synchronous_response(
        self: "Self",
    ) -> "List[_3435.StraightBevelDiffGearCompoundSteadyStateSynchronousResponse]":
    ...
    def straight_bevel_diff_meshes_compound_steady_state_synchronous_response(
        self: "Self",
    ) -> "List[_3436.StraightBevelDiffGearMeshCompoundSteadyStateSynchronousResponse]":
