...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1115, _1131, _1144
...
class CylindricalGearSetMicroGeometry(_1344.GearSetImplementationDetail):
    """CylindricalGearSetMicroGeometry
    ...
    def cylindrical_mesh_micro_geometries(
        self: "Self",
    ) -> "List[_1204.CylindricalGearMeshMicroGeometry]":
    ...
    def duplicate_and_add_to(
        self: "Self", gear_set_design: "_1131.CylindricalGearSetDesign"
    ) -> "CylindricalGearSetMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry
    ...
    def duplicate_specifying_separate_micro_geometry_for_each_planet_and_add_to(
        self: "Self", gear_set_design: "_1144.CylindricalPlanetaryGearSetDesign"
    ) -> "_1344.GearSetImplementationDetail":
        """mastapy.gears.analysis.GearSetImplementationDetail
