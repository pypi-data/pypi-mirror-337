...
class _Cast_GearCutterSimulation:
    ...
    @property
    def finish_cutter_simulation(self: "CastSelf") -> "_832.FinishCutterSimulation":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _832,
        )

        return self.__parent__._cast(_832.FinishCutterSimulation)

    @property
    def rough_cutter_simulation(self: "CastSelf") -> "_840.RoughCutterSimulation":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _840,
        )

        return self.__parent__._cast(_840.RoughCutterSimulation)
...
class GearCutterSimulation(_0.APIBase):
    ...
    @property
    def average_thickness(self: "Self") -> "_827.CutterSimulationCalc":
    ...
    @property
    def average_thickness_virtual(self: "Self") -> "_843.VirtualSimulationCalculator":
    ...
    @property
    def least_profile(self: "Self") -> "_827.CutterSimulationCalc":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.CutterSimulationCalc
    ...
    @property
    def least_profile_virtual(self: "Self") -> "_843.VirtualSimulationCalculator":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.VirtualSimulationCalculator
    ...
    @property
    def maximum_thickness(self: "Self") -> "_827.CutterSimulationCalc":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.CutterSimulationCalc
    ...
    @property
    def maximum_thickness_virtual(self: "Self") -> "_843.VirtualSimulationCalculator":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.VirtualSimulationCalculator
    ...
    @property
    def minimum_thickness(self: "Self") -> "_827.CutterSimulationCalc":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.CutterSimulationCalc
    ...
    @property
    def minimum_thickness_virtual(self: "Self") -> "_843.VirtualSimulationCalculator":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.VirtualSimulationCalculator
    ...
    def gear_mesh_cutter_simulations(
        self: "Self",
    ) -> "List[_830.CylindricalManufacturedRealGearInMesh]":
    ...
    def gear_mesh_cutter_simulations_virtual(
        self: "Self",
    ) -> "List[_831.CylindricalManufacturedVirtualGearInMesh]":
    ...
    @property
    def thickness_calculators(self: "Self") -> "List[_827.CutterSimulationCalc]":
    ...
    def virtual_thickness_calculators(
        self: "Self",
    ) -> "List[_843.VirtualSimulationCalculator]":
