...
from mastapy._private.fe_tools.enums import _1357
...
class EnumWithSelectedValue_MaterialPropertyClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _1357.MaterialPropertyClass
        """
        return _1357.MaterialPropertyClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1357.MaterialPropertyClass.type_()

    @property
    def selected_value(self: "Self") -> "_1357.MaterialPropertyClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_1357.MaterialPropertyClass]":
