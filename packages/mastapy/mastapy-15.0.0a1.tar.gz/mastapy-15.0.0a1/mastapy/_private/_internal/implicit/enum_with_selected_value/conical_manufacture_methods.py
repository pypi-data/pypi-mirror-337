...
from mastapy._private.gears.gear_designs.conical import _1271
...
class EnumWithSelectedValue_ConicalManufactureMethods(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ConicalManufactureMethods]",
    ) -> "_1271.ConicalManufactureMethods":
        ...
        Returns:
            _1271.ConicalManufactureMethods
        """
        return _1271.ConicalManufactureMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1271.ConicalManufactureMethods.type_()

    @property
    def selected_value(self: "Self") -> "_1271.ConicalManufactureMethods":
    ...
    @property
    def available_values(self: "Self") -> "List[_1271.ConicalManufactureMethods]":
