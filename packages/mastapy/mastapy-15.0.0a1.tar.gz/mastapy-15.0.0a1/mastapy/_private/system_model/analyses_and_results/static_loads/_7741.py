...
class KlingelnbergCycloPalloidConicalGearSetLoadCase(_7675.ConicalGearSetLoadCase):
    """KlingelnbergCycloPalloidConicalGearSetLoadCase
    ...
    def conical_gears_load_case(
        self: "Self",
    ) -> "List[_7739.KlingelnbergCycloPalloidConicalGearLoadCase]":
    ...
    def conical_meshes_load_case(
        self: "Self",
    ) -> "List[_7740.KlingelnbergCycloPalloidConicalGearMeshLoadCase]":
