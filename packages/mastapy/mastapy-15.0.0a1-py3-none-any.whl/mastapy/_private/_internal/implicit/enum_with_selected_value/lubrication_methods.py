...
class EnumWithSelectedValue_LubricationMethods(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _418.LubricationMethods
        """
        return _418.LubricationMethods
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_LubricationMethods]") -> "Any":
        ...
        Returns:
            Any
        """
        return _418.LubricationMethods.type_()

    @property
    def selected_value(self: "Self") -> "_418.LubricationMethods":
    ...
    @property
    def available_values(self: "Self") -> "List[_418.LubricationMethods]":
