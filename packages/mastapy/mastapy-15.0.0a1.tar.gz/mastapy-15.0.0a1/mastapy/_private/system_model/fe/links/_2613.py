...
from mastapy._private.system_model.fe import _2554, _2577, _2593, _2597
...
class _Cast_FELink:
    ...
    @property
    def single_node_fe_link(self: "CastSelf") -> "_2627.SingleNodeFELink":
        from mastapy._private.system_model.fe.links import _2627

        return self.__parent__._cast(_2627.SingleNodeFELink)
...
class FELink(_0.APIBase):
    ...
    @enforce_parameter_types
    def bearing_node_link_option(
        self: "Self", value: "_2554.BearingNodeOption"
    ) -> None:
    ...
    def coupling_type(
        self: "Self",
        value: "Union[_282.RigidCouplingType, Tuple[_282.RigidCouplingType, bool]]",
    ) -> None:
    ...
    @enforce_parameter_types
    def link_node_source(self: "Self", value: "_2593.LinkNodeSource") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def node_selection_depth(
        self: "Self",
        value: "Union[_2597.NodeSelectionDepthOption, Tuple[_2597.NodeSelectionDepthOption, bool]]",
    ) -> None:
    ...
    def alignment_in_component_coordinate_system(
        self: "Self",
    ) -> "_2592.LinkComponentAxialPositionErrorReporter":
    ...
    @property
    def component(self: "Self") -> "_2662.MountableComponent":
    ...
    @property
    def socket(self: "Self") -> "_2487.Socket":
    ...
    @property
    def support_material(self: "Self") -> "_352.Material":
    ...
    def nodes_grouped_by_angle(
        self: "Self",
    ) -> "OrderedDict[float, List[_2577.FESubstructureNode]]":
    ...
    @enforce_parameter_types
    def add_or_replace_node(self: "Self", node: "_2577.FESubstructureNode") -> None:
