...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import _838
    from mastapy._private.gears.manufacturing.cylindrical.cutters import _818
    from mastapy._private.utility import _1769
...
class _Cast_CylindricalGearDefaults:
    ...
    @property
    def persistent_singleton(self: "CastSelf") -> "_1769.PersistentSingleton":
        from mastapy._private.utility import _1769

        return self.__parent__._cast(_1769.PersistentSingleton)
...
class CylindricalGearDefaults(_1768.PerMachineSettings):
    """CylindricalGearDefaults
    ...
    @property
    def finish_stock_type(self: "Self") -> "_1196.FinishStockType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical.thickness_stock_and_backlash._1196",
            "FinishStockType",
        )(value)

    @finish_stock_type.setter
    @enforce_parameter_types
    def finish_stock_type(self: "Self", value: "_1196.FinishStockType") -> None:
    ...
    def rough_cutter_creation_settings(
        self: "Self",
    ) -> "_818.RoughCutterCreationSettings":
    ...
    @property
    def system_of_fits_defaults(self: "Self") -> "_1252.DIN3967SystemOfGearFits":
