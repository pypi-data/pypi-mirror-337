...
class V0041OpenapiSlurmdbdConfigRespClustersInner(BaseModel):
    ...
    associations: Optional[V0041OpenapiSlurmdbdConfigRespClustersInnerAssociations] = (
        None
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "controller": V0042ClusterRecController.from_dict(obj["controller"])
                ...
                "associations": V0041OpenapiSlurmdbdConfigRespClustersInnerAssociations.from_dict(
                    obj["associations"]
                )
