...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.measured_vectors import _1734, _1735, _1738
...
class _Cast_AbstractForceAndDisplacementResults:
    ...
    def force_and_displacement_results(
        self: "CastSelf",
    ) -> "_1734.ForceAndDisplacementResults":
        from mastapy._private.math_utility.measured_vectors import _1734

        return self.__parent__._cast(_1734.ForceAndDisplacementResults)

    @property
    def force_results(self: "CastSelf") -> "_1735.ForceResults":
        from mastapy._private.math_utility.measured_vectors import _1735

        return self.__parent__._cast(_1735.ForceResults)
...
class AbstractForceAndDisplacementResults(_0.APIBase):
    ...
    @property
    def force(self: "Self") -> "_1738.VectorWithLinearAndAngularComponents":
