...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1130, _1178
    from mastapy._private.gears.rating import _450
    from mastapy._private.gears.rating.cylindrical.agma import _618, _621
...
class AGMA2101MeshSingleFlankRating(_551.CylindricalMeshSingleFlankRating):
    """AGMA2101MeshSingleFlankRating
    ...
    def thermal_reduction_factor_factors_and_exponents(
        self: "Self",
    ) -> "_621.ThermalReductionFactorFactorsAndExponents":
    ...
    def gear_single_flank_ratings(
        self: "Self",
    ) -> "List[_618.AGMA2101GearSingleFlankRating]":
