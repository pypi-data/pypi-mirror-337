...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.face import _1089, _1090, _1092
...
class FaceGearSetMicroGeometry(_1344.GearSetImplementationDetail):
    """FaceGearSetMicroGeometry
    ...
    def face_mesh_micro_geometries(
        self: "Self",
    ) -> "List[_1089.FaceGearMeshMicroGeometry]":
