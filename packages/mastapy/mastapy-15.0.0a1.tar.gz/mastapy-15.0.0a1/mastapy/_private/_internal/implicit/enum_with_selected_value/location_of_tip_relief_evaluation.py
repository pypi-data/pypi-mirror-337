...
from mastapy._private.gears.micro_geometry import _660
...
class EnumWithSelectedValue_LocationOfTipReliefEvaluation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfTipReliefEvaluation]",
    ) -> "_660.LocationOfTipReliefEvaluation":
        ...
        Returns:
            _660.LocationOfTipReliefEvaluation
        """
        return _660.LocationOfTipReliefEvaluation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _660.LocationOfTipReliefEvaluation.type_()

    @property
    def selected_value(self: "Self") -> "_660.LocationOfTipReliefEvaluation":
    ...
    @property
    def available_values(self: "Self") -> "List[_660.LocationOfTipReliefEvaluation]":
