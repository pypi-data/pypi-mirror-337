...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1507, _1508, _1509, _1511
...
class ElectricMachineResultsTimeStep(_0.APIBase):
    ...
    @property
    def flux_density_in_air_gap_chart(self: "Self") -> "_2053.TwoDChartDefinition":
    ...
    @property
    def force_density_in_air_gap_mst_chart(self: "Self") -> "_2053.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    def results_for_stator_teeth(
        self: "Self",
    ) -> "List[_1508.ElectricMachineResultsForStatorToothAtTimeStep]":
    ...
    def results_at_locations(
        self: "Self",
    ) -> "List[_1511.ElectricMachineResultsTimeStepAtLocation]":
    ...
    def results_for_line_to_line(
        self: "Self",
    ) -> "List[_1509.ElectricMachineResultsLineToLineAtTimeStep]":
    ...
    def results_for_phases(
        self: "Self",
    ) -> "List[_1507.ElectricMachineResultsForPhaseAtTimeStep]":
