...
class TransferPathAnalysisCharts(_0.APIBase):
    ...
    @property
    def force_at_transfer_path_node_chart(self: "Self") -> "_2053.TwoDChartDefinition":
    ...
    @property
    def responses_chart(self: "Self") -> "_2053.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def transmissibility_chart(self: "Self") -> "_2053.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
