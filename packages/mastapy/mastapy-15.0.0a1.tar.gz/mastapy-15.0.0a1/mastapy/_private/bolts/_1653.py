...
if TYPE_CHECKING:
    ...
    from mastapy._private.bolts import _1642, _1644, _1646, _1651, _1656, _1659
...
class DetailedBoltDesign(_0.APIBase):
    ...
    @property
    def clamped_parts(self: "Self") -> "List[_1651.ClampedSection]":
    ...
    @enforce_parameter_types
    def clamped_parts(self: "Self", value: "List[_1651.ClampedSection]") -> None:
    ...
    @property
    def joint_geometry(self: "Self") -> "_1656.JointGeometries":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bolts._1656", "JointGeometries"
        )(value)

    @joint_geometry.setter
    @enforce_parameter_types
    def joint_geometry(self: "Self", value: "_1656.JointGeometries") -> None:
    ...
    def rolled_before_or_after_heat_treatment(
        self: "Self",
    ) -> "_1659.RolledBeforeOrAfterHeatTreatment":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bolts._1659", "RolledBeforeOrAfterHeatTreatment"
        )(value)

    @rolled_before_or_after_heat_treatment.setter
    @enforce_parameter_types
    def rolled_before_or_after_heat_treatment(
        self: "Self", value: "_1659.RolledBeforeOrAfterHeatTreatment"
    ) -> None:
    ...
    @property
    def bolt_geometry(self: "Self") -> "_1644.BoltGeometry":
    ...
    @property
    def material_of_bolt(self: "Self") -> "_1646.BoltMaterial":
    ...
    @property
    def material_of_nut(self: "Self") -> "_1642.BoltedJointMaterial":
    ...
    @property
    def material_of_tapped_thread(self: "Self") -> "_1642.BoltedJointMaterial":
        """mastapy.bolts.BoltedJointMaterial
    ...
    @property
    def clamped_sections(self: "Self") -> "List[_1651.ClampedSection]":
        """List[mastapy.bolts.ClampedSection]
