...
from mastapy._private.system_model.part_model.configurations import _2829
from mastapy._private.system_model.part_model.gears import _2713, _2734
...
class _Cast_ActiveGearSetDesignSelectionGroup:
    ...
    @property
    def part_detail_configuration(self: "CastSelf") -> "_2829.PartDetailConfiguration":
        return self.__parent__._cast(_2829.PartDetailConfiguration)
...
class ActiveGearSetDesignSelectionGroup(
    _2829.PartDetailConfiguration[
        _2713.ActiveGearSetDesignSelection, _2734.GearSet, _1047.GearSetDesign
    ]
):
    """ActiveGearSetDesignSelectionGroup
