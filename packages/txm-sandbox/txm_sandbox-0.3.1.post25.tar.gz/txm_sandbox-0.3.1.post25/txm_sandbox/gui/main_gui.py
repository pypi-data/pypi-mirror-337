...
from .gui_components import set_io_config
...
class txm_gui:
    def __init__(
        ...
        try:
            ...
            self.ij.py.run_macro(
                """run("Set Measurements...", "area mean min limit redirect=None decimal=6");"""
            )
        ...
        self.xanes3D_fiji_windows = {
            ...
            "xanes3D_mask_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "xanes3D_review_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "xanes3D_review_manual_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "xanes3D_analysis_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "analysis_viewer_z_plot_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "xanes3D_fit_jump_flt_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "xanes3D_fit_thres_flt_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "xanes3D_fit_maskit_viewer": {"ip": None, "fiji_id": None, "mag": 1},
        }
        self.xanes2D_fiji_windows = {
            "xanes2D_raw_img_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "xanes2D_mask_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "xanes2D_review_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "xanes2D_analysis_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "analysis_viewer_z_plot_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "xanes2D_fit_jump_flt_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "xanes2D_fit_thres_flt_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "xanes2D_fit_maskit_viewer": {"ip": None, "fiji_id": None, "mag": 1},
        }
        self.tomo_fiji_windows = {
            "tomo_raw_img_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "tomo_0&180_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "tomo_cen_review_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "tomo_recon_viewer": {"ip": None, "fiji_id": None, "mag": 1},
        }
        self.xanes_ana_fiji_windows = {
            "xanes_pp_data_prev_viewer": {"ip": None, "fiji_id": None, "mag": 1},
            "xanes_pp_mask_prev_viewer": {"ip": None, "fiji_id": None, "mag": 1},
        }
    ...
    def gui_layout(self):
        ...
        self.hs["IOConfig tab"].titles = ["||..IO Option..|", "|..Struct h5 IO..||"]
        ...
        self.hs["TomoRecon tab"].children = [
            ...
            self.tomo_recon_gui.hs["Filter&Recon form"],
        ]
        self.hs["TomoRecon tab"].titles = ["||..Config..|", "|..Recon..||"]
        self.hs["TomoRecon tab"].selected_index = 0
        ...
        self.hs["XANES2D tab"].titles = [
            "||..Data Config..|",
            "|..Reg Images..|",
            "|..Fitting..|",
            "|..Analysis..||",
        ]
        self.hs["XANES2D tab"].selected_index = 0
        ...
        self.hs["XANES3D tab"].titles = [
            "||..Data Config..|",
            "|..Reg Images..|",
            "|..Fitting..|",
            "|..Analysis..||",
        ]
        self.hs["XANES3D tab"].selected_index = 0
        ...
        self.hs["MISC tab"].titles = ["||..General Img Align..|", "|..Convert Data..||"]
