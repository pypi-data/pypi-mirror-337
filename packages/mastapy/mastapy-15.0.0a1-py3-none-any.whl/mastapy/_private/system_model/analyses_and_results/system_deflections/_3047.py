...
class ZerolBevelGearMeshSystemDeflection(_2912.BevelGearMeshSystemDeflection):
    """ZerolBevelGearMeshSystemDeflection
    ...
    @property
    def rating(self: "Self") -> "_453.ZerolBevelGearMeshRating":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4392.ZerolBevelGearMeshPowerFlow":
