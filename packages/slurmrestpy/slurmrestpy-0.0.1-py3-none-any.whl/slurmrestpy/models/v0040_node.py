...
class V0040Node(BaseModel):
    ...
    external_sensors: Optional[Dict[str, Any]] = Field(
        default=None, description="removed field"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "boot_time": V0040Uint64NoVal.from_dict(obj["boot_time"])
                ...
                "last_busy": V0040Uint64NoVal.from_dict(obj["last_busy"])
                ...
                "slurmd_start_time": V0040Uint64NoVal.from_dict(
