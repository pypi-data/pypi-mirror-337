...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.conical import _1263, _1273
...
class ConicalMeshLoadCase(_971.MeshLoadCase):
    """ConicalMeshLoadCase
    ...
    @property
    def active_flank(self: "Self") -> "_1263.ActiveConicalFlank":
