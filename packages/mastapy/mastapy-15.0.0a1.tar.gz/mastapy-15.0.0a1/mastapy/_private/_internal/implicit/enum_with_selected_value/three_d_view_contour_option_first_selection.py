...
from mastapy._private.utility.enums import _2003
...
class EnumWithSelectedValue_ThreeDViewContourOptionFirstSelection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ThreeDViewContourOptionFirstSelection]",
    ) -> "_2003.ThreeDViewContourOptionFirstSelection":
        ...
        Returns:
            _2003.ThreeDViewContourOptionFirstSelection
        """
        return _2003.ThreeDViewContourOptionFirstSelection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2003.ThreeDViewContourOptionFirstSelection.type_()

    @property
    def selected_value(self: "Self") -> "_2003.ThreeDViewContourOptionFirstSelection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2003.ThreeDViewContourOptionFirstSelection]":
