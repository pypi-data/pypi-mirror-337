...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.drawing import _2438, _2448, _2449
...
class _Cast_RotorDynamicsViewable:
    ...
    def critical_speed_analysis_viewable(
        self: "CastSelf",
    ) -> "_2438.CriticalSpeedAnalysisViewable":
        from mastapy._private.system_model.drawing import _2438

        return self.__parent__._cast(_2438.CriticalSpeedAnalysisViewable)

    @property
    def stability_analysis_viewable(
        self: "CastSelf",
    ) -> "_2448.StabilityAnalysisViewable":
        from mastapy._private.system_model.drawing import _2448

        return self.__parent__._cast(_2448.StabilityAnalysisViewable)

    @property
    def steady_state_synchronous_response_viewable(
        self: "CastSelf",
    ) -> "_2449.SteadyStateSynchronousResponseViewable":
        from mastapy._private.system_model.drawing import _2449

        return self.__parent__._cast(_2449.SteadyStateSynchronousResponseViewable)
...
class RotorDynamicsViewable(_0.APIBase):
    ...
    @property
    def rotor_dynamics(self: "Self") -> "_4252.RotorDynamicsDrawStyle":
