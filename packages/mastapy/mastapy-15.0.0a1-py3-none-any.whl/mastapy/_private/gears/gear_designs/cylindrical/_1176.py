...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1178, _1179
...
class Scuffing(_1761.IndependentReportablePropertiesBase["Scuffing"]):
    """Scuffing
    ...
    @enforce_parameter_types
    def coefficient_of_friction_method_flash_temperature_method(
        self: "Self", value: "_1177.ScuffingCoefficientOfFrictionMethods"
    ) -> None:
    ...
    def scuffing_temperature_method_agma(
        self: "Self",
    ) -> "_1178.ScuffingTemperatureMethodsAGMA":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1178",
    ...
    @enforce_parameter_types
    def scuffing_temperature_method_agma(
        self: "Self", value: "_1178.ScuffingTemperatureMethodsAGMA"
    ) -> None:
    ...
    def scuffing_temperature_method_iso(
        self: "Self",
    ) -> "_1179.ScuffingTemperatureMethodsISO":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1179",
    ...
    @enforce_parameter_types
    def scuffing_temperature_method_iso(
        self: "Self", value: "_1179.ScuffingTemperatureMethodsISO"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.ScuffingTemperatureMethodsISO",
