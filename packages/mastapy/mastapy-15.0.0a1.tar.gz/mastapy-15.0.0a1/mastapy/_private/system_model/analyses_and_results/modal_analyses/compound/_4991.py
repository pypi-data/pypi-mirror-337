...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.modal_analyses import _4835
    from mastapy._private.system_model.analyses_and_results.modal_analyses.compound import (
        _4965,
        _5046,
        _5065,
...
class ConceptCouplingCompoundModalAnalysis(_5002.CouplingCompoundModalAnalysis):
    """ConceptCouplingCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4835.ConceptCouplingModalAnalysis]":
