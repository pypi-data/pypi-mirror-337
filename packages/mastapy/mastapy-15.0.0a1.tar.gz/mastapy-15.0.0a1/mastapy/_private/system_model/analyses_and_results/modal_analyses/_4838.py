...
class ConceptGearSetModalAnalysis(_4872.GearSetModalAnalysis):
    """ConceptGearSetModalAnalysis
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4837.ConceptGearModalAnalysis]":
    ...
    def concept_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4837.ConceptGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ConceptGearModalAnalysis]
    ...
    def meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4836.ConceptGearMeshModalAnalysis]":
