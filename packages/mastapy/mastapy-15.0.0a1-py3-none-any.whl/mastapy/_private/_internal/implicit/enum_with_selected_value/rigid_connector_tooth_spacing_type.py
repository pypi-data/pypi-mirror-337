...
from mastapy._private.system_model.part_model.couplings import _2801
...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorToothSpacingType]",
    ) -> "_2801.RigidConnectorToothSpacingType":
        ...
        Returns:
            _2801.RigidConnectorToothSpacingType
        """
        return _2801.RigidConnectorToothSpacingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2801.RigidConnectorToothSpacingType.type_()

    @property
    def selected_value(self: "Self") -> "_2801.RigidConnectorToothSpacingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2801.RigidConnectorToothSpacingType]":
