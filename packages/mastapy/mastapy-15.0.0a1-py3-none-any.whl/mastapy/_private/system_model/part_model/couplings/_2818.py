...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2819, _2821
...
class TorqueConverter(_2788.Coupling):
    """TorqueConverter
    ...
    @property
    def pump(self: "Self") -> "_2819.TorqueConverterPump":
    ...
    @property
    def turbine(self: "Self") -> "_2821.TorqueConverterTurbine":
