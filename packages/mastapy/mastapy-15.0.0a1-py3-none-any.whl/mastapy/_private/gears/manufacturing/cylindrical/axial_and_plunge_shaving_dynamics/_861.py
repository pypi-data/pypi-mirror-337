...
class _Cast_ShavingDynamics:
    ...
    def conventional_shaving_dynamics(
        self: "CastSelf",
    ) -> "_847.ConventionalShavingDynamics":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _847,
        )

        return self.__parent__._cast(_847.ConventionalShavingDynamics)

    @property
    def plunge_shaver_dynamics(self: "CastSelf") -> "_851.PlungeShaverDynamics":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _851,
        )

        return self.__parent__._cast(_851.PlungeShaverDynamics)
