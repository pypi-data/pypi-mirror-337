...
class RootAssemblyCompoundSystemDeflection(_3066.AssemblyCompoundSystemDeflection):
    """RootAssemblyCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3008.RootAssemblySystemDeflection]":
    ...
    @property
    def bearing_race_f_es(self: "Self") -> "List[_2602.RaceBearingFESystemDeflection]":
    ...
    def peak_to_peak_transmission_error_chart(
        self: "Self",
        mesh_duty_cycles: "List[_1205.CylindricalGearMeshMicroGeometryDutyCycle]",
        header: "str",
        x_axis_title: "str",
        y_axis_title: "str",
