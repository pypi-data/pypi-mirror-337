...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe.links import _2615
...
class _Cast_FESubstructureWithSelectionComponents:
    ...
    def fe_substructure_with_selection(
        self: "CastSelf",
    ) -> "_2582.FESubstructureWithSelection":
        return self.__parent__._cast(_2582.FESubstructureWithSelection)
...
class FESubstructureWithSelectionComponents(_2582.FESubstructureWithSelection):
    """FESubstructureWithSelectionComponents
    ...
    @property
    def manual_alignment(self: "Self") -> "_1675.CoordinateSystemEditor":
    ...
    def beam_element_properties(
        self: "Self",
    ) -> "List[_2568.ElementPropertiesWithSelection[_289.ElementPropertiesBeam]]":
    ...
    @property
    def component_links(self: "Self") -> "List[_2615.FELinkWithSelection]":
    ...
    @property
    def contact_pairs(self: "Self") -> "List[_2558.ContactPairWithSelection]":
    ...
    @property
    def coordinate_systems(self: "Self") -> "List[_2559.CoordinateSystemWithSelection]":
    ...
    def independent_masta_created_rigid_nodes(
        self: "Self",
    ) -> "List[_2590.IndependentMASTACreatedConstrainedNodesWithSelectionComponents]":
    ...
    def interface_element_properties(
        self: "Self",
    ) -> "List[_2568.ElementPropertiesWithSelection[_290.ElementPropertiesInterface]]":
    ...
    @property
    def links_for_electric_machine(self: "Self") -> "List[_2615.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    @property
    def links_for_selected_component(self: "Self") -> "List[_2615.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    def mass_element_properties(
        self: "Self",
    ) -> "List[_2568.ElementPropertiesWithSelection[_291.ElementPropertiesMass]]":
    ...
    @property
    def materials(self: "Self") -> "List[_2594.MaterialPropertiesWithSelection]":
    ...
    def other_element_properties(
        self: "Self",
    ) -> "List[_2568.ElementPropertiesWithSelection[_288.ElementPropertiesBase]]":
    ...
    def rigid_element_properties(
        self: "Self",
    ) -> "List[_2568.ElementPropertiesWithSelection[_292.ElementPropertiesRigid]]":
    ...
    def shell_element_properties(
        self: "Self",
    ) -> "List[_2568.ElementPropertiesWithSelection[_293.ElementPropertiesShell]]":
    ...
    def solid_element_properties(
        self: "Self",
    ) -> "List[_2568.ElementPropertiesWithSelection[_294.ElementPropertiesSolid]]":
    ...
    def spring_dashpot_element_properties(
        self: "Self",
    ) -> "List[_2568.ElementPropertiesWithSelection[_295.ElementPropertiesSpringDashpot]]":
