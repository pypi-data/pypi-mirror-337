...
class TestTokenCaching(unittest.TestCase):
    ...
    def setUp(self):
        ...
        os.environ['CODELOGIC_USERNAME'] = 'testuser'
        os.environ['CODELOGIC_PASSWORD'] = 'testpass'
    ...
    def test_authenticate_caches_token(self, mock_datetime, mock_post):
        ...
        self.assertEqual(url_arg, 'http://testserver/codelogic/server/authenticate')
...
class TestMethodNodesCaching(unittest.TestCase):
...
class TestImpactCaching(unittest.TestCase):
