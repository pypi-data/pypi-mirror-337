...
class BearingCompoundParametricStudyTool(_4712.ConnectorCompoundParametricStudyTool):
    """BearingCompoundParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self: "Self") -> "_2135.LoadedBearingDutyCycle":
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7646.BearingLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4534.BearingParametricStudyTool]":
