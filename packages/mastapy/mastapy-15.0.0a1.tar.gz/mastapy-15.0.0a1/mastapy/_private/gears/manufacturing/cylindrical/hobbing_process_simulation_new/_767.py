...
class _Cast_HobbingProcessProfileCalculation:
    ...
    def hobbing_process_calculation(
        self: "CastSelf",
    ) -> "_762.HobbingProcessCalculation":
        return self.__parent__._cast(_762.HobbingProcessCalculation)
...
class HobbingProcessProfileCalculation(_762.HobbingProcessCalculation):
    """HobbingProcessProfileCalculation
