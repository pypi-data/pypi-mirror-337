...
class ReverseGeoCoder(CloudApiBase):
    ...
    async def get_do_lookup_async(self, response_type):
        """
    ...
    async def post_do_lookup_async(self, response_type):
        """
    ...
    async def get_do_lookup_postal_codes_async(self, response_type):
        """
    ...
    async def post_do_lookup_postal_codes_async(self, response_type):
        """
