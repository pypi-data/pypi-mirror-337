...
class MedicalWebPage(Struct, frozen=True):
    ...
    speakable: 'SpeakableSpecification' | str | None = None
    ...
    breadcrumb: str | 'BreadcrumbList' | None = None
    mainContentOfPage: 'WebPageElement' | None = None
    significantLinks: str | None = None
    significantLink: str | None = None
    aspect: str | None = None
    medicalAudience: 'MedicalAudienceType' | 'MedicalAudience' | None = None