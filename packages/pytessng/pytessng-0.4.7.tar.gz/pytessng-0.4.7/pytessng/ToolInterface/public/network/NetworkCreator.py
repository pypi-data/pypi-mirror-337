...
from pytessng.ToolInterface.public.DataClass import Attrs, Link, Connector, VehicleComposition, VehicleInput
from pytessng.ToolInterface.public.DataClass import SignalPhase, SignalGroup, SignalHead, DecisionPoint, ReducedSpeedArea, GuidArrow
