...
class CylindricalGearDesign(_1044.GearDesign):
    """CylindricalGearDesign
    ...
    def hand(self: "Self") -> "_416.Hand":
        ...
        return constructor.new_from_mastapy("mastapy._private.gears._416", "Hand")(
            value
        )

    @hand.setter
    @enforce_parameter_types
    def hand(self: "Self", value: "_416.Hand") -> None:
    ...
    @property
    def agma_accuracy_grade(self: "Self") -> "_1245.AGMA20151AccuracyGrades":
    ...
    def accuracy_grades_specified_accuracy(
        self: "Self",
    ) -> "_1250.CylindricalAccuracyGrades":
    ...
    @property
    def case_hardening_properties(self: "Self") -> "_1098.CaseHardeningProperties":
    ...
    def cylindrical_gear_cutting_options(
        self: "Self",
    ) -> "_1113.CylindricalGearCuttingOptions":
    ...
    def customer_102_data_sheet_change_log(
        self: "Self",
    ) -> "_1103.Customer102DataSheetChangeLog":
    ...
    def customer_102_data_sheet_notes(
        self: "Self",
    ) -> "_1106.Customer102DataSheetNotes":
    ...
    def customer_102_data_sheet_tolerance_settings(
        self: "Self",
    ) -> "_1107.Customer102DataSheetTolerances":
    ...
    @property
    def finish_stock_specification(self: "Self") -> "_1195.FinishStockSpecification":
    ...
    def finished_tooth_thickness_specification(
        self: "Self",
    ) -> "_1149.FinishToothThicknessDesignSpecification":
    ...
    def gear_accuracy_tolerances(
        self: "Self",
    ) -> "_1251.CylindricalGearAccuracyTolerances":
    ...
    @property
    def iso6336_geometry(self: "Self") -> "_1158.ISO6336GeometryBase":
    ...
    @property
    def iso_accuracy_grade(self: "Self") -> "_1256.ISO1328AccuracyGrades":
    ...
    @property
    def left_flank(self: "Self") -> "_1120.CylindricalGearFlankDesign":
    ...
    @property
    def material(self: "Self") -> "_681.GearMaterial":
    ...
    @property
    def right_flank(self: "Self") -> "_1120.CylindricalGearFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearFlankDesign
    ...
    def rough_tooth_thickness_specification(
        self: "Self",
    ) -> "_1191.ToothThicknessSpecification":
    ...
    @property
    def surface_roughness(self: "Self") -> "_1184.SurfaceRoughness":
    ...
    @property
    def system_of_gear_fits(self: "Self") -> "_1252.DIN3967SystemOfGearFits":
    ...
    @property
    def tiff_analysis_settings(self: "Self") -> "_1186.TiffAnalysisSettings":
    ...
    @property
    def flanks(self: "Self") -> "List[_1120.CylindricalGearFlankDesign]":
    ...
    @property
    def both_flanks(self: "Self") -> "_1120.CylindricalGearFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearFlankDesign
    ...
    def manufacturing_configurations(
        self: "Self",
    ) -> "List[_708.CylindricalGearManufacturingConfig]":
    ...
    def micro_geometries(
        self: "Self",
    ) -> "List[_1207.CylindricalGearMicroGeometryBase]":
