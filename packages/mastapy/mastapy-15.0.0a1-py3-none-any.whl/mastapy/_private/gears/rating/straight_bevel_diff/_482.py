...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.straight_bevel_diff import _483, _485
...
class StraightBevelDiffGearMeshRating(_623.ConicalGearMeshRating):
    """StraightBevelDiffGearMeshRating
    ...
    @property
    def meshed_gears(self: "Self") -> "List[_485.StraightBevelDiffMeshedGearRating]":
    ...
    @property
    def gears_in_mesh(self: "Self") -> "List[_485.StraightBevelDiffMeshedGearRating]":
        """List[mastapy.gears.rating.straight_bevel_diff.StraightBevelDiffMeshedGearRating]
