...
class EnumWithSelectedValue_RollerBearingProfileTypes(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RollerBearingProfileTypes]",
    ) -> "_2077.RollerBearingProfileTypes":
        ...
        Returns:
            _2077.RollerBearingProfileTypes
        """
        return _2077.RollerBearingProfileTypes
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2077.RollerBearingProfileTypes.type_()

    @property
    def selected_value(self: "Self") -> "_2077.RollerBearingProfileTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_2077.RollerBearingProfileTypes]":
