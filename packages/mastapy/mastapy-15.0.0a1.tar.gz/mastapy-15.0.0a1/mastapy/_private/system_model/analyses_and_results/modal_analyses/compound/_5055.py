...
class PulleyCompoundModalAnalysis(_5004.CouplingHalfCompoundModalAnalysis):
    """PulleyCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4908.PulleyModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4908.PulleyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.PulleyModalAnalysis]
