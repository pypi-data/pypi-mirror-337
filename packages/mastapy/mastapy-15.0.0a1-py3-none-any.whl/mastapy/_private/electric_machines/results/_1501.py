...
class _Cast_ElectricMachineResults:
    ...
    def on_load_electric_machine_results(
        self: "CastSelf",
    ) -> "_1519.OnLoadElectricMachineResults":
        from mastapy._private.electric_machines.results import _1519

        return self.__parent__._cast(_1519.OnLoadElectricMachineResults)

    @property
    def open_circuit_electric_machine_results(
        self: "CastSelf",
    ) -> "_1520.OpenCircuitElectricMachineResults":
        from mastapy._private.electric_machines.results import _1520

        return self.__parent__._cast(_1520.OpenCircuitElectricMachineResults)
...
class ElectricMachineResults(_0.APIBase):
    ...
    @property
    def results_timesteps(self: "Self") -> "List[_1510.ElectricMachineResultsTimeStep]":
    ...
    def results_for_conductor_turns(
        self: "Self",
    ) -> "List[_1502.ElectricMachineResultsForConductorTurn]":
    ...
    def results_for_line_to_line(
        self: "Self",
    ) -> "List[_1504.ElectricMachineResultsForLineToLine]":
    ...
    def results_for_phases(
        self: "Self",
    ) -> "List[_1506.ElectricMachineResultsForPhase]":
