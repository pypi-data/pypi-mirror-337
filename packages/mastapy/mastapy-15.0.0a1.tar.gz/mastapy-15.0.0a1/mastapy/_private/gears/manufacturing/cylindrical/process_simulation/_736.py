...
class _Cast_FormWheelGrindingProcessSimulation:
    ...
    @property
    def cutter_process_simulation(self: "CastSelf") -> "_735.CutterProcessSimulation":
        return self.__parent__._cast(_735.CutterProcessSimulation)
...
class FormWheelGrindingProcessSimulation(_735.CutterProcessSimulation):
    """FormWheelGrindingProcessSimulation
