...
T = TypeVar("T", bound="_781.ProcessSimulationInput")
...
class _Cast_ProcessSimulationNew:
    ...
    def hobbing_process_simulation_new(
        self: "CastSelf",
    ) -> "_769.HobbingProcessSimulationNew":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _769,
        )

        return self.__parent__._cast(_769.HobbingProcessSimulationNew)

    @property
    def worm_grinding_process_simulation_new(
        self: "CastSelf",
    ) -> "_796.WormGrindingProcessSimulationNew":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _796,
        )

        return self.__parent__._cast(_796.WormGrindingProcessSimulationNew)
...
class ProcessSimulationNew(_0.APIBase, Generic[T]):
    ...
    @property
    def gear_tooth_shape_calculation(self: "Self") -> "_777.ProcessGearShape":
    ...
    @property
    def lead_calculation(self: "Self") -> "_778.ProcessLeadCalculation":
    ...
    @property
    def pitch_calculation(self: "Self") -> "_779.ProcessPitchCalculation":
    ...
    @property
    def profile_calculation(self: "Self") -> "_780.ProcessProfileCalculation":
    ...
    def total_modification_calculation(
        self: "Self",
    ) -> "_784.ProcessTotalModificationCalculation":
