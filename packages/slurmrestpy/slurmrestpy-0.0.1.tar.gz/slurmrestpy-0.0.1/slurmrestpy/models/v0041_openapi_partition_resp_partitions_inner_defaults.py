        ...
        _obj = cls.model_validate(
            {
                ...
                "partition_memory_per_cpu": V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu.from_dict(
                    obj["partition_memory_per_cpu"]
                )
                if obj.get("partition_memory_per_cpu") is not None
                else None,
                "partition_memory_per_node": V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode.from_dict(
                    obj["partition_memory_per_node"]
                )
                if obj.get("partition_memory_per_node") is not None
                else None,
                "time": V0041OpenapiPartitionRespPartitionsInnerDefaultsTime.from_dict(
                    obj["time"]
                )
