...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1409, _1441, _1442
...
class _Cast_RotorInternalLayerSpecification:
    ...
    def u_shaped_layer_specification(
        self: "CastSelf",
    ) -> "_1441.UShapedLayerSpecification":
        from mastapy._private.electric_machines import _1441

        return self.__parent__._cast(_1441.UShapedLayerSpecification)

    @property
    def v_shaped_magnet_layer_specification(
        self: "CastSelf",
    ) -> "_1442.VShapedMagnetLayerSpecification":
        from mastapy._private.electric_machines import _1442

        return self.__parent__._cast(_1442.VShapedMagnetLayerSpecification)
...
class RotorInternalLayerSpecification(_0.APIBase):
    ...
    @property
    def magnets(self: "Self") -> "_1409.MagnetForLayer":
