...
from mastapy._private.nodal_analysis.dev_tools_analyses import _271
...
class _Cast_FEModelHarmonicAnalysisDrawStyle:
    ...
    @property
    def fe_model_tab_draw_style(self: "CastSelf") -> "_271.FEModelTabDrawStyle":
        return self.__parent__._cast(_271.FEModelTabDrawStyle)
...
class FEModelHarmonicAnalysisDrawStyle(_271.FEModelTabDrawStyle):
    """FEModelHarmonicAnalysisDrawStyle
