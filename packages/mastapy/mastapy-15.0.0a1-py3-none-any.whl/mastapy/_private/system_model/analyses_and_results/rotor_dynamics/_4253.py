...
TLinearMeasurement = TypeVar("TLinearMeasurement", bound="_1780.MeasurementBase")
TAngularMeasurement = TypeVar("TAngularMeasurement", bound="_1780.MeasurementBase")
...
class _Cast_ShaftComplexShape:
    ...
    @property
    def shaft_forced_complex_shape(self: "CastSelf") -> "_4254.ShaftForcedComplexShape":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4254,
        )

        return self.__parent__._cast(_4254.ShaftForcedComplexShape)

    @property
    def shaft_modal_complex_shape(self: "CastSelf") -> "_4255.ShaftModalComplexShape":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4255,
        )

        return self.__parent__._cast(_4255.ShaftModalComplexShape)

    @property
    def shaft_modal_complex_shape_at_speeds(
        self: "CastSelf",
    ) -> "_4256.ShaftModalComplexShapeAtSpeeds":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4256,
        )

        return self.__parent__._cast(_4256.ShaftModalComplexShapeAtSpeeds)

    @property
    def shaft_modal_complex_shape_at_stiffness(
        self: "CastSelf",
    ) -> "_4257.ShaftModalComplexShapeAtStiffness":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4257,
        )

        return self.__parent__._cast(_4257.ShaftModalComplexShapeAtStiffness)
