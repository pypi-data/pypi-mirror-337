...
def run_nabqr_pipeline(
    ...
    if X is None or actuals is None:
        ...
        time_end_simulation = time.time()
        print(f"Simulation time: {time_end_simulation - time_start_simulation} seconds")
    ...
    scores = calculate_scores(
        ...
        visualize = visualize,
        return_full_scores = output_full_scores
    )
