...
class ListWithSelectedItem_Unit(_1785.Unit, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_Unit]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1785.Unit.TYPE

    @property
    def selected_value(self: "Self") -> "_1785.Unit":
    ...
    @property
    def available_values(self: "Self") -> "List[_1785.Unit]":
