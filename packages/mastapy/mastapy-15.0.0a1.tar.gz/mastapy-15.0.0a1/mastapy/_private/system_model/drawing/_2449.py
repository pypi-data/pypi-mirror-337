...
from mastapy._private.system_model.drawing import _2446
...
class _Cast_SteadyStateSynchronousResponseViewable:
    ...
    @property
    def rotor_dynamics_viewable(self: "CastSelf") -> "_2446.RotorDynamicsViewable":
        return self.__parent__._cast(_2446.RotorDynamicsViewable)
...
class SteadyStateSynchronousResponseViewable(_2446.RotorDynamicsViewable):
    """SteadyStateSynchronousResponseViewable
