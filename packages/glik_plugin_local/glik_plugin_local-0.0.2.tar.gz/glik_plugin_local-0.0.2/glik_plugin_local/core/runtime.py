...
from glik_plugin_local.config.config import InstallMethod
from glik_plugin_local.core.entities.invocation import InvokeType
from glik_plugin_local.core.entities.plugin.io import (
    PluginInStream,
    PluginInStreamBase,
    PluginInStreamEvent,
)
from glik_plugin_local.core.server.__base.request_reader import RequestReader
from glik_plugin_local.core.server.__base.response_writer import ResponseWriter
from glik_plugin_local.core.server.tcp.request_reader import TCPReaderWriter
...
class ModelInvocations:
    def __init__(self, session: "Session") -> None:
        from glik_plugin_local.invocations.model.llm import LLMInvocation, SummaryInvocation
        from glik_plugin_local.invocations.model.moderation import ModerationInvocation
        from glik_plugin_local.invocations.model.rerank import RerankInvocation
        from glik_plugin_local.invocations.model.speech2text import Speech2TextInvocation
        from glik_plugin_local.invocations.model.text_embedding import TextEmbeddingInvocation
        from glik_plugin_local.invocations.model.tts import TTSInvocation
...
class AppInvocations:
    def __init__(self, session: "Session"):
        from glik_plugin_local.invocations.app.chat import ChatAppInvocation
        from glik_plugin_local.invocations.app.completion import CompletionAppInvocation
        from glik_plugin_local.invocations.app.workflow import WorkflowAppInvocation
...
class WorkflowNodeInvocations:
    def __init__(self, session: "Session"):
        from glik_plugin_local.invocations.workflow_node.parameter_extractor import (
            ParameterExtractorNodeInvocation,
        )
        from glik_plugin_local.invocations.workflow_node.question_classifier import (
...
class Session:
    ...
    def _register_invocations(self) -> None:
        ...
        from glik_plugin_local.invocations.storage import StorageInvocation
        from glik_plugin_local.invocations.tool import ToolInvocation
