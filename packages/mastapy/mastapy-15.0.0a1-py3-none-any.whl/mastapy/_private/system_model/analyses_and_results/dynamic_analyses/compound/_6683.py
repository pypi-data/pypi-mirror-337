...
class _Cast_AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis:
    ...
    def cycloidal_disc_planetary_bearing_connection_compound_dynamic_analysis(
        self: "CastSelf",
    ) -> "_6726.CycloidalDiscPlanetaryBearingConnectionCompoundDynamicAnalysis":
        from mastapy._private.system_model.analyses_and_results.dynamic_analyses.compound import (
            _6726,
        )
    ...
    def shaft_to_mountable_component_connection_compound_dynamic_analysis(
        self: "CastSelf",
    ) -> "_6779.ShaftToMountableComponentConnectionCompoundDynamicAnalysis":
        from mastapy._private.system_model.analyses_and_results.dynamic_analyses.compound import (
            _6779,
        )
...
class AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis(
    ...
    def connection_analysis_cases(
        self: "Self",
    ) -> "List[_6550.AbstractShaftToMountableComponentConnectionDynamicAnalysis]":
