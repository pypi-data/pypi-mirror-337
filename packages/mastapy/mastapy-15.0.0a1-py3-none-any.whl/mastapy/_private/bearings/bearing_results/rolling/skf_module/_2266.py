...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling.skf_module import _2267
...
class AdjustedSpeed(_2286.SKFCalculationResult):
    """AdjustedSpeed
    ...
    @property
    def adjustment_factors(self: "Self") -> "_2267.AdjustmentFactors":
