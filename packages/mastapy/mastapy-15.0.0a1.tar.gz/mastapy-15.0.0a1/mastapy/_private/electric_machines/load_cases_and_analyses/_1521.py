...
from mastapy._private.nodal_analysis.elmer import _243
...
class BasicDynamicForceLoadCase(_1534.ElectricMachineLoadCaseBase):
    """BasicDynamicForceLoadCase
    ...
    def analysis_period(
        self: "Self", value: "_243.ElectricMachineAnalysisPeriod"
    ) -> None:
    ...
    def number_of_steps_per_operating_point_specification_method(
        self: "Self",
    ) -> "_1543.NumberOfStepsPerOperatingPointSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines.load_cases_and_analyses._1543",
    ...
    @enforce_parameter_types
    def number_of_steps_per_operating_point_specification_method(
        self: "Self", value: "_1543.NumberOfStepsPerOperatingPointSpecificationMethod"
    ) -> None:
    ...
    @property
    def operating_points(self: "Self") -> "List[_1524.DynamicForcesOperatingPoint]":
    ...
    def remove_operating_point(
        self: "Self", operating_point: "_1524.DynamicForcesOperatingPoint"
    ) -> None:
        """Method does not return.
