...
class _Cast_ParetoOptimisationVariableBase:
    ...
    @property
    def pareto_optimisation_input(self: "CastSelf") -> "_1721.ParetoOptimisationInput":
        from mastapy._private.math_utility.optimisation import _1721

        return self.__parent__._cast(_1721.ParetoOptimisationInput)

    @property
    def pareto_optimisation_output(
        self: "CastSelf",
    ) -> "_1722.ParetoOptimisationOutput":
        from mastapy._private.math_utility.optimisation import _1722

        return self.__parent__._cast(_1722.ParetoOptimisationOutput)

    @property
    def pareto_optimisation_variable(
        self: "CastSelf",
    ) -> "_1727.ParetoOptimisationVariable":
        from mastapy._private.math_utility.optimisation import _1727

        return self.__parent__._cast(_1727.ParetoOptimisationVariable)

    @property
    def parametric_study_doe_result_variable(
        self: "CastSelf",
    ) -> "_4616.ParametricStudyDOEResultVariable":
        from mastapy._private.system_model.analyses_and_results.parametric_study_tools import (
            _4616,
        )

        return self.__parent__._cast(_4616.ParametricStudyDOEResultVariable)
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    @property
    def specification_type(self: "Self") -> "_1732.TargetingPropertyTo":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility.optimisation._1732", "TargetingPropertyTo"
        )(value)

    @specification_type.setter
    @enforce_parameter_types
    def specification_type(self: "Self", value: "_1732.TargetingPropertyTo") -> None:
    ...
    @property
    def specify_input_range_as(self: "Self") -> "_1731.SpecifyOptimisationInputAs":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility.optimisation._1731",
    ...
    def specify_input_range_as(
        self: "Self", value: "_1731.SpecifyOptimisationInputAs"
    ) -> None:
        value = conversion.mp_to_pn_enum(
