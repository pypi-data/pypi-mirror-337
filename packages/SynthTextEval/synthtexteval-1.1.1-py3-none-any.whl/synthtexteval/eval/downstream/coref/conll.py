...
BEGIN_DOCUMENT_REGEX_DHS = re.compile(r"#begin document \((.*)\);")  # First line at each document
BEGIN_DOCUMENT_REGEX_I2B2 = re.compile(r"#begin document (.*)")  # First line at each document
