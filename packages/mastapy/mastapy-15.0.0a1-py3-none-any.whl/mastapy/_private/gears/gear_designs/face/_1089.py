...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.face import _1088, _1090, _1093
...
class FaceGearMeshMicroGeometry(_1338.GearMeshImplementationDetail):
    """FaceGearMeshMicroGeometry
    ...
    @property
    def face_gear_set_micro_geometry(self: "Self") -> "_1093.FaceGearSetMicroGeometry":
    ...
    @property
    def face_mesh(self: "Self") -> "_1088.FaceGearMeshDesign":
    ...
    @property
    def face_gear_micro_geometries(self: "Self") -> "List[_1090.FaceGearMicroGeometry]":
