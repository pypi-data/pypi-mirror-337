...
class ListWithSelectedItem_RotorSkewSlice(
    _1424.RotorSkewSlice, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_RotorSkewSlice]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1424.RotorSkewSlice.TYPE

    @property
    def selected_value(self: "Self") -> "_1424.RotorSkewSlice":
    ...
    @property
    def available_values(self: "Self") -> "List[_1424.RotorSkewSlice]":
