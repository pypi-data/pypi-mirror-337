...
from mastapy._private.bearings.bearing_designs.rolling.xml_import import _2367
...
class _Cast_XMLVariableAssignment:
    ...
    def abstract_xml_variable_assignment(
        self: "CastSelf",
    ) -> "_2367.AbstractXmlVariableAssignment":
        return self.__parent__._cast(_2367.AbstractXmlVariableAssignment)
...
class XMLVariableAssignment(_2367.AbstractXmlVariableAssignment, Generic[T]):
    """XMLVariableAssignment
