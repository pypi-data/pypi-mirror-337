...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.measured_vectors import _1736
...
class CVTPulleySystemDeflection(_3001.PulleySystemDeflection):
    """CVTPulleySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4300.CVTPulleyPowerFlow":
    ...
    @property
    def fixed_sheave_contact_results(self: "Self") -> "List[_1736.NodeResults]":
    ...
    @property
    def moving_sheave_contact_results(self: "Self") -> "List[_1736.NodeResults]":
        """List[mastapy.math_utility.measured_vectors.NodeResults]
