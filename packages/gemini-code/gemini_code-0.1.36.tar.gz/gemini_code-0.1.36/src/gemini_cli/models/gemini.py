...
class GeminiModel:
    ...
    def _cleanup_internal_tags(self, text: str) -> str:
        ...
        # Get available tool descriptions dynamically
        tools_description = []
        if AVAILABLE_TOOLS:
        ...
        # --- Revised System Prompt - More Forceful Sequence ---
...
*   **Action:** The plan MUST list the *exact* function calls you will make, including arguments. This includes calls for creating files/dirs, editing code, running tests/linters, and final verification.
*   If Step 2 revealed necessary preparatory calls (like viewing a file), ensure they are completed *before* listing action calls (like editing).
*   This section is for your internal reasoning ONLY.
**</plan>**
