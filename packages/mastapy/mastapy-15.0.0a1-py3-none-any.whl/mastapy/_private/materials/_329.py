...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials import _328
...
class BHCurveSpecification(_0.APIBase):
    ...
    @property
    def bh_curve(self: "Self") -> "_1709.Vector2DListAccessor":
    ...
    def bh_curve(self: "Self", value: "_1709.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "BHCurve", value.wrapped)

    @property
    def bh_curve_plot(self: "Self") -> "_2053.TwoDChartDefinition":
    ...
    def bh_curve_extrapolation_method(
        self: "Self",
    ) -> "_328.BHCurveExtrapolationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._328", "BHCurveExtrapolationMethod"
        )(value)

    @bh_curve_extrapolation_method.setter
    @enforce_parameter_types
    def bh_curve_extrapolation_method(
        self: "Self", value: "_328.BHCurveExtrapolationMethod"
    ) -> None:
