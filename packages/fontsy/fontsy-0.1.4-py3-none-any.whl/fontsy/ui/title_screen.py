...
class TitleScreen:
    ...
    def show(self):
        ...
        title_art = self.font_manager.render_text("Fontsy - The ASCII Art Font Explorer", title_font)
        ...
        font_info = f"[dim]v0.1.4 - Title Font: [bold cyan]{title_font}[/bold cyan] | Subtitle Font: [bold magenta]{subtitle_font}[/bold magenta][/dim]"
