...
from mastapy._private.nodal_analysis.fe_export_utility import _239
...
class Overridable_BoundaryConditionType(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _239.BoundaryConditionType
        """
        return _239.BoundaryConditionType
    ...
    def implicit_type(cls: "Type[Overridable_BoundaryConditionType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _239.BoundaryConditionType.type_()

    @property
    def value(self: "Self") -> "_239.BoundaryConditionType":
    ...
    @property
    def override_value(self: "Self") -> "_239.BoundaryConditionType":
        """mastapy.nodal_analysis.fe_export_utility.BoundaryConditionType
    ...
    @property
    def calculated_value(self: "Self") -> "_239.BoundaryConditionType":
        """mastapy.nodal_analysis.fe_export_utility.BoundaryConditionType
