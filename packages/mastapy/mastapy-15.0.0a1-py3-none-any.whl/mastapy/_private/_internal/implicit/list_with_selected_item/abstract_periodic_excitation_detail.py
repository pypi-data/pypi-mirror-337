...
class ListWithSelectedItem_AbstractPeriodicExcitationDetail(
    _5933.AbstractPeriodicExcitationDetail, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5933.AbstractPeriodicExcitationDetail.TYPE

    @property
    def selected_value(self: "Self") -> "_5933.AbstractPeriodicExcitationDetail":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5933.AbstractPeriodicExcitationDetail]":
