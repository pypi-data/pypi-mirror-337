...
class PulleyCompoundHarmonicAnalysis(_6182.CouplingHalfCompoundHarmonicAnalysis):
    """PulleyCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6056.PulleyHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6056.PulleyHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.PulleyHarmonicAnalysis]
