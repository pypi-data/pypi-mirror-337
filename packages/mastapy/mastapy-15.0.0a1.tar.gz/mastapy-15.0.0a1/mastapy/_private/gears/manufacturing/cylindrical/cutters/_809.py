...
class CylindricalGearRealCutterDesign(_802.CylindricalGearAbstractCutterDesign):
    """CylindricalGearRealCutterDesign
    ...
    @property
    def customised_cutting_edge_profile(self: "Self") -> "_800.CustomisableEdgeProfile":
    ...
    @property
    def nominal_cutter_shape(self: "Self") -> "_819.CutterShapeDefinition":
