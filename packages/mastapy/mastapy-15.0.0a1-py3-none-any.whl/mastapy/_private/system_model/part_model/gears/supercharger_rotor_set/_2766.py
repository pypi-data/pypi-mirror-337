...
class SuperchargerRotorSet(_2011.NamedDatabaseItem):
    """SuperchargerRotorSet
    ...
    @property
    def supercharger_map_chart(self: "Self") -> "_2051.ThreeDChartDefinition":
    ...
    @property
    def y_variable_for_imported_data(self: "Self") -> "_2768.YVariableForImportedData":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.gears.supercharger_rotor_set._2768",
    ...
    def y_variable_for_imported_data(
        self: "Self", value: "_2768.YVariableForImportedData"
    ) -> None:
    ...
    @property
    def boost_pressure(self: "Self") -> "_2758.BoostPressureInputOptions":
    ...
    @property
    def file(self: "Self") -> "_2761.RotorSetDataInputFileOptions":
    ...
    @property
    def input_power(self: "Self") -> "_2759.InputPowerInputOptions":
    ...
    @property
    def pressure_ratio(self: "Self") -> "_2760.PressureRatioInputOptions":
    ...
    @property
    def rotor_speed(self: "Self") -> "_2763.RotorSpeedInputOptions":
    ...
    @property
    def measured_points(self: "Self") -> "List[_2762.RotorSetMeasuredPoint]":
