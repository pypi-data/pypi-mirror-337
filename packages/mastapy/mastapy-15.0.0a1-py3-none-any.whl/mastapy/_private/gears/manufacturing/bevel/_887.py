...
from mastapy._private.gears.gear_designs.conical import _1270, _1271
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _872, _881
...
class ConicalSetManufacturingConfig(_889.ConicalSetMicroGeometryConfigBase):
    """ConicalSetManufacturingConfig
    ...
    def gear_manufacturing_configurations(
        self: "Self",
    ) -> "List[_872.ConicalGearManufacturingConfig]":
    ...
    @property
    def meshes(self: "Self") -> "List[_881.ConicalMeshManufacturingConfig]":
