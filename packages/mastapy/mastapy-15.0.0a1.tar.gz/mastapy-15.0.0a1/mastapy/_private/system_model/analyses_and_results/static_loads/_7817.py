...
class ZerolBevelGearSetLoadCase(_7656.BevelGearSetLoadCase):
    """ZerolBevelGearSetLoadCase
    ...
    @property
    def bevel_gears_load_case(self: "Self") -> "List[_7815.ZerolBevelGearLoadCase]":
    ...
    def zerol_bevel_gears_load_case(
        self: "Self",
    ) -> "List[_7815.ZerolBevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ZerolBevelGearLoadCase]
    ...
    def bevel_meshes_load_case(
        self: "Self",
    ) -> "List[_7816.ZerolBevelGearMeshLoadCase]":
