...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.cad_export import _2019
...
class CustomReportCadDrawing(_1949.CustomReportNameableItem):
    """CustomReportCadDrawing
    ...
    @property
    def stock_drawing(self: "Self") -> "_2019.StockDrawings":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.cad_export._2019", "StockDrawings"
        )(value)

    @stock_drawing.setter
    @enforce_parameter_types
    def stock_drawing(self: "Self", value: "_2019.StockDrawings") -> None:
