...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2062
...
class TaperRollerBearing(_2351.NonBarrelRollerBearing):
    """TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self: "Self") -> "_2062.BearingMeasurementType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2062", "BearingMeasurementType"
        )(value)

    @bearing_measurement_type.setter
    @enforce_parameter_types
    def bearing_measurement_type(
        self: "Self", value: "_2062.BearingMeasurementType"
    ) -> None:
