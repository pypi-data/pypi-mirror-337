...
from mastapy._private.gears.rating.cylindrical.optimisation import _588
...
class _Cast_SafetyFactorOptimisationStepResultNumber:
    ...
    def safety_factor_optimisation_step_result(
        self: "CastSelf",
    ) -> "_588.SafetyFactorOptimisationStepResult":
        return self.__parent__._cast(_588.SafetyFactorOptimisationStepResult)
...
class SafetyFactorOptimisationStepResultNumber(_588.SafetyFactorOptimisationStepResult):
    """SafetyFactorOptimisationStepResultNumber
