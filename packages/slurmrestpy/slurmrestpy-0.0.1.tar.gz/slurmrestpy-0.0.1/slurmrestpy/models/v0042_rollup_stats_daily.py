...
class V0042RollupStatsDaily(BaseModel):
    ...
    count: Optional[StrictInt] = Field(
        default=None, description="Number of daily rollups since last_run"
    )
    last_run: Optional[StrictInt] = Field(
        default=None, description="Last time daily rollup ran (UNIX timestamp)"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "duration": V0042RollupStatsDailyDuration.from_dict(obj["duration"])
