...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _874, _877, _881, _902, _906
    from mastapy._private.gears.manufacturing.bevel.cutters import _909, _910
...
class ConicalPinionManufacturingConfig(_872.ConicalGearManufacturingConfig):
    """ConicalPinionManufacturingConfig
    ...
    @property
    def mesh_config(self: "Self") -> "_881.ConicalMeshManufacturingConfig":
    ...
    def pinion_concave_ob_configuration(
        self: "Self",
    ) -> "_877.ConicalMeshFlankManufacturingConfig":
    ...
    @property
    def pinion_finish_cutter(self: "Self") -> "_909.PinionFinishCutter":
    ...
    @property
    def pinion_rough_cutter(self: "Self") -> "_910.PinionRoughCutter":
    ...
    @property
    def pinion_rough_machine_setting(self: "Self") -> "_906.PinionRoughMachineSetting":
