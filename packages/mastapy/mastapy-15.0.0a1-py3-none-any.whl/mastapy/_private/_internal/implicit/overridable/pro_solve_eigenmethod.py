...
from mastapy._private.fe_tools.vfx_tools.vfx_enums import _1353
...
class Overridable_ProSolveEigenmethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1353.ProSolveEigenmethod
        """
        return _1353.ProSolveEigenmethod
    ...
    def implicit_type(cls: "Type[Overridable_ProSolveEigenmethod]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1353.ProSolveEigenmethod.type_()

    @property
    def value(self: "Self") -> "_1353.ProSolveEigenmethod":
    ...
    @property
    def override_value(self: "Self") -> "_1353.ProSolveEigenmethod":
        """mastapy.fe_tools.vfx_tools.vfx_enums.ProSolveEigenmethod
    ...
    @property
    def calculated_value(self: "Self") -> "_1353.ProSolveEigenmethod":
        """mastapy.fe_tools.vfx_tools.vfx_enums.ProSolveEigenmethod
