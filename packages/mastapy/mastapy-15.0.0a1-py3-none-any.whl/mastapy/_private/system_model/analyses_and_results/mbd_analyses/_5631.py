...
class AssemblyMultibodyDynamicsAnalysis(
    ...
    @property
    def bearings(self: "Self") -> "List[_5633.BearingMultibodyDynamicsAnalysis]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_5636.BeltDriveMultibodyDynamicsAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_5639.BevelDifferentialGearSetMultibodyDynamicsAnalysis]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_5645.BoltedJointMultibodyDynamicsAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_5646.BoltMultibodyDynamicsAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_5668.CVTMultibodyDynamicsAnalysis]":
    ...
    @property
    def clutches(self: "Self") -> "List[_5649.ClutchMultibodyDynamicsAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_5655.ConceptCouplingMultibodyDynamicsAnalysis]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_5658.ConceptGearSetMultibodyDynamicsAnalysis]":
    ...
    def connections(
        self: "Self",
    ) -> "List[_5697.InterMountableComponentConnectionMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_5670.CycloidalAssemblyMultibodyDynamicsAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5676.CylindricalGearSetMultibodyDynamicsAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_5683.FEPartMultibodyDynamicsAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_5684.FlexiblePinAssemblyMultibodyDynamicsAnalysis]":
    ...
    @property
    def gear_sets(self: "Self") -> "List[_5688.GearSetMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5703.KlingelnbergCycloPalloidHypoidGearSetMultibodyDynamicsAnalysis]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_5707.MassDiscMultibodyDynamicsAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_5711.MeasurementComponentMultibodyDynamicsAnalysis]":
    ...
    @property
    def microphones(self: "Self") -> "List[_5713.MicrophoneMultibodyDynamicsAnalysis]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_5716.OilSealMultibodyDynamicsAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_5720.PartToPartShearCouplingMultibodyDynamicsAnalysis]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_5723.PlanetCarrierMultibodyDynamicsAnalysis]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_5724.PointLoadMultibodyDynamicsAnalysis]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_5725.PowerLoadMultibodyDynamicsAnalysis]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_5727.RingPinsMultibodyDynamicsAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_5729.RollingRingAssemblyMultibodyDynamicsAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_5735.ShaftHubConnectionMultibodyDynamicsAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_5736.ShaftMultibodyDynamicsAnalysis]":
    ...
    def shafts_and_housings(
        self: "Self",
    ) -> "List[_5625.AbstractShaftOrHousingMultibodyDynamicsAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5742.SpiralBevelGearSetMultibodyDynamicsAnalysis]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_5746.SpringDamperMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_5749.StraightBevelDiffGearSetMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5752.StraightBevelGearSetMultibodyDynamicsAnalysis]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_5756.SynchroniserMultibodyDynamicsAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_5761.TorqueConverterMultibodyDynamicsAnalysis]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_5765.UnbalancedMassMultibodyDynamicsAnalysis]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_5770.WormGearSetMultibodyDynamicsAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5773.ZerolBevelGearSetMultibodyDynamicsAnalysis]":
