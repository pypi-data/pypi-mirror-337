...
class OnedimensionalFunctionLookupTable(
    _1740.LookupTableBase["OnedimensionalFunctionLookupTable"]
):
    """OnedimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: "Self") -> "_1709.Vector2DListAccessor":
    ...
    def lookup_table(self: "Self", value: "_1709.Vector2DListAccessor") -> None:
