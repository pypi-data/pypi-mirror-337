...
class WormGrindingLeadCalculation(_790.WormGrindingProcessCalculation):
    """WormGrindingLeadCalculation
    ...
    @property
    def left_flank(self: "Self") -> "_756.CalculateLeadDeviationAccuracy":
    ...
    @property
    def right_flank(self: "Self") -> "_756.CalculateLeadDeviationAccuracy":
        """mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new.CalculateLeadDeviationAccuracy
