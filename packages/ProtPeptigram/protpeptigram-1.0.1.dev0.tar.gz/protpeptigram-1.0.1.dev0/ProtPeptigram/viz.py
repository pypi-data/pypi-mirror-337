...
class ImmunoViz:
    ...
    def plot_peptigram(
        ...
        axs[0].set_xlim(xlim)
        axs[0].set_ylabel('Density', color=text_color, fontweight='normal', fontsize=14)
        ...
        axs[0].set_yticklabels([0, f"{max_density/2:.0f}", f"{max_density:.0f}"], fontsize=8, color="lightgray")
        ...
        for i, group in enumerate(groups):
            ...
            ax.set_ylabel(group, fontweight='normal', color=text_color, fontsize=14)
            ax.set_yticks([])
