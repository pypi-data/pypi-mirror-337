...
from mastapy._private.math_utility.measured_data_scaling import _1745
...
class _Cast_DataScalingReferenceValues:
    ...
    def data_scaling_reference_values_base(
        self: "CastSelf",
    ) -> "_1745.DataScalingReferenceValuesBase":
        return self.__parent__._cast(_1745.DataScalingReferenceValuesBase)
...
class DataScalingReferenceValues(
    _1745.DataScalingReferenceValuesBase, Generic[TMeasurement]
):
    """DataScalingReferenceValues
