...
class EnumWithSelectedValue_LoadedBallElementPropertyType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LoadedBallElementPropertyType]",
    ) -> "_2149.LoadedBallElementPropertyType":
        ...
        Returns:
            _2149.LoadedBallElementPropertyType
        """
        return _2149.LoadedBallElementPropertyType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2149.LoadedBallElementPropertyType.type_()

    @property
    def selected_value(self: "Self") -> "_2149.LoadedBallElementPropertyType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2149.LoadedBallElementPropertyType]":
