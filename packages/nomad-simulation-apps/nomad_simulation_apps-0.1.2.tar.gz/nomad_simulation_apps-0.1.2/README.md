...
```sh
git clone https://github.com/FAIRmat-NFDI/nomad-simulation-apps.git
...
```sh
pip install dist/nomad-simulation-apps-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Martin Kuban | [kuban@physik.hu-berlin.de](mailto:kuban@physik.hu-berlin.de)
