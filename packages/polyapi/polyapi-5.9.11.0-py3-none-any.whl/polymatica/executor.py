...
class Executor:
    ...
    def execute_request(self, params: Union[Dict, str], method: str = "POST") -> responce:
        ...
        if method == "GET":
            ...
            if command_state in ((210, 7), (210, 14), (502, 5), (503, 6), (503, 24), (505, 4)) or \
            ...
            elif command_state in ((207, 13), (208, 12), (208, 14), (208, 58), (502, 11), (503, 4), (504, 2)) or \
                ...
                # TODO разобраться с этим при рефакторинге
                if command_state in ((208, 14), (208, 58)):
                ...
                if command_state in ((208, 14), (208, 58)) or \
