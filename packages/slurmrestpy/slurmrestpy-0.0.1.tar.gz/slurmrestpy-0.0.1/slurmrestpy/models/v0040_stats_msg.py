        ...
        _obj = cls.model_validate(
            {
                ...
                "req_time": V0040Uint64NoVal.from_dict(obj["req_time"])
                if obj.get("req_time") is not None
                else None,
                "req_time_start": V0040Uint64NoVal.from_dict(obj["req_time_start"])
                ...
                "schedule_exit": V0040ScheduleExitFields.from_dict(obj["schedule_exit"])
                ...
                "job_states_ts": V0040Uint64NoVal.from_dict(obj["job_states_ts"])
                ...
                "bf_when_last_cycle": V0040Uint64NoVal.from_dict(
                    obj["bf_when_last_cycle"]
                )
                if obj.get("bf_when_last_cycle") is not None
                else None,
                "bf_active": obj.get("bf_active"),
                "bf_exit": V0040BfExitFields.from_dict(obj["bf_exit"])
