...
from mastapy._private.electric_machines import _1385, _1438
...
class _Cast_TwoDimensionalFEModelForElectromagneticAnalysis:
    ...
    def two_dimensional_fe_model_for_analysis(
        self: "CastSelf",
    ) -> "_1438.TwoDimensionalFEModelForAnalysis":
        return self.__parent__._cast(_1438.TwoDimensionalFEModelForAnalysis)
...
class TwoDimensionalFEModelForElectromagneticAnalysis(
    _1438.TwoDimensionalFEModelForAnalysis[_1385.ElectricMachineMeshingOptions]
):
    """TwoDimensionalFEModelForElectromagneticAnalysis
