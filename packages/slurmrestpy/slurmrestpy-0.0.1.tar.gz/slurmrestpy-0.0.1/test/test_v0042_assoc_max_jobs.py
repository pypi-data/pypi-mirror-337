        ...
        if include_optional:
            return V0042AssocMaxJobs(
                per = slurmrestpy.models.v0_0_42_assoc_max_jobs_per.v0_0_42_assoc_max_jobs_per(
                    ...
                    submitted = ,
                    wall_clock = , ),
                active = slurmrestpy.models.v0/0/42_uint32_no_val_struct.v0.0.42_uint32_no_val_struct(
                    set = True,
                    infinite = True,
                    number = 56, ),
                accruing = slurmrestpy.models.v0/0/42_uint32_no_val_struct.v0.0.42_uint32_no_val_struct(
                    ...
                    infinite = True,
                    number = 56, ),
                total = slurmrestpy.models.v0/0/42_uint32_no_val_struct.v0.0.42_uint32_no_val_struct(
                    set = True,
                    infinite = True,
                    number = 56, )
            )
