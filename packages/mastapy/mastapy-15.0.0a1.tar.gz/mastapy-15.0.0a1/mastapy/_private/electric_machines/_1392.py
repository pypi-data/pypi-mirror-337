...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1362, _1391
...
class _Cast_FieldWindingSpecificationBase:
    ...
    def cad_field_winding_specification(
        self: "CastSelf",
    ) -> "_1362.CADFieldWindingSpecification":
        from mastapy._private.electric_machines import _1362

        return self.__parent__._cast(_1362.CADFieldWindingSpecification)

    @property
    def field_winding_specification(
        self: "CastSelf",
    ) -> "_1391.FieldWindingSpecification":
        from mastapy._private.electric_machines import _1391

        return self.__parent__._cast(_1391.FieldWindingSpecification)
