...
class V0042RollupStatsHourly(BaseModel):
    ...
    count: Optional[StrictInt] = Field(
        default=None, description="Number of hourly rollups since last_run"
    )
    last_run: Optional[StrictInt] = Field(
        default=None, description="Last time hourly rollup ran (UNIX timestamp)"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "duration": V0042RollupStatsHourlyDuration.from_dict(obj["duration"])
