...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1395, _1405
...
class VShapedMagnetLayerSpecification(_1423.RotorInternalLayerSpecification):
    """VShapedMagnetLayerSpecification
    ...
    @property
    def magnet_clearance(self: "Self") -> "_1405.MagnetClearance":
    ...
    @enforce_parameter_types
    def magnet_clearance(self: "Self", value: "_1405.MagnetClearance") -> None:
    ...
    @property
    def upper_flux_barrier_web_specification(self: "Self") -> "_1395.FluxBarrierOrWeb":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1395", "FluxBarrierOrWeb"
        )(value)

    @upper_flux_barrier_web_specification.setter
    @enforce_parameter_types
    def upper_flux_barrier_web_specification(
        self: "Self", value: "_1395.FluxBarrierOrWeb"
    ) -> None:
        value = conversion.mp_to_pn_enum(
