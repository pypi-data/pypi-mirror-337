...
from mastapy._private.bearings.bearing_results.rolling import _2153
...
class EnumWithSelectedValue_BallBearingAnalysisMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BallBearingAnalysisMethod]",
    ) -> "_2153.BallBearingAnalysisMethod":
        ...
        Returns:
            _2153.BallBearingAnalysisMethod
        """
        return _2153.BallBearingAnalysisMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2153.BallBearingAnalysisMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2153.BallBearingAnalysisMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_2153.BallBearingAnalysisMethod]":
