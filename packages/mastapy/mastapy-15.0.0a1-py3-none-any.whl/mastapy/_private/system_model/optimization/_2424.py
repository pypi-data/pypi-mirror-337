...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization import _2418, _2421, _2423
...
class _Cast_OptimizationStep:
    ...
    def conical_gear_optimization_step(
        self: "CastSelf",
    ) -> "_2418.ConicalGearOptimizationStep":
        from mastapy._private.system_model.optimization import _2418

        return self.__parent__._cast(_2418.ConicalGearOptimizationStep)

    @property
    def cylindrical_gear_optimization_step(
        self: "CastSelf",
    ) -> "_2421.CylindricalGearOptimizationStep":
        from mastapy._private.system_model.optimization import _2421

        return self.__parent__._cast(_2421.CylindricalGearOptimizationStep)
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self: "Self") -> "_2423.MicroGeometryOptimisationTarget":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.optimization._2423",
    ...
    def optimisation_target(
        self: "Self", value: "_2423.MicroGeometryOptimisationTarget"
    ) -> None:
