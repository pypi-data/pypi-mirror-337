...
T = TypeVar("T", bound="_1047.GearSetDesign")
...
class _Cast_GearSetCreationOptions:
    ...
    def cylindrical_gear_pair_creation_options(
        ...
        from mastapy._private.gears.gear_designs.creation_options import _1258

        return self.__parent__._cast(_1258.CylindricalGearPairCreationOptions)

    @property
    def hypoid_gear_set_creation_options(
        self: "CastSelf",
    ) -> "_1261.HypoidGearSetCreationOptions":
        from mastapy._private.gears.gear_designs.creation_options import _1261

        return self.__parent__._cast(_1261.HypoidGearSetCreationOptions)

    @property
    def spiral_bevel_gear_set_creation_options(
        self: "CastSelf",
    ) -> "_1262.SpiralBevelGearSetCreationOptions":
        from mastapy._private.gears.gear_designs.creation_options import _1262

        return self.__parent__._cast(_1262.SpiralBevelGearSetCreationOptions)
