...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _6018
...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.dev_tools_analyses import _257
...
class _Cast_HarmonicAnalysisFEExportOptions:
    ...
    def harmonic_analysis_export_options(
        self: "CastSelf",
    ) -> "_6018.HarmonicAnalysisExportOptions":
        return self.__parent__._cast(_6018.HarmonicAnalysisExportOptions)
...
class HarmonicAnalysisFEExportOptions(
    _6018.HarmonicAnalysisExportOptions[
        _2860.IHaveFEPartHarmonicAnalysisResults, _2649.FEPart
    ]
):
    """HarmonicAnalysisFEExportOptions
    ...
    @enforce_parameter_types
    def distance_unit(self: "Self", value: "_1785.Unit") -> None:
    ...
    @enforce_parameter_types
    def element_face_group_to_export(
        self: "Self", value: "_304.CMSElementFaceGroup"
    ) -> None:
    ...
    @enforce_parameter_types
    def fe_export_format(self: "Self", value: "_240.FEExportFormat") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @force_unit.setter
    @enforce_parameter_types
    def force_unit(self: "Self", value: "_1785.Unit") -> None:
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @property
    def eigenvalue_options(self: "Self") -> "_257.EigenvalueOptions":
