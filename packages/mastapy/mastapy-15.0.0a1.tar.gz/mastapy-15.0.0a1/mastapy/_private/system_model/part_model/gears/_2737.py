...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2726, _2734, _2736
...
class HypoidGearSet(_2716.AGMAGleasonConicalGearSet):
    """HypoidGearSet
    ...
    @property
    def conical_gear_set_design(self: "Self") -> "_1084.HypoidGearSetDesign":
    ...
    @property
    def hypoid_gear_set_design(self: "Self") -> "_1084.HypoidGearSetDesign":
        """mastapy.gears.gear_designs.hypoid.HypoidGearSetDesign
    ...
    @property
    def hypoid_gears(self: "Self") -> "List[_2736.HypoidGear]":
    ...
    @property
    def hypoid_meshes(self: "Self") -> "List[_2506.HypoidGearMesh]":
