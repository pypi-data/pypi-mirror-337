...
def read_from_url_python(url: str, as_bytes: bool = False) -> str|bytes:
    """
...
async def read_from_url_pyodide(url: str, as_bytes: bool = False) -> str|bytes:
    """
...
async def read_from_url(url: str, as_bytes: bool = False) -> str|bytes:
    """
