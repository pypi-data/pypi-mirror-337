...
class ZerolBevelGearSetPowerFlow(_4276.BevelGearSetPowerFlow):
    """ZerolBevelGearSetPowerFlow
    ...
    @property
    def rating(self: "Self") -> "_455.ZerolBevelGearSetRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_455.ZerolBevelGearSetRating":
        """mastapy.gears.rating.zerol_bevel.ZerolBevelGearSetRating
    ...
    @property
    def bevel_gears_power_flow(self: "Self") -> "List[_4393.ZerolBevelGearPowerFlow]":
    ...
    def bevel_meshes_power_flow(
        self: "Self",
    ) -> "List[_4392.ZerolBevelGearMeshPowerFlow]":
