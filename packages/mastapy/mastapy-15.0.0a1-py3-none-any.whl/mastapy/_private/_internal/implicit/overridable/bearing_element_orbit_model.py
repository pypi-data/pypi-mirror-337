...
class Overridable_BearingElementOrbitModel(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
    ...
    ) -> "_5632.BearingElementOrbitModel":
        ...
        Returns:
            _5632.BearingElementOrbitModel
        """
        return _5632.BearingElementOrbitModel
    ...
    def implicit_type(cls: "Type[Overridable_BearingElementOrbitModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5632.BearingElementOrbitModel.type_()

    @property
    def value(self: "Self") -> "_5632.BearingElementOrbitModel":
    ...
    @property
    def override_value(self: "Self") -> "_5632.BearingElementOrbitModel":
        """mastapy.system_model.analyses_and_results.mbd_analyses.BearingElementOrbitModel
    ...
    @property
    def calculated_value(self: "Self") -> "_5632.BearingElementOrbitModel":
        """mastapy.system_model.analyses_and_results.mbd_analyses.BearingElementOrbitModel
