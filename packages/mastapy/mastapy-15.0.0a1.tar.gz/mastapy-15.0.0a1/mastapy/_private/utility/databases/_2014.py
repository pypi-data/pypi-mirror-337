...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2066, _2079
    ...
    from mastapy._private.utility.databases import _2008, _2010

    Self = TypeVar("Self", bound="SQLDatabase")
    CastSelf = TypeVar("CastSelf", bound="SQLDatabase._Cast_SQLDatabase")

TKey = TypeVar("TKey", bound="_2008.DatabaseKey")
...
class _Cast_SQLDatabase:
    ...
    @property
    def rolling_bearing_database(self: "CastSelf") -> "_2079.RollingBearingDatabase":
        from mastapy._private.bearings import _2079

        return self.__parent__._cast(_2079.RollingBearingDatabase)
...
class SQLDatabase(_2006.Database[TKey, TValue]):
    """SQLDatabase
    ...
    def reload(
        ...
        reload_default_items: "bool" = False,
    ) -> None:
        """Method does not return.

        Args:
            task_progress (mastapy.TaskProgress)
            reload_default_items (bool, optional)
        """
        reload_default_items = bool(reload_default_items)
        pythonnet_method_call(
            self.wrapped,
            "Reload",
            task_progress.wrapped if task_progress else None,
            reload_default_items if reload_default_items else False,
        )
