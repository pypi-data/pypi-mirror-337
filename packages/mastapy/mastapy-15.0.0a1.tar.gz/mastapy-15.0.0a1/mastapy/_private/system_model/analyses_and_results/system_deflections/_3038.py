...
class TorqueConverterSystemDeflection(_2937.CouplingSystemDeflection):
    """TorqueConverterSystemDeflection
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7803.TorqueConverterLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4384.TorqueConverterPowerFlow":
