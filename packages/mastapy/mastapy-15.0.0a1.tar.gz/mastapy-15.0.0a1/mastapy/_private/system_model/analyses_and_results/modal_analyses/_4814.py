...
class AssemblyModalAnalysis(_4807.AbstractAssemblyModalAnalysis):
    """AssemblyModalAnalysis
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2898.AssemblySystemDeflection":
    ...
    @property
    def bearings(self: "Self") -> "List[_4815.BearingModalAnalysis]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_4817.BeltDriveModalAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_4820.BevelDifferentialGearSetModalAnalysis]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_4826.BoltedJointModalAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_4827.BoltModalAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_4849.CVTModalAnalysis]":
    ...
    def calculate_full_fe_results_by_mode(
        self: "Self",
    ) -> "List[_4953.CalculateFullFEResultsForMode]":
    ...
    @property
    def clutches(self: "Self") -> "List[_4830.ClutchModalAnalysis]":
    ...
    @property
    def concept_couplings(self: "Self") -> "List[_4835.ConceptCouplingModalAnalysis]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_4838.ConceptGearSetModalAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_4851.CycloidalAssemblyModalAnalysis]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_4853.CycloidalDiscModalAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_4857.CylindricalGearSetModalAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_4867.FEPartModalAnalysis]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_4866.FaceGearSetModalAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_4868.FlexiblePinAssemblyModalAnalysis]":
    ...
    def full_fe_meshes_for_calculating_modes(
        self: "Self",
    ) -> "List[_4867.FEPartModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FEPartModalAnalysis]
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_4876.HypoidGearSetModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_4883.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_4887.MassDiscModalAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_4888.MeasurementComponentModalAnalysis]":
    ...
    @property
    def microphones(self: "Self") -> "List[_4890.MicrophoneModalAnalysis]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_4897.OilSealModalAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_4902.PartToPartShearCouplingModalAnalysis]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_4905.PlanetCarrierModalAnalysis]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_4906.PointLoadModalAnalysis]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_4907.PowerLoadModalAnalysis]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_4909.RingPinsModalAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_4911.RollingRingAssemblyModalAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_4915.ShaftHubConnectionModalAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_4916.ShaftModalAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4922.SpiralBevelGearSetModalAnalysis]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_4925.SpringDamperModalAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_4928.StraightBevelDiffGearSetModalAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4931.StraightBevelGearSetModalAnalysis]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_4935.SynchroniserModalAnalysis]":
    ...
    @property
    def torque_converters(self: "Self") -> "List[_4939.TorqueConverterModalAnalysis]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_4942.UnbalancedMassModalAnalysis]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_4949.WormGearSetModalAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4952.ZerolBevelGearSetModalAnalysis]":
