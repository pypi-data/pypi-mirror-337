...
from mastapy._private.gears.manufacturing.bevel import _868
...
class _Cast_EaseOffBasedTCA:
    ...
    @property
    def abstract_tca(self: "CastSelf") -> "_868.AbstractTCA":
        return self.__parent__._cast(_868.AbstractTCA)
...
class EaseOffBasedTCA(_868.AbstractTCA):
    """EaseOffBasedTCA
