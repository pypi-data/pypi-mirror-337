...
class WormGrindingCutterCalculation(_790.WormGrindingProcessCalculation):
    """WormGrindingCutterCalculation
    ...
    @property
    def grinder_tooth_shape_chart(self: "Self") -> "_2053.TwoDChartDefinition":
    ...
    @property
    def input_gear_point_of_interest(self: "Self") -> "_749.PointOfInterest":
