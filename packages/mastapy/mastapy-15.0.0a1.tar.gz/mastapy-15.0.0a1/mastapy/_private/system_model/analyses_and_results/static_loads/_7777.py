...
class RootAssemblyLoadCase(_7645.AssemblyLoadCase):
    """RootAssemblyLoadCase
    ...
    @property
    def drive_cycle_pid_control_settings(self: "Self") -> "_1751.PIDControlSettings":
    ...
    def supercharger_rotor_sets(
        self: "Self",
    ) -> "List[_7692.CylindricalGearSetLoadCase]":
