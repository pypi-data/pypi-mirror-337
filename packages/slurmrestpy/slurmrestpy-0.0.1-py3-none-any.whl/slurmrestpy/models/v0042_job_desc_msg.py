...
class V0042JobDescMsg(BaseModel):
    ...
    oom_kill_step: Optional[StrictInt] = Field(
        default=None, description="Kill whole step in case of OOM in one of the tasks"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "begin_time": V0042Uint64NoValStruct.from_dict(obj["begin_time"])
                ...
                "crontab": V0042CronEntry.from_dict(obj["crontab"])
                ...
                "rlimits": V0042JobDescMsgRlimits.from_dict(obj["rlimits"])
                ...
                "distribution_plane_size": V0042Uint16NoValStruct.from_dict(
                ...
                "kill_warning_delay": V0042Uint16NoValStruct.from_dict(
                ...
                "required_switches": V0042Uint32NoValStruct.from_dict(
                    obj["required_switches"]
                )
                if obj.get("required_switches") is not None
                else None,
                "segment_size": V0042Uint16NoValStruct.from_dict(obj["segment_size"])
