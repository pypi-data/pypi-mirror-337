...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials import _352, _361
...
class ISOCylindricalGearMaterial(_677.CylindricalGearMaterial):
    """ISOCylindricalGearMaterial
    ...
    @property
    def quality_grade(self: "Self") -> "_361.QualityGrade":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._361", "QualityGrade"
        )(value)

    @quality_grade.setter
    @enforce_parameter_types
    def quality_grade(self: "Self", value: "_361.QualityGrade") -> None:
