...
class ListWithSelectedItem_ConicalSetManufacturingConfig(
    _887.ConicalSetManufacturingConfig, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _887.ConicalSetManufacturingConfig.TYPE

    @property
    def selected_value(self: "Self") -> "_887.ConicalSetManufacturingConfig":
    ...
    @property
    def available_values(self: "Self") -> "List[_887.ConicalSetManufacturingConfig]":
