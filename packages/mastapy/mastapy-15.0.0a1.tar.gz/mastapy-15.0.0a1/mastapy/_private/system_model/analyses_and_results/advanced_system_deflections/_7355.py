...
class AdvancedSystemDeflectionOptions(_0.APIBase):
    ...
    @enforce_parameter_types
    def specified_gear_set(self: "Self", value: "_2734.GearSet") -> None:
        wrapper_type = (
    ...
    @property
    def use_advanced_ltca(self: "Self") -> "_946.UseAdvancedLTCAOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.ltca._946", "UseAdvancedLTCAOptions"
        )(value)

    @use_advanced_ltca.setter
    @enforce_parameter_types
    def use_advanced_ltca(self: "Self", value: "_946.UseAdvancedLTCAOptions") -> None:
    ...
    @property
    def time_options(self: "Self") -> "_2890.TimeOptions":
