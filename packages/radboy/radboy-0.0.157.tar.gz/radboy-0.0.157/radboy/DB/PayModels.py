...
class SafewayNightCrew_version_6003336(BASE,Template):
	...
	first_shift_premium_0_rate=Column(Float,default=0.65)
	first_shift_premium_0_accumulated=Column(Float,default=0)

	first_shift_premium_1_rate=Column(Float,default=0.65)
	first_shift_premium_1_accumulated=Column(Float,default=0)
