...
class FinishStockSpecification(
    _1173.RelativeValuesSpecification["FinishStockSpecification"]
):
    """FinishStockSpecification
    ...
    def finish_stock_rough_thickness_specification_method(
        self: "Self", value: "_1196.FinishStockType"
    ) -> None:
    ...
    def normal(
        self: "Self",
    ) -> "_1189.TolerancedValueSpecification[FinishStockSpecification]":
