...
def deploy(
    ...
    m_errors, pipes = reader.read_modeler_base_files(
        models=files_found,
        tenants=tenants,
        sql_templates_engine=sql_templates_engine,
    ...
    engine_templates.merge_custom_templates(sql_templates_engine)
