...
class StraightBevelSunGearSystemDeflection(_3023.StraightBevelDiffGearSystemDeflection):
    """StraightBevelSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4377.StraightBevelSunGearPowerFlow":
