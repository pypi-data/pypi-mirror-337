...
class KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection(
    ...
    @property
    def rating(self: "Self") -> "_494.KlingelnbergCycloPalloidHypoidGearSetRating":
    ...
    def klingelnberg_cyclo_palloid_conical_gears_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7424.KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_conical_meshes_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7425.KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection]":
