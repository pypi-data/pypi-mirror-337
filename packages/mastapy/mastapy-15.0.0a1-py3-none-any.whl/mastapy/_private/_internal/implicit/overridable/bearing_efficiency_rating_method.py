...
class Overridable_BearingEfficiencyRatingMethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _376.BearingEfficiencyRatingMethod
        """
        return _376.BearingEfficiencyRatingMethod
    ...
    def implicit_type(cls: "Type[Overridable_BearingEfficiencyRatingMethod]") -> "Any":
        ...
        Returns:
            Any
        """
        return _376.BearingEfficiencyRatingMethod.type_()

    @property
    def value(self: "Self") -> "_376.BearingEfficiencyRatingMethod":
    ...
    @property
    def override_value(self: "Self") -> "_376.BearingEfficiencyRatingMethod":
        """mastapy.materials.efficiency.BearingEfficiencyRatingMethod
    ...
    @property
    def calculated_value(self: "Self") -> "_376.BearingEfficiencyRatingMethod":
        """mastapy.materials.efficiency.BearingEfficiencyRatingMethod
