...
class RobotsApi:
    ...
    def robots_robots_txt_get(
        ...
        _param = self._robots_robots_txt_get_serialize(
    ...
    @validate_call
    def robots_robots_txt_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def robots_robots_txt_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _robots_robots_txt_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
