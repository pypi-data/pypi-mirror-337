...
class BearingDynamicResultsUIWrapper(_0.APIBase):
    ...
    @property
    def bearing_system_deflection(self: "Self") -> "_2904.BearingSystemDeflection":
    ...
    def bearing_results(
        self: "Self",
    ) -> "List[_2902.BearingDynamicResultsPropertyWrapper]":
    ...
    def element_results(
        self: "Self",
    ) -> "List[_2900.BearingDynamicElementPropertyWrapper]":
    ...
    def post_analysis_results(
        self: "Self",
    ) -> "List[_2901.BearingDynamicPostAnalysisResultWrapper]":
