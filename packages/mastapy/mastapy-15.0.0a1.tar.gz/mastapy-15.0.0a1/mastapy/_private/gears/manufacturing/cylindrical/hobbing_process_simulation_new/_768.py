...
class _Cast_HobbingProcessSimulationInput:
    ...
    @property
    def process_simulation_input(self: "CastSelf") -> "_781.ProcessSimulationInput":
        return self.__parent__._cast(_781.ProcessSimulationInput)
...
class HobbingProcessSimulationInput(_781.ProcessSimulationInput):
    """HobbingProcessSimulationInput
    ...
    def process_method(self: "Self", value: "_754.ActiveProcessMethod") -> None:
    ...
    @property
    def hob_manufacture_error(self: "Self") -> "_772.HobManufactureError":
    ...
    @property
    def hob_resharpening_error(self: "Self") -> "_773.HobResharpeningError":
