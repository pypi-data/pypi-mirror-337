...
class SpiralBevelGearSetCriticalSpeedAnalysis(_6835.BevelGearSetCriticalSpeedAnalysis):
    """SpiralBevelGearSetCriticalSpeedAnalysis
    ...
    def bevel_gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6921.SpiralBevelGearCriticalSpeedAnalysis]":
    ...
    def bevel_meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6922.SpiralBevelGearMeshCriticalSpeedAnalysis]":
