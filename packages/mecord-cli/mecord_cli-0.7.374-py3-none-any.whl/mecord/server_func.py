...
class MecordAIGCTaskThread(Thread):
    ...
    idx = 0
    call_back = None
    def __init__(self, idx, country, func, func_id, params, callback, user_id, parentTaskId=0):
        super().__init__()
        self.idx = idx
...
class MecordAIGCTask:
    ...
    def __init__(self, func: str, multi_params, fromUUID=None, func_id=None, _country='test', user_id=1, parentTaskId=0):
        ...
        for param in multi_params:
            ...
            self.thread_data[str(idx)] = {
                "thread" :  MecordAIGCTaskThread(idx, country, func, func_id, param, _callback, user_id, parentTaskId),
                "result" : None
            }
            idx+=1
