...
def get_endpoint_input_class(endpoint_input_class: EndpointInputClass) -> InputEndpoint:
...
def get_endpoint_class(endpoint_class: EndpointClass, endpoint_sub_class) -> Endpoint:
