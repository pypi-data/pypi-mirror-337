...
class _Cast_MaximumStaticContactStress:
    ...
    def maximum_static_contact_stress_results_abstract(
        self: "CastSelf",
    ) -> "_2251.MaximumStaticContactStressResultsAbstract":
        return self.__parent__._cast(_2251.MaximumStaticContactStressResultsAbstract)
...
class MaximumStaticContactStress(_2251.MaximumStaticContactStressResultsAbstract):
    """MaximumStaticContactStress
