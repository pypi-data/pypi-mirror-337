...
class _Cast_CylindricalGearMeshLoadedContactLine:
    ...
    def gear_mesh_loaded_contact_line(
        self: "CastSelf",
    ) -> "_939.GearMeshLoadedContactLine":
        return self.__parent__._cast(_939.GearMeshLoadedContactLine)
...
class CylindricalGearMeshLoadedContactLine(_939.GearMeshLoadedContactLine):
    """CylindricalGearMeshLoadedContactLine
    ...
    def loaded_contact_strip_end_points(
        self: "Self",
    ) -> "List[_955.CylindricalGearMeshLoadedContactPoint]":
