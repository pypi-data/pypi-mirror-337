...
class _Cast_CylindricalGearFilletNodeStressResultsRow:
    ...
    def gear_fillet_node_stress_results_row(
        self: "CastSelf",
    ) -> "_935.GearFilletNodeStressResultsRow":
        return self.__parent__._cast(_935.GearFilletNodeStressResultsRow)
...
class CylindricalGearFilletNodeStressResultsRow(_935.GearFilletNodeStressResultsRow):
    """CylindricalGearFilletNodeStressResultsRow
