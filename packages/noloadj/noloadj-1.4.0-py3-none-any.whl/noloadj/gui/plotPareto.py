...
def plot(iter: List[Iterations], xyLabels, legend: List[AnyStr], title,
    ...
    :param spec: class Spec for specifications of the optimization problem.
...
class AnnotedPareto:
    ...
    - iter: List[Iterations] of optimization results towards iterations.
    - annot: ax.annotation of graph.
    - sc: list of graph points.
    '''
