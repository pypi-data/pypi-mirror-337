...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.stiffness_calculators import _1712
...
class SurfaceToSurfaceContactStiffnessEntity(_130.ArbitraryNodalComponent):
    """SurfaceToSurfaceContactStiffnessEntity
    ...
    @property
    def contact(self: "Self") -> "_1712.SurfaceToSurfaceContact":
