...
from mastapy._private.gears.rating.cylindrical.optimisation import _589, _590, _591
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.optimisation import _586, _587
...
class CylindricalGearSetRatingOptimisationHelper(_0.APIBase):
    ...
    def helix_angle_optimisation_results(
        self: "Self",
    ) -> "_586.OptimisationResultsPair[_589.SafetyFactorOptimisationStepResultAngle]":
        ...
        return constructor.new(type_.Namespace, type_.Name)[
            _589.SafetyFactorOptimisationStepResultAngle
        ](temp)

    @property
    def maximum_transverse_contact_ratio_optimisation_results(
        self: "Self",
    ) -> "_586.OptimisationResultsPair[_590.SafetyFactorOptimisationStepResultNumber]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[
            _590.SafetyFactorOptimisationStepResultNumber
        ](temp)

    @property
    def normal_module_optimisation_results(
        self: "Self",
    ) -> "_586.OptimisationResultsPair[_591.SafetyFactorOptimisationStepResultShortLength]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[
            _591.SafetyFactorOptimisationStepResultShortLength
        ](temp)
    ...
    def all_helix_angle_optimisation_results(
        self: "Self",
    ) -> "List[_587.SafetyFactorOptimisationResults[_589.SafetyFactorOptimisationStepResultAngle]]":
    ...
    def all_normal_module_optimisation_results(
        self: "Self",
    ) -> "List[_587.SafetyFactorOptimisationResults[_591.SafetyFactorOptimisationStepResultShortLength]]":
    ...
    def all_profile_shift_optimisation_results(
        self: "Self",
    ) -> "List[_587.SafetyFactorOptimisationResults[_590.SafetyFactorOptimisationStepResultNumber]]":
