...
class ListWithSelectedItem_ElectricMachineSetupBase(
    _1388.ElectricMachineSetupBase, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1388.ElectricMachineSetupBase.TYPE

    @property
    def selected_value(self: "Self") -> "_1388.ElectricMachineSetupBase":
    ...
    @property
    def available_values(self: "Self") -> "List[_1388.ElectricMachineSetupBase]":
