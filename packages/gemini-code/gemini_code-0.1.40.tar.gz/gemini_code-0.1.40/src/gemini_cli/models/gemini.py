...
Includes Test Runner tool. Prompt v5 (Few-Shot Example). Syntax Fix.
"""
...
class GeminiModel:
    ...
    def __init__(self, api_key, model_name="gemini-2.5-pro-exp-03-25"):
        ...
        self.system_instruction = self._create_system_prompt() # Using v5 prompt
    ...
    # --- Uses the V5 Prompt with Few-Shot Example ---
