...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import _828
...
T = TypeVar("T", bound="_861.ShavingDynamics")
...
class _Cast_ShavingDynamicsCalculation:
    ...
    def conventional_shaving_dynamics_calculation_for_designed_gears(
        self: "CastSelf",
    ) -> "_848.ConventionalShavingDynamicsCalculationForDesignedGears":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _848,
        )
    ...
    def conventional_shaving_dynamics_calculation_for_hobbed_gears(
        self: "CastSelf",
    ) -> "_849.ConventionalShavingDynamicsCalculationForHobbedGears":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _849,
        )
    ...
    def plunge_shaving_dynamics_calculation_for_designed_gears(
        self: "CastSelf",
    ) -> "_854.PlungeShavingDynamicsCalculationForDesignedGears":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _854,
        )
    ...
    def plunge_shaving_dynamics_calculation_for_hobbed_gears(
        self: "CastSelf",
    ) -> "_855.PlungeShavingDynamicsCalculationForHobbedGears":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _855,
        )
    ...
    def shaving_dynamics_calculation_for_designed_gears(
        self: "CastSelf",
    ) -> "_863.ShavingDynamicsCalculationForDesignedGears":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _863,
        )

        return self.__parent__._cast(_863.ShavingDynamicsCalculationForDesignedGears)

    @property
    def shaving_dynamics_calculation_for_hobbed_gears(
        self: "CastSelf",
    ) -> "_864.ShavingDynamicsCalculationForHobbedGears":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _864,
        )

        return self.__parent__._cast(_864.ShavingDynamicsCalculationForHobbedGears)
...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    @property
    def accuracy_level_iso6(self: "Self") -> "_858.RollAngleRangeRelativeToAccuracy":
    ...
    @property
    def accuracy_level_iso7(self: "Self") -> "_858.RollAngleRangeRelativeToAccuracy":
        """mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics.RollAngleRangeRelativeToAccuracy
    ...
    @property
    def designed_gear(self: "Self") -> "_828.CylindricalCutterSimulatableGear":
    ...
    @property
    def life_shaver(self: "Self") -> "_811.CylindricalGearShaver":
    ...
    @property
    def shaver(self: "Self") -> "_811.CylindricalGearShaver":
        """mastapy.gears.manufacturing.cylindrical.cutters.CylindricalGearShaver
    ...
    @property
    def redressing_settings(self: "Self") -> "List[_857.RedressingSettings[T]]":
