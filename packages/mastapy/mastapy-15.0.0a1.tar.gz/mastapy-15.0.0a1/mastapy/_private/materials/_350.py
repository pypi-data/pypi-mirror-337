...
from mastapy._private.materials import _344, _348
...
class LubricationDetail(_2011.NamedDatabaseItem):
    """LubricationDetail
    ...
    @property
    def agma925a03_lubricant_type(self: "Self") -> "_320.AGMALubricantType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._320", "AGMALubricantType"
        )(value)

    @agma925a03_lubricant_type.setter
    @enforce_parameter_types
    def agma925a03_lubricant_type(
        self: "Self", value: "_320.AGMALubricantType"
    ) -> None:
    ...
    @property
    def delivery(self: "Self") -> "_345.LubricantDelivery":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._345", "LubricantDelivery"
        )(value)
    ...
    @property
    def density_specification_method(self: "Self") -> "_333.DensitySpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._333", "DensitySpecificationMethod"
        )(value)

    @density_specification_method.setter
    @enforce_parameter_types
    def density_specification_method(
        self: "Self", value: "_333.DensitySpecificationMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def density_vs_temperature(self: "Self") -> "_1709.Vector2DListAccessor":
    ...
    @property
    def grease_contamination_level(self: "Self") -> "_340.GreaseContaminationOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._340", "GreaseContaminationOptions"
        )(value)

    @grease_contamination_level.setter
    @enforce_parameter_types
    def grease_contamination_level(
        self: "Self", value: "_340.GreaseContaminationOptions"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def iso_lubricant_type(self: "Self") -> "_343.ISOLubricantType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._343", "ISOLubricantType"
        )(value)

    @iso_lubricant_type.setter
    @enforce_parameter_types
    def iso_lubricant_type(self: "Self", value: "_343.ISOLubricantType") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def lubricant_definition(self: "Self", value: "_344.LubricantDefinition") -> None:
    ...
    @property
    def lubricant_grade_agma(self: "Self") -> "_346.LubricantViscosityClassAGMA":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._346", "LubricantViscosityClassAGMA"
        )(value)

    @lubricant_grade_agma.setter
    @enforce_parameter_types
    def lubricant_grade_agma(
        self: "Self", value: "_346.LubricantViscosityClassAGMA"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def lubricant_grade_iso(
        self: "Self", value: "_348.LubricantViscosityClassISO"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def lubricant_grade_sae(self: "Self") -> "_349.LubricantViscosityClassSAE":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._349", "LubricantViscosityClassSAE"
        )(value)

    @lubricant_grade_sae.setter
    @enforce_parameter_types
    def lubricant_grade_sae(
        self: "Self", value: "_349.LubricantViscosityClassSAE"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def lubricant_type_and_supply(self: "Self") -> "_325.BearingLubricationCondition":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._325", "BearingLubricationCondition"
        )(value)

    @lubricant_type_and_supply.setter
    @enforce_parameter_types
    def lubricant_type_and_supply(
        self: "Self", value: "_325.BearingLubricationCondition"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def lubricant_viscosity_classification(
        self: "Self",
    ) -> "_347.LubricantViscosityClassification":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._347", "LubricantViscosityClassification"
        )(value)

    @lubricant_viscosity_classification.setter
    @enforce_parameter_types
    def lubricant_viscosity_classification(
        self: "Self", value: "_347.LubricantViscosityClassification"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def oil_filtration_and_contamination(self: "Self") -> "_359.OilFiltrationOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._359", "OilFiltrationOptions"
        )(value)

    @oil_filtration_and_contamination.setter
    @enforce_parameter_types
    def oil_filtration_and_contamination(
        self: "Self", value: "_359.OilFiltrationOptions"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def pressure_viscosity_coefficient_method(
        self: "Self",
    ) -> "_360.PressureViscosityCoefficientMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._360", "PressureViscosityCoefficientMethod"
        )(value)

    @pressure_viscosity_coefficient_method.setter
    @enforce_parameter_types
    def pressure_viscosity_coefficient_method(
        self: "Self", value: "_360.PressureViscosityCoefficientMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
