...
from cryptographer.Blowfish.Blowfish_method import BlowfishEncryptionMethod, BlowfishDecryptionMethod
...
def encryption():
    BEM = BlowfishEncryptionMethod(encryption_text_need.get_content())
...
def decryption():
    try:
        BDM = BlowfishDecryptionMethod(decryption_text_need.get_content(), key_text_need.get_content())
...
window = tk.Tk()
EasyAutoWindow(window, window_title="BlowfishMethod", minimum_value_x=1312, minimum_value_y=876,
