...
INNER JOIN 
  ...
  ON  TABLES.TABLE_CATALOG = DTGH.DATABASE_NAME
  AND TABLES.TABLE_SCHEMA = DTGH.SCHEMA_NAME
  AND TABLES.TABLE_NAME = DTGH.NAME
  AND DTGH.VALID_TO IS NULL
WHERE
    TABLES.TABLE_TYPE = 'BASE TABLE'
    AND TABLES.IS_DYNAMIC = 'YES'
