...
def get_thread_url(thread_id: str, data_agent: FabricDataAgentManagement):
    ...
    thread_url = f"https://{host}/workloads/de-ds/aiskills/{data_agent_id}/externalThread?debug.aiSkillThreadIdOverride={thread_id}&debug.aiSkillViewPublishedOverride=0"
