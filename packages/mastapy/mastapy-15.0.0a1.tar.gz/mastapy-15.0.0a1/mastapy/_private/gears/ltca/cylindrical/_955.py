...
class _Cast_CylindricalGearMeshLoadedContactPoint:
    ...
    def gear_mesh_loaded_contact_point(
        self: "CastSelf",
    ) -> "_940.GearMeshLoadedContactPoint":
        return self.__parent__._cast(_940.GearMeshLoadedContactPoint)
...
class CylindricalGearMeshLoadedContactPoint(_940.GearMeshLoadedContactPoint):
    """CylindricalGearMeshLoadedContactPoint
