...
class V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxTresMinutes(BaseModel):
    ...
    per: Optional[V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxTresMinutesPer] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "per": V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxTresMinutesPer.from_dict(
                    obj["per"]
                )
