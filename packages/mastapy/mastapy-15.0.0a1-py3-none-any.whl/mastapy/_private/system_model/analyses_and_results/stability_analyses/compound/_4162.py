...
class CVTCompoundStabilityAnalysis(_4131.BeltDriveCompoundStabilityAnalysis):
    """CVTCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4028.CVTStabilityAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4028.CVTStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.CVTStabilityAnalysis]
