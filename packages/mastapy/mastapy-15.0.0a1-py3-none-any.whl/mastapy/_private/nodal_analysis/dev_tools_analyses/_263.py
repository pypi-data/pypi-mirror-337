...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.dev_tools_analyses import _268, _278
...
class FEModel(_0.APIBase):
    ...
    @property
    def model_splitting_method(self: "Self") -> "_278.ModelSplittingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.dev_tools_analyses._278",
    ...
    def model_splitting_method(
        self: "Self", value: "_278.ModelSplittingMethod"
    ) -> None:
    ...
    @property
    def beam_element_properties(self: "Self") -> "List[_289.ElementPropertiesBeam]":
    ...
    @property
    def contact_pairs(self: "Self") -> "List[_283.ContactPairReporting]":
    ...
    @property
    def coordinate_systems(self: "Self") -> "List[_284.CoordinateSystemReporting]":
    ...
    def interface_element_properties(
        self: "Self",
    ) -> "List[_290.ElementPropertiesInterface]":
    ...
    @property
    def mass_element_properties(self: "Self") -> "List[_291.ElementPropertiesMass]":
    ...
    @property
    def materials(self: "Self") -> "List[_297.MaterialPropertiesReporting]":
    ...
    @property
    def model_parts(self: "Self") -> "List[_268.FEModelPart]":
    ...
    @property
    def other_element_properties(self: "Self") -> "List[_288.ElementPropertiesBase]":
    ...
    @property
    def rigid_element_properties(self: "Self") -> "List[_292.ElementPropertiesRigid]":
    ...
    @property
    def shell_element_properties(self: "Self") -> "List[_293.ElementPropertiesShell]":
    ...
    @property
    def solid_element_properties(self: "Self") -> "List[_294.ElementPropertiesSolid]":
    ...
    def spring_dashpot_element_properties(
        self: "Self",
    ) -> "List[_295.ElementPropertiesSpringDashpot]":
    ...
    def get_all_element_details(self: "Self") -> "_287.ElementDetailsForFEModel":
    ...
    def get_all_node_details(self: "Self") -> "_298.NodeDetailsForFEModel":
