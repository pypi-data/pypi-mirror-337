...
class ListWithSelectedItem_GearMeshSystemDeflection(
    _2965.GearMeshSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2965.GearMeshSystemDeflection.TYPE

    @property
    def selected_value(self: "Self") -> "_2965.GearMeshSystemDeflection":
    ...
    @property
    def available_values(self: "Self") -> "List[_2965.GearMeshSystemDeflection]":
