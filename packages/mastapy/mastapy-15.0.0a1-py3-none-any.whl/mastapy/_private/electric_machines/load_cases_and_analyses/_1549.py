...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1516
...
class SpeedTorqueCurveAnalysis(_1527.ElectricMachineAnalysis):
    """SpeedTorqueCurveAnalysis
    ...
    @property
    def load_case(self: "Self") -> "_1550.SpeedTorqueCurveLoadCase":
    ...
    @property
    def results_points(self: "Self") -> "List[_1516.MaximumTorqueResultsPoints]":
