...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.property import _2024, _2025, _2026, _2027
...
class LoadedRollingBearingDutyCycle(_2143.LoadedNonLinearBearingDutyCycleResults):
    """LoadedRollingBearingDutyCycle
    ...
    def ansiabma_dynamic_equivalent_load_summary(
        self: "Self",
    ) -> "_2024.DutyCyclePropertySummaryForce[_2061.BearingLoadCaseResultsLightweight]":
    ...
    def maximum_element_normal_stress_inner_summary(
        ...
        "_2027.DutyCyclePropertySummaryStress[_2061.BearingLoadCaseResultsLightweight]"
    ):
    ...
    def maximum_static_contact_stress_duty_cycle(
        self: "Self",
    ) -> "_2250.MaximumStaticContactStressDutyCycle":
    ...
    def maximum_truncation_summary(
        self: "Self",
    ) -> "_2025.DutyCyclePropertySummaryPercentage[_2061.BearingLoadCaseResultsLightweight]":
    ...
    def misalignment_summary(
        self: "Self",
    ) -> "_2026.DutyCyclePropertySummarySmallAngle[_2061.BearingLoadCaseResultsLightweight]":
