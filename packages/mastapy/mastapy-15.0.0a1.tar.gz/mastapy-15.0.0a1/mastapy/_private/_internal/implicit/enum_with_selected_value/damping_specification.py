...
class EnumWithSelectedValue_DampingSpecification(
    ...
    def wrapped_type(
        ...
        Returns:
            _5985.DampingSpecification
        """
        return _5985.DampingSpecification
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DampingSpecification]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5985.DampingSpecification.type_()

    @property
    def selected_value(self: "Self") -> "_5985.DampingSpecification":
    ...
    @property
    def available_values(self: "Self") -> "List[_5985.DampingSpecification]":
