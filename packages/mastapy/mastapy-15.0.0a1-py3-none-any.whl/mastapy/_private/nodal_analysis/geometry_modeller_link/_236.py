...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1686
    from mastapy._private.nodal_analysis.geometry_modeller_link import _227
...
class MeshRequestResult(_0.APIBase):
    ...
    @property
    def cad_face_group(self: "Self") -> "_394.CADFaceGroup":
    ...
    @enforce_parameter_types
    def cad_face_group(self: "Self", value: "_394.CADFaceGroup") -> None:
    ...
    @property
    def faceted_body(self: "Self") -> "_1686.FacetedBody":
    ...
    @faceted_body.setter
    @enforce_parameter_types
    def faceted_body(self: "Self", value: "_1686.FacetedBody") -> None:
    ...
    @enforce_parameter_types
    def geometry_modeller_design_information(
        self: "Self", value: "_227.GeometryModellerDesignInformation"
    ) -> None:
        pythonnet_property_set(
    ...
    def set_geometry_modeller_dimensions(
        self: "Self", dimensions: "Dict[str, _228.GeometryModellerDimension]"
    ) -> None:
