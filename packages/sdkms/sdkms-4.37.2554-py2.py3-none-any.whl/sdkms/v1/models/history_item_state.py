...
class HistoryItemState(object):
    ...
    def __init__(self, activation_date=None, revocation_reason=None, compromise_date=None, deactivation_date=None, destruction_date=None, deletion_date=None, state=None, key_ops=None, public_only=None, rotation_policy=None, group_id=None):
        """
    ...
    def group_id(self):
        """
        Gets the group_id of this HistoryItemState.
        Group ID (UUID) of the security group that this security object belonged to. Expect this property to always exist.
    ...
    def group_id(self, group_id):
        """
        Sets the group_id of this HistoryItemState.
        Group ID (UUID) of the security group that this security object belonged to. Expect this property to always exist.
        """
