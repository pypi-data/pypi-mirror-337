...
from mastapy._private.bearings.roller_bearing_profiles import _2122
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.roller_bearing_profiles import _2113, _2115, _2126
...
class _Cast_RollerBearingUserSpecifiedProfile:
    ...
    @property
    def roller_bearing_profile(self: "CastSelf") -> "_2122.RollerBearingProfile":
        return self.__parent__._cast(_2122.RollerBearingProfile)
...
class RollerBearingUserSpecifiedProfile(_2122.RollerBearingProfile):
    """RollerBearingUserSpecifiedProfile
    ...
    @property
    def data_to_use(self: "Self") -> "_2113.ProfileDataToUse":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.roller_bearing_profiles._2113",
            "ProfileDataToUse",
        )(value)

    @data_to_use.setter
    @enforce_parameter_types
    def data_to_use(self: "Self", value: "_2113.ProfileDataToUse") -> None:
    ...
    @property
    def profile_to_fit(self: "Self") -> "_2115.ProfileToFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.roller_bearing_profiles._2115", "ProfileToFit"
        )(value)

    @profile_to_fit.setter
    @enforce_parameter_types
    def profile_to_fit(self: "Self", value: "_2115.ProfileToFit") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def points(self: "Self") -> "List[_2126.UserSpecifiedProfilePoint]":
