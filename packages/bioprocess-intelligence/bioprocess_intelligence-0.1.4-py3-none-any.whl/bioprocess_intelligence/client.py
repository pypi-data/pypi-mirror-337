...
class BioprocessIntelligenceClient:
    def __init__(self, api_url: str, username: str, password: str, output_format: str = 'text'):
    ...
    def _execute_query(self, query, variables: Dict = None) -> Dict:
        ...
        self.session.get(self.config.api_url)
        ...
        try:
            response = self.session.post(self.config.api_url, json=request_data, headers=headers)
