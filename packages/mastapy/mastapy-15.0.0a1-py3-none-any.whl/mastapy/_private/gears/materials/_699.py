...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.plastic_vdi2736 import _579
    from mastapy._private.materials import _368, _369, _372
...
class _Cast_PlasticSNCurve:
    ...
    def plastic_sn_curve_for_the_specified_operating_conditions(
        self: "CastSelf",
    ) -> "_579.PlasticSNCurveForTheSpecifiedOperatingConditions":
        from mastapy._private.gears.rating.cylindrical.plastic_vdi2736 import _579
...
class PlasticSNCurve(_0.APIBase):
    ...
    @property
    def lubricant(self: "Self") -> "_372.VDI2736LubricantType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._372", "VDI2736LubricantType"
        )(value)

    @lubricant.setter
    @enforce_parameter_types
    def lubricant(self: "Self", value: "_372.VDI2736LubricantType") -> None:
    ...
    @property
    def material(self: "Self") -> "_698.PlasticCylindricalGearMaterial":
    ...
    def bending_stress_cycle_data_for_damage_tables(
        self: "Self",
    ) -> "List[_368.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]":
    ...
    def contact_stress_cycle_data_for_damage_tables(
        self: "Self",
    ) -> "List[_369.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]":
