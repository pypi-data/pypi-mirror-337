...
VERSION = "0.0.4.65"  # la version doit être supérieure à la précédente sinon la publication sera refusée
...
INSTALL_REQUIRES = ["torch==2.2.2", "sentence-transformers==3.3.1", "gpt4all[cuda]==2.8.2", "sacremoses==0.1.1",
                    ...
                    "unidecode==1.3.8", "python-docx==1.1.2", "psutil", "thefuzz==0.22.1","beautifulsoup4"]
