...
from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _739
...
class _Cast_PlungeShaverOutputs:
    ...
    @property
    def real_plunge_shaver_outputs(self: "CastSelf") -> "_750.RealPlungeShaverOutputs":
        from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _750

        return self.__parent__._cast(_750.RealPlungeShaverOutputs)

    @property
    def virtual_plunge_shaver_outputs(
        self: "CastSelf",
    ) -> "_753.VirtualPlungeShaverOutputs":
        from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _753

        return self.__parent__._cast(_753.VirtualPlungeShaverOutputs)
...
class PlungeShaverOutputs(_0.APIBase):
    ...
    def chart(self: "Self", value: "_739.ChartType") -> None:
    ...
    @enforce_parameter_types
    def selected_flank(self: "Self", value: "_723.Flank") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def calculation_details(self: "Self") -> "_745.PlungeShaverGeneration":
