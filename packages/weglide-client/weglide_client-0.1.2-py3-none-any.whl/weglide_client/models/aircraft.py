...
class Aircraft(BaseModel):
    ...
    valid_igc_index: Union[StrictFloat, StrictInt]
    valid_dmst_index: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["id", "name", "wingarea", "double_seater", "kind", "sc_class", "encoded_coeffs", "min_speed_m_s", "reference_mass", "empty_mass", "mtow", "family_name", "manufacturer", "valid_igc_index", "valid_dmst_index"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Aircraft from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Aircraft from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "valid_igc_index": obj.get("valid_igc_index"),
            "valid_dmst_index": obj.get("valid_dmst_index")
        })
        return _obj
