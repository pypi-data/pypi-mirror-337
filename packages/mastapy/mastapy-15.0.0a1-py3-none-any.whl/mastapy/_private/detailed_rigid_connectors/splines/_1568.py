...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.splines import _1578, _1587, _1590
...
class _Cast_DIN5480SplineHalfDesign:
    ...
    def detailed_rigid_connector_half_design(
        self: "CastSelf",
    ) -> "_1564.DetailedRigidConnectorHalfDesign":
        from mastapy._private.detailed_rigid_connectors import _1564

        return self.__parent__._cast(_1564.DetailedRigidConnectorHalfDesign)
...
class DIN5480SplineHalfDesign(_1595.StandardSplineHalfDesign):
    """DIN5480SplineHalfDesign
    ...
    @property
    def finishing_method(self: "Self") -> "_1587.FinishingMethods":
    ...
    def finishing_method(self: "Self", value: "_1587.FinishingMethods") -> None:
    ...
    @property
    def manufacturing_type(self: "Self") -> "_1578.ManufacturingTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.detailed_rigid_connectors.splines._1578",
            "ManufacturingTypes",
        )(value)

    @manufacturing_type.setter
    @enforce_parameter_types
    def manufacturing_type(self: "Self", value: "_1578.ManufacturingTypes") -> None:
        value = conversion.mp_to_pn_enum(
