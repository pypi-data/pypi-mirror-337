...
class _Cast_FinishCutterSimulation:
    ...
    @property
    def gear_cutter_simulation(self: "CastSelf") -> "_835.GearCutterSimulation":
        return self.__parent__._cast(_835.GearCutterSimulation)
...
class FinishCutterSimulation(_835.GearCutterSimulation):
    """FinishCutterSimulation
