...
class SimExportTrajAndSig(BaseUI):
    ...
    def _set_widget_layout(self):
        ...
        proj_info: str = self.file_proj_string if bool(self.file_proj_string) else "（未在TESS文件中读取到投影信息）"
        font = QFont()
        ...
        self.line_edit_config_proj_file = QLineEdit(proj_info)
        # 第六行：单选框
    ...
    def _apply_button_action(self):
        ...
        # 添加观察者
        MyOperation().apply_sim_import_or_export_operation("simu_export_trajectory", traj_params)
        MyOperation().apply_sim_import_or_export_operation("simu_export_signal_light", sig_params)
