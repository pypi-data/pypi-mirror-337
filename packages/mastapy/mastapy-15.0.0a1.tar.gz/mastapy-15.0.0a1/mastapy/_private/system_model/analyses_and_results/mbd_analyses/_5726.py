...
class PulleyMultibodyDynamicsAnalysis(_5665.CouplingHalfMultibodyDynamicsAnalysis):
    """PulleyMultibodyDynamicsAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7769.PulleyLoadCase":
    ...
    @property
    def peak_pulley_torque(self: "Self") -> "List[_5777.DynamicTorqueResultAtTime]":
