...
class V0041OpenapiUsersAddCondRespAssociationCondition(BaseModel):
    ...
    accounts: Optional[List[StrictStr]] = Field(
        default=None, description="CSV accounts list"
    )
    ...
    partitions: Optional[List[StrictStr]] = Field(
        default=None, description="CSV partitions list"
    )
    users: List[StrictStr] = Field(description="CSV users list")
    wckeys: Optional[List[StrictStr]] = Field(
        default=None, description="CSV WCKeys list"
    )
