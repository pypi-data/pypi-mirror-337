...
from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import _839
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import _827
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _824
...
class _Cast_WormGrinderSimulationCalculator:
    ...
    @property
    def cutter_simulation_calc(self: "CastSelf") -> "_827.CutterSimulationCalc":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _827,
        )

        return self.__parent__._cast(_827.CutterSimulationCalc)
...
class WormGrinderSimulationCalculator(_839.RackSimulationCalculator):
    """WormGrinderSimulationCalculator
    ...
    @property
    def worm_grinder(self: "Self") -> "_824.CylindricalGearWormGrinderShape":
