...
class _Cast_AGMAScuffingResultsRow:
    ...
    @property
    def scuffing_results_row(self: "CastSelf") -> "_568.ScuffingResultsRow":
        return self.__parent__._cast(_568.ScuffingResultsRow)
...
class AGMAScuffingResultsRow(_568.ScuffingResultsRow):
    """AGMAScuffingResultsRow
