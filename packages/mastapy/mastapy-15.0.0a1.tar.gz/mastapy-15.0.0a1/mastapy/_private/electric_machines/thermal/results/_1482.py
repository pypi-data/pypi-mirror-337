...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.thermal.results import _1483, _1486
...
class ThermalResults(_0.APIBase):
    ...
    @property
    def fe_thermal_results(self: "Self") -> "List[_1483.ThermalResultsForFEComponent]":
    ...
    @property
    def heat_dissipation(self: "Self") -> "List[_1488.HeatDissipationReporter]":
    ...
    @property
    def heat_flows(self: "Self") -> "List[_1489.HeatFlowReporter]":
    ...
    def heat_transfer_coefficients(
        self: "Self",
    ) -> "List[_1490.HeatTransferCoefficientReporter]":
    ...
    @property
    def lptn_node_results(self: "Self") -> "List[_1486.ThermalResultsForLPTNNode]":
    ...
    @property
    def pressure_drops(self: "Self") -> "List[_1492.PressureDropReporter]":
