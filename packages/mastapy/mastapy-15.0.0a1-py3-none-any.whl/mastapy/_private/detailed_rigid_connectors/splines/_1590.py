...
class SplineHalfDesign(_1564.DetailedRigidConnectorHalfDesign):
    """SplineHalfDesign
    ...
    @property
    def heat_treatment(self: "Self") -> "_1574.HeatTreatmentTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.detailed_rigid_connectors.splines._1574",
            "HeatTreatmentTypes",
        )(value)

    @heat_treatment.setter
    @enforce_parameter_types
    def heat_treatment(self: "Self", value: "_1574.HeatTreatmentTypes") -> None:
    ...
    @property
    def fit_and_tolerance(self: "Self") -> "_1597.FitAndTolerance":
