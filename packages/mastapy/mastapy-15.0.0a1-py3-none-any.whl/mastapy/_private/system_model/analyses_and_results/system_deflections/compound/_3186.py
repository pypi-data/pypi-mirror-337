...
class WormGearCompoundSystemDeflection(_3118.GearCompoundSystemDeflection):
    """WormGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self: "Self") -> "_456.WormGearDutyCycleRating":
    ...
    @property
    def worm_duty_cycle_rating(self: "Self") -> "_456.WormGearDutyCycleRating":
        """mastapy.gears.rating.worm.WormGearDutyCycleRating
