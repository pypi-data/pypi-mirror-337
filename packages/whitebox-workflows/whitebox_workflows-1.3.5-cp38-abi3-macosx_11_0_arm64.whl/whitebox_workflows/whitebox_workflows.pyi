...
def checked_out_licenses(key: str) -> str: ...
...
class WbEnvironment():
	...
	def fuzzy_knn_classification(self, input_rasters: List[Raster], training_data: Vector, class_field_name: str, scaling_method: str = "none", k: int = 5, m: float = 2.0, create_output: bool = False) -> Optional[Tuple[Raster, Raster]]: ...
