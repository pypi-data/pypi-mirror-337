...
class Overridable_FrictionModelForGyroscopicMoment(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        cls: "Type[Overridable_FrictionModelForGyroscopicMoment]",
    ) -> "_2160.FrictionModelForGyroscopicMoment":
        ...
        Returns:
            _2160.FrictionModelForGyroscopicMoment
        """
        return _2160.FrictionModelForGyroscopicMoment
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2160.FrictionModelForGyroscopicMoment.type_()

    @property
    def value(self: "Self") -> "_2160.FrictionModelForGyroscopicMoment":
    ...
    @property
    def override_value(self: "Self") -> "_2160.FrictionModelForGyroscopicMoment":
        """mastapy.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment
    ...
    @property
    def calculated_value(self: "Self") -> "_2160.FrictionModelForGyroscopicMoment":
        """mastapy.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment
