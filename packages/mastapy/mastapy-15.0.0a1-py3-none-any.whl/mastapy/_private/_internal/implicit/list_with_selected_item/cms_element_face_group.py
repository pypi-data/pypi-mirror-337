...
class ListWithSelectedItem_CMSElementFaceGroup(
    _304.CMSElementFaceGroup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CMSElementFaceGroup]") -> "Any":
        ...
        Returns:
            Any
        """
        return _304.CMSElementFaceGroup.TYPE

    @property
    def selected_value(self: "Self") -> "_304.CMSElementFaceGroup":
    ...
    @property
    def available_values(self: "Self") -> "List[_304.CMSElementFaceGroup]":
