...
class GearMeshLoadDistributionAnalysis(_1336.GearMeshImplementationAnalysis):
    """GearMeshLoadDistributionAnalysis
    ...
    @property
    def moment_about_centre_fourier_series(self: "Self") -> "_1688.FourierSeries":
    ...
    @property
    def transmission_error_fourier_series(self: "Self") -> "_1688.FourierSeries":
        """mastapy.math_utility.FourierSeries
    ...
    def load_distribution_analyses_at_single_rotation(
        self: "Self",
    ) -> "List[_938.GearMeshLoadDistributionAtRotation]":
    ...
    def maximum_root_stress_with_flanks(
        self: "Self",
        gear: "_936.GearLoadDistributionAnalysis",
        flank: "_409.GearFlanks",
