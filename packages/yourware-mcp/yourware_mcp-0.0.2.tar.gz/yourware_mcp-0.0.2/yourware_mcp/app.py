...
from yourware_mcp.credentials import API_BASE_URL, Credentials
...
async def check_credentials():
    try:
        credentials = Credentials.load_from_file()
...
@mcp.tool(description="Create a new API key")
...
if __name__ == "__main__":
    ...
    async def main():
        await create_api_key("yw-ak-fVgQIv_Vra1pib0ELBuolS5IQvLeioajQvviBKTzVM0=")
        print(await upload_project("/Users/jizhongsheng/Documents/Onlook/Projects/project-1743132548042/out"))
