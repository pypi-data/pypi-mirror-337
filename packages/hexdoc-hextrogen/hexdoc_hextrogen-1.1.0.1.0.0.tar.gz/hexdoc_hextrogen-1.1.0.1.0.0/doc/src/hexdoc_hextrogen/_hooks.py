...
import hexdoc_hextrogen

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HextrogenPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HextrogenModPlugin(branch=branch)


class HextrogenModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hextrogen"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hextrogen, "_templates"
