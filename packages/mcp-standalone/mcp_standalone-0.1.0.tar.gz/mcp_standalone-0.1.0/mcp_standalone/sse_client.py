...
async def sse_client(url: str) -> Tuple[Callable[[], AsyncGenerator[Dict[str, Any], None]], Callable[[Dict[str, Any]], None]]:
    """
    ...
    async def connection_task():
        ...
        try:
            async with aconnect_sse(client, "POST", url, json={}) as event_source:
                ...
                write_task = asyncio.create_task(handle_writes(client, url))
