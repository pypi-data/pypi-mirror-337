...
class tasklist(BaseModel):
    ...
    task_created_at: datetime = Field(default_factory=datetime.now(datetime.timez.utc), description="Task creation timestamp")
    task_updated_at: datetime = Field(default_factory=datetime.now(datetime.timez.utc), description="Task update timestamp")
...
class Document(BaseModel):
    ...
    created_at: datetime = Field(default_factory=datetime.now(datetime.timez.utc), description="Creation timestamp")
