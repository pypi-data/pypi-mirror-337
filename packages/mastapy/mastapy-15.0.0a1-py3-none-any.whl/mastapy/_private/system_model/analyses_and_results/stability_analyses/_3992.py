...
class AssemblyStabilityAnalysis(_3985.AbstractAssemblyStabilityAnalysis):
    """AssemblyStabilityAnalysis
    ...
    @property
    def bearings(self: "Self") -> "List[_3993.BearingStabilityAnalysis]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_3995.BeltDriveStabilityAnalysis]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_4004.BoltedJointStabilityAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_4005.BoltStabilityAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_4028.CVTStabilityAnalysis]":
    ...
    @property
    def clutches(self: "Self") -> "List[_4008.ClutchStabilityAnalysis]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_4032.CycloidalDiscStabilityAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_4043.FEPartStabilityAnalysis]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_4041.FaceGearSetStabilityAnalysis]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_4050.HypoidGearSetStabilityAnalysis]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_4062.MassDiscStabilityAnalysis]":
    ...
    @property
    def microphones(self: "Self") -> "List[_4065.MicrophoneStabilityAnalysis]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_4067.OilSealStabilityAnalysis]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_4074.PlanetCarrierStabilityAnalysis]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_4075.PointLoadStabilityAnalysis]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_4076.PowerLoadStabilityAnalysis]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_4078.RingPinsStabilityAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_4085.ShaftStabilityAnalysis]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_4093.SpringDamperStabilityAnalysis]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_4108.SynchroniserStabilityAnalysis]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_4116.WormGearSetStabilityAnalysis]":
