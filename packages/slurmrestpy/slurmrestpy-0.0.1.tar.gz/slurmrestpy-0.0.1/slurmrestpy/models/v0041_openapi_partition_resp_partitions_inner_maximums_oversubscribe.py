...
class V0041OpenapiPartitionRespPartitionsInnerMaximumsOversubscribe(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"jobs": obj.get("jobs"), "flags": obj.get("flags")})
        return _obj
