...
def create_parser():
    ...
    parser.add_argument('--check-version', '-cv', action=ChkVersionAction, help="Check for new program version")
    ...
    parser.add_argument('--proxy','-P',type=str,help="Set a http(s) proxy connection")
