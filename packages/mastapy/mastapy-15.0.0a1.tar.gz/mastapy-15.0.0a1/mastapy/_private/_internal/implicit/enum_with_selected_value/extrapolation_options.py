...
class EnumWithSelectedValue_ExtrapolationOptions(
    ...
    def wrapped_type(
        ...
        Returns:
            _1685.ExtrapolationOptions
        """
        return _1685.ExtrapolationOptions
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ExtrapolationOptions]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1685.ExtrapolationOptions.type_()

    @property
    def selected_value(self: "Self") -> "_1685.ExtrapolationOptions":
    ...
    @property
    def available_values(self: "Self") -> "List[_1685.ExtrapolationOptions]":
