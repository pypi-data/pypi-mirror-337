...
from mastapy._private.system_model.fe import _2569
...
class _Cast_ElementFaceGroupWithSelection:
    ...
    def fe_entity_group_with_selection(
        self: "CastSelf",
    ) -> "_2569.FEEntityGroupWithSelection":
        return self.__parent__._cast(_2569.FEEntityGroupWithSelection)
...
class ElementFaceGroupWithSelection(
    _2569.FEEntityGroupWithSelection[_304.CMSElementFaceGroup, _1347.ElementFace]
):
    """ElementFaceGroupWithSelection
