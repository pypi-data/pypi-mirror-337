...
class xanes2D_tools_gui:
    def __init__(self, parent_h, form_sz=[650, 740]):
        ...
        self.xanes_visualization_auto_bc = True

        self.xanes_img = None
        self.xanes_img_order = 1
    ...
    def build_gui(self):
        ...
        self.hs["XNS2DCfgData acc"] = widgets.Accordion(
            layout={
                "width": "auto",
                "height": "auto",
        ...
        self.hs["XNS2DCfgData acc"].children = [
            self.hs["SelFile&Path box"],
            self.hs["DataConfig&Info tab"],
        ]
        self.hs["XNS2DCfgData acc"].titles = [
            "Config Input/Output File Paths",
            "Config Data",
        ]

        self.hs["XNS2DCfgData acc"].selected_index = 0
        self.hs["Config&Input form"].children = [self.hs["XNS2DCfgData acc"]]
        ...
        self.hs["XNS2DCfgReg acc"] = widgets.Accordion(
            layout={
                "width": "auto",
                "height": "auto",
                "border": "3px solid #8855AA",
        ...
        self.hs["XNS2DCfgReg acc"].children = [
            self.hs["2DRoi box"],
        ...
        self.hs["XNS2DCfgReg acc"].titles = [
        ...
        self.hs["XNS2DCfgReg acc"].selected_index = None
        self.hs["RegSetting form"].children = [self.hs["XNS2DCfgReg acc"]]
    ...
    def update_xanes2D_config(self):
        ...
        self.xanes_config = {
            ...
            "data_config": {
                "xanes2D_config_is_raw": self.xanes_config_is_raw,
                "xanes2D_config_img_scalar": self.xanes_config_img_scalar,
                "xanes2D_config_img_order": self.xanes_img_order,
                "xanes2D_config_use_alternative_flat": self.xanes_config_use_alternative_flat,
                "xanes2D_config_use_smooth_flat": self.xanes_config_use_smooth_flat,
                "xanes2D_config_smooth_flat_sigma": self.xanes_config_smooth_flat_sigma,
                "xanes2D_config_alternative_flat_filename": self.xanes_config_alternative_flat_filename,
    ...
    def set_xanes2D_variables(self):
        ...
        self.xanes_img_order = self.xanes_config["data_config"][
            "xanes2D_config_img_order"
        ]
        ...
        self.xanes_reg_mrtv_smth_knl = self.xanes_config["registration_config"][
        ...
        if self.xanes_reg_done:
            ...
            (self.xanes_config_eng_list, self.xanes_img_order) = order_eng(
                self.xanes_config_eng_list
            )
            print(self.xanes_config_eng_list)
            ...
            self.reg_cfg = {
                ...
                "reg": {
                    ...
                    "XANES3D_sli_srch_half_range": 10,
                    "XANES3D_fixed_ref_sli": 0,
                    "alg_pars": {
                        "MRTV": {
                ...
                "data": {
                    "im_id_s": self.xanes_eng_id_s,
                    "im_id_e": self.xanes_eng_id_e + 1,
                    "im_id_fixed": self.xanes_reg_anchor_idx,
                    "XANES3D_scn_ids": [],
                    "roi": self.xanes_reg_roi,
                },
                "file": {
                    "XANES3D_raw_h5_top_dir": None,
                    "XANES3D_rec_path_tplt": None,
                    "XANES2D_raw_fn": self.xanes_file_raw_h5_filename,
                ...
                "preproc": {
                    ...
                    "smth_im_sig": self.xanes_reg_smooth_img_sigma,
                },
                "meta": {
                    "eng_list": list(
                        self.xanes_config_eng_list[
    ...
    def boxes_logic(self):
        def xanes2D_compound_logic():
            ...
            if self.hs["IsRaw chbx"].value and self.xanes_file_configured:
        ...
        if self.xanes_file_analysis_option in ["Do New Reg", "Read Config File"]:
            if not self.xanes_file_configured:
                ...
                self.global_h.hs["XANES2D tab"].selected_index = 0
                self.hs["XNS2DCfgData acc"].selected_index = 0
                self.hs["XNS2DCfgReg acc"].selected_index = None
            elif self.xanes_file_configured and not self.xanes_data_configured:
                boxes = [
                    "ConfigData box",
                    "2DRoi box",
                    "ConfigRegParams box",
                ...
                enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)
                self.global_h.hs["XANES2D tab"].selected_index = 0
                self.hs["XNS2DCfgData acc"].selected_index = 1
                self.hs["XNS2DCfgReg acc"].selected_index = None
            elif (
                self.xanes_file_configured
                and self.xanes_data_configured
                ...
                enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)
                self.global_h.hs["XANES2D tab"].selected_index = 1
                self.hs["XNS2DCfgData acc"].selected_index = None
                self.hs["XNS2DCfgReg acc"].selected_index = 0
            elif (
                self.xanes_file_configured
                and self.xanes_data_configured
                ...
                self.global_h.hs["XANES2D tab"].selected_index = 1
                self.hs["XNS2DCfgData acc"].selected_index = None
                self.hs["XNS2DCfgReg acc"].selected_index = 1
            elif (
                self.xanes_file_configured
                and self.xanes_data_configured
                and self.xanes_roi_configured
                ...
                self.global_h.hs["XANES2D tab"].selected_index = 1
                self.hs["XNS2DCfgData acc"].selected_index = None
                self.hs["XNS2DCfgReg acc"].selected_index = 2
            elif (
                self.xanes_file_configured
                and self.xanes_data_configured
                and self.xanes_roi_configured
                ...
                self.global_h.hs["XANES2D tab"].selected_index = 1
                self.hs["XNS2DCfgData acc"].selected_index = None
                self.hs["XNS2DCfgReg acc"].selected_index = 3
            elif (
                self.xanes_file_configured
                and self.xanes_data_configured
                and self.xanes_roi_configured
                ...
                self.global_h.hs["XANES2D tab"].selected_index = 1
                self.hs["XNS2DCfgData acc"].selected_index = None
                self.hs["XNS2DCfgReg acc"].selected_index = 4
            elif (
                self.xanes_file_configured
                and self.xanes_data_configured
                and self.xanes_roi_configured
                ...
                self.global_h.hs["XANES2D tab"].selected_index = 1
                self.hs["XNS2DCfgData acc"].selected_index = None
                self.hs["XNS2DCfgReg acc"].selected_index = 5
            elif (
                self.xanes_file_configured
                and self.xanes_data_configured
                and self.xanes_roi_configured
            ...
            if not self.xanes_file_reg_file_set or not self.xanes_file_configured:
                boxes = ["2DRoi box", "RevRegRlt box", "AlignImg box", "VisImg box"]
                enable_disable_boxes(self.hs, boxes, disabled=True, level=-1)
                boxes = ["Fitting form"]
                enable_disable_boxes(
                ...
                if not self.xanes_on_fitting:
                    ...
                    self.global_h.hs["XANES2D tab"].selected_index = 2
                    self.hs["XNS2DCfgData acc"].selected_index = None
                    self.hs["XNS2DCfgReg acc"].selected_index = None
    ...
    def SelSaveTrial_btn_clk(self, a):
        if self.xanes_file_analysis_option == "Do New Reg":
            ...
            if len(a.files[0]) != 0:
                ...
                self.hs["SelSaveTrial btn"].initialfile = str(Path(a.files[0]).name)
            ...
            if len(a.files[0]) != 0:
                ...
                self.hs["SelSaveTrial text"].value = (
                    f"{self.xanes_file_save_trial_reg_config_filename}"
                )
                self.xanes_file_save_trial_set = False
        ...
        if self.xanes_file_analysis_option == "Do New Reg":
            ...
            if not self.xanes_file_config_file_set:
                ...
                if self.xanes_config_is_raw:
                    if (
                        ...
                        and self.xanes_config_alternative_flat_set
                    ):
                        ...
                        if self.xanes_img_order < 0:
                            self.xanes_img[:] = self.xanes_img[::-1, ...]
                        ...
                        self.xanes_config_use_alternative_flat
                        and not self.xanes_config_alternative_flat_set
                    ):
                        self.xanes_img = None
                        self.xanes_config_raw_img_readed = False
                    elif not self.xanes_config_use_alternative_flat:
                        self.xanes_img = -np.log(
                            (
                                self.reader(
                                    self.xanes_file_raw_h5_filename,
                ...
                if self.xanes_alignment_done:
                    ...
                    if self.xanes_element is None:
                        ...
                        if (
                            ...
                            self.xanes_fit_gui_h.hs["FitEngRagOptn drpdn"].value = "wl"
                            self.xanes_fit_gui_h.hs["FitEngRagOptn drpdn"].disabled = (
                                True
                            )
                            self.xanes_fit_type = "wl"
                        else:
                            self.xanes_fit_gui_h.hs["FitEngRagOptn drpdn"].value = (
                                "full"
                            )
                            self.xanes_fit_gui_h.hs["FitEngRagOptn drpdn"].disabled = (
                                False
            ...
            if not self.xanes_file_config_file_set:
                ...
                if self.xanes_reg_review_done:
                    ...
                    if self.xanes_data_configured:
                        self.xanes_fit_eng_list = self.xanes_config_eng_list[
                            self.xanes_eng_id_s : self.xanes_eng_id_e + 1
                        ]
            ...
            if not self.xanes_file_reg_file_set:
                ...
                try:
                    ...
                    self.xanes_file_configured = False
                    print(
                        "The provided file does not have registered 3D XANES dataset."
                    )
                    self.hs["CfmFile&Path text"].value = (
                        "The provided file does not have registered 3D XANES dataset."
                    )
    ...
    def MrtvSubpixelKernel_text_chg(self, a):
        self.xanes_reg_mrtv_smth_knl = a["owner"].value
        self.xanes_reg_params_configured = False
        self.boxes_logic()
    ...
    def _cal_xanes_reg_mask(self):
        if self.xanes_reg_use_smooth_img and self.xanes_reg_mask_dilation_width > 0:
        ...
        elif self.xanes_reg_use_smooth_img and self.xanes_reg_mask_dilation_width <= 0:
            self.xanes_reg_mask[:] = (
                (
                    gaussian_filter(
                        self.xanes_img[
            ...
            not self.xanes_reg_use_smooth_img and self.xanes_reg_mask_dilation_width > 0
        ):
            ...
            not self.xanes_reg_use_smooth_img
            and self.xanes_reg_mask_dilation_width <= 0
        ):
            self.xanes_reg_mask[:] = (
                (
                    self.xanes_img[
    ...
    def _update_tmp_file(self):
        ...
        with h5py.File(tmp_file, "w") as f:
            ...
            if not np.isscalar(self.xanes_reg_mask) and self.xanes_reg_mask is not None:
                ...
                f.create_dataset("xanes2D_reg_mask", data=1)
