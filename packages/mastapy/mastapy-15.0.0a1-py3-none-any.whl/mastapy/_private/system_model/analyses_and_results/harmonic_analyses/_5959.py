...
class ComponentHarmonicAnalysis(_6046.PartHarmonicAnalysis):
    """ComponentHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4832.ComponentModalAnalysis":
    ...
    @property
    def results(self: "Self") -> "_6129.HarmonicAnalysisResultsPropertyAccessor":
