...
from mastapy._private.nodal_analysis.component_mode_synthesis import _309
...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.component_mode_synthesis import _312, _316
...
class _Cast_RealCMSResults:
    ...
    @property
    def cms_results(self: "CastSelf") -> "_309.CMSResults":
        return self.__parent__._cast(_309.CMSResults)

    @property
    def modal_cms_results(self: "CastSelf") -> "_312.ModalCMSResults":
        from mastapy._private.nodal_analysis.component_mode_synthesis import _312

        return self.__parent__._cast(_312.ModalCMSResults)

    @property
    def static_cms_results(self: "CastSelf") -> "_316.StaticCMSResults":
        from mastapy._private.nodal_analysis.component_mode_synthesis import _316

        return self.__parent__._cast(_316.StaticCMSResults)
...
class RealCMSResults(_309.CMSResults):
    """RealCMSResults
