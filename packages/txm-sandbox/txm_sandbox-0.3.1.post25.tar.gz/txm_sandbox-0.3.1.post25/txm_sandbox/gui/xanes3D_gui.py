...
class xanes3D_tools_gui:
    def __init__(self, parent_h, form_sz=[650, 740]):
        ...
        self.xanes_reg_mrtv_smth_knl = 2
        ...
        self.xanes_scan_id_loc_s = None
        self.xanes_scan_id_loc_e = None
        ...
        self.xanes_config = {
            ...
            "indeices config": {
                ...
                "xanes3D_scan_id_s": self.xanes_scan_id_loc_s,
                "xanes3D_scan_id_e": self.xanes_scan_id_loc_e,
            ...
            "registration config": {
                ...
                "xanes3D_reg_mrtv_subpixel_kernel": self.xanes_reg_mrtv_smth_knl,
    ...
    def update_xanes3D_config(self):
        self.xanes_config = {
            ...
            "indeices config": dict(
                ...
                xanes3D_scan_id_s=self.xanes_available_raw_ids[
                    int(self.xanes_scan_id_loc_s)
                ],
                xanes3D_scan_id_e=self.xanes_available_raw_ids[
                    int(self.xanes_scan_id_loc_e)
                ],
    ...
    def set_xanes3D_variables(self):
        ...
        self.xanes_scan_id_loc_s = self.xanes_available_raw_ids.index(
            self.xanes_config["indeices config"]["xanes3D_scan_id_s"]
        )
        self.xanes_scan_id_loc_e = self.xanes_available_raw_ids.index(
            self.xanes_config["indeices config"]["xanes3D_scan_id_e"]
        )
        ...
        b = glob.glob(
            self.xanes_recon_3D_tiff_temp.format(self.xanes_fixed_scan_id, "*")
        )
        ...
        self.xanes_reg_mrtv_smth_knl = self.xanes_config["registration config"][
        ...
        if self.xanes_reg_done:
            ...
            self.xanes_eng_list = self.reader(
                ...
                self.xanes_available_raw_ids[
                    self.xanes_scan_id_loc_s : self.xanes_scan_id_loc_e + 1
                ],
                dtype="eng",
            ...
            (eng_lst, order) = order_eng(self.xanes_eng_list)
            if order < 0:
                scn_ids = self.xanes_available_raw_ids[
                    self.xanes_scan_id_loc_s : self.xanes_scan_id_loc_e + 1
                ][::-1]
            else:
                scn_ids = self.xanes_available_raw_ids[
            ...
            self.reg_cfg = {
                "data_type": "3D_XANES",
                "reg": {
                    "alg": self.xanes_reg_method,
                    "ref_mode": self.xanes_reg_ref_mode,
                    "use_chnk": self.xanes_reg_use_chunk,
                    "chnk_sz": self.xanes_reg_chunk_sz,
                    "XANES3D_sli_srch_half_range": self.xanes_reg_sli_search_half_width,
                    "XANES3D_fixed_ref_sli": self.xanes_fixed_sli_id,
                    "alg_pars": {
                        "MRTV": {
                            "lvl": self.xanes_reg_mrtv_level,
                            "wz": self.xanes_reg_mrtv_width,
                            "sp_wz": self.xanes_reg_mrtv_subpixel_wz,
                            "smth_knl": self.xanes_reg_mrtv_smth_knl,
                        },
                        "MPC": {"ovlp_r": 0.3},
                        "SR": {"mode": "TRANSLATION"},
                    },
                ...
                "data": {
                    "im_id_s": self.xanes_available_raw_ids[self.xanes_scan_id_loc_s],
                    "im_id_e": self.xanes_available_raw_ids[self.xanes_scan_id_loc_e],
                    "im_id_fixed": self.xanes_fixed_scan_id,
                    "XANES3D_scn_ids": self.xanes_available_raw_ids[
                        self.xanes_scan_id_loc_s : self.xanes_scan_id_loc_e + 1
                    ],
                    "roi": self.xanes_roi,
                },
                "file": {
                    "XANES3D_raw_h5_top_dir": self.xanes_raw_3D_h5_top_dir,
                    "XANES3D_rec_path_tplt": self.xanes_recon_3D_tiff_temp,
                    "XANES2D_raw_fn": None,
                    "XANES_tmp_fn": tmp_file,
                    "sav_fn": self.xanes_save_trial_reg_filename,
                },
                "preproc": {
                    "use_mask": self.xanes_reg_use_mask,
                    "mask_thres": self.xanes_reg_mask_thres,
                    "use_smth_im": self.xanes_reg_use_smooth_img,
                    "smth_im_sig": self.xanes_reg_smooth_sigma,
                },
                "meta": {"eng_list": list(self.xanes_eng_list)},
            }
        else:
            self.reg_cfg = {}
    ...
    def set_xanes3D_handles(self):
        ...
        set_data_widget(
            self,
            "FixedSliId sldr",
            self.xanes_config["indeices config"][
        ...
        set_data_widget(
            self,
            "3DRoiZ sldr",
            self.xanes_config["roi config"]["3D_roi_z_slider_min"],
            self.xanes_config["roi config"]["3D_roi_z_slider_val"],
            self.xanes_config["roi config"]["3D_roi_z_slider_max"],
        )
        set_data_widget(
            self,
            "MaskThres sldr",
            self.xanes_config["registration config"][
        ...
        set_data_widget(
            self,
            "RegPair sldr",
            self.xanes_config["review registration"][
            "reg_pair_slider_min"
        ],
            self.xanes_config["review registration"][
            "reg_pair_slider_val"
    ...
    def boxes_logic(self):
        ...
        if self.xanes_fit_option in ["Do New Reg", "Read Config File"]:
            if not self.xanes_file_configured:
                ...
                self.global_h.hs["XANES3D tab"].selected_index = 0
                self.hs["XNS3DCfgData acc"].selected_index = 0
                self.hs["XNS3DCfgReg acc"].selected_index = None
            elif self.xanes_file_configured and not self.xanes_indices_configured:
                ...
                self.global_h.hs["XANES3D tab"].selected_index = 0
                self.hs["XNS3DCfgData acc"].selected_index = 1
                self.hs["XNS3DCfgReg acc"].selected_index = None
            elif (
                self.xanes_file_configured
                and self.xanes_indices_configured
                and not self.xanes_roi_configured
            ):
                ...
                self.global_h.hs["XANES3D tab"].selected_index = 1
                self.hs["XNS3DCfgData acc"].selected_index = None
                self.hs["XNS3DCfgReg acc"].selected_index = 0
            elif (
                self.xanes_file_configured
                and self.xanes_indices_configured
                and self.xanes_roi_configured
                and not self.xanes_reg_params_configured
            ):
                boxes = [
                    "ConfigData box",
                    "3DRoi box",
                ...
                self.global_h.hs["XANES3D tab"].selected_index = 1
                self.hs["XNS3DCfgData acc"].selected_index = None
                self.hs["XNS3DCfgReg acc"].selected_index = 1
            elif (
                self.xanes_file_configured
                and self.xanes_indices_configured
                and self.xanes_roi_configured
                and self.xanes_reg_params_configured
                and not self.xanes_reg_done
            ):
                boxes = [
                    "ConfigData box",
                    "3DRoi box",
                ...
                self.global_h.hs["XANES3D tab"].selected_index = 1
                self.hs["XNS3DCfgData acc"].selected_index = None
                self.hs["XNS3DCfgReg acc"].selected_index = 2
            elif (
                self.xanes_file_configured
                and self.xanes_indices_configured
                and self.xanes_roi_configured
                and self.xanes_reg_params_configured
                and self.xanes_reg_done
                and not self.xanes_reg_review_done
            ):
                boxes = [
                    "ConfigData box",
                    "3DRoi box",
                ...
                self.global_h.hs["XANES3D tab"].selected_index = 1
                self.hs["XNS3DCfgData acc"].selected_index = None
                self.hs["XNS3DCfgReg acc"].selected_index = 3
            elif (
                self.xanes_file_configured
                and self.xanes_indices_configured
                and self.xanes_roi_configured
                and self.xanes_reg_params_configured
                and self.xanes_reg_done
                and self.xanes_reg_review_done
                and not self.xanes_alignment_done
            ):
                boxes = [
                    "ConfigData box",
                    "3DRoi box",
                ...
                self.global_h.hs["XANES3D tab"].selected_index = 1
                self.hs["XNS3DCfgData acc"].selected_index = None
                self.hs["XNS3DCfgReg acc"].selected_index = 4
            elif (
                self.xanes_file_configured
                and self.xanes_indices_configured
                and self.xanes_roi_configured
                ...
                and self.xanes_reg_done
                and self.xanes_reg_review_done
                and self.xanes_alignment_done
                and self.xanes_element is None
            ):
                boxes = [
                    "ConfigData box",
                    "3DRoi box",
                ...
                self.global_h.hs["XANES3D tab"].selected_index = 1
                self.hs["XNS3DCfgData acc"].selected_index = None
                self.hs["XNS3DCfgReg acc"].selected_index = 5
            elif (
                self.xanes_file_configured
                and self.xanes_indices_configured
                and self.xanes_roi_configured
                ...
                and self.xanes_reg_review_done
                and self.xanes_alignment_done
                and self.xanes_element is not None
                and not self.xanes_fit_eng_configured
            ):
                boxes = [
                    "ConfigData box",
                    "3DRoi box",
                ...
                and self.xanes_alignment_done
                and self.xanes_element is not None
                and self.xanes_fit_eng_configured
            ):
                boxes = [
                    "ConfigData box",
                    "3DRoi box",
            ...
            if not self.xanes_file_configured:
                ...
                self.hs["XNS3DCfgData acc"].selected_index = 0
                self.hs["XNS3DCfgReg acc"].selected_index = None
            elif self.xanes_file_configured and not self.xanes_roi_configured:
                boxes = ["3DRoi box"]
                enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)
            ...
            if not self.xanes_file_configured or not self.xanes_reg_file_set:
                boxes = [
                    "ConfigData box",
                    "3DRoi box",
                    "ConfigRegParams box",
                ...
                self.xanes_reg_file_set
                and self.xanes_file_configured
                and self.xanes_element is None
            ):
                boxes = [
                    "ConfigData box",
                ...
                if not self.xanes_on_fitting:
                    self.global_h.hs["XANES3D tab"].selected_index = 1
                    self.hs["XNS3DCfgData acc"].selected_index = None
                    self.hs["XNS3DCfgReg acc"].selected_index = 5
                else:
                    self.global_h.hs["XANES3D tab"].selected_index = 2
                    self.hs["XNS3DCfgData acc"].selected_index = None
                    self.hs["XNS3DCfgReg acc"].selected_index = None
    ...
    def build_gui(self):
        ...
        self.hs["XNS3DCfgData acc"] = widgets.Accordion(
            layout={
                "width": "auto",
                "height": "auto",
        ...
        self.hs["DataConfig&Info tab"].titles = [
            "||..Config Data..|",
            "|..Data Info..||",
        ]
        ## ## ## ## bundle widgets in hs['DataConfig&Info tab'] -- end

        self.hs["XNS3DCfgData acc"].children = [
            self.hs["SelFile&Path box"],
            self.hs["DataConfig&Info tab"],
        ]
        self.hs["XNS3DCfgData acc"].titles = [
            "START: Config Input/Output File Paths",
            "Config Data",
        ]
        self.hs["XNS3DCfgData acc"].selected_index = 0

        self.hs["Config&Input form"].children = [self.hs["XNS3DCfgData acc"]]
        ## ## ## bundle boxes in hs['Config&Input form'] -- end

        ## ## ## ## define functional widgets each tab in each sub-tab - config roi -- start
        self.hs["XNS3DCfgReg acc"] = widgets.Accordion(
            layout={
                "width": "auto",
                "height": "auto",
                "border": "3px solid #8855AA",
        ...
        self.hs["SliSrch sldr"] = widgets.IntSlider(
            min=1, value=10, disabled=True, description="z search half width"
        )
        layout = {"width": "29%"}
        ...
        self.hs["MRTVSubpixelKernel text"] = widgets.BoundedFloatText(
            value=1.5,
            min=0.1,
            max=20,
            step=0.5,
        ...
        self.hs["VisSpecDefEngs btn"] = widgets.Button(
            description="def fitting eng",
            disabled=True,
            description_tooltip="define fitting energy setting according to the spectrum in the chosen roi",
        )
        self.hs["VisSpecDefEngs btn"].layout = layout
        self.hs["VisSpecDefEngs btn"].style.button_color = "darkviolet"
        ...
        self.hs["XNS3DCfgReg acc"].children = [
            self.hs["3DRoi box"],
        ...
        self.hs["XNS3DCfgReg acc"].titles = [
            "Config ROI for Registration",
            "Config Registration",
            "Run Registration",
            "Review Registration",
            "Align 3D Images",
        ...
        self.hs["RegSetting form"].children = [self.hs["XNS3DCfgReg acc"]]
    ...
    def SelRawH5Path_btn_clk(self, a):
        if len(a.files[0]) != 0:
            ...
            self.hs["SelRawH5Path btn"].initialdir = Path(a.files[0]).absolute()
            self.hs["SelReconPath btn"].initialdir = Path(a.files[0]).absolute()
            self.hs["SelSavTrial btn"].initialdir = Path(a.files[0]).absolute()
            self.hs["ReadAlign btn"].initialdir = Path(a.files[0]).absolute()
        ...
        if self.xanes_fit_option == "Do New Reg":
            if len(a.files[0]) != 0:
                ...
                self.hs["SelSavTrial text"].value = (
                    f"save to {self.xanes_save_trial_reg_filename_template}"
                )
                update_json_content(
                    self.global_h.GUI_cfg_file,
                    {"cwd": str(Path(a.files[0]).absolute().parent)},
            ...
            if len(a.files[0]) != 0:
                ...
                self.hs["SelSavTrial text"].value = (
                    f"read from {self.xanes_save_trial_reg_config_filename_original}"
                )
                update_json_content(
                    self.global_h.GUI_cfg_file,
                    {"cwd": str(Path(a.files[0]).absolute().parent)},
            ...
            if len(a.files[0]) != 0:
                ...
                try:
                    ...
                    b = "{date:%Y-%m-%d-%H-%M-%S}".format(date=datetime.now())
                    self.xanes_save_trial_reg_config_filename = (
                        str(Path(a.files[0]).stem) + "_config_" + b + ".json"
                    )
                    self.hs["SelSavTrial btn"].initialdir = str(
                        Path(a.files[0]).absolute().parent
                    )
                    self.hs["SelSavTrial btn"].initialfile = Path(a.files[0]).name
                    self.hs["SelSavTrial text"].value = (
                        f"read from {self.xanes_save_trial_reg_filename}"
                    )
                    update_json_content(
                        self.global_h.GUI_cfg_file,
                        {"cwd": str(Path(a.files[0]).absolute().parent)},
    ...
    def SelFilePathCfm_btn_clk(self, a):
        if self.xanes_fit_option == "Do New Reg":
            if not self.xanes_raw_h5_path_set:
                ...
                b = glob.glob(
                    str(
                        ...
                        / (self.xanes_raw_3D_h5_temp.split("{")[0]
                        + "*.h5"),
                    )
                )
                ran = set([int(Path(ii).stem.split("_")[-1]) for ii in b])
                b = glob.glob(
                    str(
                        Path(self.xanes_recon_3D_top_dir)
                ...
                ren = set([int(Path(ii).name.split("_")[-1]) for ii in b])
                ...
                if n:
                    ...
                    self.xanes_scan_id_loc_s = 0
                    self.xanes_scan_id_loc_e = len(self.xanes_available_raw_ids) - 1
            ...
            if not self.xanes_config_file_set:
                ...
                if self.xanes_reg_done:
                    with h5py.File(self.xanes_save_trial_reg_filename, "r") as f:
                        self.trial_reg = f[
                            "/trial_registration/trial_reg_results/{0}/trial_reg_img".format(
                                "000"
                            )
                        ][:]
                        self.trial_reg_fixed = f[
                            "/trial_registration/trial_reg_results/{0}/trial_fixed_img".format(
                                "000"
                            )
                        ][:]
                ...
                if self.xanes_alignment_done:
                    ...
                    if self.xanes_element is None:
                        ...
                        self.hs["SelFile&PathCfm text"].value = (
                            "XANES3D file config file is read ..."
                        )
                ...
                if (
                    ...
                    and not self.xanes_indices_configured
                    and not self.xanes_roi_configured
                    and not self.xanes_reg_params_configured
                    and not self.xanes_reg_done
                    and not self.xanes_reg_review_done
            ...
            if not self.xanes_reg_file_set:
                self.hs["SelFile&PathCfm text"].value = (
                    "Please specifiy where to read the registered data ..."
                )
                self.xanes_file_configured = False
                self.xanes_indices_configured = False
                self.xanes_roi_configured = False
                ...
                with h5py.File(self.xanes_save_trial_reg_filename, "r") as f:
                    ...
                    self.xanes_scan_id_loc_s = 0
                    self.xanes_scan_id_loc_e = (
                        f["/trial_registration/trial_reg_parameters/scan_ids"].shape[0]
                        - 1
                    )
                    ...
                    self.xanes_available_raw_ids = f[
    ...
    def SelScanIdStart_drpdn_chg(self, a):
        self.xanes_scan_id_loc_s = self.xanes_available_raw_ids.index(a["owner"].value)
        self.hs["SelScanIdEnd drpdn"].options = self.xanes_available_raw_ids[
            self.xanes_scan_id_loc_s :
        ]
    ...
    def SelScanIdEnd_drpdn_chg(self, a):
        self.xanes_scan_id_loc_e = self.xanes_available_raw_ids.index(a["owner"].value)
        self.hs["FixedScanId drpdn"].options = self.xanes_available_raw_ids[
            self.xanes_scan_id_loc_s : self.xanes_scan_id_loc_e + 1
        ]
        self.hs["FixedScanId drpdn"].value = self.hs["FixedScanId drpdn"].options[0]
    ...
    def FixedScanId_drpdn_chg(self, a):
        ...
        set_data_widget(
            self,
            "FixedSliId sldr",
            self.xanes_available_sli_file_ids[0],
            self.xanes_available_sli_file_ids[0],
            self.xanes_available_sli_file_ids[-1],
        )
    ...
    def ConfigDataCfm_btn_clk(self, a):
        if self.xanes_fit_option == "Do New Reg":
            self.xanes_save_trial_reg_filename = str(
                ...
                / self.xanes_save_trial_reg_filename_template.format(
                    self.xanes_available_raw_ids[self.xanes_scan_id_loc_s],
                    self.xanes_available_raw_ids[self.xanes_scan_id_loc_e],
                )
            )
        ...
        if not self.xanes_indices_configured:
            im_x = self.global_h.xanes3D_fiji_windows[
                "xanes3D_virtural_stack_preview_viewer"
            ]["ip"].getWidth()
            im_y = self.global_h.xanes3D_fiji_windows[
                "xanes3D_virtural_stack_preview_viewer"
            ]["ip"].getHeight()
            set_data_widget(
                self, "3DRoiX sldr", 0, [int(im_x / 4), int(3 * im_x / 4)], im_x
            )
            set_data_widget(
                self, "3DRoiY sldr", 0, [int(im_y / 4), int(3 * im_y / 4)], im_x
            )
            set_data_widget(
                self,
                "3DRoiZ sldr",
                self.hs["FixedSliId sldr"].min,
                [self.hs["FixedSliId sldr"].min, self.hs["FixedSliId sldr"].max],
                self.hs["FixedSliId sldr"].max,
            )
            self.xanes_scan_id_loc_s = self.xanes_available_raw_ids.index(
                self.hs["SelScanIdStart drpdn"].value
            )
            ...
            self.hs["RegPair sldr"].max = (
                self.xanes_scan_id_loc_e - self.xanes_scan_id_loc_s
            )
    ...
    def MaskThres_sldr_chg(self, a):
        if self.xanes_reg_use_mask:
            ...
            self._cal_xanes_reg_mask()
            self._update_mask_viewer()
    ...
    def ConfigRegParamsCfm_btn_clk(self, a):
        ...
        self.xanes_reg_mrtv_smth_knl = self.hs["MRTVSubpixelKernel text"].value
        if self.hs["MRTVSubpixelSrch drpdn"].value == "analytical":
            self.xanes_reg_mrtv_subpixel_srch_option = "ana"
        else:
    ...
    def RunRegCfm_btn_clk(self, a):
        ...
        ln += 1
        code[ln] = f"reg = xr.regtools({self.reg_cfg})"
        ln += 1
        code[ln] = f"from multiprocess import freeze_support"
        ln += 1
        ...
        sig = os.system(f"ipython {self.xanes_reg_external_command_name}")
    ...
    def RegPair_sldr_chg(self, a):
        ...
        with h5py.File(self.xanes_save_trial_reg_filename, "r") as f:
            ...
            shift = f[
                "/trial_registration/trial_reg_results/{0}/shift".format(
                    str(self.xanes_alignment_pair_id).zfill(3)
                )
            ][:]
            if self.xanes_reg_method == "MRTV":
                best_match = f[
                    "/trial_registration/trial_reg_results/{0}/mrtv_best_shift_id".format(
                        str(self.xanes_alignment_pair_id).zfill(3)
                    )
                ][()]
            else:
    ...
    def CorrShftRecord_btn_clk(self, a):
        ...
        self.xanes_review_shift_dict[f"{self.xanes_alignment_pair_id}"] = np.array(
            [
                best_match - self.xanes_reg_sli_search_half_width,
    ...
    def AlignReconCfm_btn_clk(self, a):
        ...
        for key in self.xanes_review_shift_dict.keys():
            shft_dict["shft_by_pair_id"][key] = [*self.xanes_review_shift_dict[key], 0]
        with h5py.File(self.xanes_save_trial_reg_filename, "r") as f:
        ...
        code[ln] = f"reg = xr.regtools({self.reg_cfg})"
        ln += 1
        code[ln] = f"reg.apply_xanes3D_chunk_shift({shft_dict['shft_by_pair_id']})"
        ln += 1

        gen_external_py_script(self.xanes_align_external_command_name, code)
        sig = os.system(f"ipython '{self.xanes_align_external_command_name}'")
        if sig == 0:
            ...
            if self.xanes_element is None:
                ...
                self.xanes_fit_type = "full"
                self.xanes_fit_gui_h.hs["FitEngRagOptn drpdn"].value = "full"
                self.hs["SelFile&PathCfm text"].value = "XANES3D file config is read"
        ...
        self.boxes_logic()
        self.xanes_fit_gui_h.boxes_logic()
    ...
    def VisImgViewAlignSli_sldr_chg(self, a):
        # this is 'E' dim in 'x-y-E'
        if self.xanes_fit_view_option in ["x-y-E", "y-z-E", "z-x-E"]:
        ...
        self.global_h.xanes3D_fiji_windows["xanes3D_analysis_viewer"]["ip"].setSlice(
            a["owner"].value + 1
        )
        self.global_h.ij.py.run_macro("""run("Enhance Contrast", "saturated=0.35")""")
        self.boxes_logic()
    ...
    def VisSpecDefEngs_btn_clk(self, a):
        data_state, viewer_state = fiji_viewer_state(
            self.global_h, self, viewer_name="xanes3D_analysis_viewer"
        )
        if viewer_state:
            try:
                x_roi = [
                    int(ii)
                    for ii in self.global_h.xanes3D_fiji_windows[
                ...
                wlen = min(21, int(round(self.xanes_aligned_data.shape[0] / 3.0)))
                podr = min(3, wlen - 1)
                spec = savgol_filter(
                    self.xanes_aligned_data[
                        :, y_roi[0] : y_roi[3], x_roi[0] : x_roi[1]
                    ].mean(axis=(1, 2)),
                    window_length=wlen,
                    polyorder=podr,
                    axis=0,
                ...
                wl_id = spec.argmax()
                wl_eng = self.xanes_fit_eng_list[wl_id]
                wl_fit_s = self.xanes_fit_eng_list[
                    index_of(self.xanes_fit_eng_list, wl_eng - 4)
                ]
                wl_fit_e = self.xanes_fit_eng_list[
                    index_of(self.xanes_fit_eng_list, wl_eng + 4)
                ]
                edge_fit_s = self.xanes_fit_eng_list[
                    index_of(self.xanes_fit_eng_list, wl_eng - 10)
                ]
                edge_fit_e = self.xanes_fit_eng_list[
                    index_of(self.xanes_fit_eng_list, wl_eng - 2)
                ]
                edge_eng = self.xanes_fit_eng_list[
                    index_of(self.xanes_fit_eng_list, wl_eng - 6)
                ]
                if wl_eng - self.xanes_fit_eng_list[0] < 50:
                    self.xanes_fit_gui_h.hs["FitEngRagOptn drpdn"].value = "wl"
                    self.xanes_fit_gui_h.hs["FitEngRagWlFitStr text"].value = wl_fit_s
                    self.xanes_fit_gui_h.hs["FitEngRagWlFitEnd text"].value = wl_fit_e
                else:
                    self.xanes_fit_gui_h.hs["FitEngRagOptn drpdn"].value = "full"
                    self.xanes_fit_gui_h.hs["FitEngRagEdgeEng text"].value = edge_eng
                    self.xanes_fit_gui_h.hs["FitEngRagPreEdgeEnd text"].value = -50
                    self.xanes_fit_gui_h.hs["FitEngRagPostEdgeStr text"].value = 100
                    self.xanes_fit_gui_h.hs["FitEngRagWlFitStr text"].value = wl_fit_s
                    self.xanes_fit_gui_h.hs["FitEngRagWlFitEnd text"].value = wl_fit_e
                    self.xanes_fit_gui_h.hs["FitEngRagEdge0.5Str text"].value = (
                        edge_fit_s
                    )
                    self.xanes_fit_gui_h.hs["FitEngRagEdge0.5End text"].value = (
                        edge_fit_e
                    )
            except:
                print("Please select a region of interest (roi) first!")
        else:
            print(
                "Please click 'spec in roi' button and select a region of interest (roi) first!"
            )
        self.boxes_logic()
        self.xanes_fit_gui_h.boxes_logic()

    def _update_mask_viewer(self):
    ...
    def _update_tmp_file(self):
        ...
        with h5py.File(tmp_file, "w") as f:
            ...
            if not np.isscalar(self.xanes_reg_mask) and self.xanes_reg_mask is not None:
                f.create_dataset(
                    "xanes3D_reg_mask", data=self.xanes_reg_mask.astype(np.float32)
                )
            else:
                f.create_dataset("xanes3D_reg_mask", data=1)
