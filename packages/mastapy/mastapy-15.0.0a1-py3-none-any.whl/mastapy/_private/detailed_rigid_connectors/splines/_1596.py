...
from mastapy._private.detailed_rigid_connectors.splines import _1579, _1580, _1591
...
class StandardSplineJointDesign(_1591.SplineJointDesign):
    """StandardSplineJointDesign
    ...
    @enforce_parameter_types
    def module_preferred(self: "Self", value: "_1579.Modules") -> None:
    ...
    @enforce_parameter_types
    def pressure_angle_preferred(
        self: "Self", value: "_1580.PressureAngleTypes"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
