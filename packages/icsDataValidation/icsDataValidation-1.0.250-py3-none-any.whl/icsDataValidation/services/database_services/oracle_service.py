    ...
    def create_pandas_df_from_group_by(
        ...
        try:
            ...
            for column in aggregation_columns:
                ...
                elif 'char' in column_datatype.lower()  or column_datatype.lower() == 'date' or 'timestamp' in  column_datatype.lower() or 'interval' in  column_datatype.lower() or 'raw' in  column_datatype.lower():
