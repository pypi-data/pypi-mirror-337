...
from mastapy._private.system_model.fe import _2562
...
class _Cast_DegreeOfFreedomBoundaryConditionAngular:
    ...
    def degree_of_freedom_boundary_condition(
        self: "CastSelf",
    ) -> "_2562.DegreeOfFreedomBoundaryCondition":
        return self.__parent__._cast(_2562.DegreeOfFreedomBoundaryCondition)
...
class DegreeOfFreedomBoundaryConditionAngular(_2562.DegreeOfFreedomBoundaryCondition):
    """DegreeOfFreedomBoundaryConditionAngular
