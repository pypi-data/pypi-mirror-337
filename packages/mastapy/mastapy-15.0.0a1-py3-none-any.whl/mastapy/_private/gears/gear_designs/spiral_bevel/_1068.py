...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.spiral_bevel import _1066, _1067
...
class SpiralBevelGearSetDesign(_1295.BevelGearSetDesign):
    """SpiralBevelGearSetDesign
    ...
    @property
    def gears(self: "Self") -> "List[_1066.SpiralBevelGearDesign]":
    ...
    @property
    def spiral_bevel_meshes(self: "Self") -> "List[_1067.SpiralBevelGearMeshDesign]":
