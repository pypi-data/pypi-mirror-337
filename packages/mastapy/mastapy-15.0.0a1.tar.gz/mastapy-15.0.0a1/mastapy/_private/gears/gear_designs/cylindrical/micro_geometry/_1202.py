...
class CylindricalGearLeadModification(_656.LeadModification):
    """CylindricalGearLeadModification
    ...
    @property
    def lead_modification_chart(self: "Self") -> "_2053.TwoDChartDefinition":
    ...
    def lead_modification_for_customer_102cad(
        self: "Self",
    ) -> "_1221.LeadModificationForCustomer102CAD":
