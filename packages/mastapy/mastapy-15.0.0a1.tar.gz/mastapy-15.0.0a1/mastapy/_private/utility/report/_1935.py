...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.report import _1927
...
class _Cast_CustomReportChartItem:
    ...
    def custom_report_property_item(
        self: "CastSelf",
    ) -> "_1951.CustomReportPropertyItem":
        return self.__parent__._cast(_1951.CustomReportPropertyItem)
...
class CustomReportChartItem(_1951.CustomReportPropertyItem):
    """CustomReportChartItem
    ...
    @property
    def point_shape(self: "Self") -> "_1927.SMTChartPointShape":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.report._1927", "SMTChartPointShape"
        )(value)

    @point_shape.setter
    @enforce_parameter_types
    def point_shape(self: "Self", value: "_1927.SMTChartPointShape") -> None:
