...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.modal_analyses import _4837
    from mastapy._private.system_model.analyses_and_results.modal_analyses.compound import (
        _4990,
        _5044,
        _5046,
...
class ConceptGearCompoundModalAnalysis(_5023.GearCompoundModalAnalysis):
    """ConceptGearCompoundModalAnalysis
