...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.conical import _624, _625
...
class ConicalGearDutyCycleRating(_441.GearDutyCycleRating):
    """ConicalGearDutyCycleRating
    ...
    @property
    def gear_ratings(self: "Self") -> "List[_624.ConicalGearRating]":
    ...
    @property
    def conical_gear_ratings(self: "Self") -> "List[_624.ConicalGearRating]":
        """List[mastapy.gears.rating.conical.ConicalGearRating]
