...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.virtual_cylindrical_gears import _472, _473
...
class _Cast_KlingelnbergHypoidVirtualCylindricalGear:
    ...
    def virtual_cylindrical_gear_basic(
        self: "CastSelf",
    ) -> "_473.VirtualCylindricalGearBasic":
        from mastapy._private.gears.rating.virtual_cylindrical_gears import _473

        return self.__parent__._cast(_473.VirtualCylindricalGearBasic)
...
class KlingelnbergHypoidVirtualCylindricalGear(_470.KlingelnbergVirtualCylindricalGear):
    """KlingelnbergHypoidVirtualCylindricalGear
