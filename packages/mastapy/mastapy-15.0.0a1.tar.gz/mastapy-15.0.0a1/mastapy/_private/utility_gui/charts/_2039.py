...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility_gui.charts import _2044, _2050
...
class _Cast_ConstantLine:
    ...
    @property
    def mode_constant_line(self: "CastSelf") -> "_2044.ModeConstantLine":
        from mastapy._private.utility_gui.charts import _2044

        return self.__parent__._cast(_2044.ModeConstantLine)
...
class ConstantLine(_0.APIBase):
    ...
    @property
    def axis(self: "Self") -> "_2050.SMTAxis":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility_gui.charts._2050", "SMTAxis"
        )(value)
